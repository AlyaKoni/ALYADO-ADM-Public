...
function LoginTo-SPO()
{
    ...
    if (-Not $Site)
    {
        Connect-SPOService -Region $AlyaSharePointEnvironment -Url $AlyaSharePointAdminUrl -ModernAuth $true -UseSystemBrowser $true
    }
    try { $Site = Get-SPOSite -Identity $AlyaSharePointAdminUrl -ErrorAction SilentlyContinue } catch {}
    if (-Not $Site)
    {
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCC2V2r+vaRJxGRE
# eNHZOfhuE/DymAlRoxAWhN7W5EDN0qCCFIswggWiMIIEiqADAgECAhB4AxhCRXCK
...
# KwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIMAk/6ad
# frlyoGYx8Th3SvGPW2bGzFyeLbyiswU3GB2lMA0GCSqGSIb3DQEBAQUABIICAL92
# asE2he7DuOJYe8MjSowm9Cr3MX664+/gRoOcVhbWUsvbrQxQdFWxodcZcoNrBkCM
# mEfrvHKRMxTOVUiBYWZzMtvHNGb2mKGtjx1SV/+TDv1fkdV+ihwRA6p9vZwvsQZH
# tZfnbLcpmP4OFNQYoOtChCjHebXIuCJYL7x4XvIrD/jnKXWm+YNRkbTtg8Twc3XM
# v0mn8QrouWFiRAfBYJY/O1TKlj/HJqobM0oeDG7OLLNq2Eaw3fGdKPx+x90PatSu
# f4MmkitZuNOk0TwfIoeZMiYPbitxIfGgaQSF4cmGiINRne3IgQwzv6dtIcpXWqcl
# ukN5gu5Ec0HlDpl4Ji6qzcfOTYLMYTcOqP2I+QpPZ1wt+s2e7rzfz2AR8qMOYhRl
# g4XV2JtRYiqDzuIuMgqyKBH9w6wNXgG5V03Cz2BT2zfKuA/k0EzVwSIlaOFMiIPh
# GMbpMH+udOxFLMiO4TdHbQnnpc2FUXRigE/iwEEHjPtnKMEhgArbgf1qo2EpHyMT
# 7ppektjM6KSQDEUV/pmBIj+m0J2/pBegx0PZC+WuPGoP1Y9mcrNY/ee+NbkfbsdT
# 1JPH9V0Cr8qlzseomJAdQwfHPsJpwfxDIXFtuFTqRMiGNYtyas0Gy3XmAS/vyccU
# G5Pc5IRRhVp8d7humi+/MBQfCpB/9CEVbu6y62qRoYIWuzCCFrcGCisGAQQBgjcD
...
# SAFlAwQCAQUABCCHnD/IdX9R1DAxgq1sE0gTGs5MO0zZS33wJ/g+yTzFaQIUChvk
# 5iCuuR/tSm/3pm4bSCv0snEYDzIwMjUwOTExMTkyNjQ2WjADAgEBoFikVjBUMQsw
...
# AQkEMSIEIFLNyUrdzoMLWo4utncxd19WLmWGUYd4d5JTGgBqrTQHMIGwBgsqhkiG
...
# Mzg0IC0gRzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGALITG
# ATAvjNjfVNGwAV1uBItEWMuZh1I5aYrgFvkzfNQML51itTa2Ink9Mfgj2wqRW6r9
# afMwWyZPS7VdFFExB2fKspkgn5Fa90AXL7IsPElttXr1jNl0QHOwwLA02dd92vHe
# OkiYEK94zpWQLd5pcE2p0L2AcrYt8wKMIK9QNDuL2EVK0zEqFLHzVUt4poF9g/ko
# aGS2pYufyiqpL/3/ev7PXBUzpkmKPCFPPX86m3+QY+IuF2vfs/E737E9JyeaTudr
# 0eeX6ocRIVmA+efDKv28iYiPJbkLbq36abSAHb47O85Ni0mBvMP4LMBtuL6xHu3V
# Qgj+w2FxAweWEgYUSClSVXOj3qmQE7gYeJyfH3xjHcCsB5Ms6Xg6nxwRaYRw/Oex
# eA4Yj7SFA1BE/uXSLBWdURatXhur9wQjcuMFIG4gdYiyVVXtrvwfhEbS7+Md4X8D
# EnzX/5d17kBFSfwCMlmJmyhuVxlJUfRobTcnk3SNsOEYLdsSODUJeczHx7R+
