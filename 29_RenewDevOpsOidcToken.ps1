...
<#
    ...
    ---------- -------------------- ----------------------------
    04.08.2025 Konrad Brunner       Initial version

    Credits: https://integrationworkz.antiohne.nl/2024/01/solving-azure-devops-workload-identity.html
...
{
    Write-Host "Token expires in $expInMinutes minutes. Refresh not required."
}
else
{
    ...
    Write-Host "Checking new OpenID Connect token"
    try {
        $exp = Get-JwtExpiration -jwt $env:idToken
        $now = [int][double]::Parse((Get-Date -UFormat %s))
        $expInMinutes = [Math]::Round(($exp - $now) / 60, 2)
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAsSAk3B+E4Mvt9
# v82UVV78np9YY5h/865ZqmMwvrP0WKCCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIFjnawZVCunERWaC
# zTZTdUinW5eLBrHGy5QtHds1571cMA0GCSqGSIb3DQEBAQUABIICAH2mhcFRRVD1
# 1TZTDUgirV76GepaGsJeAYTB9aXctCUIlmLQHzuEMmUoma81Tk0XJBctnS7G8UPo
# dP1Tiv+mw80VCCW6QMecOk71wBwxS4kSA5w2gflGhP87joZ3IdctBBtX7ljktr/S
# 53h23n7O2/xq1Z1/Zti7jutEHUbqJvYgM+ELUmHA/uy8U9b/p2hsKe0l01lUG/wY
# MWRzCbmVg84X6lLCE7UyyKatnrARtC0XHr1ftazA5435a3r3gCb4XahdlV1Ditfd
# X7jeEC20y3t0TSTc4YQmI3+MhJgkeMA/89J8YrXormTX4EnSCSlbtjE8elFzjUiQ
# 15XdNwFhCNAI5L8LcsB3y2GfYn4FKjurFb7x9to1PzvQ9GlyVtJflSH2+gUCOAZR
# LZr1GBeh34DHcsAXWbXicTcRVXJPmLNZcwTte3lxYuDqdcorqWqM+7nM7mu6yWeZ
# 0wJqLBXEkOKFmqzng+jVjkA/tvGVoWRDP2PzGq+nXvhHYJjSwyTwkPDx8zGf0+FL
# CfYhVfZVDyQTaLCFHxNMsBlaqeZBPXuCIDs9ZrJYoP7kVSO27cvf6TdWIFZaz7xG
# h5B2CM1spv5lnDAr4brLmlWpaNUc0Y4rIxRjG7l/VSNwR+zFyGpUgx6r6I2a4hqL
# mqtYaCKvUr+l20xvAUefaRVTEYr8eM2hoYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCAmXlFe+2eICuiVjUOcIohOSsFFnQCtHcWA2q2iMhm+KwIUTjwMfHvUktvD
# jtZFYpTazgeAMzIYDzIwMjYwMTIwMTAxNzIyWjADAgEBoFikVjBUMQswCQYDVQQG
...
# IP+BF7M9Vp9b/6tGgQyV2S22170qIAjwgmDNj3gz0tBVMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAmzcI101Cf1Bz
# yvHI8ARcCGikbGPEG0cdgBBzlos7c/4Im9XhxqTeDRA0eW4VkY9a7IRgw6gZzBd7
# PIbNWnP0mGeM9D25bvy6FaYuTlV+X4ADQ9uk4zmWjxWCj4pGNDr+AKZnZX/nDCTE
# NkXEuKtZEJVSFHyCHpMslW4Wv6AVrTr4dt124oFpjNeKHQ8HhaybMDinvWt4isRK
# 7mEbb3W5rcsgoXAlItDeFEYhckr+kyz1rKPDulHqyOYCdQ+g5PcpqPYioKC1RYyy
# rTBexRM5Q4mpFRLbzmOkVCwVKWmTN6p4+TetefvcYHIb7crE2+AomMDYHNVK6z2S
# hxCoiYRJm2Mz8pOOkj5pqVsKlZ+M3e+X8gU096ZywK3AMvKmOjcJqWjbnGdstSWm
# WJxK8Z/ToTrIxy3p6jlzGQkX08fSI9AeqzZbQVxKea43on77uASGS33PwybdPg8x
# zDTOeWCMhOn14R9O9TMWtQktEKSZvGhUrw4giaQtLesES1bQ7gu2
