...
<#
.SYNOPSIS
Exports Windows Internet shortcut files (.url) from a script directory hierarchy into a single HTML bookmarks file.

.DESCRIPTION
The script scans the "scripts" directory and its subdirectories for .url files, building a hierarchical data structure based on the folder structure. It then generates an HTML file compatible with browser bookmarks, containing all detected URLs categorized by directory. The resulting file is saved as Favorites.html in the AlyaData directory and automatically opened in Notepad. Logging is performed to record script execution details.

.INPUTS
None. The script operates on files and folders within the predefined paths configured by 01_ConfigureEnv.ps1.

.OUTPUTS
An HTML file named Favorites.html containing all exported URLs formatted as browser bookmarks.

.EXAMPLE
PS> .\30_ExportFavoritesHtml.ps1
Runs the script, exporting all .url files from the scripts directory structure into an HTML bookmarks file and opens it in Notepad.
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCgVn1TbRA+rrkq
# Uu3CZ1vUwTKoAw3a/PNA3+yWVd/AUqCCFIswggWiMIIEiqADAgECAhB4AxhCRXCK
...
# KwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIBaSjJrX
# hvptZ5ljlrwDxYhJxAHjHSOga9/oaRzSDPLdMA0GCSqGSIb3DQEBAQUABIICAFcK
# VSh6TOHf6AZssrTZjb6RqZ/bJs6YItvk0teHAS+AHLhBdZh+mNz1yoIcDEybs6Ev
# zFv9g4Ra+YC+lTxmHN4nbWKNKuH3w7aCbl8ADzO95qFV4YvoZh4E+Wk8Tcu86Tvn
# pC/xFQ9TU67pRPc6p9Afc9v9kXiNd7IiGKH99q989o4qx3cvuO9AdbopTQ8MDvc5
# ox4M7Kib5K0IWSF0qRB6yr3rU9hRxDHqbt7exOwTvHEa9hEdtceNrG//sJ3rglHM
# wCy0tlYFwur16bUQQxhTiN/R2ZJtX/dHiGfhnPPLvI8nXySSA3b8DUtRlrF3fPiG
# HZE1QAWcHqTqNItmpeFZQdYkeNYZN4j02WrDzQo1weVTKdpz7k6q+zOkKMpN4Nic
# fjjDmIubLaIKuz22qRA4DDunJ1Ouc4Xvsmq29uJrXXXGOm6eEtN8AxOnba60nYRH
# oRVSt+SHWINmO1cj09r4F87ueCw84Fi0mAzAbFM071LlULDvLn0lsRNbsS0dzAxn
# FXvDRo058PW6HrqgLyMvE0aW1rGFCikkYjzNr9SlW2VogL1iCKOh2J2XAlqn5H5Y
# pHvd2KHYG+yz2xYimdyqT/VmsgfzjBPJ4miukYSU7ieo74HsKb0yz3CbQlyzUIcS
# eNXl8O0/UZnyUbipdlHvk9VHVvOiZIKTEGM7Hs8JoYIWuzCCFrcGCisGAQQBgjcD
...
# SAFlAwQCAQUABCBKUcyRsmiJLF6BMtb4bufYBIIIYqf+jnCdmlXwDioQ7QIUTuL8
# rdqU5LNuvrdrZLXrfXUKF0YYDzIwMjYwMjEyMjMxNTUwWjADAgEBoFikVjBUMQsw
...
# AQkEMSIEIFJyO5MawGFJXfO64/uBMPIqDBkGOqHBNlffgCXtD92OMIGwBgsqhkiG
...
# Mzg0IC0gRzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAi/7K
# Pq0EUBJN4sXa9RSCVoRoInaDPl9+mkEhDXcO5iiC58NCjANg8HfkDWTMURR/7ci2
# qET5GeqJ5VCJX7Z/u5Z/M0o7JbSfEh9FxWVLxDnPvr5UOXcg1EuKLelpyvFbTYGu
# yXZAYT+FMbffPaZx/ivLKxqCkFbjqwfAHMiceDvRTQ75uBHiDMap+fCfl5lfs/hG
# TCA/3zN+uuAWZ74SJTMGL5ZA5A0BVrAuiWR62omEnYYhMOw2P8DlNiBJei7JrcUP
# ay39UOkEoXQI5ojy3C16tZu5trxxtA+G9HRn0E6NZbnnHvzOFM1AUi5K79k0U9Ft
# qE+yS49Wzd9NZACneKwH1b0m9s3gS9f7Oqwq8ZpppymKZu2WYOscGZsalxvOGp8V
# BaZQu3QwX6pepxStMn5XjVZlpqxcuLzwpsle6+SByKc67QVgxIVGKiBSsHAwQ72B
# c8AFwpKY33wevlpzLTNPhrV6NfRBCReX3cJ6YAc+xtKg0YBDpRCQR2zHg5o2
