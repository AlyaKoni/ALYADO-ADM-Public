...
<# TENANT SETTINGS #>
$AlyaTenantId = "9a5c1cd7-7fa3-4a03-b3aa-7caa0566dcb9" #Example:"11111111-2222-3333-4444-555555555555"
$AlyaTenantNameId = "m365x07855177" #Example:"alyaconsulting"
$AlyaTenantName = "$($AlyaTenantNameId).onmicrosoft.com" #Example:"$($AlyaTenantNameId).onmicrosoft.com"
$AlyaCompanyName = "KILLER CLOUD" #Example:"AlyaConsulting"
$AlyaCompanyNameFull = "killer cloud pty ltd" #Example:"Alya Consulting Inh. Konrad Brunner"
$AlyaCompanyNameShort = "killercloud" #Example:"alya"
$AlyaCompanyNameShortM365 = $AlyaCompanyNameShort.ToUpper()
$AlyaDomainName = "killerclould.com.au" #Example:"alyaconsulting.ch"
$AlyaAdditionalDomainNames = @()
$AlyaLocalDomainName = "killercloud.com.au" #Example:"alyaconsulting.ch"
$AlyaEnvName = "$($AlyaCompanyNameShort)1stp" #Example:"$($AlyaCompanyNameShort)1stp"
$AlyaEnvNameTest = "PleaseSpecify" #Example:"$($AlyaCompanyNameShort)1stt"
$AlyaSubscriptionName = "$($AlyaEnvName)" #Example:"$($AlyaEnvName)"
$AlyaSubscriptionNameTest = $AlyaSubscriptionName #Example:"$($AlyaEnvNameTest)"
$AlyaNamingPrefix = "$($AlyaEnvNameTest)" #Example:"$($AlyaEnvName)"
$AlyaNamingPrefixTest = "$($AlyaEnvNameTest)" #Example:"$($AlyaEnvNameTest)"
$AlyaAllSubscriptions = @(
    $AlyaSubscriptionName, 
    $AlyaSubscriptionNameTest
)
$AlyaLocation = "switzerlandnorth" #Example:"switzerlandnorth"
$AlyaWebPage = "https://killercloud.com.au" #Example:"https://alyaconsulting.ch"
$AlyaPrivacyUrl = "https://killercloud.com.au/privacy" #Example:"https://alyaconsulting.ch/Home/Privacy"
$AlyaPrivacyEmail = "privacy@$($AlyaDomainName)" #Example:"cloud.privacy@$($AlyaDomainName)"
$AlyaSecurityEmail = "privacy@$($AlyaDomainName)" #Example:"cloud.security@$($AlyaDomainName)"
$AlyaGeneralInformEmail = "privacy@$($AlyaDomainName)" #Example:"cloud.general@$($AlyaDomainName)"
$AlyaSupportEmail = "privacy@$($AlyaDomainName)" #Example:"cloud.support@$($AlyaDomainName)"
$AlyaGeneralPhoneNumber = "0000000000000" #Example:"+41625620462"
$AlyaSecurityPhoneNumber = $AlyaGeneralPhoneNumber
$AlyaTimeZone = "AEST" #Example:"W. Europe Standard Time"
$AlyaGeoId = "223" #Example:223
$AlyaDefaultUsageLocation = "AU" #Example:"CH"
$AlyaB2BCompStart = "[" #Example:"["
$AlyaB2BCompEnd = "]" #Example:"]"
$AlyaLicenseType = "EnterpriseOE5" #Example:"BusinessPremium" #"BusinessBasic","BusinessStandard","BusinessPremium","EnterpriseOE1","EnterpriseOE3","EnterpriseOE5","EnterpriseME3orOE3EMSorA3","EnterpriseME5orOE5EMS"
