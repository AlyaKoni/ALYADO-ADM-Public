...
<#
.SYNOPSIS
Extracts and exports Intune application configurations from a JSON configuration file into separate JSON files by application type.

.DESCRIPTION
The ExtractAppsFromConfiguration.ps1 script reads the Intune application configuration from the applications JSON file located in the Configuration\Applications directory. It filters the list to include only assigned applications, removes unnecessary metadata properties, and exports each application type into its own JSON file. The output files are named according to the Microsoft Graph application type and are stored in the same directory as the script.

.INPUTS
None. The script reads from the Configuration\Applications\intuneApplications.json file.

.OUTPUTS
Generates multiple JSON files (e.g., exp-androidManagedStoreApps.json, exp-webApp.json) representing different categories of Intune applications.

.EXAMPLE
PS> .\ExtractAppsFromConfiguration.ps1
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAXHH8fVR8PvRPf
# 9MLrhfkF3AuE+Sg9VXFk1fk0CZT3yaCCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIJ5AMVeNB+BZREHd
# UWVk+1eudHs/oy6TdgRTsVfZT++CMA0GCSqGSIb3DQEBAQUABIICAJOWoWpSynHH
# lKeQH9y/90193yvbXEmBRi2IwZmJWXqt7GuV92ql+WAUIYKi6PCctTt38GR5KDYW
# ZDxr1BKsbhQ+ujQoSfyZ0uwAt7euH9EdyC8Vspd+GZKph6TPwBm9RkiZZJOeIO4M
# KpgZpYCuCX76wdubI3vjisdQVcO9BVKv6RvSz3JhdLfUZHvvKuS1lSqeu3Smo+qP
# RSjzl7P4ZhzKkV85jBnkGdDO8eXnEvT3VCKgI0PLJgDZTL7iWaHlY14Tn+vJbYOJ
# TfadnMmu3yn8/wK6SxA/481dpsGrp2sYcp7vacFK66Rs71Kzr/lTnsMo2rMvF8PL
# M8vHN+uEeJmizlvyGUbkNCidFS1IVY8PW1oiWjfaJoeXDBdC5wvUFCAEmCqlOoNN
# KdbvettvtDoZA5aylQN5Mtzlm19R4f+5zLH4cNXOusPSwkU+mIWi4HzoV2nOvwX1
# LZBWbEwuAyjIsN8YxsCxNDJP8yNorRu19iOLq1U8jgdmtaIGLuq/Fci025eDiTEw
# Oq6I1lT16uZFbwK7ESMRxaI8IUW/ZPKbaE65uaR3yRdWq06pXzgI1viqDCgtoQ+3
# 2LyljTcJVDQ6c+Zll67IZjN8mrWfzkCjhGXGyIjzsz9KUq9ocryIc57L41LSaREP
# 46yscy368pr5TsxmSE+6UJIQyxmgmGaNoYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCB3B+T4TVPIxCiaJMovu4haej29Y4gsCuMq2O/UAm3iuAIUepSFew3QV160
# riL7dns+rHgXv5wYDzIwMjYwMjA2MDk1MDIxWjADAgEBoFikVjBUMQswCQYDVQQG
...
# IEiroDpbhGVjRwPxfjJpD0qWOtwpBHHZHU2RtOtQwenhMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGATareWjsd6up5
# H86uzzJQhmelDmkIivb/hZLsdp6NaXDhUW7X1Xf00CkbmIMienjI1RBCReRrotLV
# K7ik164OoBNcfcFlmpFSBmlWjkQfRGZGXTmtV44IgjCWGkptf4HzN3zsi2Fw00vn
# T4jevnwnk3QLKowCYmGm1Ee8rR7h1EuSLQDhVYGRZaggD8g8U3F9ppzYToNTi0YH
# V1et3oweSZmJGl2UBRlFDQTKZFv3lZFKgreMdgD+iOp4HGrhBR3sSMb2DdjJhnfb
# qrx6nizYbyvzUqOCEmFnkGfN4IdxbFq1d3cK9v9yMCzxleK/kSyePz/wa2qWeeQT
# W5n/+wiw3I0wBnNFuEXKgERYCVEp7YyoEFjLENyP5bqWwchRmGGqolPRTqtKPyIg
# xfK6I4XGjq7WaqBMXJmQbBkwA6eG0h0WGfWroybQzRLWhbq4w1TbzkvtI3km6ma7
# WtyPRe8A/tb+sk1I7W7Iakr5XW884vSLDyva1R7RJZyVJtXs9VDA
