...
else
{
    ...
    if (-Not ($UserLanguageList | where { $_.LanguageTag -eq "fr-CH" })) {
        $UserLanguageList.Add("fr-CH")
    }
    if (-Not ($UserLanguageList | where { $_.LanguageTag -eq "it-CH" })) {
        $UserLanguageList.Add("it-CH")
    }
    if (-Not ($UserLanguageList | where { $_.LanguageTag -eq "en-CH" })) {
