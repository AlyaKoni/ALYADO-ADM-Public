...
<#
.SYNOPSIS
Uninstalls the Microsoft Azure Information Protection Plugin for Adobe Acrobat Reader from the system.

.DESCRIPTION
The script UninstallAcroRdrAzInfoPlugin.ps1 locates and removes the Microsoft Azure Information Protection Plugin for Adobe Acrobat Reader. It ensures that the script runs in 64-bit PowerShell for compatibility, logs all operations in a dedicated log folder, and uses the registry to find uninstall information. The script generates detailed logs during uninstallation and waits until the uninstallation process is complete before exiting with an appropriate exit code.
...
.EXAMPLE
PS> .\UninstallAcroRdrAzInfoPlugin.ps1
Executes the script to automatically uninstall the Microsoft Azure Information Protection Plugin for Adobe Acrobat Reader, logging actions to C:\ProgramData\AlyaConsulting\Logs\.
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCmKsSFYWQ0c1DV
# u/7f0LB/bHmj+jlmYF36gNp9qWazTaCCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIJntpue3cPEE5nLZ
# 0R5XiGlX31yR/s6kIiWq68O88GKNMA0GCSqGSIb3DQEBAQUABIICAB/3w3oMPYIA
# hjv5OUQI8Wwc62dToWpj4k7BviepCYrQPODykueX6JKkD2aSIrooeTwP/WPNdVWg
# Wuep+yRCMZ3rFkutCrOpvvO7hH13gkM1nB4g0HqsMfdI8AEMBeRMwXOuDoJpd5oF
# f/DE6H8zdHEZifnINR1PXuwERHJAM88BZ2SD/Wup3m/P+JwWAaUg41kzb49wBxBh
# qd3KRZqrOc1jU6+aa3+L2XzPiYMBn7C/1jjZPSkz4BDoRh3XDtN4GSzBg/Uylrrm
# 7r/SJoZAETq/kfrRrT8aZkZAxBaD06wfEz5UavzCrANjz42JOqZUcNX4sK1+AIvo
# /gQk9QOqeuCJfcJhurpkBw6gPeyf6IWQRG3nnJTC9QlO38E91VyIVEMCWbfzD+GX
# Vpgf+iSyVZfLS7lUWgghtyo6pNMcbexVgodKuchFSno0sJN8K+oWar+sGg9syknC
# DK3I9DIHp4Gvt5oIUUKvIBavql9OYQdrQR3E/vVtl0ypiPX3QJJ3CXvbYVEqeSuI
# ckZ9KrBV3EKuTNz4twAAUThyuZV+sQICZ+vikPqk7FejGmod+QEk3JPYwXyCDSiE
# VWlMgE8MBvmv/YKcVk8X3ekQghWQCVTT6xWfeuLb5IlGB7qilGY1pWIsvvcc0r8h
# MOPV4CT08sUxoGCJQqaEOezXMbDyceNeoYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCCKU6mcLvcgYyDGYrgkJauZKoiLNro5E/qZuB6eE1pQEAIUPnwkOq2ndOCy
# X+s+aWwVUOSB/74YDzIwMjYwMjEwMTEwNTAzWjADAgEBoFikVjBUMQswCQYDVQQG
...
# IImwe/3IxuhlSZjkyzvqgaCUnPXtuMuaNnFUOJxntdEdMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAJiQ6KLph+CTl
# Odgv2ipHzAWmt4HqsWPPSugnrf60Q6H8dIn2quGg+Wie6WGy9zZwH5qKARoFFyZx
# 1bzw5Nvovi/oNfeVDe2QGMbNrvBEmX492ppoYH+1d+EdcRabC586oQp7NmEAncGH
# Gnda49JRCMQa/U/0BSllgAQo/LZewzE/h/Y0CNRxPqKE5eeBwrATeGgkQaCZ1iwN
# axldPz7xMvHMI8/wpA/OXZWXGJq9HX8fTcq1Ph0dY2tnUJM2lXRlZMETkOyVnqq1
# FOOORfYjJPKsvsTcnaXdw2NA+MI1GfUaIfVrwWPczUK78l6TWDMNgXd7A4HnlD6v
# mNiIa+PR3GToBd5m6y+JV6dmxlMiTiXuZnfn9Y2dEKpiNyLg2dsSBZrpMMrrRM7T
# u8S31X1LLtBvnKUZUh1p3d5cmFALkSz14xqAggtydrlR/yyOv8w9QPD/d5mfpLtP
# TbagoqNZ7K8ryBOW0GeI+4LBONKKZYeZP6+dIV1U34t9Iw4NP02J
