...
<#
.SYNOPSIS
Downloads the Microsoft Purview Information Protection MSI installer automatically or guides the user through a manual download process if automation fails.

.DESCRIPTION
The Download.ps1 script retrieves the PurviewInfoProtection.msi installer from the official Microsoft website. It first attempts to automatically determine and download the file using web requests. If the automatic download fails, the script provides step-by-step instructions to manually download the file via the browser and monitors the user’s download folder to locate the newly downloaded file. Once downloaded (either automatically or manually), the file is placed in the designated Content folder under the package root.

.INPUTS
None. All values are defined internally within the script.

.OUTPUTS
None. The script creates or updates files in the Content folder.
...
try
{
    ...
    $req = Invoke-WebRequest -Uri $pageUrl -MaximumRedirection 0 -UseBasicParsing -ErrorAction Ignore
    [regex]$regex = "http[^`"]*PurviewInfoProtection.msi"
    $newUrl = [regex]::Match($req.Content, $regex, [Text.RegularExpressions.RegexOptions]'IgnoreCase, CultureInvariant').Value
    $fileName = Split-Path -Path $newUrl -Leaf
    Invoke-WebRequestIndep -UseBasicParsing -Method Get -Uri $newUrl -Outfile "$contentRoot\$fileName"
}
catch
{
    Write-Warning "Problems automatically downloading PurviewInfoProtection.msi. Please download manually"
    Write-Host "We launch now a browser with the PurviewInfoProtection.msi download page."
    Write-Host " - Select 'Download'"
    Write-Host " - Select 'PurviewInfoProtection.msi'"
    Write-Host " - Select 'Download"
    Write-Host "`n"
    pause
    ...
    while ($attempts -ge 0)
    {
        Write-Host "Downloading PurviewInfoProtection.msi file from $pageUrl"
    ...
    {
        throw "We were not able to download PurviewInfoProtection.msi"
    }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCXO1ZDACYX7loU
# 8t8+q/MaI6fN57C8Ybj1gM6J4txFE6CCFIswggWiMIIEiqADAgECAhB4AxhCRXCK
...
# KwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEICjrUtlf
# wfq7VjUeQblkzHyMqDPAcjexI85vJswXeW+uMA0GCSqGSIb3DQEBAQUABIICAIAO
# lOgffsO+vLfjftY9uxOiz6Ey3pr3pmtWZWxIEPvZ606XH+KRDHboHx95onIRfiwb
# vxWBJaj3Tgcf9RfB5Xy+NZxQ6cMjZenT6Bgtnw0y3oyMbzHBkSkRd/lajQ24n4fY
# hLHd25Av/1olSoazu+5sMLX/CVVsAC8Fw6iIP7Nwx+Matxgiqi2cRXLE7WPpJWo9
# grh3InLS/YOsE3zTD2RHsEQP8n8f1pP0Sz8+peO/rSmVqn3MPzNs+8IV9gMSnt75
# zzihiK3pr6hKyNCjZnyffYh83ZtXl1/kHNXi4Rh96UBUhXbfECFH2TtETFNV5E0G
# IJCaibIV/OknE4XXS8gMz7dig/44sPVh9LaPBB5ggdf+eGFgE77wg5dqnW6nL+zF
# 5TsaA5ly+1AdS/+vgGEYotAxlptSusm7JSBCllQ2c+8lLeqDP25jA55aA2TVikDh
# cgAZnT2A9mpEuwWbu99Qm0R9585TQTgDlpYPItxHONp03+6R2oTrQ2iF9Nz1ziKZ
# Hj+LI870a+mwMUgJLdBSwmRnQkzye1KOPQLIVIuZxRioNoMZ9P9RkH/eXQvi0gTk
# 6WMJlOlOoiAvtLcs0jSqdZ+5rK3xWHVBJScXmcqhjpdGXNzMocHqHMG8Y7agoY45
# 9eFW8WHBT9fN18dLgFQ8iczU0MQPinHyajXIC+86oYIWuzCCFrcGCisGAQQBgjcD
...
# SAFlAwQCAQUABCBORXbuL/oUovQwOnP8bnU1S5efurA7FbxjyIP0sAOVmAIUXBIW
# yjNxDWDgDUDq+0VvOToAXYgYDzIwMjYwMjE5MjIyMzAyWjADAgEBoFikVjBUMQsw
...
# AQkEMSIEIAiumUQTyFpQCRqTPl9K/+upX3WVi/T3Xnwqd0SDsI1NMIGwBgsqhkiG
...
# Mzg0IC0gRzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAa2Nn
# e1Y0WTb9sfJZGfTLuVZG3C/w5nDWNBTepJ/dfyKR0fLHcTdjhtLbTJDJW8ISt6By
# BjV1/M/her8i726lUHQa/FmMeyvZbRP2NjcS+QOjvl9BZiTqe1shK2uWhPMG/34H
# gegGMNpsT3HfUf4HVCM5f+7eA7j2iI4ylqHrzPMVij0LRXP8otN87obXgaN3yf0l
# kN2yFUll/+8dHnVHd6IqAqOmgXPafwZj9Uzj5XPGt2REBfZr4bk79cbhV8CRDI5h
# MaHvVLmxYS2bpqPDsUgptaoTh8/jW8AihmB9ZXPXV9W7bke38ErfWAh+atqASRGl
# Gok783vlOS+kfKKRh7zIXsbU4USKoFDNqgWMSQaJvcbWfLmTcPCWHD0DqMMAYY/m
# tH+1LnpzcUY1bfEKOAZH9ZRvaQf1UjKZx1YqjOBDKPlWp+uz6Lt4wnmYo1RNuZnb
# xOHpz3pGjUSD3n6plSiiDgZ/pOUUvTioHN20OX93nz6ejINuVCIKP4tgJsTH
