...
if (-Not ($reuseExistingPackages -and (Test-Path "$($AlyaData)\intune\Win32Apps\O365AppsProjects\Package\*.intunewin" -PathType Leaf)))
{
	& "$($AlyaScripts)\intune\Create-IntuneWin32Packages.ps1" -CreateOnlyAppWithName "O365AppsProjects"
}
& "$($AlyaScripts)\intune\Upload-IntuneWin32Packages.ps1" -UploadOnlyAppWithName "O365AppsProjects"
