...
<#
.SYNOPSIS
Installs and configures local printers including necessary drivers, ports, and registry version tracking.

.DESCRIPTION
The Install.ps1 script is part of the Alya Base Configuration and automates the setup of printer infrastructure on Windows systems. It ensures that 64-bit PowerShell is used, unpacks required content, installs printer drivers for Sharp and HP devices, adds specified printer ports and printers, applies configuration settings, and updates the version number in the registry. The script logs its execution and handles error conditions gracefully.

.INPUTS
None. The script does not accept pipeline input.

.OUTPUTS
Log files are generated in C:\ProgramData\AlyaConsulting\Logs\
Registry keys are created or updated in HKLM:\SOFTWARE\AlyaConsulting\Intune\Win32AppVersions
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDcKSsICz3eI52Y
# M9/R8Ru0UScz0Ix7iVt8alU/a+EDO6CCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEICQwfO6Ecxm2K2ab
# CPJpPjVBbFitbDWvqPpBtjh96SacMA0GCSqGSIb3DQEBAQUABIICAJ8F+Eogido+
# wkJM0CxZ4Kcp5rgle7HF7Rteka+b3FS4apFx3ntqccr8k7oCZ/nbrWgAOx5PQ9xe
# 8SUck9BW/3MTSDeG47twdBvVy0K53lzAFrCrNeGaFaZ1dujLexqxLZskP2uxumDr
# j9s9GRJoir/LlKzlXJRNpSBx9hA4a+d7sdNSJxjuk2ILKdVtE7cp1kx1eM/PE9Sp
# HOJ7/KwvPCuu8c2UmDTpH59/uMX5Xlx55oh6qzyY7mgCA1ltrAQJS7lv3hM2Cy2U
# NWyI423JaPsTJ8OQo1cP104e67gpxP4opI8JncqgBEhwIz9iRey173LqdEzMGeJY
# oL0fQIZJWd6/kqDg3Q5IAzq05zvTFoVKPpm3sb4AqvsHeQL8iiPQmPEhVDZ9wEdg
# 0/cTkf9kFmPSSH6SKb6AShT03ekhLZJMFKgJgc+Gpgp/IwG/T8R64UWpsX2SpnnL
# cazMH+VSX8fCpKqwIPGjtYNdRYdqIbhbEwivk/QmO1lbPJOGLW/BOPQlJcVVK1bv
# 6DjrPERif2gGMvp/Y4MqBnBgGVMZT60cVBEeW2lldr7VWOZLbOp4tUBRJL8zF1Ty
# ZYvF46Y25wjPHC4Ahh3CNNLNgLMXvgem3j2H39clZB40y49nbiGi4ZZuAdjuMnjR
# nq7MegIBrWprdXzUlN3AV9qyLQdyHrzxoYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCChzXuaTrNiOxknd6+Rd3aZx0RoX6DEFAt86iW6bvvtngIUDFYiTYhoZw8b
# Bd6GnwynbdoHetUYDzIwMjYwMjA2MTAxMDM3WjADAgEBoFikVjBUMQswCQYDVQQG
...
# ICLm6AwRG4rXGfQV7qlDJ0p2X2eTfMCYJuxmjrn9VJi1MIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAoholBIONsxOQ
# kugvFKBvTvYjNWP0Mvyw9JTZyvf2TLmy+w5byA/LvuTeEtAVidnjPOXHYC0EP2VF
# MUcmEtp/Wz0RnUIDo/jGDvt7s2VRXzFmCD8D7Ehm+6qEPouTE/1oYKGT4QzEAlL8
# lqLa5mFlooUOGIMcifuc35tPxvZ4X0CMYbHxurBishQOLCB0583k9noxumA5LORu
# E9KyvtrWkQ2Vqx1Yez4zI4TBb/guT/qriFHvjpIdsq8XPAheBHXJhk0Ic8RSsgcK
# V2T9bxPQ4tlY2hOQuqu15PSn7vw1offR/17j3EjNKpUD066sqPd2D8gj4m1ff/Ip
# 4sH0dTHZ2gTqJaa1sOJZHVqF1mDs1+T551xfu3eBXhCPVqo9cc6pe6YEiNdPDsPR
# T91pYk18cBXsSRcbno5TZtTGcsxndDryCgpWkaHBGTP69Bth4t1QkLjx4s9b1anU
# 9+ABFF5dHoQSB26RG48sruxhWK169pg9wl17jVFzH7K4icIrHt3b
