...
<#
.SYNOPSIS
Downloads and extracts the latest NVIDIA graphics driver package for Windows systems.

.DESCRIPTION
This script retrieves the latest NVIDIA GeForce driver version from the NVIDIA download site, constructs the appropriate download URLs for different driver package types (DCH, NSD, or standard), and downloads the installation package if not already present. It then uses 7-Zip to extract key components of the driver package into a local folder named Content. The script ensures compatibility with both Windows 10 and Windows 11 architectures and removes the downloaded installer after extraction. It also creates a version.json file to record the retrieved driver version.

.INPUTS
None

.OUTPUTS
Creates a version.json file containing the downloaded driver version and extracts the driver contents into the 'Content' directory.
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBj3ehejF4lbj2f
# DcrY1hyRrKWjd+PbhBEJD7CftExIGKCCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEII9amI1g/8m08cZ4
# XgVXK9nAkuPKeuuW9+dYTY33YmtvMA0GCSqGSIb3DQEBAQUABIICABbUvii6mjzL
# Obpb/fACPBuFAXFpR2s4geN+26yP3hwmfOdhr0vsM5En+uOKRp5ZkiwgJAYBQKil
# 4gmc0c3FOJ3f7D5rhgFBTgeEjOLeMAaLD31HxMS2ZJn22g02LV5VoiOiGYyKrgO3
# 4pWDjH/Y0c8JiUAL8LetUE9rKXJ7UevOvkg3dg0JkPQQofH2KEpWtnBbtNpG1nlR
# gzZxRfMdCNsd3L2TeSpQUOd5C1fKFjeTjDRFjzlbkuzk1OZ5P+0d+dPExnYEQAfF
# RztAnI+jRVJe6JgBguY/lxLOFGVHykm8NNlvi1U3/+gwMHWyV60c0gfq/27YP2NF
# y+C9ASA95A9pvVJygUjyNOTL67oTrvWAFwqyzcF/urpd6y0TRgFo3VRIdWtFuBIw
# 29kJY/UZhMDNDy1qcklPUIAyhprszXHhmxWTzD0y/2l4G8WVGNxJxu/rzmtOSqEa
# FryX4SRWJYwqpgr7b+6v2HP94W/VRXIKZhyZUxzRcn3p2yefJPr6kCL6V5ORZauF
# qZQwVqPV/FZ47NUfkwWhj1ysJ/9wtDm/WqFUXlZ5CtPg68lsK33oAL9L16PnTMUv
# R3wNW2siY24Tt7FYX2weYtis2vO+aR9KozLgmA4ebbmEe6bhb+HQOUlty9XT6iKe
# i9PYkYYRbSjJjTNTC547xyBGWrWGr3eSoYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCB5Xb+5ZYw/drdvQxq35rHGcrnTFbJmmz19TesyBYxjDwIUImjbypkvql5h
# 88RCpx1G6fO1seoYDzIwMjYwMjEwMTExMjM0WjADAgEBoFikVjBUMQswCQYDVQQG
...
# IMDcLpRhW9LgphRfIz4Uq5k4UM0ICnk7bJTFjb1uH77uMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGARb36GY1Noi5S
# DSh/ZZ/k11kso8yaemd7JTAI04Bj6AJh2lMxB5RQ1+XQy2TDyCI9ccAhitzZGcYu
# LBr5xDCN3ruQdiZ6Bstwtch/4q27AtRuQDKpxnP14L1sUXtxMHPSAHFJpOiioLth
# qYUeeAK8V9xoP5iE+7zP4miILFj2adv4urGTy6PPtxQRxGyDp6orFiUrGCLKLbQt
# AGdzeFMuYsSi2CGWeBIQc6ocUFRubzKrzuoa65NYs7q/mluyhvgtC7jjRlozaOxH
# P0BsX6/WrryBTqik0QxzsJ0acY4qjUMgcJRGLGNi5HCi3AyfGIuECLQz/u8OAZ9q
# raSgcYAsvXw7etLZpWN/jyH2OFNFQMYFSWzmHf4pj1KZrjAWiefM0GXYvokxM5aM
# 8Cdk3A5bUfKpNNwx9nuQcD0NxDI22DSaBtkggd7vOgdOIr5oP8arY18JrynXPxHf
# 795aMxg+AspZ0VVRuK8egj0YPwaZwQNwzC6l3YpBl+KFPwsDxEwM
