...
else
{
    ...
    try
    {
        ...
        foreach($toInst in $toInstall)
        {
            ...
            $installString = "msiexec.exe /i `"$($toInst.FullName)`" /qn /norestart /L* `"C:\ProgramData\AlyaConsulting\Logs\OpenSSL-Install-$AlyaTimeString.log`" ALLUSERS=1 ENABLETELEMETRY=0 ServiceLocation=$serviceLocation"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDpK7vXcOXtoDVe
# nQAyIVbji3vPSgdo/mdCJEydBt0eLqCCFIswggWiMIIEiqADAgECAhB4AxhCRXCK
...
# KwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIJhsCYYF
# 0FuYU8IdEB0Tgh99QC8KPUSAJkjopW5KFnJWMA0GCSqGSIb3DQEBAQUABIICAGJp
# lDeZ5TGh1pKnQRzG3O+tXPX7d491/dpU3BAi0VvTWuklo6rjV0x3gKMsI2/cE0qO
# 038+aKjDOKJjaosVKJm211MpfYrOaa1pbzExrUIwU5WhlNwL6AxDXUpTHdgdqFsv
# s3vLBR6s0sK2ifI61Hmssb7rBEKwwQLQGkj1ylgNe5HsslSvMJnRxnA1YqePLfVm
# ixl/e/LPa76KNQYyZoR9QGufJ0krNM/84Z6QD1/lBzo4hlFrXfbJOY5CqnSNOmG3
# jWC7O7xqsy4bYwhFhD+PafGAklVu+BOCLz2I8E6Hdhm6d5vOAeVaMt9UhsWi06Ds
# R4Ah/rG/YVtURz54eCP1wFPlzt+unBH5YoPk/i/40PGih7P7b2pYRGU3wNUicVs2
# /cWSqRGFUrdjmxHjzU9FVbsGfN6OLvR6703Mm6tE1hOZMNqqaSzSwFgGMabA6Df9
# 8R+8u9UC0DvWyNTVtCLZruioBNgiGC4TvUA/1znTOHdRf4OQke+/xVrcA5xjzxOh
# VmjwikUelNhrB3opB5LAm0O8T5XbOtffl4ZUajLyAB3ielVWit3AH7bO4oplXj6a
# Dwy4AlhgJgIEeGT5UUEvrWr89mXRH7tSt7VFKoR2w4HdAAQvZRsio/uVdchh1tDw
# wnz554LCaott3Otth0pYxlGF5pyPSxeo+KboH8ZioYIWzTCCFskGCisGAQQBgjcD
...
# SAFlAwQCAQUABCDrBpLN4B638hB0aJczSYoVnGBiu/eedRtrFoPORmfJ4gIUba8m
# 9XKFc6vMB90T93LUXmyY7rQYDzIwMjUwMjA2MTg1MzU1WjADAgEBoGGkXzBdMQsw
...
# hvcNAQELBQAwLwYJKoZIhvcNAQkEMSIEIF3iQy7vMqMGqdwLLmgcNCJHpDE7cJMW
# hYqKAALk20iHMIGwBgsqhkiG9w0BCRACLzGBoDCBnTCBmjCBlwQgOoh6lRteuSpe
...
# KoZIhvcNAQELBQAEggGAwfzBOCl0dCWMLcQVxS4fEC+NZd+uKjvXr1nd20Z4JhOg
# s9BD4MoA4xFg4pHNazd53bQBXTURqWzqvVG3bdY1lMiLe7ULrY6sHW6uvNbJ30Mu
# wkFiBsXIFCuSA3wyO/vPdTODikIVDaCzpu6MoGSrAyYgq4nPObEKgKy4OxtusZSw
# ab3UriiK1Hr5y63Ng85+eSfsJvYOTNHd9zkROCB0tnpNvdifxhSb+ctFsqrhVN7A
# CSr+3z/yKHgwbZC5oi6kiP1yTbaW8gUmq/Zd400le1auCzeMwgy9XigOYb4A9kB9
# KHvfGax2top1siAfjHTJXPdUl01lABbblH5IN/ojjMZUgcPoVYu8jCFhZzwyHaVC
# MWI5uUCyTqec8OtQe2pMjBt7PA4i5tvgA6ZIiOTThQvfrwtwsmDCpd7hgXOP+cRp
# UmZqOKNTs27PKyKlFi8CafrLfBZWQm4hgZD7BgEzJyhwCIZG1rO8tSIVgSTviHFz
# uQ/N3HVwFsucQAQ4zspJ
