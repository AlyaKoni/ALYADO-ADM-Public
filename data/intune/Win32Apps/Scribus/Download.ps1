...
<#
.SYNOPSIS
Downloads the latest Windows 64-bit Scribus installer from the Scribus official website and saves it in the Content directory.

.DESCRIPTION
This script automates the process of identifying and downloading the latest available Scribus installer for Windows 64-bit systems. It first retrieves the download page from the Scribus website, extracts the SourceForge project URL, locates the correct Windows 64-bit executable download link, and saves the installer in the Content directory under the script path. It ensures the target directory exists before saving the downloaded file.

.INPUTS
None. The script does not accept pipeline input.

.OUTPUTS
None. The script writes output files to the Content directory.
...
$pageUrl = "https://sourceforge.net/projects/scribus/files/latest/download"
$req = Invoke-WebRequestIndep -Uri $pageUrl -UseBasicParsing -Method Get -UserAgent $userAgent
...
Invoke-WebRequestIndep -UseBasicParsing -Method Get -UserAgent $userAgent -Uri $newUrl -Outfile "$contentRoot\$fileName"

# SIG # Begin signature block
# MIIwlQYJKoZIhvcNAQcCoIIwhjCCMIICAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBC8AGtC7WixT6D
# TWoBSy4zJNmJ2MXERk/vUn4vZ3HXzqCCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIICmDUJrN9oMJoEf
# 6xYadHEH0i5wCOiGK6USZ3iQU3DBMA0GCSqGSIb3DQEBAQUABIICACEQZerrvgU5
# 2+bpHV3T/Ci3bdXXt/87gRmPyxxs8EonnoWwNGDUIhXe/lOasAeSX2t5mOSMf4+P
# 8qdmcv9q/1tq5NOKyTW248U92KIXmmlCS4RbpJWIV1GmQ0YkGug6STBE2vDBPcH7
# 1cKDsI6VnW9lGqnaL8+HgScjFWqZyPK18oy9qxDH57yW/dso2v4Kz1y/EMyzrt25
# JHTLqeG9LORrbzrVLPLX63X5CYNT7ZGhJeBjzufYwvuk/SNoPV1AtAdxJ70xc7O8
# C02/+1FbpLVgpTwM+2OxtpMdwPBhU+tbnD8l9E0bamhbA54PA12ds8xghk0ORCPy
# rqGlZ80dr0uOSMmh3qVgbcNTkk8AIE7DrhOvv3N8gzzinU70O5Y4zQDzpWs/7XSQ
# v0jF/HI6Ccq652D6ugxLX9DktBEHzNBGCqst+RrhkLbIclfPIo7SD4cIyMyjs0QW
# l3+SoQwjd275GIDEI2tFn7fiHPbG8oxXlf+TQEpv9nxAeB4x+6W0IF+DDM6Qvnvc
# 89+RTwfZBCzrOj2GbVzUnuU+x+z7bb0Fle9snRb5XDvdOc7iDSGxZU5g4eEpARp3
# wugOOTZczg5NiL1wn4wq1X02XGssMZglo4rD0u5nmmBDLw/J3TGEV+eCNPctTI7w
# E7WWPC3t77LEx3T7WXi/OUe4TBIrb+G7oYId7TCCHekGCisGAQQBgjcDAwExgh3Z
...
# AQUABCAJtvKnxOvqIu5DJK03GfIQP0e3Mt9kct4UELPIJ86LBAIUGZlXX+4rt/Na
# NkE6b9qiL6h8RBwYDzIwMjYwNTExMTI0NDM0WjADAgEBoF2kWzBZMQswCQYDVQQG
...
# MBwwCwYJYIZIAWUDBAICoQ0GCSqGSIb3DQEBDAUAMD8GCSqGSIb3DQEJBDEyBDCw
# wDpAiTFxFCRICxMhgIVFsCZJhvu8N1sr4oFkvPR9h2M3dQwohGILMXhOCipMxPIw
...
# AQEMBQAEggGAkRcNpeOfR8WH5LlVLZB2iPM/5t5pplmLKCqk0ZGtXcaI0Pf4XwK0
# SGnUYKzQHF7QaMuwGlN6EJ4O7jvGNObhR0nPVWvfCmUsskBnpHYtY7XXxuUBHUAM
# LylqTINyj8YQfj40WldpbPlXkn7hUuMPrkfrxitlBWYSDXXRJxFl2d0jIYm7aReN
# hZA2xP0AgLit615Q9LT6hCUNywSnsuFw2toAzLQB9Z3wqJvfDS7bbNzLSTg56Mak
# DelCppTJl/HIvJgBhYYsaXmWIqqTZzXwt09z9uLWz0VuwpWG32uqWLWXjtjplYJy
# XR5smvQV+Hn6x3XS152/2PkgLkP3N+mhy49wig/MvOP2OqETN0zQsZBmucNdiLF6
# SeoVd0jIh1aiaYkHdYb30zyFUIhAySjRHrtuEs3HJidGTqCTdrxXjoP5u4/uvCy6
# WzdaGgq12xDg3d5tsG4aYbABfEUclPpV0xYo5U6ky+ZWN4k/W/cdjSkqDbGs4V2s
# oA0u/S73IkHo
