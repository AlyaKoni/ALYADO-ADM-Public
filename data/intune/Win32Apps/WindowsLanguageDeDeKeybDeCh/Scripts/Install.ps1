...
<#
.SYNOPSIS
Installs and configures a Windows language pack and related regional settings for the system and user.

.DESCRIPTION
This script automates the installation and configuration of a specified Windows language pack based on definitions provided in a JSON file. It ensures execution in a 64-bit PowerShell environment and logs the process for troubleshooting. The script handles locale, input method, and system language settings, registers and runs user configuration scripts via scheduled tasks, and updates the Windows Store applications after language changes. It also writes installation version details into the registry for tracking purposes.

.INPUTS
None. The script reads configuration files (version.json, localesToInstall.json) from its directory.

.OUTPUTS
Log files created under C:\ProgramData\AlyaConsulting\Logs and updated registry values under HKLM:\SOFTWARE\AlyaConsulting\Intune\Win32AppVersions.
...
"@
        ...
        $valueName = "WindowsLanguageDeDeKeybDeCh"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBeHB6bmWat7ewi
# sFBvPbozCfrGanYvv4bK6Ze6lZi2pqCCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIM7Iit4JRFZaOFpk
# YJqBPx8SywAtrZ0ECvWeqT0EjIgXMA0GCSqGSIb3DQEBAQUABIICAH6iCoKf9C7L
# WS4hfiAW+aMDxDRocWui9F69uJP6byuPxoPFz210RxHhs90jW7djlaYd3Fnn3QIS
# Rdw8SVlVxgNC89H60khYY31aXjlcWiB+RU9C7MdN2oFzM3SZMyLQvA7uDejyPFM4
# 73YvUKVq+Cpoc0Cb5goszmTOI0ZhyZohYAN41NFeDLvB8Gfc4pe9LqyM4IDUtcnh
# NYrEYCmbLDO1SnXlu7q7M7pCst/l9WTTwtxOTLV7LFaVy5zNQhA1ZDSOEmDQu0vv
# /UoZ93GY/yCPW89monxXQUkDhtVOy2gl5aWY7htLUMx9q1nZqaNdGsW4EM1UD/Yy
# GM3hzKS4wi+4tpGYoBUB2k66LQHtxBk/o8HYLKO4Fu4uXQBvqO9g1EZPv3YzCx1o
# kmu7ELYIXt2P09uYZ3Sjs3yEGDS8h/w7We9g4eNJp20PtCPRYjKhxUMc9f/tXlsm
# PcGrTIQyP5zNvOvbrE+8UOvntFjWFdWShDqBJBs4BC0xdKva0EHPlmhqkOA4N1/y
# YTM+j5y/QMuizWUm6baUveGr25uRaaI+r6gcE2FzQ3psjToMpD8QAB9X1WS8aIQq
# JsFV28n1caQ8QiON9sxwEy+1XjSAS67qfa26+fH9sE+xXJtsYJGnLl89mHm/R9bK
# Q/bZqsieHuLW7l/K1U9DvwKGoWSVyQ/roYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCDQajDgWiBqI++p6MQOaRcMPq7enqSzzKrCuVa3FRST4QIUZhOTPT3AwD/i
# xIKSADmXjEBLNtkYDzIwMjYwMjEwMTExNzIyWjADAgEBoFikVjBUMQswCQYDVQQG
...
# ID3mF4kC4+EAIrEwD7N7UyQk1ZRWssfYeAe4yUtXAssEMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAUvzha3XkJ9M6
# GPHhNvWnY+VqQGxp24IqkVfUaICl3hXaa8LBqMgMCjU9q620MBLxhKThmRM3Qikx
# Hsd4Of93wyIKTzTTGOkr0AiV9CW+UyUZGz53rIzCc7GNikrl46k/l/WfBAPFU/Ze
# LkNliaINFQgCshDd47Vsm2MMxBMevRomb+mgZ8boJhPg1EjxxQ+F5IepoDOMNdco
# 9bQssmsaWkParlljPnPJCFh0oqK1GXoZAwgwcfIHH45EWJPItPa9kolfMdo7gzJS
# EAVQDtBcmkuxj3UoG9dCxqAU9tvyNXqEvSlLmuF56vomyn+gomLDlEijbihogHs5
# Rxi9XmfBiNcLFs6Dj5e5w/kEXcglZ9rcgywm4+Cpg6w1Lh+461J6DyLi4HOf8zH3
# hrL3g0Y4rn2g+vTKQfqgWZUMgKLqatl/Jyl23yCscb6xBJw15JFfwOAqm3YppYZv
# iucBmEIQliSvUqEP3ZQz+cPstT/XZqHEqzeolhcTEvvhK1mMYA7Z
