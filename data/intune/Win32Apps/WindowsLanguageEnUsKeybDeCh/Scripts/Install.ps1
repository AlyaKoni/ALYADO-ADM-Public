...
<#
.SYNOPSIS
Installs and configures the Windows language experience pack according to predefined language definitions.

.DESCRIPTION
The Install.ps1 script facilitates the installation and configuration of a Windows Language Experience Pack (LXP) by reading language definitions from a localesToInstall.json file and applying corresponding system and user settings. It ensures that the script runs in a 64-bit PowerShell environment, logs execution details to a file, configures user and system language preferences, and updates registry information for version tracking. The script also triggers system tasks to finalize localization changes and update store applications.

.INPUTS
None. The script does not accept pipeline input.

.OUTPUTS
The script produces log outputs in the C:\ProgramData\AlyaConsulting\Logs directory and updates relevant registry entries under HKLM:\SOFTWARE\AlyaConsulting\Intune\Win32AppVersions.
...
"@
        ...
        $valueName = "WindowsLanguageEnUsKeybDeCh"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDCJulzR/OIt65a
# Z0WrydbMWMOAPTYFgmKanQDnFD1p86CCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIBmvR2eloWDIHGux
# PxS7Q08OhtCdtJZMLkeoWwUSpgvqMA0GCSqGSIb3DQEBAQUABIICADwGdRtcnud6
# 5VVidctcUr3Ad0JqQOi8Tg7Dq1njiPR0gcnQw0YGSKmwwGWSRXurTjxxnAcrrZX+
# c5asTSiUwgvI14uyhjzzTZSbbv1aW+r1unC/rdL/5NsL0J77W7ip5Qp1y3cTuwCQ
# P+mWyU8XVzmhNZRXwnR4F9YwmxhnU2qX+0DwoQVn3489vRoxPXt/h3d1DFfKM6bO
# uvIa+QaUkTVeh+yxraW0VnDR7dfZVYCqy/Dp1CR1rje4ioPXmVxQ3Mi05f3L/POx
# XH9to/rt30/F2Def6Pbi1m3nfyquwLiFlXr5gFAit8rXo9DZ7VryoOzDG+Vsr6hH
# F2WMQ8tIJMCpynW5UUGbQ9BeJA8DIgvL7QpYTSG0G/ama+iox88Fbox02sdsDMeW
# kiCKm2ezhKRmQtnFRFIkm7N1ampiAbRelxrXjJLfVip1PR011k5cWJwUDJ2ZN9Gd
# oWwQNYlXFdb89PUtP0IDb02cSpb7UQYuM4Au7gd9NuNmuhRt336nPAckylATLnXA
# Adqwm/5IVCJP1lOMchLHFLXwbvNDe9dwSKFo5r5Xobd7Ry38rWY/rLL4CwqPKhtw
# JYnrJc6+d5MI7UOFNYbYYIlFUcx3OsNxSsDA0RpHUgjWaBnKok2PNN1nVuQhMOy0
# FV3SgbRBIVaS7mDXNdQYGZO2YpHsl4JAoYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCCJ6z5URtSCIJ26rjdR/uwfBo4k15d7BQjeSJRl2YYdpQIUTBA7R4AxeO73
# s4SFKtuOYa+ND3IYDzIwMjYwMjEwMTExNzM0WjADAgEBoFikVjBUMQswCQYDVQQG
...
# IDUGiS8t1SDLumiVsDbuMTOJgdAs1vyBCnMK6mQo7Q3AMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAbHS/RWwG5Pwl
# kOelsIF247M1wJLUCeuZYRiXxjp1TtMSq62GKk20L1TKt/FdYxZY4SwFlRrJTlzZ
# bYwKEmDlSDU+uYyXzPCuhRYW4+mRBnWbFqFSH/W6w9wjLlbqw2Lk9A4/cLv9pgbO
# RvCUJDozFkRlGytm2dpxL6H5r2PULc1K/e64WuZtD26F6eiEJQpZcV1ajEpqLkI9
# W6KVvGwAGH8BruJa5Rw9E4U1MbFVu6R3RGh1ofvUwAiF6B/j35Q29QA1SrJTcDAw
# QAtYD5+X0JGkUoy6DeGNe36VDI2hXycyufLGe1QoRTd1kElF2qSlB9W0/f7HXhRa
# jXmYkAAgxHftSRG/gcIiq0Fw3QInCEb/1cTUQanpYTiA1gUAH58nOty93amVasJ+
# pco0AxZGIFHPMjTFV/8AfFDRL9Ivdehu4S5vBV9u4JQJb12vBOJYfeukJw/qxPLI
# kW00FeLqwmZ3hRqisPZkH7wHblc1yrrn2dovStpuOmga0FNXg8A2
