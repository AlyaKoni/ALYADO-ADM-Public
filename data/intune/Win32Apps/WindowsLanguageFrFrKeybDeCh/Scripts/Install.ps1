...
<#
.SYNOPSIS
Installs and configures system and user language settings for Windows, including localization and language experience packs.

.DESCRIPTION
The Install.ps1 script automates the setup of Windows language configurations. It ensures it runs under a 64-bit PowerShell environment, logs execution details, reads language definitions from a JSON file, and applies system and user language settings (locale, input, culture). It also triggers required scheduled tasks and system updates to finalize the language configuration. The script updates registry values to reflect applied versions and supports multilingual setup automation for Windows environments.

.INPUTS
None. All input data is read from configuration files located in the same directory as the script.

.OUTPUTS
Creates log files in C:\ProgramData\AlyaConsulting\Logs, writes language and version information to the registry, and generates supporting user configuration scripts.
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCD1UQlfbEEM44Eq
# gWiHU+pywIVqwGLjjNOaIB66Zhzr8KCCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIJjlvHHn/y8wOZ6F
# pOK2u5ZB/tw3aJ8z53GyewVQCnBNMA0GCSqGSIb3DQEBAQUABIICAEGfDrB3QFZk
# v3pkSxorDW4XM3RWDCjeIzzgxQ70eei3gzgN0AWeiLRitOGNfjlUyY5fGcJ9nta2
# MXsdihA0V1H0f+aB8pnkHB3px140nRm7PegeSGRZcjPTduPeCTw2jg7UVjSdeEX3
# VOZL01QB7h3FTPf9LitQJvl9W7th6nb0dUUkmtWV2d8RNrAxEmnJwAZN+FaSL602
# 3VvmMg3H76JUA/Lw+92VreTSd9Mg3fPYUXVxUAtC/sNRIp2w84ad/IJI3jBfU7EX
# MBzJjnruzhWThkwbfuvajhQLZW9zFUGN9xNWjUPQeuepqiLuYMjIh8CJ4DdiOKQ4
# R+/V1VgtplQlYf4eM9MgSiOv6nhyJXzl+GUhXAgxan2AchM0swJxGEJfc6gQaDja
# anuMMiyKGnwSuZkBbQxGAtIJt4zPdWZ/P+F4YZqClbjDTIn50JpPGPc6++e+chrB
# vA3ajY/7ZhNg6eIgJ8j0MSyXnz+56ksye9lBu+EqfBphNiPskR1VcDsRT5AY+GHy
# EU/P+YgRh7Lim/2uvf9IqfbIAC2OxsjU+X032YRQsxgkxdTRss5qH+HkdRa6YZVh
# zbN4+8nzTU3Ru2mfTIwPWqBBzDKbagaFa6rF/4QTUK7t9Ct+X0mUqGb7+LM1yHly
# CfPLEQRmPItYuUX7lOtZTKO2znT95T77oYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCCUSulNt+WEDrcdINZopVXDNXmnwcpGWfHImdh6A6knxAIUPXbAl2Pykc+t
# kednjh9a2UBl/RMYDzIwMjYwMjEwMTExODA4WjADAgEBoFikVjBUMQswCQYDVQQG
...
# IC5HwIXyHz77XajEFfWPYLYdg/4OFMrYryHDQUOZlQdLMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGANMZgEW1jYfHJ
# NdGWXZKWA24C6A+2Ty4CDuHLeIEAYOkKMF9AfOS+UQ4+4IOY+pkJ3OuGeLo8IPpo
# xdkx5IiiQokU5DsqdewZcYALNS8jEHcU+u6mArBzVImi8W/bFdxc59Q6/ODPF2eJ
# rJGLNTZOZEY0GAS6jUxvc9mGGCIGZdoYEDMmUQQsaNntAyBX2qFO4KcMGwXwDaeS
# mhxDLcoqwL31FJbgAExlGJZygqPSzB/xcTN8pDHTjLqZqTJiO/IBo/NbL/QAmjQt
# XhETOmvYlnH45Sw2VeryI8HiYfBIHRQonrcMRJDj1SXRl5yyRQMIjn+hiGcZlMgV
# ZtpyL/8BbSCwqbtAGlPfAZjonziQ1z4ilaY0UbdZLUiy3vho8vwxvOWOr2il9O6O
# u054zn4NDoK2Uj6kqEF+0+ZoY9rBSD79vao5AT79pcGMy/jMF1V4UkWLXOPGTCr8
# G5Cy4q/Fz+GOFPjFX8xn1I7HDHGpF8M/v1ZxsmM10I/QDiIADl25
