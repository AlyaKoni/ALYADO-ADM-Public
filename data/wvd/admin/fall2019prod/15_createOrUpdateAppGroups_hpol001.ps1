...
$AdGroupName = "WVDPAPPGRP_Desktop"

Write-Host "Launching hostpool script" -ForegroundColor $CommandInfo
& "$($AlyaScripts)\wvd\admin\fall2019prod\15_createOrUpdateAppGroupsRdp.ps1" -HostPoolName $HostPoolName -AppGroupName $AppGroupName -AdGroupName $AdGroupName
