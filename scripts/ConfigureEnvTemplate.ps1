...
<#
.SYNOPSIS
Initializes and defines environment-specific configuration variables for Alya Consulting’s base configuration setup.

.DESCRIPTION
The ConfigureEnvTemplate.ps1 script provides a template for defining environment variables used across Alya Consulting’s cloud and on-premises automation setup. It includes placeholders for tenant, branding, resource, security, networking, and service-specific configurations. This script acts as a foundation for tailoring deployments to organization-specific requirements and Azure/Microsoft 365 environments. Users are expected to replace "PleaseSpecify" placeholders with actual configuration values before executing the configuration scripts that rely on these definitions.

.INPUTS
None. All configuration details are statically defined within the script.

.OUTPUTS
The script outputs an informational message to the console indicating that the custom configuration is being loaded.

.EXAMPLE
PS> .\ConfigureEnvTemplate.ps1
Displays "Loading custom configuration XXX" and initializes all configuration variables for the environment.
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBK6knVGJs1QUTh
# vJsQwXPjPG9SdZER8A3aGv/fydyPtqCCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIMsYppGhdcA00Pzi
# 0Bp2R7EBzE9JWUQCuh/I0VWiITFOMA0GCSqGSIb3DQEBAQUABIICAFcGXDuuv1ys
# IniITmiD+W7DR0L6iVTCryp6g3Rhtdg21AlcF/GS8nJ0ivQHF9Q0/MWAFz9CIFzS
# rwZybTTVRqt3Zt9mIKMVAdDWqGvJbJ+wxYAVy0OCuEu1RoOdeXKWqQwfL2/qquUQ
# am/PoDK2cgZDH787cESiSdAzPaMwRoNrlBm1VhBkJNShHfsr8ER75QEydJ6MC3F4
# R6OCaukfWm6tPAKiERXAgnghBsNhn1/pa1KfitOTRdvrJca07FDvrA3uXkiDU5FQ
# NjCZaK+07rwfc7WSIBDOjNvheOJUiGa7WO3EBwwfXxM6hoHuv9C6DH/St6Gr1vHs
# UM8hzfWvF2MTbOhmUX/NqyBQgGaq1nS24DbML7WLd6P0W/ypqYqnOT0Hz8w6cgAn
# ycBrRpzx1jt6022IoUyn7YUHM8UOhO5FEHHR1ueUjElN8dBIekPmIfXRem51Jz9X
# ivvwzmIhx3zeDxHNtUYOPnvk6ezuv/zG6xqGMSInrrCPrmoLdgF0DgvwN+WZ63Re
# UYkGL3HVI8+wl0wDWuTxo3SQXgTOFlBLafPUvqlGCZHzrHvahZ2+xUus/n7H5+eU
# LKq0YkBd/1e9X55oZ0lvfz/XCWtYSxmLqjstRfnR8hkA3IJm7g5XJ2tjVbR3W+uH
# mflFx3KqB8GaDJBU6X5T7kxi1gwoLFWloYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCD10L2iVu0d1/W9e6p4SWQNPKj8fCLMISXLVyMMrWrzVgIUErui0xHou1/d
# coIdoOtfR4Snr0QYDzIwMjYwMjEwMTIwMDQ5WjADAgEBoFikVjBUMQswCQYDVQQG
...
# IAPDzK8Wsq9coO7Zs4jsJSBLNBxctxd8FK03rdHGe54kMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAFUmGDNFfG7lh
# 3SYimuGa0YY0stejYGtzN43YOSFEnI5X3K4jFuWwcSS5db61bO5Br1tUYpIdxiQI
# xt+63VVPs1d0m1K2LO2QurNPXlp8Z8xa8HZQAxpViYl97jtmJ7NBtc/SyLenNA1A
# 7mb6upaEtiaNYmEHMrXOA0qVE6ZTtYtSNuN4A1f7x5CjcEDo8qHzDy/PWq5Ns644
# 3Rv61ZkIgggb75Kz1RhDN/SLn4zXHe18zMTVIsK+0jkZVvAr1ChhG3hAO+Z3LDu4
# zoNL1GEq7w8iuveInlvoxBFQzVnZfBN6OBEQqJNltFhmjYkWrbgnd/ksDGVCtIMX
# 8J0oRr8otT5wZc7Lsr1Xf/p6PT7qp0rxK5xSXn5pvgHLVrqZun/5z9rhtePhjae8
# ftA6b/2RJGk+QS2LgcRgJQDbLi0m0oYCd+zV1qB11O0/RNHAHjeAyGT3eTPPazwO
# UhD2xgV/VTNHhuwrKbyNv9cC4zEELDei/yzBpGPseNr4/YB11yjO
