...
<#
.SYNOPSIS
Configures Azure Active Directory and Microsoft 365 groups based on input from an Excel configuration file.

.DESCRIPTION
The Configure-Groups.ps1 script automates the management of Azure Active Directory (AAD), Microsoft 365, and Exchange Online groups. It reads group definitions from an Excel spreadsheet, creates or updates groups in Azure AD as required, applies dynamic membership rules if enabled, assigns group licenses, configures guest access settings, and sets related Exchange Online configurations. Additionally, it disables groups marked as inactive in the configuration file. This script supports dynamic membership configuration, license assignment, and Exchange Online settings synchronization.

.PARAMETER inputFile
Specifies the path to the Excel file containing group configuration data. Defaults to "$AlyaData\aad\Gruppen.xlsx" if not provided.

.PARAMETER dynamicMembershipDisabled
Indicates whether dynamic membership rules should be disabled. Defaults to $false. When set to $true, groups with dynamic membership rules will throw an error if dynamic membership is detected.

.INPUTS
None. The script reads configuration data from an Excel file specified in the inputFile parameter.

.OUTPUTS
Logs are created under the AlyaLogs path in the scripts\aad directory. The script outputs information to the console and updates configurations in Azure AD and Exchange Online.

.EXAMPLE
PS> .\Configure-Groups.ps1 -inputFile "C:\Configs\Groups.xlsx" -dynamicMembershipDisabled $true
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCANP8aAcaDqcPYz
# siGa2odvYYXX1gjDMxp/kAEtZh60OKCCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIC4c8ogFkCBqZLVN
# FCpO1xplVQM0WKZIcZ/kPpvFmEA+MA0GCSqGSIb3DQEBAQUABIICABBsJFQRogI1
# 0bHzPmUGOUJgJXVYt6JWnW1rzUCqERhakm8BGxcTqIIZmpteGFX5OvNm6FPu7i4p
# 2pPr1G6cGhPsX64yKE+cikgkcLdAXJSc+4D1wRINDOttQjJVzDiJWi0YWnLTOroX
# aV92q+vMras0u/RYfiBkv+AjTbv1kuIR9fUkW6si9b6ZRr+GeAURcGrJp07XpTB6
# 4WJBdTgfp8R0F7QQilSrfu4pWls1OSoaYicKlNODCfGjJo7v0VwzqT6eXHRkVf7D
# 1208jN0Kq6luhIPJxE94ZybuXKFv8uBofakFvmXtzW3hMGvr9vfcDwZ4zlX+2900
# nwSKtTnwlOA4mJCU6M6BgVhH2aVsraxm5YtsKK9DdxEx7N3ydmYS2irXrDzEmI0v
# ymxIx6O6i1gUEQef+1OgcCnK+JYsCnGnvalgUVdEMVVnxFfviCjylIj61JwphRAP
# NN/miqzGtdwsvPAkiOzIo2REYmeN43Q3abUlp08SiTRr43zfTktwbuNNc5F+DfML
# 48fYsiw322KI18Tfx7GRBdZziI7HnqQPZH6GQw/iObreOQDKFtp6pilXT1VX+qxV
# E3dKwP0qo9E2NQLCNpajQ0NFDu+xfSSaEVboo1ps6HufhxPUTJO3LO0i4z95f2fm
# somGfKnBttxqWdKQgj4NKY09zxRU7zrCoYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCBGIiNN0M37W6sq4Zwi7SVMtlkEToTwWaEAsdQnowIUOAIUIWOMgPioE9Gg
# R3Cr0xZ1prbqSDAYDzIwMjYwMjEwMTEyNjAwWjADAgEBoFikVjBUMQswCQYDVQQG
...
# IAVixOruV4/8mUPLmBkU6CE/1hOH8NpWr8K7IWOuOv/ZMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAALPhvUU4Bdmy
# ScopJ8pnDGMZ5W8P8FrDXp35O7icB1BE3WfgjzKnlb0zuYZJykJZUQxCjEB/pZeM
# Ur1EAyQgq+aBOZdnJHHli65G2anuFln7c8CyLwxKBtV+bmUE6puYNy1uQfNFOwIj
# VcLBy5eIce+MtUA/xltCJMYuIMZV8aVIbS8rEidWAoUcBhMmPngu5Nq7c5aLHbEr
# aDWfPaphHBL8XWS+wLKwb/Xequ8LGp06kf1b/RqdZAAfq6QVjw6Fvt5cDAif1KRX
# spzt9cUSUiGqvglA9OwxKzKQ/WiiS2y2MjBlV5NfvivU5Pyy3B2W86rYJH+OJCl2
# 5akjDBCogSfhO83+h0yXsQ6cLyR3Rf2NbU0ZELk8qsMOdm0aoS/Eh08sNTwBlgvp
# Cf+bkZrV8rq6gSKrVi4hlG9dwZWpNQrtzoIey9Ez2xj1J7ikYzGp2/J8F6BrEQwf
# UpxvgIFnycsdE8fkUfT4zIVSZUBzzcRZWaBtA8qAjJKboHmUpeQl
