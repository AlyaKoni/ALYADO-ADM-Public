...
<#
.SYNOPSIS
Creates and configures two Azure Virtual Machines for Active Directory and DNS roles within a predefined environment.

.DESCRIPTION
The Create-AdVms.ps1 script automates the creation and configuration of two Azure Virtual Machines that host Active Directory and DNS services. It checks for existing Azure resources such as resource groups, virtual networks, network interfaces, disks, key vaults, availability sets, backup configurations, and security extensions. Missing components are created automatically using standardized naming conventions and organizational configuration values. The script also configures diagnostics, backups, and installs the IaaS Antimalware extension for both virtual machines.

.INPUTS
None. The script reads configuration values from the 01_ConfigureEnv.ps1 file in the parent directory structure.

.OUTPUTS
The script produces console output showing progress and results.
Logs are written to a timestamped transcript file in the Alya logs directory.

.EXAMPLE
PS> .\Create-AdVms.ps1
Executes the Create-AdVms script to provision and configure the Active Directory virtual machines in Azure according to the environment configuration.
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBg10Ahj0yguVsC
# W+9Znc/3R6wC9aJNUz/P6ENREnL9kKCCFIswggWiMIIEiqADAgECAhB4AxhCRXCK
...
# KwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIJApSzxh
# 0pBgPbhY/8Nisvx/Q9P0v3nxc4vaFjdgU5xzMA0GCSqGSIb3DQEBAQUABIICAGHo
# veyAsJBF5IR+HqyvPXbyKj6MP3VJ8G0cMoo4prA5UQ0DJXXAzTkcGz9s2KzPc9u3
# gW9vIdlu59ZwzdhXk27J8xc3UlfmurZcuqPrLLPgZWJWzbXeEleIWLqsgim6FdMq
# Yfg9dSQxmvWteIYAdEscqLo1tduVtDKOFzFimv3gq/ScXUzFzNh0CmDOIJ8R5SFW
# Yin6yKRZ9rFctAGzr8fA+hvdLoZDY/Xs2XI9nU8CmSnLghUac9nDa1JQ3BAYX6hq
# l+alvNvXdoFVPQtoglltPw+cqo7stRKuHFEx1RaM0nbGE4TCcUj/pUe9hrX15fbO
# oaJ6Xz4nodIU72Bx4dR5AtRTxPiaaJeO3JHNWdWo5Pf+T7/NK2Hk471LaGUIiuWi
# sw1/rc6SgCpcEc6rnt+7wg7JTcoiyOEnp7NEG9lnySWDdrr0BEEFubBFUBrnEz6N
# BnPsY9HPCM6sCr/ySLsZu4gXJDssJOZeW4mItU6ckE4SaY/eSTAC7Y1VvgwDmbP6
# bT1KhRJuJoUv88g8l4RKGd3rQSmDMVaN9afN42/XZhp/ZsqVCTYz5ubCvulaxTlo
# cCu6lkiqFMp5xE9IpGqh4Au2xXfUgsqybSrUb487lAUnZtRt4JUjIX0Hx9M85Wi7
# ZG7NCII8Hp5qrXA6wiMLjKf9uYEZu9Sou23Nb74voYIWuzCCFrcGCisGAQQBgjcD
...
# SAFlAwQCAQUABCDUfgMbsDkt/gKGDQaiAQ8UvybVp7DYZljFwT8NhdwldQIUC3P5
# /Oy6ZyKdfuRq2ggGv5vL7KkYDzIwMjYwMjEyMjAzMzU2WjADAgEBoFikVjBUMQsw
...
# AQkEMSIEIMc+tfwha+wR5wmuLOfyhtLnB6k/YQ4cS5jWHqz54yEmMIGwBgsqhkiG
...
# Mzg0IC0gRzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAGlP8
# NDu7gueSoD+XdUmDp/gWnv+WrIwihgazqWHP14ayNPyQQCEMBKNi/wqTShmHq7QC
# ZthfZ8E96Ha45EE+L6lngEiR9VIT2R4Np7zIshwPs2/1SkLu21kvwnNjQSy9HQdW
# 8LzafiRsfyHD+uVfkw+ymIsotnN603pk9GGeHJFNRmYNfCCjZdUwrmuawByrWZHU
# rh5q9Am7LmUc0RJWWZgpuZfAreokp7cHnm6Vx5IvJeEn7lppp+HD546P2AhgDWoW
# LmE2Bb0f7S8hXUZUGarGQlrPRvxbcEnQJNeRbhfinLUXi+bQByeNj1+z3NqStSwN
# brkm32lHpcTQ0n/jC2T7VYUTcClkJw+fzb+G+qdRPsyiM/UxmHudJoV7vRIXX97z
# /GUDrq8DpiCB7DMLRhR4JAdfrmHh3A+Sy6quZQxNVV5OQgt/+7aPORhcyJfDR5+n
# Odl2T858HXj/u5Htr83hYwdHg7iwQfsD+wZ0G6i11o3SCtzoDtN9wtQjT2Xt
