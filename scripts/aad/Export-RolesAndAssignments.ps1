...
<#
.SYNOPSIS
Exports directory roles, role assignments, and custom RBAC role definitions from Azure Active Directory and Azure subscriptions.

.DESCRIPTION
The Export-RolesAndAssignments.ps1 script connects to Azure AD and Azure resources through Microsoft Graph and Azure PowerShell modules. It retrieves all Azure AD directory roles and their members, as well as all Azure RBAC roles and their assignments across management groups and subscriptions. The script then exports the gathered data into CSV files located in the configured data directory. It ensures required modules are installed, initiates environment configuration, and logs its execution.

.INPUTS
None. The script reads configurations and automatically collects data from the authenticated Azure environment.

.OUTPUTS
CSV files containing exported Azure AD role mappings and Azure RBAC role assignments, as well as console output detailing progress and results.

.EXAMPLE
PS> .\Export-RolesAndAssignments.ps1
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCN/4gVEIQI2b61
# DOY+6LBNYNxTQ+OsLg2QcipUn7EqN6CCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIPN1+ZZ6RFuJ3C3L
# T7rdHJ8V0HcvKkYu6Wk7y+f6EN0iMA0GCSqGSIb3DQEBAQUABIICAFlq/J9285AC
# Ql6D0wr6Z886BloWB9S02lUFaW/rjLhF1BBSyIWhzEOtI3fhrBmWPRO3CxcaRGgt
# XIYRykIFIppxCfooJslA+ukkBBzO9svbSQAeXGhkdHhbfhCKKGITsVoVrbb6zsUv
# JmnKz5SF+gaOSwkdTXNYmtMIsIZvKwCoVlq7sTgF+BiB/2q98BjyW0CW1uebaEzl
# qrPQ2FYKx4UeROvZ6WmWY6buwWUr5oQF+RosrrZt004dpaQhts2OakzIGuVBqhtF
# JtqYjuoTj+cLV3BMGFQ5YVssVqJgFsuJW7/Z66TtFdBfl4o3Vp/BSVL3MAPraOH+
# D6mB2IcBhMW2PfQ2UpDVL0fCvq0whHC6TvS3iAOeUVgvKZ0NxFs+lKZHa5heexCZ
# y899OoSAeM5PKqC23vCTdiv6Dky/qAc8GNi9Xag4XvZ9YaQ4WZcb0v0JqLhuIGu+
# ccGmzfBJReX/Ij/Q47jzWlu7UCfJDeiFQGn2aHp2GUNJxLPN57cIwgDRN+LLXvmM
# 4HxFn29D2G4HMxN4G9UnzarATYcnJZDTjIWAMVEB2ZOD8jvnRKTZuZr+8EHMKpjZ
# DAdsPiUY7GKExyVRE+Buziu/eYABwuD7Y7FfGbLh3CrOnttmJKuTdd3aIhB3ictM
# QUJ1w/S1v/ONAbLqG+Mzd6ZJmo8hUDigoYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCC77VfBxCAuflcYMYrOdjuUDPwGkL7+xW5b/UF2GHJonwIUZzrkqN3kkZF1
# LiwEofYmtWtDXQoYDzIwMjYwMjEwMTEyNjQ0WjADAgEBoFikVjBUMQswCQYDVQQG
...
# IHwfB7Gh69uWy8wRtu1njpf90D6Qjfc8pFC9R9vDa4vZMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGADl1sx+AJ1Mad
# 89WRItx5V1U8ixAqgtM38QtGEwHzoK/qSm2y5ycOKYhheiHx183fM1U4cop1SaZF
# HyJGKwL7UdFFI+QB1dArQ70E3KthEdya2zDU7VwKEN/LDteFOgCisgbGyXNp+yvt
# t3Zb1hmCau6xmaC9r2oxedzfLYVUdaQJAcN2CHPVGEdVTZrxV8lbq5OI1yMkIjhX
# 0+12Q2y1s1X6Drx3b7OJtCoK8XzwDFPdllhKvJiYnDmBtK5ACNSMVyeBpsQqqoMf
# us9dN/dmbJqneEM4PYSXXg3huByUGMKAX8yIZ3IZtXBu5gJvB/H/JuSe+XGAQB6L
# oNiEFSBCDYnBYf+Uc518ped+7YdOhuPnooh7OvlS/hH3RPtgH1PoM0lwFAOXM9Bw
# xkNsP4AzGmmExfS68Rm8IAcbO9WzDMsFh2v1jymOZfqdBjKecKPMpjQ5sSTQmfTF
# q7dEWez99T0Az68Tf/nJVH1EMSW29eInFQgJSvKXtLbnT7Heh6pD
