...
<#
.SYNOPSIS
Exports all Azure AD users to an Excel file.

.DESCRIPTION
The Export-Users.ps1 script connects to Microsoft Graph using the Microsoft.Graph modules to retrieve all Azure Active Directory users and exports their details into an Excel file. It dynamically collects all properties from user objects, formats complex properties into readable strings or JSON where appropriate, and saves the output in a formatted Excel file using the ImportExcel module. The script creates necessary directories, ensures required modules are installed, and logs the execution to a transcript file.

.PARAMETER outputFile
Specifies the path to the output Excel file. If not provided, the script defaults to "$AlyaData\aad\Users.xlsx".

.INPUTS
None. The script does not accept input from the pipeline.

.OUTPUTS
An Excel file containing the exported Azure AD user information.

.EXAMPLE
PS> .\Export-Users.ps1 -outputFile "C:\Exports\Users.xlsx"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDmb+0lAQaVz8sK
# g5YerWTyrcaqXRJeZ6ayXvtCzDXSg6CCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIAhRBWLZBc9fuu5p
# LjFMn4KsYhm4hNlasfYwMJH+TjbmMA0GCSqGSIb3DQEBAQUABIICADPNa7dH8TVh
# +7eV1S7+9HHGz5fEpIRAKBC8trBTom0n3rj+sWjaOtJTqurGC8LR9PUXerf92Gur
# i+8DW9lcGzS+I0cK8OLRCoLzTVL+zniijIB3OQeTVQJvPlI/MdXIteOZlAtmlYUE
# hQAi7NtciHlfwp6OiAb5ALjhlrV4mDw736w3D7wE9+3yR52iwlN4jf7Sz18cG333
# 24VsPKEQ0DqvfGb3CoScAjBUAksaaW6zOF9lclOSJWLAjdmhon3e9KPhjynxc8Kv
# cuwymWDYYTk5Hl1IsZigqi/3p0IS17ROClk3+RaivyVjY35hcDNx3dvJFCtGkie1
# vfFONTTOVqilHA/WaJ5dxwJJKuc0ZlT5OUrHhIHV53+qRJ0eAPGBR+kIscBJl2yF
# ZSR5XUwdgrMwykoJ38N+xaivLnFjo0w4+0BhVSX/T0YOmGJPAqoNfyIlqWnQd8iI
# ld1IzIRQZrElOnl7922q0sZpn9xvmDS0CZD3/rk7pp8ycO25/MGd7K/OgY8DjylL
# t4/j5UYoBHW6OGc9SnhteznuHgSqZ1L7+Zqn4kVx0rSLYHIDgFMI+3C96TMMeEmc
# J3cEmGdNLqyTK6lPHpuzm7NkzPkzltNDszx1CGFCmijeagJoLqwb1FRPaPpQbpg2
# EH7o7QLSBtn9oBCeYg0zyyPhveZF4/zYoYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCDlFPsAWzaw5PoIw1AXN/hfvhh+NIyUhFTUB1lez9heZwIUdbTNTy9ZICCj
# v6DpD7D2yRAb/v0YDzIwMjYwMjEwMTEyNjQ4WjADAgEBoFikVjBUMQswCQYDVQQG
...
# IPla099Hl/9bw+H6cJMhsgSn3VOgyKTdzGe/F+p1l61QMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAMAgBYGzS357S
# eFkPet6KoFZ7n46e67ADthuwrbxFiF5TZLtisWqkTzNU7xyl/HKOk0ElnIjamLsH
# i2wxMdAg4IjB+xvedPFzOCCTa5gOv1Zi5hl6SaozRnEa4jZVc6AlbWzIxnQuhlqX
# Et2F1kRLxqF/Nrk9D3wOeti84jO2gJzXOhqlKl80NdkrJfFtA478AYHxlB5eMAax
# v7qGuyRNlWnIaUdefKBk3tPQrOYhUAIg1mDJl24cXcmHdGi/hLxNAtqcoKD6Puas
# ErYU9I4toVaylKJMSaVno1F48FB6bE0zFWdkDlzzSOLJ9hNgoA+NQQT/4sDEtCwI
# mEvTjR8PLubNlEFjKsDTvnSog1PzDb6hg5X+OwfaU7AQi1xJ8/mWaUyGeEw5Sk7l
# ONLkvXJyXiLFSMe6WohleQP4+YjiKYm5pEXPddu/t48t68V4Rimn3usYdfel9oNn
# Jtg7hehRa25pxQEJMeBjPSM3I8QxhMT0w0fySVFBSgwjalbCRMSG
