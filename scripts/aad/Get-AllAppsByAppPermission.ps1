...
<#
.SYNOPSIS
Retrieves and lists all Azure Active Directory applications that have delegated or application permissions to a specified resource application.  

.DESCRIPTION
The Get-AllAppsByAppPermission.ps1 script connects to Azure AD and enumerates all service principals and their granted permissions. It identifies delegated and application permissions for the specified target application, distinguishing between Microsoft-registered and non-Microsoft applications. The script caches objects for improved performance, collects details such as display name, application ID, permission type, resource, scope, and owner, and outputs the results. It also creates a transcript log in the defined Alya logging directory.  

.PARAMETER permissionAppId
Specifies the application ID of the resource application to examine for assigned permissions. Defaults to the Azure Active Directory Graph API ID (00000002-0000-0000-c000-000000000000).  

.INPUTS
None. You cannot pipe objects to this script.  

.OUTPUTS
PSObject containing details about each application with delegated or application permissions to the specified resource application.  

.EXAMPLE
PS> .\Get-AllAppsByAppPermission.ps1 -permissionAppId "00000003-0000-0000-c000-000000000000"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCYZAcWn2976pDg
# mpEXFlRc52m9PtGVMkVNLoknpgsBF6CCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEINIWRL3gbVxTPIbx
# SBGV6BIgUBWVWuPM8YYQ8lC3LRwwMA0GCSqGSIb3DQEBAQUABIICAFw5yo1s2D/Y
# ZjadTzWp9lE6qX3kscqvoGjXHJxXDdDMxlPiYCNfjnR3kluOit/tS5g0+4IayMo0
# qT7iMJ9fVHMnV7UcO7KavdmPST2vcHoRiiQ+rzjJYnSJCXhQiZ3Dg8xwE+Ry/VZT
# jGwWMf2PXRtj/surarGix7y1jtmOmIPykmS2aW2dJRXOTjoR1qdynK5E65d8m24j
# ftPLEfwOnxWN452OZVJ83Vmmq2Aw3anRvir6WShWZWTUbWBvWEVpBQavIJTviOPb
# q3NpJsixW/8kq/2gGtbbRCj/H7Ia8rQPIuoIj8dozFX6PJEhDxelD4hZn52+zkGD
# 6KOBKVoS1+8tNznLdPVwl6/ldBYRhRiXVNW8933AN55IFCPzNCWga1DYybE1qM0D
# U0v4D6JhLmkgY6j0VdVNO4XG+VXzxzOW7I/QOCk2aNNfyYmF5AkN1c5FcUy4zycm
# tzCayGd1rxQwZM22+IvbF56Oy5zOgdxsPMQ3+5zmXWMiEefOG2UkMfm0s88+ezwO
# 8+GwCcX69MEhxXlUtrTGaKSz8lx+zrgXhmnPO5Mk20mVrpSEjhfpYLcb8KEtQwcI
# 4TOOMZ8nHMZv59LL69CwnQymS8A9ZFNun+jKKCCoEpgsUOhT7sXUgtD4jiUXiMXT
# XgETAJHruzBgidLn/SBw3LfgIhjo328loYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCD7BT8cW8LCimSylQPuJUsP27RYn80D+kLRv1+7PhV3/gIUcwHkOHS/cSfL
# QJMm+Gplu+tl5G4YDzIwMjYwMjEwMTEyNzA0WjADAgEBoFikVjBUMQswCQYDVQQG
...
# IKT0kwg3iQnbNcNIXabjxjS0V3cY7txL20VwFm7PXaw+MIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAgMtepyxSoXWk
# scK3lecnlvibrAlSx2FCvomXy9Ogimt2ydkrFPy42tkkLAw2ydIcC6EZ+E5voqGI
# lhWAi9InS81yUazZkGySCX57pg8oKoIokmL2P/27XgadnftPjWiAk4Bgy1d8rgNl
# wt1Utu10d0EI/spwH71UZybDLmbz447s/IF9PXxJw6HnJi1EfjpUbSzFZJKDf40L
# 5MWQCqZeNBAlX5TQ6CSwGajuRYIvrYS3fcqFs8Ea1IUnpqCzoyJbUT6zrEs1UYyS
# 3YiPQG2hs3BcmmqG6/uDqcWH3v/HCJQ3SXj72+ziftlHIS1a20GK7rhiZWEXauph
# 6Uu0yR+CU4gUSpuahWOvHzf5G5KCqLoe6uToy6O0C1aCH+MDxM06LxvL81qfxtXQ
# KxXWruwLLSTrjnm3dgeitbqKyfHcQv1IBtYTUwJDoaRqGFQCGk8th9u0R74avzVR
# o+5eSODblqqF7QRi6qExcw8cIWyhcnd+q9U1Naprn51ldWc6k4sZ
