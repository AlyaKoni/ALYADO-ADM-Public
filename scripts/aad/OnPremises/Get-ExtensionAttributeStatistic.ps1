...
<#
.SYNOPSIS
Generates statistics on the usage of Active Directory user extension attributes.

.DESCRIPTION
The Get-ExtensionAttributeStatistic.ps1 script connects to Active Directory and retrieves all users along with their extension attributes (extensionAttribute1 to extensionAttribute15). It counts how many users have values defined for each of these attributes and outputs a summary to the console. The script also starts a log transcript that records the execution details.

.INPUTS
None. The script does not accept any input objects through the pipeline.

.OUTPUTS
Displays the count of users with defined extension attributes to the console and writes log output to a transcript file.

.EXAMPLE
PS> .\Get-ExtensionAttributeStatistic.ps1
Connects to Active Directory, reads all user accounts, evaluates their extension attributes, and prints the count of users having each attribute set.
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAns5D0rop0vMdi
# 6etUSFKnMvr12D9cMX/oKw/0JowGMKCCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIAAi/Lmk8ytqIJ4U
# E1rxt5U+NnAUWmf6UfbCcGjZlIuGMA0GCSqGSIb3DQEBAQUABIICAB310hj5rcnc
# +vh5wPvi3FTqF26ay9hGt3HbhH4eslU0nzyRHXzR4QCtZIaD84B/CyL441UNeiPX
# 6ED6SI8m7uOkdRr/Zvh7AjNifpNix74AApzG6oxM5/omIJnIyVNe+nVMp/uhjQZ9
# Xy4ymZ9GeXyzELSnvueZx5uF+QV8SB2lZt5WbqcRM/o5aDawdrfGz1T5LftrQP2x
# aMlu/NQYm7sVhTi1JbPElw1yCRo6Mj4XMKnPbTivs/GTj+NpNnYx+X9MHc2W6Uzv
# wNzs5LFVqVc92107KlzEpzaZkgjGGIV9h7K50SweMVKZqkWfe3wxecUOLCufnmB6
# SUlvuchkaItBpVmE6N6N8mQuA/DZWixkMjRUh7iWP68jqnpFhinu18dlLWgxqlDF
# o7fSYL7bPzue+oanVsBuBes8k3vMm2Ou6+V73Z2kJelQaB1tR/6xi17onbFV3C+y
# MK8NYwImvl4BEs+Ws5OKPQWb9vLFUjxU3BDcor4b60mZ5JXvUw5qRb4QOPQ1VILE
# 5+ud17o+jlXVSr0V7/YlMeY79YvhnfycyQ4LiVDUJjWoPKD3QvkwgG0K9HvMqKAH
# yr61Z7bl1fIYnXswA0vre5eMpID57+QjcoRFQT9nk3rl+b/NydSNtEdjQL7iDRgn
# caH7Jaummer/ITVflQdaK/xsowrokDnAoYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCDjJMbZCjzY/Xlzodhq/9qP8HBOW44SiLkllnj8QO0yGgIUYUvt5TrsZFpy
# HdxxNbbcv7Ixw7gYDzIwMjYwMjEwMTEyNTEwWjADAgEBoFikVjBUMQswCQYDVQQG
...
# IIoHTFuLFMyba676TKt1gThCNm0geF21pYbo0kkTxc8xMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAE5EwAvb4Y8T8
# /LqC4so+4mYsq5EjzuxwDQ9Gnhp/YEW9y6N3/njgKKgURpiMbjKxrkEReVefXb9Z
# FDF5wSGMd1zDTv89Th6k6aWcEqd9bUDEnl7kWFovElnu+Si5yuNDXZszPGEGnl9Y
# YmBjDghAOt2xPr/GESJ8TsJ/wVnYHZsz94pjX+cJxm8+wUj9PVNflBl2tOO8JMJz
# YpVb5q8fz/khVm6fuqHfgJ5Pt7GrGYZwxxLJtuMXZdzTohMrzLrEqqenDtzI+LNi
# GTII9JCF/feWxliM55YSnxsj0zg5UspWG6BoJMYJVtUdxFWUMg+S9f3aF7JBHRiC
# Isc+ZR48hQ+7JX5CuKEYfaJnondI6V5H1GaSyJj4RjelpA3cg5KG89qTfPJVvV+E
# iKTXTrYqIH9dkJTvsh5O2hCs1z6mmydn1n03q+0LQY+40Yxbb2QKkh4tun4LVZeY
# Wwv7DR2ZcotgQjq75qLCpJcarKFzDttriqGLKBOr8a153yw7XowP
