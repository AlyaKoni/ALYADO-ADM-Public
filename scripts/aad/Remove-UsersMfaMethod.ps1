...
<#
.SYNOPSIS
Removes a specified authentication method from all Azure Active Directory users using Microsoft Graph Beta API.

.DESCRIPTION
The Remove-UsersMfaMethod.ps1 script connects to Microsoft Graph with the required permissions and removes a selected multi-factor authentication (MFA) method from all users in the Azure Active Directory tenant. Supported authentication methods include Windows Hello for Business, software OATH apps, phone and email verification methods, Microsoft Authenticator, FIDO2 keys, Temporary Access Pass, and other supported modern authentication methods. The script logs its actions, ensures required PowerShell modules are installed, and handles potential dependencies between authentication types such as SMS and phone-based methods.

.PARAMETER methodToRemove
Specifies the type of authentication method to be removed from users. Valid values include:
windowsHelloForBusinessMethod, softwareOathMethod, platformCredentialMethod, passwordAuthenticationMethod, fido2AuthenticationMethod, temporaryAccessPassAuthenticationMethod, microsoftAuthenticatorAuthenticationMethod, voiceAuthenticationMethod, phoneAuthenticationMethodOffice, phoneAuthenticationMethodMobile, emailAuthenticationMethod, smsAuthenticationMethod.

.INPUTS
None. The script retrieves user data directly from Microsoft Graph.

.OUTPUTS
Generates a log file containing information about the script execution and removed authentication methods.

.EXAMPLE
PS> .\Remove-UsersMfaMethod.ps1 -methodToRemove "microsoftAuthenticatorAuthenticationMethod"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCXFozzbMneBy8c
# DK1lbPMGcfnRHditTYY8ehZjTMfiCqCCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIFGf+8UOv8uUtC8a
# fn7CowiNtrQzlQuoSNWpq0VrbV91MA0GCSqGSIb3DQEBAQUABIICAIeDPDO42EsX
# mHLQ9vwgItg7uoswTxEkGftJxVwBBkC7tzo0INiD6bKTCmL0RUaQJpee55BdaB+C
# 15FU4e1txTdGM0hAAxrXq8W7lkgZF2T1zLovhiYl2WEQTG+L2aNz+3T+Ikivgk6q
# wMLm1M7XGIQGu1G6PBX2M/xp2WHl1LizU/JZ2QvU1S5tMiIBwkOK6BHTVcf79z7Z
# 5umb5TNP0IN/xQphsehcIkojj+4XY1nKZoXP8B5/AO5KGqD5FwmMsM6paCXE35+R
# VUoOspnx+LA68Yy+5T47dXyW74Ira75WVLswl2uT6JGgSLJt5GfAtT960jKr0VIj
# PTdi6wzCJBUjzrIlLOTmcsizlooz6TTGyXhUVEsLKikjE9yOj6TqnEu0sizd4TPy
# wB2MYV3HWEJTS8qOZRwFg+WJmoVeg2IVJsCPpUKTGY8JfFW+pmVg53wJDiuTLr99
# 7UTst/DZKiNCaiLJ4jGSB96Bj+0l9TSllf9e2M5JH92/q3+MIJuOxaI6bXCrgKZv
# qhDv38xCE/u0laYtsBzKwZ1tc0D653Um48Q+ltzixTpLoO2UnpFSslDDBzkqU+5J
# oIJe2PwDRNQ+XiNIxwLHF6zdTQlO5Um/HsfChWo1ZAQ31vp8xuw3HxxmRhSqt9jT
# Gd78wYsnkK7sAMxbW40s5BQ9AIjS8kSsoYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCDDrO+O2AtV0fd82XD3wCna/lti9X2DcEvTQZkPeKNBDgIUdv93YZuWV7oc
# qleC8Zt6LgLrPQMYDzIwMjYwMjEwMTEyODI4WjADAgEBoFikVjBUMQswCQYDVQQG
...
# IKAwvsdcJtdfOaoPNFjKaGoSBKXLch9gJbnvN+IK+HVWMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAba3w2zOa+GBQ
# WlrE12h16CWgwPllxEdzsJFdCGsO7wCviDNYD8yBAxnXodMK8YUgHwAo+gz9KTkl
# W81CDhfMIIfV5q/2EiKMmIq7TgefvwAFHecyNcH3tyqqGZdZ2NGOPM61tq2N3Nv6
# FQNmZYkRBlur54GzWX3zjGt0Ab93f6YlW4RQ66ScO6VGHga56uAgf6/R8mR1KJoG
# 6cSKv9zpPHWcRI1zPHCc6jewIKGxIcTLLboNhVEV+eE3tGSxTLxjfgBgbE7zrfOR
# 2KWDQGyYDK35Ke7WzDDvKjpSzdNqGK7HgrETxYnwLzmumuvlkgPJCcgGumpqhEu5
# W50CIodN8zaRpXPW8U6bIjNS4G8lDnq0c6fkisGqehFPGzbFWjlQxM+FJb4epTKD
# 1KSqAPeO1aQubQuIlqNVbIgqSqI/XC7Y0EaHWy3kKETpX88q3BqZ/57a0rIAsPnN
# 1PTFUtncNv94Wwy0QvZlI0KiST4B+DnxMQCm9To/mzIoLD9IfhC/
