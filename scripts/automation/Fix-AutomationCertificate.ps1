...
<#
.SYNOPSIS
Fixes and updates the Azure Automation RunAs certificate used for automation account authentication.

.DESCRIPTION
This script verifies and refreshes the Azure Automation RunAs certificate for an Automation Account. It ensures the necessary Azure modules are installed, logs in to the correct subscription, validates access to the associated Key Vault, and creates a new self-signed certificate if needed. The script then imports the new certificate into the Key Vault, updates it in the Automation Account, and synchronizes it with the corresponding Azure AD application credentials. The process is logged to a transcript for traceability.

.INPUTS
None. The script does not take pipeline input.

.OUTPUTS
None. The script performs configuration actions in Azure and outputs logs to the console and transcript file.

.EXAMPLE
PS> .\Fix-AutomationCertificate.ps1
...
if ($KeyVault.EnableRbacAuthorization)
{
    ...
    if ($Retries -gt 6)
    {
        throw "Was not able to set role assigment 'Key Vault Administrator' for user $($AutomationAccount.Identity.PrincipalId) on scope $($KeyVault.ResourceId)"
    }
}
else
{
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCFKlT9QWVZXcPc
# UGxWDKoIIvaaWVTs8vaIeBecwrMw66CCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIOJfnYwejkWAbqZq
# X9IC7ZBWzaIqehOpDihpL8hxD0uKMA0GCSqGSIb3DQEBAQUABIICAEhi+FRtvqgn
# gd09k8ISR+isriY566SOdWP83rXURLV1J/NGypOXP6BHDqTCnRepdjqyjzAs45Zs
# Q8rkth5KzlPsVptlVa8mt88zL/T/CSmN2qDLXoPMYCatIu8zcQhKXPpecZ36ccUx
# vwLy2321abxu7kaO93tmBZaEqxl0qgAe4LjxTqd9L+xnp5HqmaW5ekUMWnQcHpUY
# yfPzFbKhdEeF05+V8DthNK3gyjSWLgZoUKswwlSULWewBpIat4sI5Q9PLgLYuOnm
# qTXrsJXM+JRIMfLkP0gkOzsQsbOCBi82GqAjAL9Omu1KA5NHmjAMKIUXcqyEbH6F
# tFHZCkiyVwDBjNWdEpWVL7hPiqTb7tLPe4ShOforXREdRBOfvNRPVKDAerfqJ2pU
# l3GXwL2gsEOhgp1n5/oM/LFtiF3Smspcnw2rB0T9hNzXk7trgMkWBaWHeWfTe4dA
# G+oSPt+B5Oi271JvTnXlT245Nzi3aAfW3ZT1nZVdiKpfOXZT9DCbmPAUPlHxHGAH
# XPsU8wWBKpz3gtemxrqlbSGJ3Oh5J4dq/PtwQN+ixEun8N1xUKpbqHyBckischx/
# xsRO/1/kb8FyvrwUTxlsDw7tKieworX5ddK83pDNZAZQDLqjJgm5aSIW+yZzttd1
# uM4NzuSNvlB3Hzom0dRIJjFKNOBpNdNgoYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCAR45HDW0WSJQWmFDSfKAkh1/9QCfF8pT6rOSuTPLxZJwIUJeWLBV1l26sG
# Ofxhd1zhanQMJFEYDzIwMjYwMjA2MTE0MzU0WjADAgEBoFikVjBUMQswCQYDVQQG
...
# IMfne6XO8LkCouV1AnDSwxlmXpHCBYs3+ggApjhT8eGUMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAOlEOxV25QZJi
# Je8cZ43v9vVhrTgHoZSea01kY6tg4zSYH0TGpw5J6klzknwPZWCuBCVWnGMS8WL7
# 2xVSOnrS6SHlZuF3dRM6wOgS2fAuzuQflJhMX3b5Y3qCQIzsC1C9vvBfL7Bu1k/8
# rP2oJNap7zY5yLns+S2jdAusRHj02edJ/Ms8hyUSx60cdn9sYRBaRnOqFC4bbOYw
# CSJrgnZhGUyGGuNIx0CwJCN+lEZDhkmSAmZ7RJCSsWKNJb5EhHkHbWlFgyqQOtvk
# cgv+Fi+2f1pRYhRTxH3OhkHkbRCSrdayBmZstDCAmtSS7TkT9AaRAJnXmfIpnxNe
# 47/vGaluXZEcPuPsRGH8h1NYifFlt0ksleByjG5pf/99nU5PbHImA3bS/6HNZGuQ
# vuEULyMsbblTBM6waGI0tJQexGfwDNohQfVDO1d/0b7utq9qokZHnNDCvY/20oO/
# Sv56OGsWXDbDKgJots2i+1xG8x2EIRjFB7w1dHFceeXz8EiCGOKm
