...
foreach($runEnv in $runEnvs)
{
    ...
    foreach($pkg in $packages)
    {
        ...
        if ($pkg.properties.provisioningState -eq "Failed")
        {
            ...
            if ($resp.StatusCode -ge 400)
            {
                Write-Warning "Error deleting package: $($resp.Content)"
            }
            do {
                try {
                    $resp = Invoke-AzRestMethod -Method Get -Path $reqUrl
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCD/hm5TxRWRU4EW
# CzqSn2P6B/GvpY874tk3bTsNEKvUE6CCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEINUHblxw/n0Sls0q
# uXjggTNRrwv6OabMhy3QG/Btkf7qMA0GCSqGSIb3DQEBAQUABIICAHbrMojbLCiq
# aFkNpjSzyLLdgRWC3FeOibk03F1PEFd3YbLompl+YPR2Ween3S/fOSgRkBiEgIzQ
# nHA3jEi5ZU5vC9rIuvihexl9xZYoW+u51bEF45787eZd3hh84F667BPyEVvfArmx
# H/T/8oJNdx+robvRv7z1pBNi52BKYELO22Hk2Cvi4LSZ+0yFXDG2IXgm55nHuZ/c
# zbxdGUENbcVj2EqtAbzGwJYGZ2Bt3LRJw1VEvPCSOsUghWAK+IYLVgR1tAA8giDE
# murx/bnX7ZlRjUu4OKROo+K3S4i8wGvfaAiY75uSI/lQlJ/qRsRToybJSRXVlUk6
# daATYwba16IcJ0ZD+S9PQsw31yvFUjYIgiCEWYVMEbLqsPSENZsn72QdRsIZbl0f
# Lp1tKX38e/HE/U4wUM1wJSQk36BJ99rQo6ZOy3fjfONdtNYD2n5Qa2FQDx/yygPN
# oKMIe2gq1omrwdXgAqxCeXwx2tPdurzS3M865+UWa62J0zEb/9jDQ7OqZ7f8UrWP
# gBceMtz7wM0h8vsAm9ZPnyDhXFaGdTt/LnDWJLV51fgf21pwlY39q/akPQ2A58lF
# +9lM5BfkDmwYhzIeJNw/QKzCgLyIBS+tH6r0/iFA/tt5PF2l05QEoDbaFsOSGVx/
# etcUY2lyjtk4fi2jWhgd7tArlYnxR0mloYId7TCCHekGCisGAQQBgjcDAwExgh3Z
...
# AQUABCB5uijOSmqP+xgACYkuEjaN/H4lyKcbdM5stEOfkt1owgIUY3n9qDRd/K8j
# XQVemaRYEDSbwlYYDzIwMjYwNTEyMDkyMjIwWjADAgEBoF2kWzBZMQswCQYDVQQG
...
# MBwwCwYJYIZIAWUDBAICoQ0GCSqGSIb3DQEBDAUAMD8GCSqGSIb3DQEJBDEyBDB/
# zy4+cVsN2KUOKzWJd9aGGVMu28mfuSHhqyKsn0Ca8PzsBpPdvfmqh/+aOPZV+yMw
...
# AQEMBQAEggGAsP6TXW6EHzl6cHLtqOxzi+EPu6G+3oMOfqW0j/SEVrB2ZGyorqxR
# D1zmmrKnaAoJkc5U3UdHsehJXbNWumGJormJMdJe5g9YRwJvmj9A50eJ3S3N7W0Y
# xHXAjTBoi8Vg3NEOd8flS76jXnrCkz1iofWFkpYW+GCqys8t/qSFA/dirN8ynsNX
# fRojMVuRVFd8ESpribLORntki2SlNgsSnzmNttMYdHJH0jdm6PgAFvzRaNcjBEPt
# AAtQk4YsYK833xgl0s7N1ZyJAFimZEsRRZaDBv+yJ59GXdHIeTqunXDuBr+xxtFU
# roS5c936SVVHEBWbLTX/3nxM9/uP353NUaZc2yxAPDnK8PYx1L3Cb8XFa/euG8Nr
# 5FPQHH6rBFCBCOJam0+ANbd4pOyzLr//RJfCupADUA9PXtIYIJju9YJPhgD5gAg9
# MQXqcG7RU+6IDOUM9fsivD/gR9U3KugCYEednnoxur5L6ihjVbo1+05iWyhUkg4F
# JOYjpaNNpNAI
