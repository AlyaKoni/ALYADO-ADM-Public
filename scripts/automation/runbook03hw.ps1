...
<#
    ...
    ---------- -------------------- ----------------------------
    08.05.2026 Konrad Brunner       Initial Version
...
try {
    ...
    Write-Output "Exporting $($RunAsCert.Subject) to local storage"
    $SelfSignedCertPlainPassword = "-" + [Guid]::NewGuid().ToString() + "]"
    $guid = [Guid]::NewGuid().ToString()
    $PfxCertPathForRunAsAccount = Join-Path $env:TEMP ($RunAsCertificateName + $guid + ".pfx")
    $CertPassword = ConvertTo-SecureString $SelfSignedCertPlainPassword -AsPlainText -Force
    $CertBytes = $RunAsCert.Export('pfx', $SelfSignedCertPlainPassword)
    [System.IO.File]::WriteAllBytes($PfxCertPathForRunAsAccount, $CertBytes)
    Import-PfxCertificate -CertStoreLocation "Cert:\LocalMachine\My" -FilePath $PfxCertPathForRunAsAccount -Password $CertPassword -Exportable -ErrorAction SilentlyContinue
    Remove-Item -Path $PfxCertPathForRunAsAccount -Force -ErrorAction SilentlyContinue
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBasg47N1+baLNC
# DNzdVYG1I5KRPfrN7fdR3dYO3XJCK6CCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIHAXrjtubT1WckBd
# ZWrORenPpdpiQqbS2aluWokrUblBMA0GCSqGSIb3DQEBAQUABIICAKih8W1bmRCW
# Boo6SBdjsovW6Yj+kFfItaZaNpkWSyeLUJfr2/E/pWIfRJ5PRuyyDgXwQm6EQMA9
# EMbQ7k0lNdK1kNVxTnIjZcrlwYVIWFPPlqewnNm0rPQEmVqCyR5jInihBNuzamts
# 78HCbDoS3mfi6FyA6hhR7G59KmpAeus8ypXnMPpKxfpjv7I7Ce1MnvZ9NXlqwWVU
# /b+XMWD4Vex6xdSLPOqyiJzAeSrfdZNFydqSkKBpXW1t1n+JVtQ3OwAp7FbkJic8
# N7t1DVhulnmwXYATGTSwY0DAlsqg1Mr+HO81lEmEI65HpaaGKbV0msXB2WA5UBqo
# zZL4LEvUp7toRSDSYE4TWVw5sRKEClEGPdb7r8GARYWxD7e3DYgWXjOfgnDzsF7f
# Ipw5CD2y89WG7pkNCkukiTbgakzX4iqLpWNyoUN/7BTV72YHQ0GB6EErNUwBt8u3
# w0l/1INFkCrb12nJ+Zvm4ty0uQ3N36rJhwXc+0JctsiwsN4F4bBrWx1oBVNzjA8r
# tg4r86Eyj2A5PeBTR/HDZgNwe/zYnc/XVNG7DDI38yWJ/GhPjA1XgOBep0D4bSCa
# ePMLiigpph98+NRgIxPOTcztpq12a22VCGFDb2R5dQB6zjFsETofFjeKahCKX2ob
# MI3wASF9Sj3zc6lofBcIHPNCul8afoOkoYId7TCCHekGCisGAQQBgjcDAwExgh3Z
...
# AQUABCBywYSqDJq8bIjFZ/Is02D+3vb+WujNuGMKge3VMsZ1qgIUFcJ1Ellbsa2H
# XqTxiO8vkVBTQcEYDzIwMjYwNTEyMDk1NjEwWjADAgEBoF2kWzBZMQswCQYDVQQG
...
# MBwwCwYJYIZIAWUDBAICoQ0GCSqGSIb3DQEBDAUAMD8GCSqGSIb3DQEJBDEyBDD2
# fleRWNDxRXAm/2RUXmak+/1fp34gjPdZ4jcQpWd/VfmSaJ2lD8oCA8TlnmYvszww
...
# AQEMBQAEggGArHWQAtjxVF+QLYoXqBWP77tGhi0kUjJFiXV4ZUldDKgMMihA1GlT
# uTVZYxtDKbymQXzx50JPTL8NEYuGhPJrs17jkg/N6yFi1Ta7hBa6RXw2i7Ui8feJ
# yPlU4eSPsOEG2qQdG92MtwEt+Q/lbcbKiVEoZbak3n2CPw3+3/X/JsE+Axw//wq7
# yvKNRszNxGm3+Km/UTmIyDDqbCanT9NUXZVMUFS9DT7WQlXYSC1KuZ2Z/I/D5qiA
# rTyLDhc/JPq1SOXZyGGUpUhB968BdPwdvj2kMD8Uat9NHrm737gRjasOcX9P2ahm
# 8W3Atso9PHODS9VGvwfDb7sq5hOkYMKHGkSWeKNlJNENrcFzm84aXd0vaH/zqQtP
# n89wGHVOlOXHrNPT871UWckZDZttoYF3BAtgxfmR8exRKqVypxTaHA+Dgepxhbei
# Zeoe7oCUWwZDhZfAmk1ai9hsac787KwUYDoZZfHKSS4nPpgz/GVF9O9woFLO1O06
# eKqUoDrB4h2r
