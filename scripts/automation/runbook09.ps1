...
<#
.SYNOPSIS
Synchronizes Azure Active Directory user memberships across internal, external, and team groups within an Azure Automation runbook.

.DESCRIPTION
The script connects to Azure using the managed identity or RunAs account credentials, retrieves various Azure AD groups representing internal users, external users, default teams, and project teams, and ensures that each user in the directory is appropriately assigned to the corresponding groups. It checks membership consistency and adds users to groups if they are missing. In case of execution errors, it sends an email notification using Microsoft Graph API with details about the exception and runbook context.

.INPUTS
None. All settings and variables are predefined in the script or configured via the automation environment.

.OUTPUTS
Generates output messages that describe login status, group membership updates, and summary results. Sends error notifications via email if an exception occurs.
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCC1n3yPvkK/D+Vl
# HRm3PenrqIqdy4JUFy4FupcEE5SEB6CCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIMxlSyrHISuYBnkB
# 9pafDZN+Rr8IL6ZIyV9FxMn/hamUMA0GCSqGSIb3DQEBAQUABIICAAPoNHW4pnOj
# ilkpclQxe3ReMrVwm/wcC7dVk6T2XzDzb7D8OHVSe1npOGqtP4kKV4HDGSuk4zj1
# pKoE/D0eG/kQ5bwWx2AdYu8ubnhquPJik0NmrGjblwffGrMULMY4DP7ow/a17fIt
# WZxr+5HYmOLFiESz80eGQ/YbHdONl/jn1jvQghli9thxf2HtLWgmPkgk1LA9VptY
# AmrrYjQ4KQpPkCMFWP9QUA2H1ilZQ8hPKdFCSeZM2ghlvmsYCr5iAg2ajv6STUmq
# X/bmunkvobdZh1Yg8cqV1znNiNPLT5zitSMUNEeYDWRpcp1XigNbdU/1ypvuwCH9
# ZeT2sGWtmu8SiRVXEVpdKrcu6ovRnxVm3F8JlVmSr97OfWdUTX42eJd8vV8pRz6S
# MHwDyd8vt/jGxW8bajGKuXKy71Gt56RSWgfk1mECJDqlTFwQ7501e6PMIAJp1f/B
# CbXnl2mZbed9vpKOt7QLyjYNMn6njQwhz0uED/705ds+EbN8WoZDpGvhj4mIKcu5
# dZMBqCUqJKKYiFGvRbigsGKTQhIuwH1UvOvEpUXuI8FzPX9rcPT1h1G6dxsR/1Sq
# zmgBTQvvS5/yHNGwU9ddpCTBzpl6gzsJVkDwlv9H1JHsTOOp18e5t+wSbwch1ivh
# lPdoYQnzTrSIWxCTa5g864TdDmbkTFcboYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCA9HbT0uR21dKl/0xMEIFnfSAuOwG3FOYb2ZpuA2MlwYAIUWaUjlmjOIvw2
# bz3QALXQ9nh+WLoYDzIwMjYwMjEwMTEzMTE0WjADAgEBoFikVjBUMQswCQYDVQQG
...
# IHW1Qy+uEJ7Yr/wfehsY74lrzHmXBd8G17EWmdOeF5NaMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAYCgOiQf0qB95
# YKygUJngDKUJYGS7xVN28DGavcYjp0yHYqc8qgf+GzC+Vzr7Q4yVDEFuZHteeMAd
# FZK9fwJaNxRYVbIQW/UyjxG55Woc2ufuXNTrOeo2/yJIuOtu63FhKYIG4VVgRjqJ
# GwJ8MiFcKDJbHbixx20r+yFbnev2rNlk5cCgFUu9fET8FZzGbtL2e6tJqtXA6acL
# As9HDhK4xmGTIT+zkUsTnPJ1Awpxrq1qeqWhevek2Xn9dHoi8nrM7IvhpNyfrl84
# /U78LvgeRBdQqFJVCBsumV4zgkFd4WMJEGJYIZ8wvK4eOr2Z4gMxm7M/au5pO/mS
# wOJJ3V0IxuLZi/i3qfEWPmn9u+yFPoyZsm6xMLr8aPqAV64qDtfajaZKOEoROP0J
# EkKLUwQfCHzqXvY4aPAYmDfSg7DRGMSnav+YbjrMF45x8cNVKntbXP2DvRZaLgQL
# a2tDnYfLYD56Zj8MGiSG7pCwXniwNz1b04rgTTFkLPM9rBi0yMPx
