...
<#
.SYNOPSIS
Prepares an Azure subscription for Azure Virtual Desktop (AVD) by verifying module installations, logging in, and ensuring required Azure resource providers are registered.

.DESCRIPTION
The 00_Prepare-Subscription.ps1 script automates the initial setup of an Azure subscription required for AVD environments. It checks that the necessary Azure PowerShell modules are installed, ensures the user is authenticated to the correct Azure subscription, and verifies that all critical resource providers are registered. The script also logs activity and outputs to a transcript file stored in the configured log directory.

.INPUTS
None

.OUTPUTS
Log file in the specified Alya logs directory containing details of the module checks, resource provider registrations, and execution results.
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCC72SihCyKZkrqr
# 8rtYZ4rcgbegLuoJ2CJrXs8z3wdpC6CCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIOWjOnmduJHe+v6X
# +xvk5r0bfow5uCQl8/gyPXPKMmheMA0GCSqGSIb3DQEBAQUABIICABhzNnaERzCZ
# qoH6Hx2aXjS5M43d9t5cme5CqEpvdeU/CWnhyKfVapb4oxiaxEFWB02PmNjp998i
# gcpah2Sie8d4oqmexgn1nHcguvuBwwYy2gty2rj8bQ1jtgwtnnDX01FPtmuEXfiB
# 4skqPu8OEk7kp2Uv7pdCgAF/I51mcuhAjDXZNxmJgqnrbFVIRTJZUnGdkQFNFrRc
# iyWX3XhLHyVWg2dHgrYB5IgiTNVvNrJdTf+7aGCMw3CwjRKqvKK9xisHOE1GtOvS
# Kq1LVYlp76rOYzBm/yYlbrexLm9Pfj2/8NL/uoN+JbGO2Bxvcm/0cGf9QyMIp9TF
# PByQWaGpFSU2WQ/F8XSf4ZmwGcJxszC0k00v9jcnnMxFmyVxp4hwYQvQrvO5TJNk
# syclWD83CoHdce8EWid3Q+mDO9jQ+LeBqSsCuoUr1kzVRE1f9Y6Fm1TwIxi8ql5Z
# HrPjz/TuRMgSxpaNFusf4tfP+atIHxtB7q2OmQ3mJAeVtL8wr/6+PJzXBBArj2zb
# kWrdHSCR87OE8vTPJFBHr1inLJN+5v/8aBPB0h09mG7A9/zmJmUAGhR1kEWOH4z6
# gtKjQ8ZtkzTNPvxe12JDjVk4lxfaVYWbbaGyXb1/fBgGUDmwm8IaM8m3Xa6ZF/6W
# 7bNKAzvT1zJxNs0K4TOFC5i3T01cgVsLoYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCCEt/cMHb6FWjgAb+ifgIXMgK5dMC1WV7WQbXiFunML+AIUPZW9BfwA4vU3
# WoBIrm85sFeCJ8sYDzIwMjYwMjA2MTE0NDM3WjADAgEBoFikVjBUMQswCQYDVQQG
...
# ILB/WkRoOQudubbb19cJUmKQ790RZP/OJ+hB4OD2Kkj/MIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAATAaoSMb2AYn
# 3sc+Tkgb6KCkOBKyhlZUT1nizD/14LsMR2fgq0wM56CKI8ts2ahu2jMpgEDlRNyw
# TO9XKdS1+rBr3x9w4tjMXU470iIw7RXyiEmVZmlI0upeGZmlkTySFHHOQ0yfiL8u
# drLOa5VyrRn3UNaIwmMMQ1r9sXjdfYci9UfQHH6RgpuirEh/qmM92K4bDkKw4si3
# cv1+6Z6EvuE8Q/HO2Sgpz8IR3j4s+BPDj7FA0FTZvguCXwxVg+LnNmxNKoc2lErL
# Iz1sfYNYU4W8hA9tyQRs9/uA4PgWM5qfgM/OoF8C1Rr7uc6UpOqnsTJaZSVQksxj
# 9cyAzxGOMn3gRvCbv47EpHyiNxb0lUa5TDI0uaDbSKp8HZ2wwHUvGqvJVWugTdz4
# LtV7wP8MiSI1uEOs663s2AzsysKlx3rTlwWUeBTzPbkLbDgPU7WqZk2PG+z81Bt+
# 3nwL8QFvN/HQHOG5+x44amPMdOVi+sHxUG6EaBxqhekSIyoVsY6H
