...
<#
.SYNOPSIS
Creates and manages an Azure Compute Gallery for Azure Virtual Desktop (AVD) client images.

.DESCRIPTION
The 05_Create-ComputeGallery.ps1 script automates the setup and maintenance of an Azure Compute Gallery used to store and version AVD client images. It ensures that the required resource group and compute gallery exist, checks for an existing image definition, and, if necessary, creates it using the specified parameters. The script also verifies whether a current VM image and image version exist, and if not, creates a new version. It maintains a transcript log for auditing and troubleshooting purposes.

.INPUTS
None. The script relies on configuration parameters imported from the 01_ConfigureEnv.ps1 script.

.OUTPUTS
Creates or updates Azure resources including the resource group, compute gallery, image definition, and image version. Writes log output to the transcript file.

.EXAMPLE
PS> .\05_Create-ComputeGallery.ps1
Executes the script to ensure that a compute gallery and image definitions for AVD are available and up to date.
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDzlPsK1OsofwoP
# dvZJHJ3LEUG8061nBXd4rlYnZJfSnaCCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIClgTzVU21xv+QDs
# Mv502vDGRJu5ZQAk5lC5AsZqAgG6MA0GCSqGSIb3DQEBAQUABIICAGZn3BMEB5Cm
# 5t4dhBlD88gXKaOhGfp41znbpQpWJOn8Band5UdWDzBF/eJV3vuYD4gSiPrAZdQ6
# eBFR0zVrXBM1SzQGFyMHRo9n0VLqxXdo93sgYbuOIOnSLxOlkH8JfUr5/SmA4jsy
# gueJqGMQEWf7GvzUEYTX08/m7fpWF6twP6f7/P7ToZnTmc6xKe4r70HM+Cb6ifzs
# 9b/DU1OlDZHamSFeMDEZAMSoIztS/RP3Q+z+zVVWr8r55HGSqblFzLBdHCbQWEoE
# NKHFZ2QI+06BHS56czRjG23F4ELhk6DP+WxnthKU5c1+8DjD7Q/ajxWRNLKW+g4x
# lLO/3u1Vf6X5hdUi1DVWjUmkv8GFNA8h/CcmuJLh0lpaQSaAbxVXtRoiML0rZNEy
# U5BGvRpnDyK6AZWsVq0Pfyv/jBlSZs4a0+xU9F9Uqdsipzyzf620MgAXXT93yWmt
# GLXiKwTkFNX8TnbTRus/z9mou+D5nFaCMbtt84ecCxDvOy0csBkfe7BXLmeO24/g
# 7GukgNiF+5lvFTrZCD9/1RUduqMwPcvFoWmXxhgejmPYyFLlrnc2zSzyTI1uGj1n
# CGd8Id3YuHTSXLx1pewJY1aNm/CrV3t9f9o424c4OCgHOBD03EFd7+r+2X3UkU5w
# 0WB/m21/Bo0isHAQNYcTbcVpnc7x2O08oYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCAIIO3aDPbDc89iBPqvggMjuswKL8pqB6cgBBXTRquiYQIUNLPIQUk6aaPJ
# M1wDwNAv6wxI3a0YDzIwMjYwMjEwMTEzMTQ1WjADAgEBoFikVjBUMQswCQYDVQQG
...
# IMYwkikGf99IjhGm3U6VEFIURj2kGqSSR48Qn5pVVcEyMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAbV9eU5aEqz2F
# 5xWrYncsG6pHFHnY2hf4S5RGiiUs46ckFAVto7HE798jC7bVVNkL5LflYGU6SwxH
# 46ywklvK7NPrOFYfDx1LJ6x9mEL3WSFTN0Him9AAaTZJHjLHJgpQkLxtSj5SbGU4
# dELjZ4QnsxF/Rt+o6L0RHWgSpB3UjylH8UX8QQLiuFRAGxUL7SDy9uHX42ygcBf3
# 4Xf0p2APBRCUEDJfyYGyLKJJjS3DegpqvV07cXCmWEbVpJV/SRGfcTuPYl3bM6O/
# VmhpOggg4GdHLcUSEJtIaYFc71G8/LXUhXoiT69ONvLg5sOKrteEl6xSAOc5bi1G
# jddWKW+BhTSs0d9ocvuWCf8237glNwmQ2JFPrXCTSOpVWHbGQGvi1GUtUVHDm18V
# knxCVRoPstgtZSG/B29iNmzggTF4PTCFuar8iyDdREjIugaLNK6qiC6aYleovhpe
# Vk++Rb6GGAyz60uzFrlveW9ofC3ESli0jRfhNiw9a557jniazICk
