...
<#
.SYNOPSIS
Creates and configures Azure Virtual Desktop (AVD) session host virtual machines in Azure, including networking, diagnostics, monitoring, and domain/AAD join configuration.

.DESCRIPTION
The 06_Create-SessionHosts.ps1 script automates the deployment and configuration of Azure Virtual Desktop (AVD) session hosts. It reads configuration settings from the base configuration script and performs a series of checks and creations for all required Azure components such as resource groups, virtual networks, storage accounts, key vaults, log analytics workspaces, and availability sets. For each configured session host, it creates the necessary virtual machines, attaches network interfaces, configures diagnostics and monitoring extensions, installs security and monitoring agents, joins the machine to an Active Directory or Azure AD domain, and installs the FSLogix and AVD agents. The script logs all actions and starts or restarts VMs as needed to complete configuration.

.PARAMETER JoinOption
Specifies the domain join type for the session hosts. Accepts values "AD" for Active Directory join or "AAD" for Azure Active Directory join. Default is "AD".

.PARAMETER ImageOption
Specifies the image source option. Accepts "Image" to use a standalone image or "Gallery" to use images from a shared image gallery. Default is "Gallery".

.INPUTS
None. The script reads environment and configuration settings from external configuration files.

.OUTPUTS
The script creates and configures Azure Virtual Desktop session host virtual machines and associated Azure resources.
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCA3YOa0REpzJ/MT
# v++SpfY2mdDXlm/8kEaNdRm8IvA9d6CCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIGc4mO4xIMtRaaPI
# W77CdcPKwR1lD0ZdtDGSjYQzsOI5MA0GCSqGSIb3DQEBAQUABIICAIFl0pefM9hY
# EPBzpWmfWGEtEPa9o9NPKo8fW9jDuOXvJNHngo9LY0F63nMrkkkdgTbOv5Gqi0x8
# dKEtZoQjsZn95YAQ1w6SPmf52Ew2bjO1LgiKLAtCaCP5rHp3BcoLz974KbBbObn7
# 0nCrb1sMlnRTA1nbRDuA6DLLtxSVNBCG8SttZwQO3UG6aKbsnUBALHQFJShrRbPx
# HivZ9WuAS55S9f/Albc3mPsFdkYLHjme1QApqI1uQFj0MX7arMQicIfs0PNvToU/
# GPGXU1SRtNaoqGf5RcIslFsdfgu7nXSC/u7JNDah2cklHEOUZyMltlnR+zksUX6g
# rRe8MA1ekMPnOC4yMskVeoC0ALrMx+fRXVEn30IPYiiBUoEegL2gfjLZUcdx6VZ/
# P1qHGiRF5bTqbRLUdJN9Yv/KddKTACfOyWuSnDuEj31hDvl/rMulFzcnk6q2qqMR
# vf7UftqR1dOX9nED9vhTSdyxBsaofmZsAU6LyS3yGsfrOi70UyYHuwRkwlYjrtF7
# qVF1YWBNCuL2tkfyxPL/TfrLVTgkjproAeWdzuJIACwgq6/g/X1mCLydYDl9WInG
# 1pnRM7V3mrnDRorXNbEEVekcPp0Mr9OnSXpZlPJ4xB9EKv6YKaPELGOC4vzhzfpc
# 5nL08HsEUv6wmf2hkk0GSciBmk1WPUVaoYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCCL9ny6zJ2wRFaI24BFUYlOG38es8P4JDpzVWx/bF6b/wIUIbdcy5ISId2n
# k1+q2EoSipLdXZ8YDzIwMjYwMjEwMTEzMTQ5WjADAgEBoFikVjBUMQswCQYDVQQG
...
# IDHaHD9T57sMPvuTDCFB4rovyBg8nRWIWSdvUCcfx0IVMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAZW3HB7k1blyQ
# k5ANf6f5qimzhhpYuGOO+d+TCwG73T14/on+0gG819ngDlvCgValKNm5XWIAPK18
# ByaCtpRPZuAzSD85HbufAhwlbIdclZgvUpyu7B0JXnC1BDH/lqoHzoXh+TRqoZbl
# KN3iVPuhdETUqtR/jhtYSRzbojofLGzcSOKGuCZUJyExolFR3UK1BIpm+4+9jpB0
# uWoqxKOpGF/931QtQXesb52t6WjHF/7JlrjVUEWekGRm/j2cqbL8H/p9S8xTB66J
# BYz4/lMb08osogC+tHVEIjJSwvUP7W63FszifuJ8s5r4NuU+I7W+ungGSboTXz/k
# Bg6p1WGNaX1EUanzyx6OAjPCUHK6fZ1VA4py+To9YLJ3bAJ0v5n+61M8zjE3jTQg
# NpAugd6hoHeEqPBifKGSKA079CEfBg3JS/TDGIkrmnyDNOAPAcn0T90gd6AaVDAX
# A5QASnFkiiJVlp7KH3XaxJOl44ryPnYTx62pVJV28UVs63W5RZ30
