...
<#
.SYNOPSIS
Creates and configures a shared directory for a host pool with proper security permissions and SMB share setup.

.DESCRIPTION
The script '13_Prepare-Share.ps1' automates the process of preparing a shared directory for a host pool environment. It ensures that the specified directory exists, applies the necessary NTFS permissions for administrators, users, and system accounts, and creates an SMB share for accessing the directory. It also creates subdirectories for profiles and containers with appropriate access rights.

.PARAMETER hostpoolShareDir
Specifies the file system path of the directory to be shared. Defaults to "E:\Shares\alyapinfavdh002".

.PARAMETER hostpoolShareName
Specifies the name of the SMB share to be created. Defaults to "alyapinfavdh002$".
...
.EXAMPLE
PS> .\13_Prepare-Share.ps1 -hostpoolShareDir "D:\HostPoolShare" -hostpoolShareName "HostPool$"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCB4rQpzo0HIRIx7
# 61GqpBhYFGcDrb2eYbjDnarpM3gbj6CCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIOLOHqPX/q3CF9dI
# n+FzX90k4MhlY77kmLDKNI+VYj1OMA0GCSqGSIb3DQEBAQUABIICAF7jhlJ5QN/e
# MQ+1Js6+AZtqz26L/VAQ1fk5UxfYgrmJJfmnsaUGMlDQxzYhX5EBlL0zJcXCXXou
# XEuPo0OSeOC5/hR2yOcQP9D/WE1hxulOXYENmeP0l3Tv3qHbmcy+gfJeXCjVn4uS
# R1HgP3n/M5DU1fN9LBVtKNq+YfshYZqbbVZXEB+6LlzjDXQMYsl6jXU8Lstu4AxV
# tQLaCPhGTQ3QwiAYXznjx6AjFbCUQV7wNrppIAAOFp/IiCeIDiFFH9IJV4c/tVbf
# GFwtHDYmB/EY9dpf7hzNKAkHw4FDPVzc4eD++GDierO1/T+x3S0ccBH/29JEkGDY
# PMxDFLpJU5T5WXbDk0arBqPoMfS581H9LnMysV6IyHXUPw584rRMjIRZ8C3yrmyP
# 3UjDCYXcd6DCmQk4l2+R+pIN4OclHeDV3GyLY9pBN0Myj1+CYX0nbEktiDMOfklM
# lsc00Uj6q2Y3cStMpDFq7IXTwMKhHzpBKziGBGEE0GFng4VYmOBn1cOALKJ/H8TB
# AHO8tdvia7MylTKZ4rcrBiT5PCxpROPaU+zD7K9NKZcCmAm8ebrvP+R1btEJr2rp
# ERzhSmCmLV4NtVz2nTrqLSHxuPR195WxtSFBDxA02QoL7J1eosveIpHedTaBux3Z
# x9NOqdikYSzQgysbady1TypE9uR0r37joYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCAFZczK0mBfsCvmHccaPRYLzy2i6dUBzelrMyHxydhLLAIUHPcCFqrBB+vs
# p7FMN8rC8q2wkk0YDzIwMjYwMjA2MTE0NTQ1WjADAgEBoFikVjBUMQswCQYDVQQG
...
# IA0BNNx9+HLNbXPoht92LxHT80mLxeDT0mn0ol7RV7wQMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAQCD2u/cCn5Is
# l3wS4SF/DkfzLqGQp78AWDMC6jQ9qjk03wY/dezaS51gAj/UINtrt7T8Vrphw0xj
# s8/JUzCQuHXdp1D9ennJD3MvgXFQGOS9hMjbMQuVVHo2wXLfEgxpeJmT5W9iervC
# sByx/bN95bSTgS9p8iGImM/KWL/QCOhSw5VIZmoI807luKkxqFNB3M83FVWMn9Xz
# 9hRxBy8jwoVTKJWZafkWKhOiy21OnA43JcwvCEoLwt2oBPsowvlODP9j6Usb8xoj
# ip6VU4RQjgqM7ucCnvykL3Hzqo2l3AF6rfJEou/KTFQKWH9v9d2znk2Xepx3xZzk
# 8vFNv0VxoGRq/eYXPLI1rLuAnziLAwRfvetYCGwwwWa9yUILw6XCp7VP553oB4ei
# Am4dSr0jSrq8If7BqcWir0iQihhozVIj338eXF7wW26ywEuYrffdKflhjUJNnrwI
# q8Zedzv7PkxD8i11PT1UZtt1Pwmzu+o9Jo4Gln5mhhBDrvsvqASt
