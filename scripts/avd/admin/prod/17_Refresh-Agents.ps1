...
<#
.SYNOPSIS
Generates and outputs a PowerShell installation script to refresh Azure Virtual Desktop (AVD) agents and bootloaders on session host virtual machines.

.DESCRIPTION
The 17_Refresh-Agents.ps1 script validates Azure environment configuration, ensures required Az modules are installed, authenticates to Azure, validates the management resource group and AVD host pool, and refreshes the registration token if it has expired. The script then prepares an installation script that can be executed on session hosts to reinstall and register AVD agents and bootloaders with the current registration token. The script writes detailed logs and outputs the generated agent installation instructions.

.INPUTS
None. The script does not accept pipeline input.

.OUTPUTS
String. Outputs the generated agent installation PowerShell script to the console.

.EXAMPLE
PS> .\17_Refresh-Agents.ps1
Runs the script to validate the AVD environment, refresh the registration token, and display the agent installation command for execution on session hosts.
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDvRKmnDn7y94kX
# bdA2pxaJnIzlQH0rNM+P12z5yvYVCKCCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIFN07/qveKomoGIm
# NAw/9n4qBVvkjfLF5AxzPCCie5ElMA0GCSqGSIb3DQEBAQUABIICADHsq27MUDVV
# miLDcsiDnTLIIvpv4dmE5GO1gbr3iIskloaJEY8GjcqmglndRv7quVOZqDbXi5gD
# NRmNV54IMSON63CtCy6shrxxNTXkibFLR8QqcM7gSZ85iaHHuBcetnZy/GPL+Aax
# PBIQtm2nhOOx/OCdxWgHAnm7hB2DUhfQuiqRhpgoocwkshIztRczws/s8c4s8jFQ
# cA0KzY4p5O3eujjZmYYCIeLr2Bwijuh2aSiBQ1sRTQEO6dl+o2tZ6Npcpud+8VIs
# s7DIlHUyzKtQg1diXVW4hrJsKiuq5uS8WggCYa9Td7A1OEM/ImhK/TSU7DY5wsGh
# TOKYOT7XsWC6eHnYoKDlXG1huxJc9tqcN3IkqRke+AspJyiXURVNLD/A+N14kp8g
# 9e3obadEwxOjh+yKFt8tdVpHjTiX1THzCEcczmaQEuVwMCFQSBP4aFGoGRXG6N29
# tghVr8MysuVv74RXh9IDviB5slKrhS296N6F+XKlJ/ARfQ76L1rDJ6Y9X7YrUyEZ
# fkrOAuBOmr7mHgew7PRBSa65FbfmY7EVQRk8pRIMWLS5f8OvyBpmJ2nsJj57WdBd
# 8DlJoU6Cely/HZDuN0K3ThZitloITsjfe1v8RXs8QDIx9oeJgZBGzLX3iuXAHOEV
# bAz6OMeudyClfiCzihwcdcYxiN4f1+HdoYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCBR6fDVdxyG+41j2VI1fFNOoy963mK2rxYixdDLRes3pgIUcl5aclzarKGf
# f15b5xuKAM31KvwYDzIwMjYwMjEwMTEzMjE5WjADAgEBoFikVjBUMQswCQYDVQQG
...
# IFfRasRANEeq6oDk3QPwxBnCOdZpmJIqaaqy7tSAMlBwMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAMjqhGuNbsa3x
# R8oU/2uouOk048koaF7sP01LDBbVCr7ofAhU37bd8T4VR+oHjswdJPP1522UwU+X
# PwUcdxYN/n3WYoztaNlxmolD1XIf7TjlNiSbzGdywwr9Y7UGdcI001TzthMMQzV2
# LrStKrltwFe90yNqUme28rZSLtktznX9eI43w4BOQkClCI4JJVos4NOhv8isd/gO
# 8t3tyduZHasGqCPdI5W6ev8GkULORp/dR264+8WJPS7o0znwcMhLLfk2TRI91q/Q
# mHstQcWMqbvAeE1AcDFH2GN+mBohuoVe3SPifR8tM7g9povHRsPwzzFbMsCmy/db
# RqmhgDi48+eDR5YsvKSumM0n0PmCy5RJayX9EbSFaoR/dxUZ6/plPXPN/wxCq3Vo
# rDQhMnneagKL4rt3/QdmwnLQPnyYjXK1KhLP+N1Jif+PmUjxw9JslO7uBrckfsIC
# VxtJ6pwhgL9mN8Fns0If1cqDlSAovrDcqjdFcWao2etYGuLSdS/J
