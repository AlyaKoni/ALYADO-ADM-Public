...
<#
.SYNOPSIS
Lists and displays details of Azure Virtual Desktop (AVD) resources including workspaces, application groups, host pools, session hosts, and user sessions.

.DESCRIPTION
The 40_listRds.ps1 script retrieves and outputs information about all Azure Virtual Desktop (AVD) components in the configured Azure subscription. It checks for required Az modules, establishes a connection to Azure using stored subscription details, and systematically enumerates workspaces, application groups, host pools, session hosts, and active user sessions. The script displays the information in a structured and color-coded format for clarity, providing an overview of the virtual desktop environment and session status. It also logs the output of the session to a transcript file in the specified log directory.

.INPUTS
None. All configuration values are loaded from the environment configuration script.

.OUTPUTS
None. The script outputs detailed AVD resource information to the console and writes the same to a transcript log file.
...
Start-Transcript -Path "$($AlyaLogs)\scripts\avd\admin\prod\40_listRds-$($AlyaTimeString).log" | Out-Null
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDTM9U7SDrGdFXu
# xt+rHC4YEY7onhA7uYnz/dV0WP+77KCCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIJEqjfGupQGTro7C
# g4sE0tgsA0ONWdZKVYBfY+vPoWUuMA0GCSqGSIb3DQEBAQUABIICAKmFPppkHhXa
# wu6TW0vnstz1DxlGf6m5s6mo68yHMFTRx00GJ19tXVdh084DDr3RwtJs4hn4ao/K
# 8ez95xG04Vk6O/SpCtuRaDGkwArJ9hcupSasLMPKwKwX6lSgsB2BaO0rko34mFok
# 0GDMQTUBuQ0Q10tCg680A0xD6ooobCwb9fgk3vSL3UuSrQIWo2vkSe71P8skp88n
# YoALwaiZWahl3uZYr5CKr9QypO14w4p7daGj/+BIJy5bvooOEvbbnQg5T2KSOTwd
# WnGFM75UBTMPSiesQf+osaw/FoJbAygMpsEk51XFowu9WlA4pvRwpQFI63xkKNNo
# Itk21BBMmYWctR3d6/8Cw61U3duq0rfcU9J/ChQvYPm6TD0t2mnCZBs8RbYe1xmP
# wczZXwQBh7HmJDWGo8nwqkKohCrqP7dplAOj1cOga29TMSUrwn5t2BfO0tUOUp83
# yI+O9TRHjNyErSPrdpsJMTarcrIxZLUiQR+YYijO4A5NVvINiFhPohCKPHcTEYn8
# dmV/thtReZ4NkdyDM5OJFTP5GbZKRQP/N3uT9SzZjbVixOYGDbcoheaOv9rVeG9+
# iDP9LmA8co5+keDtRVXCGZc8DOWJW1E+6XEpH2B8jR1pnSyFTDZDPGqiPOLWeIGQ
# dIn78gtwSRF6FvLgOteWCNbyTdOcyxR0oYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCBb+aUiQTpU0Jtd5WS5vN5hD5hESNILmRxG19cy1Yx/AgIUGjEsIO62MrnZ
# /GvvSpYAatA4oLkYDzIwMjYwMjEwMTEzMjI0WjADAgEBoFikVjBUMQswCQYDVQQG
...
# IJ/CfdIm+JssN5GyBmFWjRSzK9CqX9yW9Sl3oUScyq3NMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAidw5EY/6PS1A
# xuq0qaaAJ4MoQ+6V6iNRtd0k0PulK+lGGxQ1H3rk6ZcXvjIgBld1y3MHu8N0rbfR
# Aos7ohGm8ylL9Trj1pkXus43E/8la516GOkpbowdItxd42Z0ktB3M1plSUP7BRHR
# yCWXjB70VlojJY+KuwF6X5OSj7oaIJ0LUti0AMtaLVq2thrUFpDbWsHg1o8Mfor4
# DvmjT1OuVPC4p8gBILQJdtU3NJe/iD2+l0HECvfFJv14jTiFCzzPBHU1TAVDBSpq
# u5bY+NFAgFmZxKgGxd+oeeHpxoX/kHsT5LxNF3bpsX9ShGcbynRHiD9CfKzkT6Wh
# vRcjqMo/eOxqjix/f6vn9E7I2kQ8qV6by6NvmoAlz4N1S9j27JioiogYkFzKkuHS
# 8Va5wIUppwAm8MDjG2g92dpgU/9mWQPz8VD5ZnJUOFG6sazI+Wy23Z8wBo7FJIvp
# j8V+hVjDdqBvUxEAi+iUFRY4StfJ68Tk/lEMPvXec87i6GkHDMPK
