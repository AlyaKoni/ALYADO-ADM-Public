...
<#
.SYNOPSIS
Prepares an Azure subscription for Azure Virtual Desktop (AVD) deployment by ensuring necessary modules and resource providers are installed and registered.

.DESCRIPTION
The 00_Prepare-Subscription.ps1 script sets up the environment and validates that required Azure modules (Az.Accounts, Az.Resources) are installed. It logs into the appropriate Azure subscription as defined in the configuration file, verifies the Azure context, and ensures that required Azure resource providers such as Microsoft.Storage, Microsoft.Network, Microsoft.Compute, Microsoft.DesktopVirtualization, and Microsoft.AlertsManagement are registered. The script records its operations in a transcript log file for auditing and debugging purposes.

.INPUTS
None. The script does not take pipeline input.

.OUTPUTS
None. The script writes status messages and logs activity to a transcript file.

.EXAMPLE
PS> .\00_Prepare-Subscription.ps1
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCrQZiUlSsHDNXk
# NsK4rcG0yjBvMJzsCeqZZWcydWBRlKCCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEINqLHU2NaY6uz/GR
# j6OExrs99oPl7bwi7ORt9GJxqtQEMA0GCSqGSIb3DQEBAQUABIICADYuH1uMi/M9
# qDCD5f6mL++O0Mzxko99MWtnfcWUq2VG0A1sEOD3mI0RcG9LZ48vamvfw00ZKFON
# ui4PUveOxWGJUjr6sLBpVvPuZ6AhXjfjwrE4ab+HX35zHvDlTx8EjkEs/Tdjm/06
# i5Mmd88DVRrN8sTMVnkct6R/AMT7gmvTNZrTNgphpwkujtDoz+fLYytb1cYcVKfT
# sB3HmmLj0+C5YJBU3YqX4lv/N8l8CcoAj0b76G0icAo1IR61WkZf9V8A9sq+Sz9d
# awXsVhzjZ38SB09oHt/YkgOoD3PEDiqUaxUq3x1GhKmH3noSKz2NnKL/JD2S0xTC
# mkLaveJvsj6curn+9Ko4eaKbxq/heCRYqfL8nDjZ9ohq2aLmgmZmfcUoVo+xMZ0u
# dc0X6bjrKmnoNSn6RJnH6fEBBjyC3X6p+xcNpCdPBgCdrVqXfHJnutO36tw+2S60
# uZ3Vt6s0ezRfacSZ0/ZZ7g5IpL34UZSeYmR2kaSB+9rZzuIoWu48Nlha6yjLeMA5
# 84MhLnRZ0gZAqz56gRu/Pacr4Jz3Cu2D21Rrud0nPkLmJs2z779fEJRUfIZBd57w
# z1162Kmqn34Nkoq5rNPDg6YhLr2/+OO7zIoP7Q1Lk9S+YG9VDsRQUqkORHu4oE0O
# 1LhU66yZlLLCUYq5XXmF4NrGtGhNT3uToYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCDi009X3QIAI8RQa/DINwXtTGMToX/NuQXSddZSi7ARzwIUPtGKcddIot7X
# uNOvP7qJU6NCdncYDzIwMjYwMjEwMTEzMjI3WjADAgEBoFikVjBUMQswCQYDVQQG
...
# IEk/RX7tny812WyWxn9T+f2CB1cUvVxqiENDdzXFw+K9MIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAZtFBUDgS+igz
# QTjhC2WEzxUH0Ohjft0ynuTsYF4BVP66J7Lkj/xvRfNmMpoUy81s0mLb7KoAGU6y
# LNRZ6bGBB0BvnjDNks2OQ/euGE2dxGygN8HKwTlmZ7tic2139V/xYhpvVeIqkBvW
# jH86Lv581T/iItVkpADqfMJ9Q7NAZIqaBm8DMAF706H1F4zrc25cW81IAJAVmw15
# c5qpXz1FXGZCZn4nmAb/8jjJU7T0E4NC4D/48w4Cj3LgQnLgH2ogzA/tQjok5KRO
# S0onhiccsdsRC2nb8z1XllSFMh8O97RkGpvTaLFzPWrdALErG+jjKUGdh8q5hPYJ
# mLdw0bJMLjkjhcHaoDkDyMxIVIrLd2wL/iwHTQ8AC7Nyhs9Hs4TrIFr1iTo2e+1T
# Vz6x7LYwyabeUDUpxMSriWG2+WIfDyvXyFpDg+U9jhjXbz0Nr3GAtOLP56S9sS1H
# 64Whkj8MkuvDdsB8Ip1Te7otuXfqK7Tk2q7ulr1yfC8GnGRr0fng
