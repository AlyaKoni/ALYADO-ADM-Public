...
<#
.SYNOPSIS
Configures an existing Azure Virtual Desktop Host Pool with predefined RDP and connection properties.

.DESCRIPTION
The script connects to the Azure environment, verifies the presence of required modules, and logs into a specified Azure subscription. It checks for the existence of a resource group and a host pool. If the host pool is found, the script updates the session limit, validation environment, and various connection-related configurations such as device redirection, clipboard sharing, and audio capture control. It also ensures that the host pool has valid registration information and updates or creates it if necessary. Logging and transcript output are generated for traceability.

.INPUTS
None. The script reads configured variables and environmental values defined in the included configuration script.

.OUTPUTS
The script produces log files stored in the defined Alya log directory and outputs status messages to the console.
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCYrei7swSRGmUX
# yoPHiB89ahCHoLKMHwoJN+Nxb+rcfqCCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIALfr1b3S4aj5c/i
# ZSMG+TIqyE6LUp4o2b+E1v7GknTAMA0GCSqGSIb3DQEBAQUABIICAH3+3Urwkigu
# h8eSTVmONzQhcP3z0CvIDUHTGCH1rjMbP8nV9TL7i5DG74SrNb2F+Vjq5xPlUArq
# aVQRC+5lOBxfkW7uAa9YMzG40MJ6ibaBY06eXrAgSor/rl88YgRb4FVx6UyWD2lJ
# nKvMQj+2FHb4KRoFkv2jWkEVY6T+QtyuLHCaymEC1E0v+eUyhVTVJBTrRzlj2136
# nYktzzVDpLNNw0opp0SdzKnxbAzPv/GBRWJ9Tl8u7KXrMnAC7mz2/MKXtGaghx0o
# Wnawe7kY6YSUcgg5Gxry9xdkyf9Yw3m034yLLpArCD8PNoY39IRfWxe5GLpfnYU6
# VzuJ6BM9wLjfs2Qemp+41YyRkNarRCaoWFLYa82ktPZjTsTu7IdUKtVtQiZrcYz5
# u5PxnYGbn1tWSJegnD5ljtFziWRb/p3lWpbhIe7lI78A/e7qmzmr+9EDXAmlBxBR
# wZ0MV9Ls1LAZ2hvXa/05X1s/xL7R8f9g5V84vnJ/VJrWdviUGPEcndYT0xrEsPG6
# SEs5y6zQu/w3FxKn2YyRoA+pApJaZPkHkEa8g4KZSJD20sIvnYoASCNuxXAbeIoG
# DbpAV8zZosdtdavtWP3Fonva7rrBKI/vTKzqHHswm67XiBNvvbL+YQHiGunSAlJv
# WryBY3n4W8J2B5nd1eVces4zirGbGcTJoYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCCUDmvr3HWfQQlJkR1jP4rwrhL4Y/pnopjSZI3z+KHqFAIUJFAc75DogtMp
# ei2glZv5cbLyMuoYDzIwMjYwMjEwMTEzMjQ4WjADAgEBoFikVjBUMQswCQYDVQQG
...
# IMZolyznwAxFPnPTPfRX8gk0uuezF1CPqSH9LgTZqr/UMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAhAGKbW+GK4uz
# lyTfeMxeHOIdG8HhooV/2xdkDR0Shiri9reiXFA7fCUjuXyMUTPaomj0x0eMFmeh
# WBgZ2zVCLfwGkt4YuNQvU/y7ZUAsaxq5b11gvgDKQii2jR/D4V2e5j1kSgIOGDDk
# tHifCqxKD2lfAEdF6hs3k8mntvXaumtConLpG3XiNGeoRKfmSlf8ODb+KmBvV9kl
# 9s0BvZYF9y31qXVE1/Li1cxeKFzJTojx+X+Unoam4jHx7JyYdCLu3VN/LTRtSaN5
# hYBVovzY3bRZMgHi5OwHtZ/R0+eLLKDfoeC7OILmtlCc3bauXXWLtT8tZe7wBtIJ
# 65HombqT6FpiUGA++qAxA+qoTqwOAEAF+cVMX0s8/9L/1Aq88ntdy48p5yIjRqM+
# x3lIfEfh6wycBpXpaGfi0OT1ZZxfQlcnETwfNZJJWlZSbRIp4TUkgDAy3vvDNgwE
# YlHten4za03fXqVEm6h0cW2bWIzkki4i7zHCozvbWgekNd3FpQlx
