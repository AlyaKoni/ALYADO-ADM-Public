...
<#
.SYNOPSIS
Generates and displays a PowerShell script to refresh Azure Virtual Desktop (AVD) agents on virtual machines in a test environment.

.DESCRIPTION
The script validates the Azure environment for required modules, logs into Azure, checks resource groups and host pools, verifies and renews expired AVD agent registration tokens, and outputs a PowerShell installation script that can be executed on VMs to reinstall or update AVD agents and bootloaders. It is intended for use within the Alya Base Configuration framework to maintain and refresh session host agents across the AVD infrastructure.

.INPUTS
None. The script does not accept input from the pipeline or parameters.

.OUTPUTS
Displays the AVD agent installation script and writes logs to the Alya logging directory. Outputs informational and warning messages to the console.
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCqVN1gLsjsn4jZ
# e3FXFjqMeI7luQe2R39SDvZOnURmJaCCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEILBY8vbfGt5ZKhma
# 4jEVMxAN3BjwG0ii4rbfzCvW2UgXMA0GCSqGSIb3DQEBAQUABIICAFk7bUypPaiN
# CoVi6DRzOl77oq/+mCw0OvylUS59CuF+hVqu8zi5+jYF+YauKtjOBkXpXCOgNcdh
# UW6hJjcU7LSV5587tPIbvxuzJt8cbIL4h1dhkN6WsyIA+NNRIepe7hamecNYtUIY
# 2sjaVvu+p1R4I4RdLN0GQ8EPjHyMTpgKekhhQ34YcbkKM7lNxDrctQUUGnANHX7V
# SL41R85/kLFwRwGxXGXwtSZmCiBOQiZtUupvWZ/j+fmmGRV+jC2BA7idzCKHef7L
# DPDdMXrNGw17N3ZqisR7BDi8pSD9kr9INoUCcr4vUvH2HJo3gAmzhPZYLwsP7zc2
# ygLd5Qx7UhmpH7io3sItfcOBqPpRxCEhTG7UutHSdbzpoWqx2Bs1TRUnHmXkoO2N
# EhdOGoWiMrEjMVydUpEj+gqh5nUAKGbsY/Xr237lzXaBQ2rpl5nFAkYynNyY4wmm
# klD2B8n+m+c0cnY+s0gdHiovJll+in0eUnJ0m39JVjD2b7Oi3oTsLdjjwmfzrx8J
# MkafFa+YhCq8YtO8DiNAC/CmgtdDIuZx0pCy5JIIitqXtpZQu8Uh4U0uPAHYVyei
# Lk2wmp9hd9W5SC0BKKTDGW1Z5PW+VtS2etYFm/2fJapUxm2ww8GbB+c0kz7Woay9
# 3eDYZUzQv4MaWIXt6i3TrtXw2h+xAQraoYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCDferPXMeZGGTndhP7WYXY1JE7VFVvWk1nOIajlqQKXIAIUSZhX2s42kNQd
# CEyCtQjINiEEm4wYDzIwMjYwMjEwMTEzMzA0WjADAgEBoFikVjBUMQswCQYDVQQG
...
# IMEDWf5uEprmxCQ6H9pucOcNLr6ykt8Q8MoByCLJWXB+MIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAbN9gBF/sQv5N
# 1rpfVzfT7faXDzgwUB66FT0e0vUJQED+yJlJifqG2BmJT37sSsv4RyhLLRfmDkP0
# aiSEcLULZ0V5TrJNn1qnuy0UD1XNnSWRdTCYqbKUM2X8Fw7TIguruRHGy0Ib1AqP
# FnEX+ZcSFO2/iX64YQaeuvG8EXfqIztW5Q1jQYCR8EUZYJKE0dNZ09A7ysaDtlVo
# SjEiLJ9hHFxtuYDElYBRFs/JEwQZOTQk/VsxVstrlP/Zf3ZXpWc1UOF7TcvC9cxj
# opMytZBUdKnD6P4IYmZZylvO4otPYKmSyCSWVD4WGzQGBYA/Q4fV4ENv9y570Vgl
# YfoucG3UcYti4f0Apdr3vjtKWdHnOLr9ze3SMdRM320/wvDEopQDSvrSFbxbqW93
# OO4MU+Tk8EZGSABVB6woVC+V8kYqJCFtX0T1rTu4pLkQf+P2Jc+xfsrFVbC8VlTo
# x1mk42LPVWJQYiUYehufKvlMBBu23fPz1N2NzrRH8+mpsX8Sx+/g
