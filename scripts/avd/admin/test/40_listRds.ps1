...
<#
.SYNOPSIS
Lists and displays detailed information about Azure Virtual Desktop (AVD) resources including workspaces, application groups, host pools, session hosts, and user sessions.

.DESCRIPTION
The 40_listRds.ps1 script connects to the configured Azure subscription, ensures necessary Azure PowerShell modules are installed, and retrieves information about Azure Virtual Desktop deployments. It outputs hierarchical details for each workspace, including application groups, applications, desktops, host pools, session hosts, and user sessions, grouped and color-coded for easy readability. The script logs all actions and results for administrative verification and troubleshooting.

.INPUTS
None. The script does not accept pipeline input.

.OUTPUTS
Displays information in the console and logs activity in a transcript file under the configured logging path.

.EXAMPLE
PS> .\40_listRds.ps1
Connects to the target Azure subscription, verifies module installation, and lists AVD workspaces, application groups, host pools, session hosts, and active user sessions with detailed properties and color-coded status information.
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCB2Jr4s881CS5sp
# 34Q9KwSUZTPQqdaBLgLZqbzddEyipaCCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIAnOeCm62PUb4Hhk
# 5teLTNXLH0bcojaVOF9JozmbRggdMA0GCSqGSIb3DQEBAQUABIICAE/IePmd2Ns9
# LzmFCWRLXklQhVHfh4HG7BIje78eZNwQd3kTSlkKMtjJzLrSA1IesQ4BRWeBqIuP
# hSyUbIz0T+GydKJ3JXfXlLIXIBzLdLmACbnz8HGZtiVlft/t0A/+BDrOapriuRMv
# 0avjF4u3T/JBFlEyOqT7T3inxL1A6baKiq6N7m7hcwOKz7rTF2taZO24j58Mba9f
# C+pEY/pq7+v60Gqdorar2IkMcByQPIQTINr0uE1148yiD1G6KppAt1oS1Pq/f+Um
# 8ucZQjETua/hfGv0V1mHiaPEKcIj/h7FFIuX7nhgFa9q7ynCDSE/NNwtyjH0yuNe
# 4GKM0iwF/iezdj774t+F8Nm8brsd9WXMPBKean+m+8th0nm6PQY99vezNUBWqgWm
# N7uq/5JYn6eRuzeUzSapt13s3/eJhrt5rpFbqDz00i0+9cPWFq9gxcatrJn+7BXM
# CbolBJqb/e9SWcncJmEDkzlht4iFk7q0ntz3RN2qIthHP3GplacIY2U5ZganqkOC
# GXO3fDVWYTZHWX/76XsYNMIAJT7/5eYT5qQ82Wfgdx4qxp7R/PStXfeenJEYsMJn
# AU/rFpvO2WfsGViJ2OiKPZRiAPvFhxaUG5LX22yVvr3FMem01d/5UGiNBeeABrXl
# tZwB5gYOU3fnIYht9vK7Adzl1zaP5IOVoYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCA3ztpeFhHzhJBSWC4upz45zAvXoGqz4eBvNunv/f9gUgIUDraJGfTeWJwm
# jqryAD73emJlYqQYDzIwMjYwMjEwMTEzMzA5WjADAgEBoFikVjBUMQswCQYDVQQG
...
# IKhK6gI527jpXoVUfqat130Ub/jPolifxDbO8Ggc2o6qMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAaZvSqdMAaarE
# HM61howEEr8JK57AGpvGospJ1Qt7yC/w3DgVp8C0OHSn43K1AwREWL5WC2bgpLjD
# q11B+hhgmq50C43sXko6qghbSJppxp2YLOg7+Y83Wy2gXZD22sdQqrLWo7NngJNo
# 4LPJgW4xQUR+sDGe7HXVHGpQfcIJbAjO8Lgv2IdMoEJ4qMTwjUa/soS8xLHWptkD
# ndwx6UxwLh26ZAPluxTAqAbLU4jo6PYwaLrPlpmCCce+FSj3v4EyjJiU3etGZnPd
# MLxhB/JMGfYpAEw1yaq8Bpwd4HUXsn4tBlN+uyqZtCYcRJ/nK807laVswRqXPuyO
# KKETygypROrXTKmnVBxcXYmtkvw8VDueW80hFeJGg8ZfcdIgJQZ+FvlPas2AckI3
# M+ZZqkpeyMmi3YMThs+LnPlzwmLiAEy3vUgjElxsWfy5UIkLMzXSOds5HJ34arm2
# 5/ClPASbBo3UzQmARda8DJcYiAGeJmPqoEbFzowTB/pLZyjV0Usl
