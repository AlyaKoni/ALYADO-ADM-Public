...
<#
.SYNOPSIS
Creates or validates an Azure Virtual Desktop (AVD) Image Host Client virtual machine and its associated Azure resources.

.DESCRIPTION
The Create-ImageHostClient.ps1 script automates the process of setting up or verifying the existence of an AVD Image Host Client environment in Azure. It ensures that all required resources such as resource groups, virtual networks, subnets, storage accounts, network interfaces, and key vaults are present. If any are missing, they are created automatically. The script also manages credentials within Azure Key Vault, deploys the virtual machine based on selected Windows image SKUs, and optionally installs extensions. Logging is performed to a transcript file for auditing and troubleshooting purposes.

.INPUTS
None. The script reads its configuration and environment variables from external configuration scripts.

.OUTPUTS
A fully operational AVD Image Host Client virtual machine with associated Azure resources created or validated.

.EXAMPLE
PS> .\Create-ImageHostClient.ps1
...
Start-Transcript -Path "$($AlyaLogs)\scripts\avd\admin\bkp\image\Create-ImageHostClient-$($AlyaTimeString).log" | Out-Null

# Constants
$ResourceGroupName = "$($AlyaNamingPrefix)resg$($AlyaResIdAvdImageResGrp)"
$VMName = "$($AlyaNamingPrefix)avdi$($AlyaResIdAvdImageClient)"
...
Write-Host "ImageHost | Create-ImageHostClient | AZURE" -ForegroundColor $CommandInfo
...
if (-Not $ImageHostVm)
{
    ...
    $null = Set-AzResource -ResourceId $ImageHostVm.Id -Tag @{displayName="AVD Client Image";ownerEmail=$Context.Account.Id;stopTime=$AlyaAvdStopTime} -Force
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAOlf2WZ5zIbgM0
# UpXjf1kXzhGGbpKtm/zHy8oLzRm2CKCCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEINplyoLYH/pbiNBC
# 9OOEYyAI5KEsusoxGBnkx0IVeqSEMA0GCSqGSIb3DQEBAQUABIICAIfp9uDbvpMs
# 3CwecNC55N0BgfQDMxX+FBQ6e74NJxCdt30wYEMHBqqXJ9qpf53LZyObIZsLtP6S
# 62a+ble2FzbAmNirbe+ptoG1g/A19rXPD9bhDwwf8CHn1yTg9VArXCnQEOEPkKcy
# W+aO3eSxh1iXJ0sEoAgJ6MbwFsdPadfs4DAVOG07fY4/b/6rsZ8eLSFprZYuzBgd
# 55u/P8V2IzWDl/OqEGFHFpa/VAyFemmY1K37ugHeEWJkPqdFAJSQRwLaCi+ML1c8
# EGQ6QvLrNkxi4ujSn9urwb4pUrdxPNMIKMjtsbRKT/tyc8ag/Hy9Xk8hvrqMNnCM
# ZlPlBz3ZP4YQIKtzT60IrLrQDT6YsVWuK8Ax+Gj0hbk4QoutfJ5DSzOO7gKhczm5
# mZkVwPtmJoVd/Hz10j/7z+iq3tRhvvADbE4SKSNs4MyBZTArUrHz8ecCZ+NvDSmb
# Vvmch4y6w8USLF2J6doDDrcdlWAXGy9WQuVOuAhtq71zLaS3g/Am8KeyBJcz81ka
# Reyjl3UY66H31LIrMMpm2yEvNxhmByZOGfIqPzxf4awCemGOhITTdlevvIvqV9DQ
# M4GLvGqqieFuZpEgsGJ7seJY58rWZPcp1bDsqVmiqZ3OPxQD4zzkBC+gHJQ2AudA
# oas4xMfKd/NF83B+PbqCIfn9ouP4j7QUoYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCCcg4hwikBELUS4JPkVDrOuBKGtSLvIq0y4FvvG9wm1ygIUJyCvE603Mto4
# BG+PC/li2X3dS28YDzIwMjYwMjEwMTEzMzE0WjADAgEBoFikVjBUMQswCQYDVQQG
...
# IJZdCP65zs1d31hhicYD6dJUcrcy8dcWliWmYnXvQn+TMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAhai7SaTFMwtS
# eM3YxY8udC+X/AxPfs6e4usN088Qg/R3iA53xXy4G8ASxnF1Nsgycijuddw/fZuW
# 0RN4wnvkH7A0r7I9curmFZuyjAvnCcnZSqwAWC/6sTLkkQu70vm830P2ltu+R4On
# rxlXNEVvhR8KNFRUL4vxqS1Q0kWA/MDTPbRVg/hgLWTgnIU2vOrUhFejww0yUXoT
# 99gIKYHFarvOwQTu0Q9TRREA8AON88lnjqU2hTYqCO5q+E5+8vS9SIAVFE8XPvlA
# JIrElWC3Mo1O/TFTZcqgCV2osVnJcYZ5KBIfNuYbdWBbAdkgtBdGa1fbTUkCa4qr
# IQ6OMjOYj50dly3ZtHjec8BjkaTbSm87Ti3W7MmRcDSTAC0rkwa5xxkvjWRJMdwT
# JFI2OCYIN/UqtTsG6M0wvIhO1aep7ArCxiJvGxbG1DU8NeueewCxH49viCTrJS3S
# o1uXRxCYD7EJF4KkG12Cxc1lcXd8Fa1xKAx8pi12GZV8kAOfhGZb
