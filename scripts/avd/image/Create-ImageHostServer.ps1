...
<#
.SYNOPSIS
Creates and configures an Azure Virtual Machine to serve as an AVD Image Host Server.

.DESCRIPTION
The Create-ImageHostServer.ps1 script automates the setup of an Azure Virtual Machine configured as an Image Host for Azure Virtual Desktop (AVD). It verifies and creates required Azure resources including resource groups, network interfaces, subnets, virtual networks, diagnostic storage, key vaults, and credentials. The script ensures that all dependencies are correctly configured before deploying and tagging the VM. It also manages the creation of secrets within an Azure Key Vault for administrative credentials and configures the VM with a specific image and size suitable for hosting AVD images.

.INPUTS
None. All configurations are provided through the environment configuration file loaded at runtime.

.OUTPUTS
Creates and configures an Azure Virtual Machine and required supporting Azure resources for image hosting.
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBA2lq53juMJqWa
# fX3U4P7C5/3M4ZakG7cz7VPchPxO0qCCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIH6XPnSB6n1+M3DL
# n5HzkCi3+CZs3l1uPuM2b5RKA8M2MA0GCSqGSIb3DQEBAQUABIICAA9HQaWyMNSd
# bNUVfIeOLLb24QJx0wBGJEgFsE0OTfMrVPCFM3vziSTtezNSb539fbsyyBkpxXG8
# Eb1bbweK88kfQUG0N4IUU1EgN98M/E6H76ok3ERY7t7KfZqJkL7nV60rCTZ2zM4Q
# IjVN2A4AK8q0CRBMqyYBgz9Utqo1ys6wRVfQmiJmEmmqe9XXX85ZmQ296x5zdpkH
# sESqhlSmGWRoMR58T5A7gUBCfwanY7g5UY6lxCK/tDVH2hp3whblAoMy/tAa8ebU
# 5DYewxLkxLe85knT6ibi8kPVjE4LHF1mDvKMnYdXmzq05gVWBx4sLrWxbWxj24pd
# 0SnzfApYQvYI/pT/JdlTHT8Sjwo0yiG2pyXAWsr3WiH/+qM3m2dr+l6+vqRmPdDn
# JJWGjz749UH0rsdig2b8tdNObpgsFhTcmUvRPnhYdo8N6EkSz9GlxSk4dpMLY2cU
# FAB5Hbfo44TJC6jJAFKBn/SQF5oLswi6T2I4QwD7SXk3yvWFlsc9QxLsM6N/WYgI
# qbP9EaBHeyoFwDqxkPyOUkqVXrUYPQ2vJIxSsIK+Ct/XfafFrkZCURX5TMWo6loX
# pOid7MefE/MlDFfzz2dLSrETeuYpi1QXkB5fgT17niX8WjwXyBYyY8MRwGStq01C
# nevq5qDwKK4k3D2OT62OPjqvNcWtcLPooYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCBcqArL4RFqAiegJlFPuhzvGFUXNyN2Zl14FNZ40WvmTwIUZfKur+lcbDOa
# SOeUyCmvwv9uPoYYDzIwMjYwMjEwMTEzMzE3WjADAgEBoFikVjBUMQswCQYDVQQG
...
# IGJ1OV1X1W157BHbbZRVHxBsqUjp7kuHGPTTYrU6AAH7MIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAFWs6okaCHRvD
# mzHB5y75MtDZm7xk2w8DrmaaPp8aRP5S4kwChclkYUhkFCZSCOLFdsn/FVAxMvz+
# qIGKV+o/x8JMT3oFPi5XPXZOArjKWXeqfKGZNj0eEzsTPN0BduYumhR9wGTvGuOX
# l2WiG7wsgQmk+uYxnchlcqF710GKoxC/XT0Yw/yh8q27ulk1RgE+Gs8sBw0UQUgz
# 0MCYShSq65p8/Q9zu1fKgtR+4YCbMy42xWOWPMg+lJqew8+KMI6IDWiSm8BWfhHq
# 882RHCPn61Iuv1vfR28AX6fXPskjoQyYAQyJs7kr6HKkrDCuPrH6DV8yrNjgsFAo
# 03pNWKUpR6SpylIyTDzx5g4YW/oja0ZZfnW94Dg8veJESQ69ZhrmzguLEUElzK+N
# H2XO1jKgPb47jjwpbsToQcYkJG77Hq9wC7fm4AsXDTkzT6Fy9S7oJ1PlijJpeMcL
# 5sPVfm8HIvWpr+lw8F5+847ZQ5B8Qu12NxJU/DWhZ7RNDvzvN2vT
