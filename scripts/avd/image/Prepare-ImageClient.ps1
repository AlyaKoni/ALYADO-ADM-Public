...
<#
.SYNOPSIS
Prepares and creates an Azure Virtual Desktop (AVD) client image by generalizing an existing VM and saving it as a reusable image template.

.DESCRIPTION
This script automates the process of preparing an Azure Virtual Machine (VM) to serve as a client image for AVD environments. It performs tasks such as validating Azure module installations, connecting to Azure, verifying and creating resource groups, managing resource locks, creating snapshots, generalizing the source VM, saving it as an image, recreating the source VM, and configuring tags and diagnostics. It also manages credentials and secrets required for the image creation and VM recreation process through Azure Key Vault. This script is intended to standardize and automate image preparation within the Alya Base Configuration environment.

.INPUTS
None. The script reads its configuration from the environment configuration file (01_ConfigureEnv.ps1).

.OUTPUTS
Creates and tags a generalized Azure image and a new VM based on that image. Outputs logs to the script log directory defined in the environment configuration.

.EXAMPLE
PS> .\Prepare-ImageClient.ps1
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCC9V8l9//gkhfY3
# uBZgxofjfqCyqrLaRd3Bg8unCpVccqCCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEII0z4GWXpLo5xjhY
# sHCP12RK81u6FQY77sj0fThqznGHMA0GCSqGSIb3DQEBAQUABIICAE9v6hwD3n2T
# CPxEBN1mT1B74gwUqKbh7yI5CI0d6JQN3Rhx2EDJPJNTBrGnbheGn/eq1iFwBIA3
# ZXIf3H0FCv5apxDb7qizoGzCaG9RPvt0cgVmxReiXiZOrKf/PKfM51Yq0TjScNNM
# QzGzoB9aHRIBw87E4lnkubQZB+fN1G3AD7VD2tSUH9go+V7SkhYulf7L5IYigYTW
# lNrzMtxODm7kBas08FL1k364uObTu/gy10q1cJFbwIRjltz2/bze3gtcc/d8OClA
# 1TCTgg+VEYPr1+doSkkUiyPpxxji6qSazHrVidVh7kCE6XDIzzKL7uQgEHlZxX0b
# 4K87Rveg1o6cAokZk0jMAVLENSKkG0HbIcFAMo2NurNyECcc9YTju/9ThWyJFOUF
# jY3Bs+KbfJSaOkfXLTCSAfuARC5CIujxxWw9LXwJmdxdSCJ+a1jevr2swXEqqj4R
# iqMtkgPsb2LFPykJ7E2AC6YA548MuGc+3ExS046G/Xc9a3CxTm6IbBt8v6H4FVnO
# xow+99+sihTUqKBurjB79pOivjT36fUMaxcpx/C4MU5DidVtMWTNKQopaxFRgEm0
# DfjCZDWby99mYIfnbHuNg+kVsAe9uRXUdKNFt26ZnUrnBbkViM/3wAaGacyeKLyZ
# E+jCi5Ka1Ixxb3o6IswbGAjgAnbWB8iDoYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCC9ZiKlfxq7R+pvtn/l5mKtvw8qcSsddQB0rqBf6k7a/wIUGLD0D3ICyxg2
# GAKTu5nWjcaxp+0YDzIwMjYwMjEwMTEzMzIwWjADAgEBoFikVjBUMQswCQYDVQQG
...
# IGTPv+CwCV1Dn6x4HSbHtaPtlYqNR0IMMq36EN+AvGOPMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAGxEoc7OLuIuI
# 9lINBo4LDBDZ+ZzkbQGfEj4mVttXsgDzgw71eqDqB4SytR/jySPDwJ/5/7hNg8K/
# yw117R81zdcGmsdaUvb6ThyYvLhQCK7JeS/flHg5pdK3fyAJYHAt5himurC7XxLg
# xccu6jUaDpffeA9I3xaqLdmb8SZn2Ze98ciWYvEc9FUx0oVT+8T6k71gdzo/LTlY
# q0S7uopMYviCoyR+NEnEyneFykgvhkTl775+u3Mw9pNFtUzYo+7CAl4JXsBDnGa/
# C1tp4IxXAqJqbPD4c0jlmJC30Kuj0KGoicqddMH36BpnMlLmx3aXeYKRWnGEktIt
# vKsE04QzJJ58kT4pJaWHMykkdolaJvhhuV6bHWPIpugxJzgNnf5A6ejDpVcctWK4
# vGgxP9hgJbfFrqOXBuoK57CSRtRiz19+XdZoUqpeb1nsnxwWAvllWJhjWoAR6pHa
# k9UoQ+pa5TBoWu428KXIehPZYQuW+BZCJW5dx8RHSh5a0k4PwU68
