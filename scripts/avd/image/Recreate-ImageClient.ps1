...
<#
.SYNOPSIS
Recreates or restores an Azure Virtual Machine for the AVD client image based on configuration parameters and existing images.

.DESCRIPTION
The Recreate-ImageClient.ps1 script automates the process of recreating a specific Azure Virtual Machine used as the AVD Client image source. It ensures required resource groups exist, prepares necessary dependencies such as Azure Key Vault and secrets, verifies module installations, manages locks on resources, and reconfigures the VM from a previously created image. The script can remove and recreate an existing VM or create a new one if it does not exist. It also restores resource group locks and logs the entire process for auditing.

.INPUTS
None. The script reads required configuration from the environment file 01_ConfigureEnv.ps1.

.OUTPUTS
The script outputs informational messages to the console and a transcript log file created in the defined $AlyaLogs directory.

.EXAMPLE
PS> .\Recreate-ImageClient.ps1
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCB3CoUEB3t2fvCx
# 2Sp7YTlmHoMQ8BnGc8+QXQhsVJkfw6CCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIJd+6+uh83wVFd2K
# a3/EQzpJZRNMpM2ruGOtgd/64pLsMA0GCSqGSIb3DQEBAQUABIICAFQG7fJmKt/p
# 62NoqmnOVYI9jlkt4DrDx+bD8q8CO37lai8wfAmkHz+jJEYGS26AG5JvUJ7FD3e9
# INf7OCs4qq+QDjIMihN9R8DcgyUdLOgNasKxcAMzHLOFkY5M4+STMaDITmBqXmHD
# 3mcQ1vLGmZvf3JVp/xcMzIlPEEUiIXGHXk4bCxnwCpHRLhNFKSmR3uioFKoU/ZrU
# cDUwfWTYaXmM2luefuseuFckCDh0w2XSZVYJdrD546p2j9qMlxVBqtDjkTDgmrkh
# M0EJ5k70UmG5RaYPWD8DLa9U/ggAlKpB+LuqP99ROZ36llWzyN702aiw97Taxe3L
# k41uq+dwauXadaXlC3fwv2mdqJUJyW/HkePJr0pr2MVZe4fsfA7JVBLlgYHKAjrG
# en9dQE6Qr0UiboDuw9RCZR4oLnaG+HzXBLAOVzybxcIxoxa4gsCLks7pOLhLaKHj
# KQAbLJQoO7+GEdqNmT0MJ+P0R35ws0FQ5LcehfnQp2EXGG+Cvwej4jXANV9bhoB0
# tsMyyXvNe2MaiAupzgUdO1Li/H0TzFFwVuooAVeFBjKYqwFePTeXTHnEUmCMrktE
# 2CoXVyM4KiwJrinnhNO1GMn6k+IwaMAzniQXSBaf+AnaOdmom7st9ylDnDYFfHsK
# JuMiybAUOhZ1NDz0NQOfWubLg9oEOnqJoYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCCa9N1+8op5RQV99JwqFNeF/2aXuEprbF+A/BpzkS2SkgIUa0Zx7uA3QrLg
# 0W7lFnBTE/adSpYYDzIwMjYwMjEwMTEzMzI1WjADAgEBoFikVjBUMQswCQYDVQQG
...
# IGE2I+WlGnw0Jc9kKLTmMyeBjsZrsdx0GQR9dDvc+EexMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAmff5PCf46CUV
# 1Sk7KJI8aeieSZMYwYAODpp834aoJpT1XxCUcwOwNJkf0yOHIbz7xx4/bwvb/vnh
# Gxtals7/UY9JD/qah6Jx0T88VouiD+GUpalqe5qSL6baiZVabzdNsLo1Vdxoa5Jw
# wnmcUhqbgKKHSdmfTyXJjwPXT3MYXePTotYe38qL2vuJcJ+1uuCy6s2Gm4VGPexL
# y4jGEg5Pyuj+2z/ZUxrT3q27TOoXVLwlE52U/IG+ixKwaLvj0cB28DHnUkOkH4Q9
# V05NER64SyPmI56ZBYZACDk9/PadkLxWINgWUVllLRfH98oTQG93UAuMk0HzGla1
# FrEqmylO1r9McRTiFs1w8bUouf2f/Yic9tanHrtLccsFeL7CNbTSAZppv1EA1cqT
# shF6nuJEUZs4N4WZbs8tWuoUucrDdF65nmADBOdYakpEnVLlKiKtW8VAp8PkmFpB
# PhEAzKsrRKGi5s8/k76RYhbxWQIGNcDPoLpeJbDCGOmYpEy9n6t7
