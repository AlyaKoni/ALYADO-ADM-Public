...
<#
.SYNOPSIS
Adds and configures the Windows Admin Center extension to an existing Azure virtual machine, ensuring required resources and configurations are in place.

.DESCRIPTION
This script configures an existing Azure virtual machine with the Windows Admin Center (AdminCenter) extension. It verifies that necessary Azure modules are installed, logs into Azure, ensures the specified resource group and key vault exist, sets up key vault secrets and permissions, checks the virtual machine status, configures network security rules, and installs the AdminCenter extension if it is not already installed. The script logs all operations for traceability.

.PARAMETER ResourceGroupName
Specifies the name of the Azure resource group where the virtual machine resides.

.PARAMETER VMName
Specifies the name of the Azure virtual machine to which the AdminCenter extension should be added.

.PARAMETER KeyVaultName
Specifies the name of the Azure Key Vault used to store secrets related to the Windows Admin Center configuration.

.PARAMETER WacPort
Specifies the port used by the Windows Admin Center service. Defaults to 6516.
...
.EXAMPLE
PS> .\Add-AdminCenterExtensionToVm.ps1 -ResourceGroupName "ProdRG" -VMName "AlyaServer01" -KeyVaultName "AlyaKeyVault" -WacPort 6516
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBVv/qSh6le6hI1
# oB+19xGJKiZSmHl+MdooyTW5lzEaa6CCFIswggWiMIIEiqADAgECAhB4AxhCRXCK
...
# KwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIMr77Iz8
# RXOiyQBUxyM6nLyp+13Rh7vgvJpYKCk6xtJFMA0GCSqGSIb3DQEBAQUABIICACPv
# OmScRz5OZ7oCLYEm2HNy8dNJqTmHuVV/V/Gfh4chMImgnPDna1Q9Txr0RzhPAlxa
# pX+1OrFPqmhPVfO/eBh+Lr7Yqguho2IA0t+WSJLce9Kk67o7lqIaCxiZQpxdz5so
# gdhZAs5d5HEoONkh77roAnp0if5gOYM5d/jSZ7nio9wAF+JMthiQIyQrYwwTol0B
# d9gO0zMaHl7cxV21VemRqCH5wmArFJzQU+o70T23I1eIWdrmPdXxlbqQ1BhNADRk
# VxUD4+G+UmMxqoX6oa3RDEfkkziCvjvTbDYs9616tsaJkJd5vzIYc5J5GZQB8ikf
# MdLmg9DjJJQSoWXNraBLYePohQX9EBTL2/LRHUKy1iaA2P6whzrlQOW6SRK2YFJN
# Ag7c8Gfs5ag5zQDSdFDJ6QhWRFLw11ioGfaS1bsOST6O5oCI13CewwsLXd4RNg2y
# vFwj/Ev5XjwBrMoFzGSehQJ7ujk8yaGrKSN6K9dgoTCJIrzm4otjXjxQFQ9j9CVs
# 2iVYBwcr5wk6qIPvZ7prz860xqWxhz6SiTIahAczEL4DbNrFEoBhX/uWUuqpww1M
# F2N6xWl+0jSF8gB0YUd5zsNpwQPZY6fag6QkY1YGnakjmJ8yk6bjbcMWJUZdCzDK
# iZfjn88LEgjtHXyQaPasMoh292gqJ4l9w9CM8p+qoYIWuzCCFrcGCisGAQQBgjcD
...
# SAFlAwQCAQUABCCB2eySEjOE0IgKPB5oOVQe0ynjIR/XUBoyll1LEOOBJgIUNeY9
# av8QoFHav/LmUoI+NF2azHYYDzIwMjYwMjEyMjAzNDE1WjADAgEBoFikVjBUMQsw
...
# AQkEMSIEIJ/nbGYov3jZeouZkYUEjiDQ6H8PGvTv6UoqdDhftTekMIGwBgsqhkiG
...
# Mzg0IC0gRzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAdA/j
# njts9BDDjvt4qAlg8i9Vu3UoPVxVUoluJ4Q3dV+zk5JvLsuOP4gY1rNnuq6HUyi5
# OO/a2GGZPQIrvwoFaIRg9PouJsyXsRIlfxC+ZPjLn5cQQBd4RCczUjmEQqwGzkVb
# yH2fQPpxGWHZw6E+oFZyUMwf60GWO0ercMjECcTnTpf7DgqgsGPQ0GDXRZRLg7WF
# +rRuzgQBqihtvYJjCHfD74gkU4BWhW3RD+KT2cdQvtwDgFGe4978E3qNB+pvQOis
# hsb6d5Q6geqiIMRePPoEbTeFYaDnsGfDpLg4nitV3TmOVt60I73VDPwjaoBoKGYs
# AL/Vtom6RcGbYeTssk9pz1cZBnzPGxcVwuKFhWo+ROlE5GO2Jvk2f1/4KGE3VMum
# q/QvdHJnl6/8PIt3aB3QVYbZXxZa6FQsNeTCVjVUGgcI3VMigzAwggSuIyRr72Uw
# eMHZhOtwkPQRIWknyx3OXJTJtx8tJt7bAEl/JJaVvsCxhqD3/Fi8XjUZpkE3
