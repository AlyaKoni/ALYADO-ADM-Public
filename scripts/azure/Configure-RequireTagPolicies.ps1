...
<#
.SYNOPSIS
Configures and enforces Azure Policy assignments that require and inherit specific tags across resource groups and subscriptions.

.DESCRIPTION
The Configure-RequireTagPolicies.ps1 script automates the configuration of Azure Policies to ensure that all resource groups contain a required tag (default "ownerMail") and that all child resources inherit this tag. It verifies and registers necessary Azure resource providers, creates or validates user-assigned managed identities, applies relevant policy assignments at both subscription and resource group levels, and assigns appropriate access permissions. The script also triggers remediation tasks for non-compliant resources and logs all actions. It supports inclusion and exclusion patterns for resource group names when applying inheritance policies.

.PARAMETER requiredTagName
Specifies the name of the required tag that must exist on resource groups and be inherited by resources. Default is "ownerMail".

.PARAMETER includeResourceGroupsWithPartialName
Optional parameter to include only resource groups whose names match the specified pattern.

.PARAMETER excludeResourceGroupsWithPartialName
Optional parameter to exclude resource groups whose names match the specified pattern.

.INPUTS
None. The script does not accept pipeline input.

.OUTPUTS
None. The script writes informational messages and logs actions but does not return objects.

.EXAMPLE
PS> .\Configure-RequireTagPolicies.ps1 -requiredTagName "businessOwner" -includeResourceGroupsWithPartialName "*Prod*" -excludeResourceGroupsWithPartialName "*Test*"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDQyuowu3hUF4+o
# T4bRf6GNSZHOhzxJ5aOT5RMibVi1GaCCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIIsn2g+g2KVqmJ5s
# C16V/dPnY2JcjicyatjoTlRLcTB8MA0GCSqGSIb3DQEBAQUABIICALDTeyX28sGL
# GAP1f3WtsF8Rg3jgE+TI5e6nAVCS9V0g1xTRCWpAql4McBzn8fXiHyWsb1IYjVS+
# nueAh+JJHl4GHNwJI+ksTJHHIvyF2HKdgXhgnFjJx00ANOX/hh0Ip0uad9RkuFh7
# P0Ak0vEqJ5LL5X+hgLZ7KXpxOAlJPZCi1CbMtazbdKC4NDvCY0ZDg3KdjqpXlS2h
# hwP6tqPOp5oI3mZxbFqitE5TTt4af3U0/wBFVwdWW8Ffzd7/joNv7PfYSPCNiIv0
# 3fV7v/e74OZ3sC8zHB/82YdhF87Q7JUFDiNuIBKg8h7Nm5nGnWGXPMaJFmmmthHw
# 3iO/0a8/VzTp1nUxZrMiUA8P8vTc+Tnl3fRqIqAfdHmshdzo4mpMA1zplOtm3/Ry
# g6is1kqdFyag4rt8qHoa3xgb8tpZMo4ST225BmqfixoCeAALn+ObgXSk3hqRF504
# 0U1EzroY4mUXCeAbwVYKaxwM8sJM1FYbH2SjRMp2gWqXOiwVNsGUPB+Zf4RT1PS8
# DtO//dU8YWzXwexEAMrTRMq+nVndw4nIRJaq8Bc3ewqBWiFmAxiDH2K9EGPERneD
# 0L/KVyy+GhzWaQGfyELfUSRjCqvoddBolMAAsyOgBlBxqit8TEtCzBTFK+FEionA
# qkx3OUNGbfICQr3u07/myZUlS8zjRPWYoYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCAoIe+QSZQAH2pOzmntjZtxzYHcPL7fRPRK8UzOCSvncgIUQhI1o88KiZyi
# 1T9SfJYdKuZJ2QkYDzIwMjYwMjA2MTE0NzUxWjADAgEBoFikVjBUMQswCQYDVQQG
...
# IGRdiJxpct4cyN4nrZEwiZg4f9diNqo4HDkgyhGrETINMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAnQiZepEpJdzz
# Ybq0Fvh3nnh1qbYlN5gyNBD5azm8CNQv+3wmZ+ElLvGTFbcSamDhb2p90ea6lUdt
# dCgnWvNHQ3awtEDNb7eh39AG+uCkEP2a33JsI/JxWofEOKgVdfLtfM39s2jH6T/s
# bdcv6db1dshz61LiSh1QcxpjMct5p6wFB4pJ+1qvYYyXvvtIT6zwc0ibWHSo5YOC
# ap6+I+t9EA97uVS8D0sXH7sUSZ9GtmUfHpWGEDEs7AZqaEXvkT7he5eQvR1XR0Cx
# kvcM6UdJ7V29YCfiTu0HuK3tlYJqlZGqxIlapKd3PcOZtC5OGHn5qFDVy+/AcnNv
# nvv3DAClQh3AuZy5iXB6D6MzekWBrRnE4UrMJDk58uhj35G/Bg2ATLUUYzJ6cVtM
# MkDSoMooYjlpucs7bQmT5qiTaiPRcGQQ6GdbuDWG+NQSZ7LJY4MEu0OFsC+mrG2R
# /wYWkmCs+HLDUoERtJ2zBRCi4q8hWlRW6LIAUsdoOHfpA2+2QSdY
