...
<#
.SYNOPSIS
Creates or verifies an Azure Diagnostic Logging Storage Account in the test environment.

.DESCRIPTION
This script checks for required Azure modules, logs into the specified Azure subscription, verifies that necessary resource providers and resource groups are registered and available, and ensures that a diagnostic logging storage account exists in the Azure test environment. If any component is missing, the script creates it. It also applies lifecycle management settings to the storage account using a separate retention configuration script.

.INPUTS
None. The script reads configuration values from 01_ConfigureEnv.ps1.

.OUTPUTS
Log file containing execution details stored in the defined AlyaLogs path.

.EXAMPLE
PS> .\Create-AzureDiagnosticLoggingStorageTest.ps1
...
$StorageAccountName = "$($AlyaNamingPrefixTest)strg$($AlyaResIdDiagnosticStorage)"
...
Write-Host "Azure | Create-AzureDiagnosticLoggingStorageTest | AZURE" -ForegroundColor $CommandInfo
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDiR35f9gqCRtQ8
# ChS5W1Nji8MskvvpOw4LsctOP5E+aqCCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIAw435gB4oMcy1pQ
# HnpPmYO5QJB8MxY9eNu2+ajX2NRsMA0GCSqGSIb3DQEBAQUABIICAJpvHvKL8COG
# vz6h47vw0WNnDWjEvQ/O3/6FTe+IcUNeZezfOg4I3YXRBMkDX7gfjhSTv//LEz6r
# BIkbrgxhkfktWkRifFIzQIIA+/YMn0vPymGtex0E50fIHkwGuMIxP4AJaCQMC7dr
# 2IplWatL763iAqinkNHDmojfZpyOLBbUsjPerRACUm7NRChc45EplYOj4PY9uxgD
# BAJvjx2cBQ9TSxTQgXCCJXi9R/eI+cP56bNWwoR2S0tppkZT1QAYIcqSUqjKzuP9
# mwZ8gebwMOER+stYmPfRg6D9OqblIzzK1qRcxe9eugnvo9qmTk9nLDJYh9XnvQ/i
# Dnw9NBa9y+O2bM6IgPOW7Ul5Lw1PC1ABgQkoBH2Tkib1XkOArtw4s/N96WokaXEU
# mjbOzpiNKY3cmgAsgmqllUDBbYTzsm6arpuu/UBoJuhrG0gDkHXoM85nFCdFsVNx
# eD/+pQDpazC/62D2gkeiGx4QJ8i/OfuXz9KzaYqfbv1WuZ6IFesm49FF1Hp0mIBT
# bZHsTik5ZdEMJHvYeIuS8sR7Nj3q37ey6HkuhojslXBIT0DV28u9wt/X6QsxUWHF
# pvq/JeyWk8VpWOlgqg9LgP3c3XtnNvUv89zLYMKq5GHJoqcM9ZoymcFj66dlYKn0
# x5zbYlb26EbPVGThx1mMFIQ4H5MCMJjroYId7TCCHekGCisGAQQBgjcDAwExgh3Z
...
# AQUABCCkoZ0ii30FDNEhoqzbvMezNEatJbdDWq/uWzfyIPmi2gIUP0RTaAxABE1X
# x8ch+QoQI33EBTQYDzIwMjYwNTE5MDczNjUwWjADAgEBoF2kWzBZMQswCQYDVQQG
...
# MBwwCwYJYIZIAWUDBAICoQ0GCSqGSIb3DQEBDAUAMD8GCSqGSIb3DQEJBDEyBDAg
# CvUgqz4Kuf41rXxE8ZN8e0X2ccYxv0eJhj+Mnru+XM3vTz+CNtviB71T8ZfU/cQw
...
# AQEMBQAEggGALLL5e4XvNYxH4dX8vmGJpycYASX7rHBdon2rqBdb6w6wKmUynqlj
# 6o2D76J/HGuSnXUs7Us7DZywOi0FiLzzZESwdHmb3i5xzYvWj52q6g5JhOsQPjyJ
# 6/WWKMduZYzcAjfsqv9oIkAnvh701MWZo0defNFhMo+Wtp5HqK7Bt/4vaYQSmWbf
# iCIGkV+yxoLB7QTuZuWbEmDDBebzqMEcVtLPqaOviWScpbNYDy2yeDrQQg48jhFk
# tjFWtutqtwT8VRPNMMMlWeian7QeZwbnO2vI3hih6EI/tj8RbA9pMcqHhLGMAUIz
# 7h8DjEUQd7C0LoLSS+mAbsHuvklckzdJ3ervO5A3YOj8IpLagWsKKMrhZO1yDd+r
# NMoVRJo0YePyaP9T9qKALxAtHUjN7Trlb2Siu9yNPatERc6PNOfXqMjo2p4+ZM1m
# cEXxmk+dLkOnqndRLtZFsYgkv3z96AVvjXW+mfiP2i9TYuqpwDlOJU3shkM8N4JR
# OyvgZI8Gwzlo
