...
<#
.SYNOPSIS
Creates or verifies the existence of an Azure Key Vault and ensures proper configuration, permissions, and resource group registration.

.DESCRIPTION
The Create-AzureKeyVault.ps1 script automates the creation and configuration of an Azure Key Vault within a specified resource group. It reads environment settings, starts a transcript log, ensures necessary Azure PowerShell modules are installed, and verifies Azure context and provider registration. If the resource group or Key Vault does not exist, they are created automatically. It also sets the executing user's permissions on the Key Vault for full access to keys, secrets, certificates, and storage. 

.INPUTS
None. The script uses configuration variables defined in the external environment configuration file.

.OUTPUTS
Creates or updates an Azure Key Vault and associated resource group. Outputs logging information to the console and a log file.

.EXAMPLE
PS> .\Create-AzureKeyVault.ps1
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDemDOsbcATJb8X
# ZVS+/9B3yRMFQmaKE/g9jT9imns/naCCFIswggWiMIIEiqADAgECAhB4AxhCRXCK
...
# KwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIAiH7hHe
# LCMH7hSwLStp8HtlX4MP7pPK02VnhiqKOoDoMA0GCSqGSIb3DQEBAQUABIICAIvH
# 0ihyiRRz3ZPYCRzL8dO81++rdaMx+AbNG/dZqZIKHbZV/K5hObxwiCGbeMKVIH26
# Tt9XGY9zIbFw2/ifMfkS5VfFL1ghlsiq0eniIO0S9zP9Z0yXxlumXH7+HPgRnMnG
# XU7mOrv+WlJE1OYA4DNnN+lMV3qp2coMq7wENTpMj8T8uTQhHEScrUs4tSprXgFM
# gNpTKpr+mbEfhi0qSW0zGWDEacV0zUdzWiwVWhTQQiayjSHGWyuDJVLwtzSeNi73
# btRixQwz4ZIiJfLqIp6KpHJnpiHd6478MIhSwTYLMg8tzbJ3MCickJ/wbakMX9bZ
# FRUnsrPKiEMcfD09Yl2svPKAIArdxAiJgUdak/4jl1B7xkN2SlLEGSWzqGa1hMel
# hdS4qT1VlotZt8EZHW65feiCpPs/J5I2boKZUtjgw1J9rR3tI67KNr/KmVFGmGRG
# +GxPGm+AyTCSy1DQwJO1F8tR0ycDpiXA85mRqdmw8B7AMIHLswu9zIZMzaUg9w5I
# 0e+NBGWzz4euCyssaYGu6W9mnHMUl0CfgWseDRWoWrEpbXf2cpluMLeeIU/GFkTR
# sv9tsj7WEZUmC49DuZ61fyq0RgXLYSumFAewLPNSCpzYmISbJONJFBuy5Ff0DxuD
# 1R4kh3G4h9zyZGodGWPK+bIiTeK8cjuMbfEBCMxLoYIWuzCCFrcGCisGAQQBgjcD
...
# SAFlAwQCAQUABCCs4c8t0VT/dr9M2n7YYpjR/IEGTRRKgH/C9EDZyQPawAIUR7dO
# +LL/E6LoaDu3YhdAluWI6OUYDzIwMjYwMjEyMjAzMzU3WjADAgEBoFikVjBUMQsw
...
# AQkEMSIEICIMXVgLh2O6Mv5XjdUhpLMOheLjmi22D3uK0T5awCuvMIGwBgsqhkiG
...
# Mzg0IC0gRzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAXIUK
# SeGYFcuL/8R+8iDanWu0XwPsBxxdXB+45zRrN1TVNPU35jqC1XFm+biyBxDlI1Kc
# Fc1B2u73R7fMKpqzC+DWhBgo0EkX6IQ2mHyZMhDcSuVRpTvqqvBoV39yk3Qgrfoj
# cobC/6ef5N9pbBpemSK2W2EcH44I89umVn60wicNEjkY++CZyAzQw7LArn9KAsS2
# Q23IW1ALmXRSw9H8QRPAiVevKmLNvWguXDBU/na/+CqW4h/JpdFNOue/YLh50aOu
# z0EnxCh67ekGLieyzvWXeilZHSFz2Fhq1wptL+JgP0mTe9+3VSqxXJ8h+dvmu6FI
# kdbNdjLGYAO6l44eotdpoiq/gdwooOrb/fZv172V/261XdIiFHcn7+ZKYXOk8W41
# zWS0cChhFJvKc3/e49DYJPD+2ewejfa7/XF+FNAgwEBp7up3e4rGAjsIPRnzn8Z2
# MNDx4bFiHQy3mPEowFfX4OUzOQyqA4An9+FlErIXho/K/L4oWPxqOdDGeY7q
