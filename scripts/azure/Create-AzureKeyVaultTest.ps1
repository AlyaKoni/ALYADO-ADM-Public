...
<#
.SYNOPSIS
Creates or verifies the test Azure Key Vault environment by ensuring resource providers, resource groups, and key vaults exist and have correct configuration and access permissions.

.DESCRIPTION
This script configures and validates a test Azure Key Vault environment within an Alya Base Configuration setup. It performs several automated Azure operations, including checking required modules, authenticating to Azure, validating resource provider registrations, creating the resource group if necessary, and ensuring that the Azure Key Vault exists and that the executing user has the appropriate permissions. Log files are created for auditing, and the script leverages environment configuration from an external configuration file.

.INPUTS
None. All input values are derived from environment configuration scripts and variables.

.OUTPUTS
None. The script produces logs and console output for status updates.

.EXAMPLE
PS> .\Create-AzureKeyVaultTest.ps1
...
Start-Transcript -Path "$($AlyaLogs)\scripts\azure\Create-AzureKeyVaultTest-$($AlyaTimeString).log" | Out-Null

# Constants
$ResourceGroupName = "$($AlyaNamingPrefixTest)resg$($AlyaResIdMainInfra)"
...
Write-Host "Azure | Create-AzureKeyVaultTest | AZURE" -ForegroundColor $CommandInfo
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCCK8UTC/q0gRDa
# mxYSQ4umUfLritMAEj/XeIPXl22WLqCCFIswggWiMIIEiqADAgECAhB4AxhCRXCK
...
# KwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIBGXGQ9v
# 8vMjwTZOMNg2d5FIR5GU063tWXpzsXO8WOcAMA0GCSqGSIb3DQEBAQUABIICAJDd
# lcvsY+vVGca6OjAqZlpzQdSFRaRU572LZX5nAKIR5DIM+Db+z+3z6vRE0vO619gA
# R5lPi9v6AyGisozFKm09JjcgC6wCJwlzflgqUQ4oWZYsZUtq5dxrhnYo3yF287MD
# eE57EPTEh+hO/srQb/mU4lAPkWuIrzOCiAq63xgue5tSNHMZcuPexoiKWoh22xOj
# iC1vT724F5uKYa+tVKdCFeFJF9oc7gKxIwGlM7Y5BXLLTGGheb6cbyeFMNr5dGkY
# QRzXba3tXPxNrBTuhTK/yA0CztCAFS3SxIrXO5S/+B/1W3elWeJEWGb0NiX3uIa/
# 7Oems6nUnT9JoU9v77hjblTEmOuF1xuqjnC2/Pl2EwtZS/bbLFjIK2kR6ZORG+89
# FAx/fOtib7/Jg2Qyl4Mjy7EB2F/NsyNBRdGJB4gyHRLpTHP49t/gVAXEyZkdPuIj
# EsP4rAJwELOvsWgQVQqqjWQy3NPgjxGadygQ/jlKodFqxvbHXrmgbcIDv2hSUGcl
# L1zwpsANLq080eZrsvJLHJku23iiUW2mO1zoLYmnpJpytjxImu147fTJd+6wtXQT
# P3pVOl5ZLLBXZ4pErzZ7LqNO5y16x4SY4gwKkIkkR5HaVopirqwXjyF0AT+/Ea0C
# o2+oFtMthjKGitFItb0DnkQQIchpKKcbpRiwGjK/oYIWuzCCFrcGCisGAQQBgjcD
...
# SAFlAwQCAQUABCDDs8dLqq3JAyGW2rj36yYBT1EU2IyEL9TH4GMefv3ImgIULb4S
# kEkSZHkxsmLEfPpKqWnwtP8YDzIwMjYwMjEyMjAzNDE4WjADAgEBoFikVjBUMQsw
...
# AQkEMSIEIC7XOzfq2j6qJs3GE8hVVxlqZtt/b8NPkFGTHz3BzfGoMIGwBgsqhkiG
...
# Mzg0IC0gRzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAfJUl
# c268rIC5dM/Z6U7DPkrH17EZrOXW3hSEkTfU3fjosPZf1BkZVoqsWkOlz7oqhLqC
# cVNaygHIhI9waPo5ziD1hLZocsTOhj+R9etyFVZp1MYZtNPLQcTu5uxd9dUvyhg2
# qahfbpSGX1HOH2O/AFJY+W6bk1idrMceG9yUgJjRzLxTAn1kKpfPjIYeHe4OfKnF
# uYCb8JaWO/S21JZdKhFnwoQvS0FxCRE7qdkxm2NpoAyCgM7B2eO9vkmK45ps0yp7
# RE4NRzkXxWxzYVaOrNqrAcCRTDSrQ1/k0jhMRiWh8KOKH5x0Dt7QVupEVBi0BXNL
# Q+4AdBL6qLwGkh8qV8u758pLu0HbqWzShoojgeynTrtQQIzb5GQhFq07SDXjRkB8
# TaLYe7Im3LLaVfdoxASp+r8wLez95msxYOj1blaVR1Lwz8hP5JHzj5kaXhRAn4lC
# 3IhspHL4rDkhO7DRi+jgsP/CBevfcpB/feAADedE7GGdnPEdPFOZAheRBLC/
