...
<#
.SYNOPSIS
Creates and configures Azure Log Analytics alert action groups for auditing, support, and security email notifications.

.DESCRIPTION
The Create-AzureLogAnalyticsAlertActionGroups.ps1 script automates the creation or update of Azure Monitor action groups used for alert notifications in an Azure environment. It ensures that the required resource providers are registered, resource groups exist, and action groups are configured with the appropriate email receivers. The script logs execution details and interacts with Azure using the Az PowerShell modules.

.INPUTS
None. All necessary configuration is imported from the environment configuration script (01_ConfigureEnv.ps1).

.OUTPUTS
Creates or updates Azure Monitor action groups and writes logs to a transcript file.

.EXAMPLE
PS> .\Create-AzureLogAnalyticsAlertActionGroups.ps1
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDQnAhrOXAjv1SH
# mGCZXY23OplwRR8bMlRNwstRv05pLKCCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIFv7stYY3j6zNZrx
# UI9Fy7qxaqxZGCcWtASuKGZwWbPMMA0GCSqGSIb3DQEBAQUABIICADLQiL5cW63j
# G5YaRAxCvvadpHLJPw+SlworcFE1USh9AR331mPhWqyFSuPlZJhzoDGgIv67Sf5S
# dz08G97NrwTUHUYOR0ct/YA36qmX7Z8JvQlCAaTxJOnXGDZeyK4RVbe13i7YjWl+
# /S4lobXp5Op+UDjw+8DHef0DsIsqO3ZNMwq8Cm689eZs2BdnVkSov07SiZ1d4ZG3
# zxwtDEbnH3JRgWnxwZqZnUa70N91YHghpKUmhI4Q9K9+zs3oFlaZ6M+i3SxNXFQA
# pMB71FoSck6gkHP9zRCk0j2VA7TkxFIwj/DoqsY4WyJTr8kZqj2HpBt7eJ10Q7Lv
# gZfZRei0kXjgvMLAszenkJCTGi04zwhZEUVsKgAn69Kb3jKb2qAW4xgA22/Bu60L
# 3gTPM82bzfugoHWqHohrKbRmMwN/hvCeAubv8/kHBV5CGoCduksVfynRgqea4DyR
# NQee6Y5e0ecVV2xSZKyr3jyx7PDkr84BYEMuVk1Wavot1fQPacTrSEPAQBxa9gS9
# E9w2PagA6ojUgme7S2N9+ZkrIkVKjD7RZsRv5j8SPRRKhkwzpd9y3UN065BDJKA3
# NtdoTh9I90KW8TZdPJ29WeMJHRMcOJv6Yu7uRDgVDuK24jKlviCl2HC31rMhCHkI
# nzItUPY2TUZ4Y7i6ncC0nXIpYUmHyls/oYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCAchrjPJmFIDbHgmBTnSHAqI7D6Aw8pQAyKgdjCjceF5QIUZqJSSFjw4e6U
# F0zL9K2kPhSmV5gYDzIwMjYwMjEwMTEzMzUwWjADAgEBoFikVjBUMQswCQYDVQQG
...
# IHrIhmhXATL4XDsyHvFGhGfGozoGOo+Er6JaW9gqhQ7JMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAh5ex/AVLkA+a
# qu2eNiNlJ0VQZxEuO61B4bphdWXmaeVM8UhbiqYdGexVuYsxTZvprtCuKevKl1bP
# i/E6oofObIMdv42AQd9yvX6IFrIWBAlZQTLMEkw6Cta3Gx442nNLKPZvb6v0wzeY
# GyIDCV8HdHa9T8Lx7QeH0EtoP8JZHe8/RpZ34lLNzMAfvFk0b1s1rqRtCHXyB3Ft
# jjBnF79VvacnOZ4/hpoHk/qS0p51Juvxt6Rjbyr01WU/LdHw98fgiZmqNsPsGScm
# iu0sx0K2L4gq6MMyJgWEeT9Y5MNFfnKr+Aw4ET1AjbG5JlMi1phxivaUlQEyqr87
# 3sR1alGn12YAuHG9Elki+EHbncgMorr2lki/ry3HHgFarBfFkT/60QvgXl3/HWBH
# GBsC/jvHlLa5lmyvQn7hqkekUOqwtyn2oghgIQTrJTVwFLzeOGAbiHp/Nf+1CLoL
# wjktxlPl2W9PfiuuTGTzZ7aq0fszV4JbtGGZxXguKp0m918bljkT
