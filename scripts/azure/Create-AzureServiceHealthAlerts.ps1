...
<#
.SYNOPSIS
Creates and configures Azure Service Health alerts and associated action groups for both general and security-related service notifications.

.DESCRIPTION
The Create-AzureServiceHealthAlerts.ps1 script automates the setup of Azure Service Health alerts by verifying module installations, logging into Azure, checking resource provider registration, validating the required resource group, and creating or updating specified action groups and alert rules. It defines two sets of action groups and alerts—one for general service health incidents and another for security-related incidents. Each alert monitors Azure ServiceHealth notifications for relevant incident types and sends notifications to the configured email recipients through associated action groups.
...
.EXAMPLE
PS> .\Create-AzureServiceHealthAlerts.ps1
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCVIawv879b3rLe
# OdeTStUzWCi/rM2AGxVscQslaxrKZ6CCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIMfOG0TqkG44fSlT
# lsVgMQkJSihsdYYRXz944bI3YSDpMA0GCSqGSIb3DQEBAQUABIICAJQ62ELI/avi
# MV4zd4xdhPpjasAfIHs23BuiKzbX+NwXOxavzQiVnDSOxATRNJaov4kKWHojOKyp
# Yue2SYrb7KmGdle0geNRFjgs1QPinQen/ba+4A7nMTXukTLouKLcCZr/Tc6TegZK
# ESb3cut+tX6mIGMwFH5PfF7gq+wPOdX7Dopp0Qzkhdx1m3pU1MkONWemQ875P729
# gGYIG1/bFGniCcfuaK8aPieS06NDBpf7Lw64WC2tnlKjdw1xTR4YCaWxsEr5L5h7
# CFXfL71ryqrCslRhga+aCzVcdMdl9vGWS35fO9KlCz/m2dUmm8yc7w1LM5afOxCK
# znhMH+r32q5hCHTKjD5F6H5v8bvUpps8vDw3XF7faEkQYI0SbTkAtEhN1aIE+IbW
# dOqwjGouZ9oXymY9gGwc2FKuF2mb8vAmxv1OX7YkE/Muai5RFI+CiEv6dhn2FpHg
# aZ5dXJFNRrydpk1cZKNs6B+NKI3IizZOlWJ8pnkDt4ZAD359pWys+T56M9wpBl4Q
# 1gnGCEoe6MNHWe2eZswQY1DVZd3O7lv9NOg5q/PyQ9vaAwjk2Ep3ycgmnfj4FbI5
# d53CpHEXuIUNGnCTYC4uUusjdsDyzyNnsKWRXyw7/Peox1GxrYNbABqshC2KjoPe
# qODVOJXrIlOTIoJIqyiQznGLTwOLi4d1oYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCCQnb/HDpUsSdIMnazR7CAuBFUHenL3bH4zuRaSIdMX9gIUAnJPjSbgORFU
# Aa228cYru1PwKkcYDzIwMjYwMjEwMTEzNDM5WjADAgEBoFikVjBUMQswCQYDVQQG
...
# IM5AvgKR58Bts5RAodLTpCG866dRTaS1IpWLVSIqLGCrMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAPaR9QJ1DLIRC
# inKrli6dlDzXHT9pgEFJ4lhcyvqKI7w1I62PAaMWXghVDI5A38cJstu216PviWEe
# MTZNd8fGRPVtG894dbJlcFTK0OC2GIv2gqob7/9D22pQsOgkAdMBAV04Bodm9S/g
# MtfBTVM9YQHheuVHjHy4peYCN+DKbk5/FZPU2mlOgjloN52wM0/reG/vEDDil4vR
# +MJa939dRhOpnrVXmUijTc8B2GliM8F6S7D2culHNr2UBheCjDftQTzdOhAbD49H
# 5fkdoPjH3WTyF1mbYG9rzYaHMRPKJLmLrJmR1Mf507bhzwHnK3CqaOfMWLSgruHK
# 0jm+fLsXO6vDYIomQ6dHl7pWFC0xI4zTJf5Knf2rVq4ltI303UOa2s8VwTebCJKh
# yZqz1+6D9RmJHDDsMQvjEJiq0ogUo8Np9pV+XefvfJDlHoaHpXftHRHw9uc1rRFO
# ZqsADrRFi0LSlq844zhDe86ZXIECuivWG8WOokkVbdhdXauDnGAv
