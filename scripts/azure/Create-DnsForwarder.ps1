...
<#
.SYNOPSIS
Creates and configures a DNS forwarder virtual machine in Azure as part of the Alya Base Configuration environment.

.DESCRIPTION
This script automates the deployment and configuration of a DNS forwarder in Azure. It validates prerequisite modules, ensures resource provider registration, and verifies the existence of required resource groups, virtual networks, subnets, diagnostic storage accounts, and key vaults. The script creates a virtual machine configured with a DNS server feature, domain join extension, and antimalware protection. It also configures custom script extensions to set up the DNS forwarding service if it is not already installed. Logging is handled through Azure diagnostics and transcript output files.
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBLTfVvk4zVUQTG
# v1AxjZ9gHTz10UfrMEzl0o5Y7z11K6CCFIswggWiMIIEiqADAgECAhB4AxhCRXCK
...
# KwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIEmGDYdD
# pAQfXxXj6rFUzF9nSGzNk0V+ZOQc23Sxoh1fMA0GCSqGSIb3DQEBAQUABIICAMVm
# jW30zLqp7g8WB3oRDpxvzKPFbeaEE64fJDC4ZEvh/CXhdHDWWfGq9/0FAgkGfycC
# WeXk4vMtmoPr31vu/H1AzkhyWc4CWJaxTH21BabVvkdXDbSnA+6GrAs2hPspi4jx
# nuxFjQQ5NdOKZ/kh6eBgpUbr/pgKqL0vQwPTmyQFaXQKxvMNsGOwALa0Y8ZLoYfz
# 2GGxZ1mPH9OKXs+pngRHmCz3+KrSD/HatxaLGaOooFF8tDGO8BVPQSQGE4hBUvK7
# xAhoUg8z3Ry/g2CWz7SqZ8OAXFYVuJQQjrzzvIRwGgaRXc8LKfaEeg+TzPG9DdDx
# 0/JRWCDEcizL8TLA5gzvtQB5bB7bIOY0QCoCM2/bUIE6kWwicO43Cxe2eIo5jFz/
# kR20pVvBmp+hMKL0CkkqkuM+KVQ9QAQ/NpPvNwR5vDur7tjoAWUwMJu+nMrRmIzs
# ZC1Cb3gHauixm3n4kY8zMemjD4s8DCZv3QsA8KAQ63OW1n4YhncS29QDj6NLTa7y
# MWSm9rC1t/xwnEtObKS0QmfiixcBw3E/GE+TMkZFAjTboSqyhgjHubWyhKCDNJhu
# BQ28cGm0+c6xa1beZ/mWQI7K6gIoVHrtbHKReAbOv7uh6mTzw5TVtEcBJiTryAKd
# 24/jZ2nxxYAQJ1p68NHYBftcqLCo0Xwfd/50Bk4OoYIWuzCCFrcGCisGAQQBgjcD
...
# SAFlAwQCAQUABCAvzPrthEswYE9z4RVvEFWHGtlJrwewMDRZpoE7A0k0MAIUHDrH
# DD7V8PTR/qsBRY/DG88vtxkYDzIwMjYwMjEyMjAzMzU0WjADAgEBoFikVjBUMQsw
...
# AQkEMSIEIBoyHSoPHy2Vsw5oaD7N3W2+THNLiwHypUY2l//9DgMfMIGwBgsqhkiG
...
# Mzg0IC0gRzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAJ7Py
# be6o03J77m+gjllolCLIv7/j/Thrdi8p1Im9quUH1arfImmFFLDQ7aCyiGmaA1Hu
# T1cQZ9VNn92sYHYqTQUWrHQLohXwcPN3aGVDgov+LnPK4o40el3lu3X2P/duvPRx
# oKlMEg07y4C9TfOXBxHmJ08sur3TMnEZMPvdiWc7wKLz7HSGAk1pqSiq5tPJ2mp+
# Pqds4j/0D6KA0dSknBJPikKgQN49zrurTe07r4rv8GVWYKCVDhlffPcVIUdx3pjt
# Dy03iH1LL/yXqfaCrAtzxsq3tx9ric5J2x3H3VnHbTQdCmqBxzX5Vrgs7dxYPeBw
# 8SDBQjmoqDYbX+t/ANM4fkPsM8smwj+LebFGmnxSxisz4a9Xfe6Or6KVXnmroflA
# Lxo107t873mWAO01mjVTnxNewTVzkcJlvqNIHbTj6aiDmZjIUIzsGnpbw8gwhIDi
# InwklzYeLGVS/l3BZL2DjxZh3Weirikw3rrAr7gTm8lj8h6XYw2rUexWdgnw
