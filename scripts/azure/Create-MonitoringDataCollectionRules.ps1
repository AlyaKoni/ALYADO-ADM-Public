...
<#
.SYNOPSIS
Creates or updates Azure Monitoring Data Collection Rules for all configured subscriptions and associated Log Analytics Workspaces.

.DESCRIPTION
The Create-MonitoringDataCollectionRules.ps1 script automates the creation and update of Azure Data Collection Rules (DCRs) for monitoring purposes across multiple subscriptions. It verifies the presence of required resources such as the storage account and Log Analytics workspaces, dynamically replaces placeholders in DCR JSON templates, and deploys the DCRs using Azure Resource Manager templates. It also supports updating existing DCRs or skipping them based on the provided parameters.

.PARAMETER updateExisting
Specifies whether existing Data Collection Rules should be updated. Defaults to $true.

.PARAMETER subscriptionReplacers
A hashtable defining text replacements to map subscription names to partner subscriptions that can provide Log Analytics Workspaces when local ones are missing.

.PARAMETER ignoreWorkspaces
An array of workspace names that should be ignored during processing.

.INPUTS
None. The script does not accept input through the pipeline.

.OUTPUTS
None. The script generates log files and Azure resources but does not produce pipeline output.

.EXAMPLE
PS> .\Create-MonitoringDataCollectionRules.ps1 -updateExisting $false -subscriptionReplacers @{ "a"="b" } -ignoreWorkspaces @("TestWorkspace")
...
# Checking dcr folder
$dcrFolder = "$AlyaData\azure\dcr"
if (-Not (Test-Path -Path $dcrFolder))
{
    New-Item -ItemType Directory -Path $dcrFolder | Out-Null
}
...
foreach($subscription in $AlyaAllSubscriptions)
{
    ...
    foreach($LogAnaWrkspc in $LogAnaWrkspcsToProcess)
    {
        ...
        foreach($dcr in $dcrs)
        {
            ...
            $dcrFile = "$dcrFolder\$($ruleName).json"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDRBAVP6kpM0UiT
# meBPe+lF8nAIUbq4smfNkvF1bt6gL6CCFIswggWiMIIEiqADAgECAhB4AxhCRXCK
...
# KwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIHv/9vf0
# pt/gx4S4zEXsrZp8quRf/Zma5sCN2mZlgDOhMA0GCSqGSIb3DQEBAQUABIICAAWd
# ZhR+XBtfN600ajclK/Zy420k+tCSeq2dbRG1t/Zc9xKYadBICjYT0RagIS/llq7c
# IeMnRegHLG70+KoxDeAVofLt57JzDn7gFUDK8L8wpLPsfC+rNMLSaBJXI2rzohp9
# JiyreU1Q1a+nWbpmiNICGdbcHuQZMV4iK6o4sSBelVESugjfIwvnhLyalOqxqYYH
# 7lGdRQeahfapsknzy+DRYozxXjlWDheP6bKefu0xvTw6KTz5h24TaU2nx/+pqlvo
# SSsiNvi09kl0Ai4xI1FzIm3mhiclqqIvae0u+2cCO2BOGQDa3RdPEn6B3wqRaImu
# 99/5INJsf/NxWdYutV9nOeb/j1gYUz1V3WzVaAvbgsVvS94W9alHoixtwPFXbOuC
# jdZ3iPcd6s6b7HspkqoWp262OMDs0am5vQGCZdmRC8i03l2qBcnOmJ9o1LkzGIYv
# /6Vl33lIWi7mIwxjOdda3PpP2dBGckAI8pTleRvtkNlC4ZG1iBkzMDHHpD77Ifrj
# QI2RSkPUUkMo3AhA9pAIUCTyZhccuNWPsN4bG8brXe+im8+sPn+NKYO+GeBwpocL
# Da1BBKHlMzqHQbrFHj7wMqZ02kQErG1ilUPCTyceebOX0zY70jPeYdKL9LX7kEpl
# yAyoaji7jnx+WwhbV0umh+JPWg+t52txrH9m97HtoYId7TCCHekGCisGAQQBgjcD
# AwExgh3ZMIId1QYJKoZIhvcNAQcCoIIdxjCCHcICAQMxDTALBglghkgBZQMEAgIw
# geQGCyqGSIb3DQEJEAEEoIHUBIHRMIHOAgEBBgsrBgEEAaAyAgMCAjAxMA0GCWCG
# SAFlAwQCAQUABCB2yGI93Z1nYmQgCuVNRmRiK097XKLEpJMKXaD9J0DfgQIUMv4D
# aycNTgXIkZJAa+AaotaMjKsYDzIwMjYwNTE1MDY1MDU0WjADAgEBoF2kWzBZMQsw
...
# BDEyBDCOJMlp86DDm4vlReFhGhYvsb53rSOLX8JnDQ40x7KngUVIyfizjnns8t2n
# Nn7s0CIwgbQGCyqGSIb3DQEJEAIvMYGkMIGhMIGeMIGbBCCDKtcuUj/erIP6RpS8
# 58bMJhdkiChmVmWIyK3KOoOFUTB3MGKkYDBeMQswCQYDVQQGEwJCRTEZMBcGA1UE
# ChMQR2xvYmFsU2lnbiBudi1zYTE0MDIGA1UEAxMrR2xvYmFsU2lnbiBPZmZsaW5l
# IFI0NSBUaW1lc3RhbXBpbmcgQ0EgMjAyNQIRAIRyP8GVzBbx2yui9mDfK+QwDQYJ
# KoZIhvcNAQEMBQAEggGAIt8c475yAIay2I7nAzRr/8K1uuJQmXISrjw6LLnLFBIe
# 74QoSno4neu8zGen3npQTs++QLV4obRZoWqb/mmxue3nXPFWXGGIJY1Rt7wWr7ak
# DdjmhjC9cTYw0L4CLXcV6yuoZQKtiX56ZY3gY7YKDQvDndnQX5gkcNbFP0TJYgl1
# uwMZCiJlZI5ixi8d49jb/LtfchVNLjcNF2kgPBu8NVBrOizy8yav+jrIBVmoQFPd
# XfH+mjB45CPY6FawtKIM7rqTrCsPUPcThuhsNFlvcxdpHgKv+prcQdCjKSkJd/d+
# MC54AEn/gy1WuClz0FkseVxw2Lo9elPldyry/YwlsmMS2VUovft8G0wsQ+NGcJp8
# Wlm3DIs6rfOneLMIuTgHNuKYr+wTyr/slPMUIYhUb0P8PfPemOa+XBlw+N7E7V3I
# MblVYO7PxgHfaLU3H2XY+x3Ppv5spw3RBMpnaofSboaRsdE3v0Pt9aZQUqRZ3X/S
# +nnIqlH3ZnxVC4Qz/hz2
