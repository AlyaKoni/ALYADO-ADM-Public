...
<#
.SYNOPSIS
Extracts Azure pricing and benchmark data from the Azure Pricing Calculator and related APIs, and exports the results to Excel files for reference and analysis.

.DESCRIPTION
The Extract-AzureCalculatorPriceData.ps1 script retrieves detailed pricing data for multiple Azure services such as Virtual Machines, Disks, PostgreSQL, Azure SQL Database, and related benchmarks. It queries official Microsoft pricing APIs to collect current configuration, currency, and service pricing data, converts these into structured PowerShell objects, and exports them to an Excel workbook with multiple worksheets. Each worksheet represents a service category (e.g., PricesVMs, PricesDisks, PricesPostgreSql, PricesAzureSqlDatabase, etc.), providing a complete analytical overview of Azure cost components. The script also downloads performance benchmark tables for Windows and Linux VM sizes from Microsoft documentation pages.

.PARAMETER exportCurrencyName
Specifies the currency for which pricing data should be exported. Defaults to "chf".

.INPUTS
None. All configuration data and input values are obtained from environment scripts and online Azure APIs.

.OUTPUTS
An Excel workbook containing Azure service price and benchmark data saved at the configured data path.

.EXAMPLE
PS> .\Extract-AzureCalculatorPriceData.ps1 -exportCurrencyName "usd"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBe70Cg+ruurDsj
# 8/0XvkAdEhjNv3XwdgCHylGqK+0iqaCCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIOoCoJeFR0HQQuxs
# nF8xLlgYJTjMME7ZnxQ5Caa3Hk2hMA0GCSqGSIb3DQEBAQUABIICAHj8Ijevou54
# 0ogfKy1L0AuUPKxHdOtpzc/vIDkbt8QQh2ZpmjkWfmqU9yRIb51BjN4ugYxuTwYq
# SV2LllEXVTDa2dgoUT8oqi+MzhJSlydjsp8UeYNYTdgKNu1kKvXomkGpVFV36APC
# TU2gblNWQ3RZxSHo2er1jwXPF3s4EHOuMJJsEJFcoTZ6hokK9f+9yEHmOZyX3VNs
# GjJMni3UVhrcKmZ3xb0kqFY05/dn/11ndp7NZRsdxFtlH9CtXNn8Bv6azI2GruSZ
# +YXupyalqbX3kFUn/lliYzmdVJONExTLU0VdbUCvHg7xPSz5c/AOQqvdKtY7VNaU
# sjN2dYU6HuBS4Zg4J5g4GP99hRt8o1wRdLUHETucpRgDY9thEHMT5UT/+skgS1KO
# 5MqTLYQ2NIO/L0wHE2hlb4WRxe970WlFcMMhiU0s7gqAw6j3VTnShl+Ie59sIFhZ
# ds+5ZAxc/r9CvPTOtryZFb4KhRMNLwSXmmhxX/tDyvKjfvjzvJG+Pjnwj/niek6i
# bFUDZpGxekKZ44CFK5Y1B/pAQCyvHRjY7bMxMIMI2aPLkRzWISnA7lsogW/mGsaf
# jREK/fzZs1jHITT2G0gIz0Md2+N0NNePf14fWZJf3yue2It9YkdF4m6TxLWUTVlV
# byrnJcwaa0BQLAqafvjYojikc2XjQqqooYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCAK2w0x2+hTB52UxYG7fj9IhEPHwET+BA5Cb3Yf00WIbQIUNrwibAGx8tpx
# I6Ca0BHg6vvwPLEYDzIwMjYwMjEwMTEzNTExWjADAgEBoFikVjBUMQswCQYDVQQG
...
# IC2kkyrvqdhLDewqQeMbrYGc1HICez4O6fTsSmJXMmuVMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAADhvoBQZobGa
# ZRkbDTRq49bWVETAiLvaab0sVvrJVTsqfWUJbBqzmsFO+oojxYdoO+IMBFSFBF+K
# DV2zGt8xqBn05ySXBmNy7D6nOmkMZvom12K8V6ZRROWI1mrm3NOlc4LZfUBBOG9s
# /uegi9f0W+ia7BhX1SssEuLeGPlMLuEFk0yS1dse9HZreF+jlCH3Nz6Ck4kWUGrf
# wwvZta3KRahi2w943K7hR2X7mNZdmgJuO4GpvW9kKAVAXQjsRmNz6rC+UDWakEa6
# fNBJ5VzOT5BqxAS6V/C+ORGSQFi60BMTNu8xQ43rzTuyNNrWi6Zfb7jJOMF+rIDc
# 6IGw3WuXJc5e5ynRJa/7sqjzoHog+4Yr0MBIRK9E0Hwe6u3jA3oerLG7MT0jWpFr
# I3QEkHTr61RhvoNBI3Jz4otfqXeDBMHlpNUpENSYeI6AScJoaBCV5PopW7RIOc2F
# cpAeiAWCjdz290QK2S391Y5IUHnRkhZeyxvfJ5u1Aos/qRasMq6x
