...
<#
.SYNOPSIS
Retrieves and exports run history, triggers, and action logs for a specified Azure Logic App.

.DESCRIPTION
The Get-LogicAppLogs.ps1 script connects to Azure, retrieves information about Logic App runs, triggers, and actions, and exports the corresponding logs to a defined output directory. The script can optionally export detailed inputs and outputs for Logic App actions and supports exclusion of specific actions from this export. It provides a detailed view of the execution state of Logic App runs, categorized by status such as Succeeded, Cancelled, and Failed. The logs are saved as JSON files for further analysis.

.PARAMETER logicAppName
Specifies the name of the Azure Logic App for which logs are to be collected. This parameter is mandatory.

.PARAMETER exportInputsAndOutputs
Indicates whether to export the detailed inputs and outputs for each Logic App action. Defaults to false.

.PARAMETER skipExportInputsAndOutputsForActions
Specifies a list of Logic App actions to exclude from input and output export.

.INPUTS
None. You cannot pipe input to this script.

.OUTPUTS
Generates multiple JSON log files containing Logic App runs, triggers, actions, and optionally, their inputs and outputs.

.EXAMPLE
PS> .\Get-LogicAppLogs.ps1 -logicAppName "MyLogicApp" -exportInputsAndOutputs $true -skipExportInputsAndOutputsForActions @("Action1", "Action2")
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCZE4LlucPTFvyb
# DdwCtKLio/TnGZJS92BK5avt2di7kaCCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIOtq15Qp+SwsbUqj
# jROYaajob5ujqcXKmdACPdjE7sFBMA0GCSqGSIb3DQEBAQUABIICAHfxKwwZHoBm
# DnCSnQyvsuRYIp30Knyrif3TUhZwFmELnEAeK2SWuNtzBX0QdiQrhXqMIiqzsvP5
# DhzjvvJ04u8Slj0iWNYiYLy1WejiswMBt/3oh+5R032dA+NXQiw24WpOfqzMhsdy
# VYLpb0rlArN0Wvhr6dcEZ0Mdyr4YCL6nFr/TlhW/wOxOu5/sCLYC5AV6vL83WwkO
# lxMRfhB1Ut9GRmGs/Ai7vLSS6ODRa+K3TcMZiPHRDhxA8+aPllaFZRvfxal/AYsT
# URBSXY/TpfE8hHdeaotDolGn3fcYiEQucKZGGLWsz/GMJPHLvQExegylRblzY09U
# eM5OFLRIv0OxCwWs5e8oaweYvwIgCLLFZyw5KITrsL2bu+nGtIA8N2QDok5ChtZ2
# Fq0JP5NfylcvZueDuEQx0eEeHzuu4vVd+ah+5QyPQU3PGMDywllibYUuXb7fv3GG
# UV5QbBsmr0LKt1rr9HKU2rae4Dn1BdPulyXqACpIT/dlSfLKJOeDKgVnCotSvLeH
# xchjnqJjobnDHsUE22/bQ2M2n/SapXoQ2Y353qVyE5Nw5iNvsCG7UV9caur5XsGk
# L+CuVGl8xXzbWQRmPwhcEvUAc42RZtU7vTwg0RRs3Yh1wYLdSjnsJODgVCyAa46I
# 9ENNNFo39sIWr8BCf90IlSV+olfLsCxCoYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCAbV+jQZDiEBvslmtd0R+IvMY9CF0RgTIdvY1EqGiyG6AIUAqj0ccBdRs3i
# 0GqnCFAghtkg4ggYDzIwMjYwMjEwMTEzNTI0WjADAgEBoFikVjBUMQswCQYDVQQG
...
# IKDApaOxdiC32RggFy4HXvrXGurs5yxPh5kC+lepmjWYMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGARONjuxtvENFN
# Nd2ldyiZkwew36AtL6HumEMui7Ljg1ZtN46EzryAX9aIyVVHvPldNYRVXHY0gyEK
# nXDNcsMp+gFB23a7X1TR5upWRbfCRj4aQVNsp3gHRuH6cWzdDbAAIECASuUv4NEn
# IkBtg8nJQzAVHavmBcDT9Y3xB9KLDAMhnBw4364Q+xtJhRNNfGidrUfoYozpRAr7
# jbZbvSf9+Je2mN6NtxANPBCIuEFeZnPjKfMi9Gvx7SJoWjB0Qn+OF+fkVkt/kToy
# Puu2T1WT/T7pxhPTbVLZVBivrH5BWaUa/r0D1Odtd2PC0RcIgqwOfZ8ZkoFVkTOn
# gUCrnoNM0ikwPht/37RLk1QCK3SiQgbARXEozPu7lh5m/7C1ugfrtCh39hEqlJH/
# QYfpSfcQrg1SEfbzyQ7FZb5n7hyp0Ae9aVgQQve6li4H2x8UwAFr+Oh18I3sbxs1
# CjhSz2eo2HNmwd3+TZAWBOFVfsjZCBCiUvcbniu/gKRlf4h0/tSc
