...
<#
.SYNOPSIS
Configures metrics and diagnostic logging settings for all Azure Storage Accounts across all subscriptions within the Alya environment.

.DESCRIPTION
The Set-MetricsAndLoggingOnAllStorageAccounts.ps1 script ensures that all Azure Storage Accounts have proper diagnostic and metrics configuration applied. It disables legacy (classic) metrics settings and sets up modern diagnostic configurations for each storage account and its services (blob, file, queue, table) using an existing Log Analytics workspace and analytics storage account. The script validates the existence of required resource groups, storage accounts, and workspaces, installs necessary Azure modules, and logs its actions for auditing and troubleshooting.

.PARAMETER AnalyticsStorageAccountResourceGroupName
The name of the resource group containing the analytics storage account used for diagnostic logging.

.PARAMETER AnalyticsStorageAccountName
The name of the analytics storage account where diagnostic logs are stored.

.PARAMETER AnalyticsWrkspcResourceGroupName
The name of the resource group containing the Log Analytics workspace.

.PARAMETER AnalyticsWrkspcName
The name of the Log Analytics workspace where diagnostic data will be sent.

.INPUTS
None. The script does not accept input from the pipeline.

.OUTPUTS
None. The script writes progress, information, and error messages to the console and to a log file.

.EXAMPLE
PS> .\Set-MetricsAndLoggingOnAllStorageAccounts.ps1 -AnalyticsStorageAccountResourceGroupName "rg-analytics" -AnalyticsStorageAccountName "stanalytics001" -AnalyticsWrkspcResourceGroupName "rg-logs" -AnalyticsWrkspcName "laworkspace001"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCC7T3TAgoyk/OE9
# C8WJmpIt6w1hh8Hxlha13aBF9ThRa6CCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEILzMBFsDDTSstqZt
# 1Ly+Vlql9/Q/VGs86AcQRj1M36RQMA0GCSqGSIb3DQEBAQUABIICAKESI5D3vWXh
# JPCk/8Y5vH2WUzXg0cvUB29tLzaRN5pqFtqgSsOjekCc2nk77gDUHrifGyRhnbzC
# QK4zbnOZ4cX5ebSfGuEgaPDxCb+MDOcVDwQ8GfEL1wYDaWjq8mzHP1jvCf0wuZVz
# sgNeE9aZQYgdySUVh4wA5qUL3Tri+LrDupL7yf0UrckO7X7z8I0ftpfM5JdLdNHf
# ETnPBmg3hxh1z0A8PnAE0KPMpEtvBcjWqO/wZGkOT+PbzMckoRlo+JOmfxNK06im
# RNP8T5UK/SUW6/FfqSpCt98NghUlo2JUZVJRsp1bjnoIUyTgCMmthFeaSBTM61Eu
# y+szUEvV/o8o47V3+9VaAcQY+ShqIUX8HHNrObaHoNDNDOsvcB33cf/clq7b4sJI
# Mrkh/INm1fu+Lzp20tW4A8FMS+7QVsVshSGpHXI0tcZwEqhsq+6DFn2/EGSV0WCA
# qIchwuHNY0K6iiRlgA2pcct+OFpDjSCmBMnHMQEQxogn76898fOMvnzt0ZiZ1mwE
# tV3Yvve63RA4zB8ENquLnPx8ShF8z7VmnkDp79UsMotORP7jbYdEUdnEiB2co5vl
# KTo5r7ze0e1NcnK2V9eFn1rf8clTVq3HwotBSSlqfBJ/YFls2NBmUq2ksQ3EIxLT
# fTySmZhAv+ib1swKZMabBuTkhaXQ3xygoYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCD7X+UHwelAIAQaOlCMLTDRvIW3oMbSs7m7CuMBqldAKQIUEQxL+Sbncvt3
# n/TSdnbFY9T46kkYDzIwMjYwMjEwMTEzNTM0WjADAgEBoFikVjBUMQswCQYDVQQG
...
# IPRUBr2AolufzPg8/ssg9WEiimSxq1/Vnbxu1zy13KS4MIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAS4wdGxkGlCxQ
# Lx46OzRJwMLegSvAvezUp5SdENzLqXBCX6lpV6x5LaGMOaUQr8byaq4FNONHklGo
# kAk35QVHVY2d7mQRJ5yq9aNZ+0fml37EOqxPrSr1FXJkPCzUMU+OJHGcmOHd6aG7
# X1njZ/H9czyeFn9F2Tfq+OBNTtNRbKG47wubahWyu2b/tfyVzdbO4KgxgXuIbW3H
# G2qTwyw0MNjXjVY8cfuxEldnrHw2qQ1U43yNFvjb9fDyD5htH/WewcjwvaB9BaSS
# e7lhXdnC08mc7rqg6ss9ORsahqnQiMcLa3B4fJmoUj5xCL0SefPZwRnNGhuRtH0U
# Tpi1LsBN5ytF4snXRd/A6GsdyZondARnIroszwYtYeSUXpuV5S7xM416kbuNspfZ
# 9VCfIL1xc59QF/5J4jmQHHA/vD/Aogsoych9esyMQr6lePtHamz/v77ZYKi1TNry
# HXCx5bXGYcbKslgO3T6hInPdBQH0fspCSfS7TL6/S3ApXQgFhQaf
