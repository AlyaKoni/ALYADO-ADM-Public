...
<#
.SYNOPSIS
Compares the contents of two directories and generates an Excel report of differences in files, directories, sizes, dates, and properties.

.DESCRIPTION
The Diff-Directories.ps1 script recursively compares two given directory structures to identify differences between them. It detects files and directories that exist only on one side, reports discrepancies in file sizes, modification dates, and extended file properties. The results are saved in an Excel workbook with multiple worksheets summarizing each type of difference. Logs are recorded, and access errors are also reported for each directory side.

.PARAMETER leftDirectory
Specifies the path to the left directory to be compared.

.PARAMETER rightDirectory
Specifies the path to the right directory to be compared.

.INPUTS
None. The script does not accept piped input.

.OUTPUTS
An Excel file containing worksheets for directory and file differences, including size, date, and property discrepancies.

.EXAMPLE
PS> .\Diff-Directories.ps1 -leftDirectory "C:\Data\Source" -rightDirectory "C:\Data\Target"
Compares the "C:\Data\Source" and "C:\Data\Target" directories and outputs an Excel report summarizing all detected differences.
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAHiJd7R1M6k0Zd
# 7dlc2xWGGkCWqNFdXW0MnHH9u/2u/KCCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIP+3CbOcg3QvVt1O
# NfR85t64q2iQp8CV0E0O4UxNh49oMA0GCSqGSIb3DQEBAQUABIICAGpnZZvVpoxp
# +MX4Wp/irFj1HBqHzZgPmhbKil1M6lJoHZd9/s3zOsoIGd7kcw2KN0haeMRHqFel
# JLNkKrWBbT49J1KKVN7wIUCt2P8i/eguQiQFE+JaGb0I1ta3oeEL/FaxK6Cpkif1
# OpEt0Y0CXGcWw5gtibl0XcMo+zRIl89YQKr0SZatIYXL9JEerQULFAYLWbW9sOEN
# DSSiiNxI+s/Xgx7LJ0JZvlYtFX5DoYG7S7rKS+ztV5bzTTRIhIenq5rgiX7zWQNg
# ZvC14bx4n6k2QtEbGxiH07rzY4kwALwf65F/l9DuFTHc+Cb3wyHDE0nqdfyNN/2a
# jD23xa7Sc2jpmjdfhk8gT/QpDCs5Uq11nqanN6UlO0m0rpFOta1M28cgtAXV0JLo
# hFQWD8AWCtr0mz3gGOFAr32JWjijsMK7hH2w6TbJlQKXaCEdTUbjGe63m26RHhjU
# KGiKLViv6j2C20QMYDBsXutYT0PD9DuWUDCb/5w/byGfzwrhHrt00XgslzyFo9Z2
# Db0opDLwoCnBF8GmzfdCed0pk4DH+5QFKqDugPSXd53wJqf9A2FNE9PCc3uaZEAU
# Tp0rz1HUfR74wcfrci1zMSNXd+LYtY8EEw1w7uNVrWcC/TNMh/z4EAVB/Ly1uPNe
# 114LhqDS0Wdn57/3gtOeb7jl/YxQMIm/oYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCD42qIw3H5XqSiwKtSJ7hGn6mIMq+gKw6RHRjR1DyNnEAIUPFwH/zq73Gbn
# c03td/xzAym/E7QYDzIwMjYwMjA2MTE1MzA2WjADAgEBoFikVjBUMQswCQYDVQQG
...
# IA7Oc3xZ7532XjajXW5wXmGHu0s3Wk/eB6zRwrepddMdMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAAk5RgCMHWMY9
# kZsCVR193el8GWaiiaZViQomHnZ4NZxqkVXWFqGqaSiOc+uXl9JI7V4idU2j3Iev
# dfFZdAeb74Jfyryo0KcqcvrzOBCqRm/DK/51P9GGW3FgAKZHCqHykT2E6Ii5zfEt
# 6yrkGLN2wjQDE8eKbrvL/BTuWYWnBGHD9khp297uteN8kVe/OMgelWh7wtqpoS+8
# FSnbTdt/Vuar/WS5Ne+4ygtNOQZTNBatAPaOvmhqw0WT403xqmZ8o5FIfn4yT/cU
# tsbEs3hoB1STKcwlgA4XtjxoQe7CFutJtjShRwxxLZUxKHsFl7CIvN5oO2AKi1hy
# sEvIH7HoUL+XbVowUEzLEq7ahvc0PoXmZbwpnuuTbgH4PBXD3iq5Tu39ju7+So/z
# T/zrC1pEgtiuDi21a63lwkOlEFN1JYmsBWoBR9WLzQhTn6T9DHk1tOwDW7HEfoct
# 8oYYZATCn19ocrLjVy6OYUdwWlLRqQg/5DrMl1C3sATrex6/gQ/s
