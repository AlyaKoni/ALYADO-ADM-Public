...
.DESCRIPTION
The Enable-AutoUpdateByRegistry.ps1 script configures Windows Update settings by modifying the registry to enable automatic updates. This ensures that the system receives updates automatically without user intervention.
...
.EXAMPLE
PS> .\Enable-AutoUpdateByRegistry.ps1
Enables automatic Windows updates by modifying the registry settings.
...
Write-Host "Enable Automatic Windows Update"
$auRegPath = "HKLM:\SOFTWARE\Policies\Microsoft\Windows\WindowsUpdate\AU"
if (-Not (Test-Path $auRegPath))
{
    New-Item -Path $auRegPath -Force # Key anlegen
}
New-ItemProperty -Path $auRegPath -Name "NoAutoUpdate" -Value 0 -PropertyType DWORD -Force # Automatische Updates aktivieren
New-ItemProperty -Path $auRegPath -Name "AUOptions" -Value 4 -PropertyType DWORD -Force # Auto download and schedule the install
New-ItemProperty -Path $auRegPath -Name "ScheduledInstallEveryWeek" -Value 1 -PropertyType DWORD -Force # Einmal pro Woche
New-ItemProperty -Path $auRegPath -Name "ScheduledInstallDay" -Value 4 -PropertyType DWORD -Force # Am Mittwoch
New-ItemProperty -Path $auRegPath -Name "ScheduledInstallTime" -Value 1 -PropertyType DWORD -Force # Um 2 Uhr morgens
New-ItemProperty -Path $auRegPath -Name "AlwaysAutoRebootAtScheduledTime" -Value 1 -PropertyType DWORD -Force # Erzwingt automatischen Reboot
New-ItemProperty -Path $auRegPath -Name "AlwaysAutoRebootAtScheduledTimeMinutes" -Value 15 -PropertyType DWORD -Force # Reboot-Warnzeit in Minuten


# SIG # Begin signature block
# MII2OwYJKoZIhvcNAQcCoII2LDCCNigCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDOFiYIkkFYWJcP
# JqdGEsFmAMCtvG+XeQ9CxTZZZKXEDqCCFIswggWiMIIEiqADAgECAhB4AxhCRXCK
...
# KwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIB+N/EUY
# tBrMBR7QwLKsSW64yYn3ooFI0N5l0r55S4lSMA0GCSqGSIb3DQEBAQUABIICAHyY
# N2uKnAGil/tnYpdq6tHRnPhqYhjUM6mlzoTDgmVDj+DgUskzhjSAVIZCYLdfEYOa
# aFN5IjIBMFZrd/n/BtBLe3xyNxLvD4tM/nqLcwdI4H/wOu3FnJPyTp+u30fLYBib
# PJPIb6Zc/rSMZ50lmz9/yq7ZuafHuXkv9Nx6+Qn4j5cyDhxavBrN/rVV+yzQN63z
# UG59QuLxKEFL5RFF2SD9wHKKLH5Be64gyZSbOgYbxeU1Gj64QGXecVEY29UcpxGj
# D2hn3keFEPC7t4+pJoaE0JlhZsjhTJqpBBJTWJUii5QDWX7i1SqbDcqqEXqyjxhD
# cw+AdO2T7WdAhrmsOrp1R/Xm2cvPua3mICTPEYFVl2L0asPT6fsQOB8zGr5dGeQ3
# DlzbE+t6ibp3tMZL7jc0xmXC0tyHoB6pn4Gpx+8WCxvrWiY6KAe7RYfqEE/leemw
