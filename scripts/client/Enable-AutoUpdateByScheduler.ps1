...
.DESCRIPTION
The Enable-AutoUpdateByScheduler.ps1 script configures Windows Update settings by creating a scheduled task to enable automatic updates. This ensures that the system receives updates automatically without user intervention.
...
.EXAMPLE
PS> .\Enable-AutoUpdateByScheduler.ps1
Enables automatic Windows updates by creating a scheduled task.
...
# Prepare PowerShell for Windows Update
Write-Host "Prepare PowerShell for Windows Update"
Install-PackageProvider -Name NuGet -Scope AllUsers -Force
Install-Module PSWindowsUpdate -Scope AllUsers -Force

# Creating a scheduled task to enable automatic Windows updates
Write-Host "Creating a scheduled task to enable automatic Windows updates"
if (-Not (Test-Path "C:\ProgramData\AlyaConsulting\Logs")) {
    New-Item -Path "C:\ProgramData\AlyaConsulting\Logs" -ItemType Directory -Force
}
$argus = "-ExecutionPolicy Bypass -Command `"Import-Module PSWindowsUpdate; Install-WindowsUpdate -AcceptAll -Install -AutoReboot | Out-File C:\ProgramData\AlyaConsulting\Logs\WindowsUpdate-$([DateTime]::Now.ToString('yyyyMMdd')).log`""
$Action = New-ScheduledTaskAction -Execute "PowerShell.exe" -Argument $argus
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCC2/6PuW3/kWL6W
# Pa4BBW+kngR3EQQAnQFouXy72V4JiKCCFIswggWiMIIEiqADAgECAhB4AxhCRXCK
...
# KwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIGjAFm/G
# 1hYg9MpfQic1ueO9agtMHHrzgwE/gbFsrdz4MA0GCSqGSIb3DQEBAQUABIICAKGN
# WaK25lXvF+9ead+nwq8WLVO0aAyZMkXabyPHrX47xNXnM68O8Ut3AYHqCrGCIdxD
# uhqQLFtZgUs1o+xvanKpSWB4etHlTiC08dkY6+22Qh/XREPqJ0pm2Zhj4nPFoUnA
# c7sAjZrcMhR1TwxntnAp3ODPBKWY2e8HGtMqCZwve3yVeXmMIcW14vrcdzi+wBbH
# rbYcl/Jtekc9bvvrJa8x0Z6qfCUY3OkIjeookhzJA6s26sG51+vTIA43fGcp11+2
# j4SbZvfJs1rkijCWjGB8xx+f9Z/fIuqBl696yDM4Ukve+Zq+FNC0KCoLENJnNVN7
# 62YO2hS50qKizN3KabfIAS5DgZnFO8xjDbyObOQSsEKsG11JBwAHb9/gMF+uBbDX
# t8LoIB8ip5m0co8N7rnlAr7aY+iFzGeq0zGbPXuIJenmhawk+xaONPFo1EI/CF0v
# Ot3JZQrEP5RuuI8j05VGsf4bYwzXACZYHC3YjZXXA3Pd6uPaH+40agfpDmWlILuK
# C2kr6HMm44viEMNskXjKhpVmLS8/yVjF937HFVwU+Gval+RDCYpBT8Bm+5F+YqTd
