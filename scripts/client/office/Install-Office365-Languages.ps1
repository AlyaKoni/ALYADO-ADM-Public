...
&("$AlyaDeployToolRoot\setup.exe") /download "$AlyaData\client\office\office_add_languages.xml"

Write-Host "Installing office" -ForegroundColor $CommandInfo
&("$AlyaDeployToolRoot\setup.exe") /configure "$AlyaData\client\office\office_add_languages.xml"
Pop-Location
