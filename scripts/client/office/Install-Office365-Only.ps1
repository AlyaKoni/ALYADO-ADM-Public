...
&("$DeployToolRoot\setup.exe") /download "$AlyaData\client\office\office_Only_deploy_config.xml"

Write-Host "Installing office" -ForegroundColor $CommandInfo
&("$DeployToolRoot\setup.exe") /configure "$AlyaData\client\office\office_Only_deploy_config.xml"
Pop-Location
