...
<#
.SYNOPSIS
Compares the contents of two directory trees and exports the differences to an Excel file.

.DESCRIPTION
The Diff-Directories.ps1 script compares two directories recursively, detecting differences in subdirectories, files, file sizes, modification dates, and file properties. It generates a detailed Excel report that includes files or directories that exist only in one location and differences in file metadata. The script ensures required PowerShell modules are installed, including ImportExcel, and handles environment configuration automatically. It is useful for auditing directory structures, verifying synchronization, and detecting discrepancies between file sets.

.PARAMETER leftDirectory
Specifies the path of the left directory to compare.

.PARAMETER rightDirectory
Specifies the path of the right directory to compare.

.INPUTS
None. This script does not accept input from the pipeline.

.OUTPUTS
Creates an Excel file named Diff-Directories.xlsx in the script’s directory, containing worksheets with comparison results such as missing directories, missing files, and property differences.

.EXAMPLE
PS> .\Diff-Directories.ps1 -leftDirectory "C:\Source" -rightDirectory "D:\Backup"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCC0GfjFwHw90Vjo
# 5vPxh/U4LoCCdceWvA+BDmjrPI+1VqCCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEICVvrs6KXYZOBGwB
# jrDcpdgjjZDamyUz4j9R/5w0MkPrMA0GCSqGSIb3DQEBAQUABIICAL2C+9Xl3Ou/
# qGP+wp59qcLrJEqj+qP1ivR3o+pdrR0AEHdKjQSj1MTZT/p8Im1BWxoqJ1L6YVrV
# GU2wJLoM3ct+II85gZewc5Y3078ypv1YHK68VgCtR6VMZI3iQqm/7F/HJCZFXgYF
# OpyTrHpr60Q9hMqX8I/9UKZQmOmvPStVpruTY29vo78ouQsoHI5ZpuwY87w1kiha
# WtnrJf/Ao0r3+20eYJrjqIu8LZsJLt+/u/152nphdApEo0teap+pVIPwHv2TwhRB
# GqTIf7tVhuvdLl/GV/LNLxfTMlBjSlrSxcD1nC3jisuanvDJcvvtZ8sDaKEDkg2s
# jpR7lGLp1CWCRy7zLMmdgT31wS7dBZjJU1JLPOOC8xjkH85n+1f4DPXEZ1qr4QPy
# XPV/FyOUbSclTD5UIM/NkYo3kB4Wrg6DBJukuojoAx1+0TNucdaBVEJWEF0uO9MK
# fCEsKpguVo/Nh53sSsJC9r5u5Swn/c9mGaxAnjSkWzjS2JTlQp8btKiDoIbimz0T
# u7Ch+UmI0xfFrqTQKIbWN8osiFiRCJ1Rcd8PvVl5TKIRdcLTEGuyAv0gp9iaVq+3
# 4hgAtRyPApp2fsP1Rbc1ALCmQWcvNBXiersNB8FjjchYVnIJ6g/LhhkvoSA85xGE
# Lh91eSxxxD0ivGoTOr/g7eeC1/zJAyrFoYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCCBKZKAyKKTpJzXb8i5YVNVJhfV6Bwy2mMhx5Ppv1OnSwIUbQG0Py/L0NMT
# 1zamROyAZCmCkDEYDzIwMjYwMjA2MTE1MTIzWjADAgEBoFikVjBUMQswCQYDVQQG
...
# ILcDGOot4kvM662n30OJeZqMTrzpc00wlouGfNEafQMKMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGACyPzyt9H47lM
# DK/VcedwE3gWwVRo/tHdfFhVs9XfmRNQZWHNmXIs6Omy08vnA0QqkJCIvBFmZxYU
# aD8PcpMUPXB0mswCkTicwNiOFXxXVSwl2PVaSfPP7NUKo9j/D5pU26aHiYtUiKNp
# lTR+2IR+8ARjvj88ENK4UfFHwn5g2Innp9R3mH7jb4BsqgUe0WV+0k/CH+AKhPul
# kuOxmyBjU02N+6/1cyiyy8TIe0qGXjGLiebYltDNoOqexIIt371IBv1WP6X0aOGX
# dMkxIgUri1EUnbCM2frXfPen2+8TtN4keWJJg+F8rfNCy4d3snuILfezGqwEo2oO
# XGFgyFvtF4NIuPKs3QtNVrWXuELcJXTItzLY7UtA8wCrGk+W6GiaImslz1xQjQnf
# y3Cy+gJhNelO7O6J4H7MsSJy0WfePADzpXldiMTE+0BH1fjpgiUk+KhrVJjGXCok
# cEE9nZ/4OIRRouSzJ5/Y2sv2dTTKOpQY8rxM9r6A5sfk06YdbxxH
