...
<#
.SYNOPSIS
Enables and configures BitLocker encryption on a Windows system drive, ensuring compliance with organizational requirements and backing up recovery keys to Active Directory.

.DESCRIPTION
The Enable-BitLocker.ps1 script automates the process of configuring, enabling, and managing BitLocker drive encryption on Windows systems. It performs prerequisite checks, initializes the TPM if required, configures registry policies for Active Directory key backup, partitions drives as necessary, and enables BitLocker protection. The script only executes on domain-joined systems and ensures recovery passwords are stored securely in Active Directory. It also creates detailed log files for auditing and troubleshooting.

.INPUTS
None. The script does not accept input through the pipeline or parameters.

.OUTPUTS
Transcript log file containing the results of BitLocker configuration and enablement.
Console output providing status and error information.

.EXAMPLE
PS> .\Enable-BitLocker.ps1
Executes the script to automatically configure and enable BitLocker encryption on the system drive of a domain-joined computer, backing up the recovery key to Active Directory.
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCA0w/IX769beKY
# Ny5Dv21L/qTGbEQERWkGmxzoMAJly6CCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIHEKIJPMJAmzT0nB
# AjafwYCqRQRNZij0PSjkqG9bi+WPMA0GCSqGSIb3DQEBAQUABIICACw0ce3ZBd6b
# WIeIrqW1Un402Kbt2xL+PqOAzHfYzjnFPCF7aoF6HEw9S6G8tO3AGNqEGApJodfl
# JiEm0P4Xrlksg5eLLBBIZ+tgT59O7+Vl9yqGiKGuIVPn/YlfefXeZsXCcmQiZuUq
# 2n07Zv5b13EIe4N++c0uiQL5eWPAp9o511LR3pVu97mFOVAfBg/KF2mJ3FmBSKhs
# ShRJmrKSN/JyjYe0pFbJ14whvn9TSF6TiJ21OxgWS5N9mRsFir1OTp9KBx866T2e
# Unk/5HzrhHrOJVQCbgqlDF8vZ+jWUUqTTm8+Un/ceXmNwPWRv+b+hYRnZJAuvenq
# +9wkL67/e/Ut5ZQ50Lh9Z3nmczwQa4xKvZVR8XQ70uUWMngKEjGVa6uYXuudVwC7
# 2HSgY+Q7j6syjLJT/hnr7/CledbHKqYdxRFHLVaK7lweRbm9zb+BEc7aw+pRRlGG
# ba6QLY77OOQbzh2YaCVTYr/pVsud1J38+uvkSf5vxIrIMvZb56t/hN4DF07oemQq
# hfZkNpMNsTaYlRA+VTem5oAfpFAybaQEnfOHdJJyCySXIdslkdCBZbXWPKJdWpBy
# WgnBWg6HN5fBXpQ9VR60ZL2ZsL5+7LFvP/mO+nUEHdcQY71GQkCZDId+rvVOpd8E
# 45xi/g0LVqiWeyvymm1SJNr5VIknH3+VoYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCD+S+5xIbz3L/se7Zhk8eUJnV7v/N+qce3AJ+TckEpjAgIUR3hL6Z6Pes8G
# GEOR3eDyTrfSXYwYDzIwMjYwMjEwMTEzNjMyWjADAgEBoFikVjBUMQswCQYDVQQG
...
# IKmBsfUGSTHKs5DzaBpHhv7awYnRex8OK+vBYcUz46rGMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGANudDdUufFSph
# gnIKDRxp+IydhJyoyRNBuebcrGQMRNoJ+VXkNv+4LB7JdI28106pX+wJLVaHjYxY
# wqij59/DptCifQZ10oK+3sOuvijhxIeTBsZqUavE8EMjhzbDQFzoL2iIEMeMURA+
# 5JVvvDM0WMqlrm6aX2AmsRHO6WwEfdAVWSz+Bx+r0/9smeQevrBrz+xu9Ksb4EfM
# dIr6pnyAvP5uQ4/ybWTkZTZTmQsDR5wf2uZgRZsg4zi0l/uKjfsqAyANtbHR8aWh
# RVTRRGWR49ksGgADzBudVUiieLIZqCLfql3qK2rn6hTmmtodrqjDYdLkNaJ46kLF
# So/7/L4s8fxnN61Z7kKHB3EYqcfhyuZTKr4SIbZcRBLfo/aE1kC2TDp/CpobK9G8
# veu9j7WyNODpGLs0eFkw6vnzXxLcOL6NjJ+WLKw5+6AOkQcHnIlUCFrY5RfnG4yQ
# tx+ZlozpGiuX41tbYYzriVYkJZxF3YfJ2manKAJTEQBRbFKaP+UN
