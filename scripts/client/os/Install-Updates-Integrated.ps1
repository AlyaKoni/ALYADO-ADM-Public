...
<#
.SYNOPSIS
Installs Windows updates and optionally performs operating system upgrades, with automatic handling of retries and reboots.

.DESCRIPTION
The Install-Updates-Integrated.ps1 script automates the process of applying Windows updates using the PSWindowsUpdate module. It ensures that necessary update service managers are configured, installs all available Windows updates, and reboots the system if required. The script can optionally check for OS upgrades if specified. It maintains a retry mechanism across reboots to handle updates that require multiple installations. The script also logs its activity to a transcript file for troubleshooting and auditing.

.PARAMETER retryCount
Specifies the number of times the script has retried due to required reboots. Defaults to 0. If the retry count exceeds 5, the script stops execution to prevent infinite loops.

.PARAMETER installUpgrades
Indicates whether to perform OS upgrades (e.g., Windows 10 feature updates) after regular updates are installed. Defaults to $false. Not supported on servers.

.INPUTS
None. The script does not accept pipeline input.

.OUTPUTS
None. The script writes progress and results to the console and to a log file located in the AlyaLogs directory.

.EXAMPLE
PS> .\Install-Updates-Integrated.ps1 -retryCount 0 -installUpgrades $true
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAtDpkixkgpHwZc
# xcnBlv5tTUkm9ymAOErO9Mr0NI2GaKCCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIDLRCTXsI1BaaceL
# DNayDKbwuSpOPsiUMTv19iTyXSksMA0GCSqGSIb3DQEBAQUABIICAAgMIz2tareR
# ymx0oYOWdJOFuQpl4rn3zCk0dUhBQbpilHmvw+ROJU9J5IvCJn3f6g+yr+dExmfR
# k27ChcIeHLUWe1iG/U3olFrSWi0AUoQ3QX3V9Y+ePHNtTLqCbqKCVE1dKPthae1l
# IS660RCIgY5X7XV30LU2RCb0yW8cIjpNX13JsE7BPMV5aJTcYbMdMTRph6PrD8yE
# wctak3iRTxssW7XCows1ZI2EKlNhVkv7G5oij4D6MRT6z0BiNVcuxmWKQPM3PZ4c
# ds6JF4RXvSKg5NrVZoI0dspQ7TGBOw0jWJB45+4neZLyBOy/32DWaZKbiihm6zHr
# nreSNAynY/bYZaZeHLwunF+ztZCwRyk66xH2OaYCz2mqw/f0no8z0EfU65zvvMLy
# XPH29Wc+328xAhyBbypkQlzFxwT1bcnOyiFQTYHGlmsPFRTyn1LZWi8BVzT4fCks
# rHsvUuvSUxILRiOVX5G16DSeZ96CaHCXkBInHlVjsNMHohpissYh0yFvP0rtOOao
# sf0wC+xXpy/Pe4dyDtUGaR8o7cAAuaVBMxMyEZAGKk6GNXMUk16KhTcINyfc6rFl
# N1siconncgmLltNHf8zq5vPwmg6jKLc7udwPG9DYk1kSlVDWsZb57i3BF7u6I7Gq
# tHzwuKxHBVWUBDgxrGfhsOano3HkzhyxoYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCAUSwnUWpGZEP+5jN5aevnhKZVGS4V5FYtmWD9wKS8amgIUVh5JDGu1EZmf
# A8wk8jngJOlk0pEYDzIwMjYwMjA2MTE1MjE1WjADAgEBoFikVjBUMQswCQYDVQQG
...
# IFaiLUuSjwJhMG+P3yA8ErdciE8Bf8Yb7PM/hXpVGj6yMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAgmaAQt+H7MSV
# l1dDjWI3spGWnKk3ckGDJbeu5yRPb+uRN3SyO9qbW+J7AcT/v4gCxxX0u/OdrpRo
# AH4BdygL8FD5AglAR1ZL8N0V7crA4bjsa59g5H1j0NohaIbLdkyMurZfHly3Hg3G
# 8cEMKPIfCki6k9+Uq/uMbuVDZ4z/w3RNI//JYSMFhhbLFv9enslRAuUwr6eV9+IY
# L66ptxfchKBH+naoTua2q1QpFRcWxcPNKGNpVnWgPh7oK6OmYqMUDOXxJyfs2REJ
# 7McnSp+40V8gNQdUTpdMnHQKJG6GdilTUkbFaQWtte2+TmMV+cfJZYoeAzjU9x7r
# Y2M6mfLSZM7CfHyvP2miIDMJ4NwMaA1EsPnDmiVBpIFOrprqlGblzFnYM2Ei/Mud
# 5Kwyu4KEBW0JyS6+2YVaaMerq+3ddy9sC6bvOSYJ4HtW2H1L14Bc/p+K7Ep1/RoL
# qpgbA5tafzunWkoPv0SL/wu7QZ2aOc5V85DvEkmpO/Zc78K1WtuC
