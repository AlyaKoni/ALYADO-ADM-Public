...
<#
.SYNOPSIS
Creates a complete backup of a user's personal data, application settings, and browser profiles from their Windows profile directory.

.DESCRIPTION
The BackupUserData.ps1 script performs an automated backup of a user's local data and settings. It creates time-stamped backups for various user folders like Desktop, Documents, Pictures, Downloads, Music, and Videos. Additionally, it backs up configuration data for major web browsers (Chrome, Edge, Firefox), Outlook signatures, pinned taskbar shortcuts, and Microsoft Office MRU registry entries. The script checks for the existence of relevant directories and prompts the user to close associated applications before copying data to prevent corruption. All backup actions are logged in a transcript file saved with the backup set.

.INPUTS
None. All required paths are determined automatically using environment variables.

.OUTPUTS
Creates a backup folder structure at the script's location, containing subdirectories for user data and applications. Also generates a transcript log file for each backup run.

.EXAMPLE
PS> .\BackupUserData.ps1
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAVQNcvWEltH3MN
# LxOPe3kfbMg7rx1EDb+1mnEmzNGxU6CCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIEW1lHym0vxIYEWL
# UjcUGTqsA44jcst40ES9glVFdC1OMA0GCSqGSIb3DQEBAQUABIICAEToLNpOBywk
# xTM92xM+3exVgoUt9xm8HDvDm+gL3hEm1QF47j+POz+GT5Ggz1FSX9TObVIlZ/um
# slUGKUfGWYG7k03/pcM/itdAP5isazDMHvqc/I/cqGQsS8Q0QmZJHtawSYwUAAjM
# WdbQKgb0NTnLykunLJjsDDe9nLAYqsnit7uiAbIN4ls9ZI2VI+uvIVTFbQmIE6fi
# OCTYBzGzholxGei+z4aLennTjUaVtTE3puBOzy7x9PXOqCoWRAoEb4VnA0fbhrUG
# 0Xa/vL+ESY3sX8YrVLPYYNbHD4QO1/fQar03yjyQtd9k/Tp+K813eEWS0WNsv0OX
# F19T5XefDk3NTlD8wqjmNTy+xmpjXaaYGfCYF4kZ6REA6BIyOvCJf42hs2EKEG9m
# kjBSCgoyXriFnAtYEBz8kvyJ040A8G2tlZtvEDjh+GJZg9yoZB63CENk5J0dlvva
# w+mPNioQXXO6y7WOuZP7lsiSIA+amz5LJrDw35zNNL2wmSuQJa0LddcupGqvT1lc
# OvBMQjRas94ycvCI2ZCoEHLVcgn3cIvDlPUiab/kRUDSQsl362uvyTMM5LhbLM9s
# YoxlKRR6n9OMWxogPGrrz74JVJTbQ0PhgFkBs/PSuOnDNu5Qom6pBiXvDpmL5tPU
# wmmM43eyzppvOroYXInGxxG9dwLfh/iBoYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCCvYB6mTOy4Y6eNNYr1Ja5iMJqzvvuySeHVQAgdDibjOAIUKt4/XRv5kNLG
# NaWRVdh+aj9yho8YDzIwMjYwMjEwMTEzNzIzWjADAgEBoFikVjBUMQswCQYDVQQG
...
# IKWEh87HCD77O223JrQde6Epu0gIaa0tiNbJcmf0t5S+MIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAVzHHIBr4lSvU
# S5KjNmTJ8x06cN7u58zxQiwoRjbbKya75zg4N1x4quWPnI9UhwyPS644cJ1NdMDL
# bFR/o3ATsSMzDogoWaqiTW4l3GO1GSpE6JYzRPO63dGaHm2mPHTCnzHKerFZf8Hm
# eV3ep98LeWVxlM7+I8VNNTwjokFGrpcLBS3BeTGxJtxZ8x1k9esYm0zrHO1hDFJC
# 0Jdd8ZJaW60ejCCn2Q72HJqeHvYTTwC7V49EEMUBUB1ax0a7kRWfBMf2d0B/BpLN
# x5Q1kasoC6X85hV/mZUKDBX0sQDloFK/+LMg80GxBnc5dfYkIRuHyrKk7sntyPnK
# v4UoWwx0eTLmyOUq+8PaTiEEdOKz5UrNf0bWBGu1dY93muZp5P01JcpwwJrm+lOV
# lYYwzeQYiGZDnugfsKlMB0SXzD5TQzEWrL0O+WpF1pfKazdmWZXkkeUuQPPVQD5x
# qN0fV0luyPT8+X//aa/xuepY9uprGyzkYdiYUMD8meJT4XeLBcV2
