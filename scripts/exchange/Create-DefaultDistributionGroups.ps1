...
<#
.SYNOPSIS
Creates and configures default Exchange Online distribution groups for an organization.

.DESCRIPTION
The Create-DefaultDistributionGroups.ps1 script ensures that key company distribution groups such as Privacy, Security, GeneralInform, and Support exist in Exchange Online. If the groups do not exist, they are created with appropriate configuration settings such as join restrictions and authentication requirements. The script adds the current Exchange Online connection user as a member to each group if they are not already included. The script also handles connecting to and disconnecting from Exchange Online, checks module dependencies, and logs its operations.

.INPUTS
None. The script reads configuration values from the 01_ConfigureEnv.ps1 environment configuration file.

.OUTPUTS
None. The script writes output and logs to the console and a transcript log file under the exchange script logs directory.

.EXAMPLE
PS> .\Create-DefaultDistributionGroups.ps1
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCUKmAwgcgW4qvw
# r9CiD1vhIPh06sP7oyw4EUHYTmhigaCCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIJZ0YXKrVuzaB4TP
# VVnv2+hwSTgKhll3AERrC8zD2RRkMA0GCSqGSIb3DQEBAQUABIICAH+NomXe4b9U
# /cqYeQBYvbau5FcsozPLju0g0r3UPkP6VZYl6NmNdWmm4f3/CAq/HtkwgHCpJ29X
# wU2K2gdTMhq6/87S2CcVcr2CLIMy15mz0aX7HWKgqOe9AIrdkrVI7DksP/VC6Pcg
# ToE/t75BUi9xCtb+LJxgnb4wn46hizb4CDjkBaiKTNCD6CO1L03o5XV+RDTaTS2s
# 3sWzIyS4hvzZLTVSsCknk/I6s1Zc/UT7tXXSB4Hd+/mD8DeNpC+YIdNHVeUA1PRU
# E5DkLC5FMKJka9EiMe3RH40HsYAKMHKcFLWecyT0/rkdLnCkgF7YkyPGBGb/PLek
# UsI5ap8ruU6dPL6usZk7+xznyc8gn6K0zGMSrjDcAUAwYDgi5cn+6W3C1jDXna6J
# KbuAuzFUt68bN1qbHFOCHmdu1KERMMjLNVIjz35S2lV1CtCwao7CAoJeHWmTmUVJ
# xj6zpyBUSaTq2T12uLgLsY8wtpaib1w6fFOnA2/FZboSZwASlC86/plfStkZEtXo
# hLZ3EduNnhEJom99S2PBRA9jaaaaaqV329Ls/vQHgWWN+R4NZ4KGcu+BlXqvzCEL
# EUtevMyPAdYE+2j08I1W+Vq/0tH0VOi8athVXw/BT8gOsVrelAZad8NjAYO6Y8QJ
# 5KDD8Rjf6LVVL6rjkrBNHfM/stMN6ljRoYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCCo6i7vRdeRR17+kFSDbNRanmfHrsmtBqFLPmfzQzzIdAIUOwWAHp81KmKa
# ONpw0Tm4fOTxsv4YDzIwMjYwMjA2MTE1NTU5WjADAgEBoFikVjBUMQswCQYDVQQG
...
# IEGdr4E3kJcPYYNJNp1vT+PWBcdXBv+j8B9KUrlnlIZJMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAT5PRi909NyoH
# gSEjtvJo6P6Tf9FUVKHMV73EN11PPS3B+WgkjLGhCI+IOufBhG+VzjddBIGwgfzx
# nXIqgqqRxh0R27esPdqbXU6pDy8dE88L+ewwnQnS37rJjdoJruyndiR5nxMQaMLz
# hGO3oHIAxBtrWgGBN4x7RM1dSB3QGS/nncUxs8f+4KKTNW8wWlVSXYfxFWetY5Sn
# TZ7wTajxGdpRmaliLq3UXcRX1E9Omi24YMYnvH3uxYFXH89jxNLB1s7EqJzZffci
# AUvY8So4TwuzJsAmxEkRGK4DuTqh0f4vuibxE0UZaL/iGTHAn80utG2LR4I+5gCV
# pr0DbKOv94nrFC0mTknhU1+tSzy0zSiVQ+pB6c8PkgWdNMaLl3+UixHKUJjkP3I8
# Lij11LQdCFm4651zW6FuGPA4FOjVINjWclr973OjgfTVakkEELjAXG3GfAVzB/Bv
# YwFLsTErx3gNy9hHTWdml4ynyOMgmxZ7eszyapyTj11i4c1v46ah
