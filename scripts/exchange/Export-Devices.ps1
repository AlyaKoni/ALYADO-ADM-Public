...
<#
.SYNOPSIS
Exports a list of Exchange Online mobile devices associated with user mailboxes to an Excel file.

.DESCRIPTION
The Export-Devices.ps1 script connects to Exchange Online, retrieves all mailboxes, and exports the details of associated mobile devices to an Excel spreadsheet. The script checks for required PowerShell modules (ImportExcel and ExchangeOnlineManagement), establishes a connection to Exchange Online, retrieves devices using Get-MobileDevice, processes their properties, and outputs the data into a structured Excel file. It also handles diverse data types for device properties and ensures error handling during Excel export operations.

.PARAMETER outputFile
Specifies the full path for the output Excel file where the devices data will be stored. If not provided, defaults to "$AlyaData\exchange\Devices.xlsx".

.INPUTS
None. This script does not accept pipeline input.

.OUTPUTS
An Excel file (.xlsx) containing a list of all devices associated with Exchange Online mailboxes and their properties.

.EXAMPLE
PS> .\Export-Devices.ps1 -outputFile "C:\Reports\ExchangeDevices.xlsx"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCAxAneJqZfPW+a
# E2vmlMOaKesAvSOnpcNahzcYvMSoc6CCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEICxyklFQ+j3HbowP
# 1qCJN7eYkw8kNIzwJ9yzXLn9dKWkMA0GCSqGSIb3DQEBAQUABIICAChok81opczc
# 0m8fzQkTalT+QVQb5xzWlceSpaN8yosvp2teQ41RnRkdNt4WCAdHKYSip2KWlqnm
# SA8Z2xV3v4ZgD+m/RgdgfPwg8vk+cbsXfHLn/NceFAK5Cm0L2IMDBUbsSVq2apzS
# 8iWhqoY8hcGNtNxsgp9qjCyiHhtMKkX1Dzh156E35dgyHACvSfkjKeTaeF8+2Bkd
# 21QeQQuOz9pK9KfrBugZZFL9zblscKQiu/133WPykS77Yn0Q+bEt842BjskYtgyT
# U24m9NlyleahMp45Gjr41qGzeJ8WcT6b87VeulwlpsUn1e9Plu6dH4xeXO4EHYv6
# JZdgB+nLewU1bNKd1lTLH6j22CJaqewKtRSiKQJ0PCLRNNfWTV4oJ0aohAMwBTiW
# K2xjOKTokwa0qFzL+ZRjEQGiFcTbkoygnvIhfZ32jfT35g6wYA83tZMyvlfmWL9L
# sp7LXiM6/UG49cYGFN7sJEV1LPrOyoDQZjerUzEfAiOo7IQZ3kK9uR4yltixHBrz
# /ugQQFIfjU+T5oPkSWwyaJPNcjpMUkX6uveU4zIZvSKVhbUKN8QaQx3+oOObjxrc
# 4GNj4kWYtKNDqsN9dNtTwg0sdVFd3ot/O6HLAgFr/X7y9zu2SUpZYZ+Vmy3t6ZvX
# 1wGG2qRvt8ihKNfLw21mz0GOAyNbo+vFoYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCAKtC6drUBwsDnTse8JuC9Z4wwiH6RfDEEu7p9XwpGaeAIUCryCN6XCdRyb
# LwqZinhKplRM78EYDzIwMjYwMjA2MTE1NjUwWjADAgEBoFikVjBUMQswCQYDVQQG
...
# IHBBP35zaHUJmwHfPNubSXuecXSz5Ue/lCW1MsYt+YZvMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAZurvv62uJQg+
# rSx3m2wp+nAtXDkK6J55MKya98d+rfh9vyA1/mWoYCb1et93Z6QEq1yI15HKjt6D
# vdQ5KNOm6x+FcChn9gr3hoqz88L+Q/nhLmBQrWbK2VzoeSaOqYsnJI/vGhjPbkSi
# o0bkvN56ooSAhRkzY4M34T9C/JoCPlR48x6cSCbhLgIRh/uYe6CjFMp+Xcm/dcNC
# 0z02c2LD4gfWK5i2IthaPHAvhfQEvO/MOM3YZx7cGPR7UT2Jg3MM2eCw95geTMtD
# TqoxmwJv7cdoqosnljJMdEmSQI1J69UcXJSetzwB8gsBL+yCFKAiBkRAv98/8Wy0
# OJdDYbl4T1TrRHQ++xcIuNIfjWl7KLimyTqFzWQaPqdYZkVh/fVR1n6m/QYanA2n
# jjE12Mvk4n1QQNEeFqa/GseejztICvR6Dj967jiddQMcoiZxsrlYCu8ISFuQB1wQ
# vEwcrEQrRMhpd2i5k2r0Esq8RdSuhoi2eNUvkDMR88/L/DusfXEX
