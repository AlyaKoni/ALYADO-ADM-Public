...
<#
.SYNOPSIS
Finds and reports Microsoft 365 groups that appear to be inactive based on Exchange, SharePoint, Teams, or Planner activity within the past year.

.DESCRIPTION
The Find-InactiveGroups.ps1 script connects to various Microsoft 365 services and evaluates the activity status of all Microsoft 365 groups in a subscription.
It checks for activity such as Exchange mailbox conversations, SharePoint site audit logs, Teams messages, and Planner updates.
Groups with no detected activity in any of these areas for over 365 days are flagged as obsolete.
The script logs its actions and outputs to a transcript file stored in the configured logs directory.

.INPUTS
None. All configuration values such as subscription and log paths are sourced from the configured environment script (01_ConfigureEnv.ps1).

.OUTPUTS
Text output to the PowerShell host and a log file containing the evaluation results for each group, including whether the group is considered obsolete.

.EXAMPLE
PS> .\Find-InactiveGroups.ps1
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCulY7kFE/2a2u0
# UlqRGEWTBM6czwfUG/Rz3lCHMLFKp6CCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIKTnWRbEwYKPuyOx
# eWBh6KD2z34wkqxUu5px89A/nUgzMA0GCSqGSIb3DQEBAQUABIICAErfn4vAstAS
# Ehcy7fELQV4K2bMj+0V1AkPg18KlLWwKAsF1eXti7iwEJnbac0odbaA8XmDMq50j
# dOrAw/8TZ4Z1EUylq9yj1s5pZ1B8Petcq0ZuDYOWX14FE0PwEEHiGqi2zbvMuWHI
# s1YxPfUMrlj/Ipv/L72mXtZcGivK+U9Wv3ClMEYpzUwWbMYyw1LYxojQULTRu9iZ
# PChK5Ktas7Fggu3BAIfADa9L5o0/k031wNXQ8cxsXqajMUmF6zkbcsDr2CkF0yf1
# 4ShOWuLQILE5WtqCPlLLASVKSJRHlJGHQvtMid6Sg28bIydsh0EyZyabI34lcv7h
# tGE1dquFmnbAmqezqXDg4ApMCXc4qWbV6t2Irru3Tlwgc0DmrnFap7wRXADklt2d
# bBCmWBN6Ut7bR/ITVFLgYU2QjZ9xFI3nQMfH0Ecv5Ey6OEmrjC4GmUvnfU2p+wYg
# Bc1mRNL6BMf0UCqNdjUbJSVQtQ/LdKmjGpmTajbLPfCiSb27umUUthzuRfjAgFdZ
# 79lj/kAPr3vJX+b16x2BDFj5v/08174n5gams0pi6iJGl+OFjDn9D9hDT5npkMNx
# I/7y5ZzGg+DEQGNGfNM7vMdzTr8VFJTMOzhCcWqgQ5+3a+MQLpp9JBhXpTuVuCBj
# LDQc2RxoKiSF9QftOt+xbvd44TOa9Jw0oYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCA5M2gpfC1vJIK/OJFTk7QtPgOTJQYaXEXetLP8fObNJwIUBYBKIXoZEirN
# d9SdD6rXFYPfxrEYDzIwMjYwMjEwMTE0MTE4WjADAgEBoFikVjBUMQswCQYDVQQG
...
# ILI0xm/9ooFrW52asXTsWbDxV4RKJxtBd34NocKo8XKMMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAhcKrR3ErdTQy
# EVshMiKzLA2uHcYFf6Oj2Md2eUlHN+QfJtm+Fn0OaN3MoHV2P5knQm6E50y/EEZh
# GKqqP7dyaqVq8olqaQwhiNsqVMORJkLBdrpSWlJCBLuYeVthDwTPSPWK6NOjU8QV
# lt8j89ISqWdMCZpWReGsbrOoqASKLsldKgIc4XTeOauYpW7xeFBgNJjssDT/3/Pa
# 7gsOV+JPyxh+lZBqdE7KjqZvhWcHCakgMoIk5woQCYBDa9oPc1oCBu8nl3m0Mdlo
# HwCaA9AZ9nmLgBQa3gU030SR+B/sKU2tSTuctBapubO0m2w3/zxY84bwlFY6oTt+
# Imb5JTgQSCY+2S64nErqCXH5akPr2J8D1ZI1ApeXclZ++YJBWUd4QWYTxbRPEGrm
# TJ9+4Q+b0vvtiRjvG/8ntNrdS+8S3spKlq4zsjYFbLHvZlf4uqejqDQZnTUKk1km
# cek2ib0kmmUtO8q+e9j4vF4UWh91mZCCpxKmSUC23/mIIJD4EXvc
