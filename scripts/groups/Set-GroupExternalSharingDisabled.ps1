...
Write-Host "Tenant | Set-GroupExternalSharingDisabled | Azure" -ForegroundColor $CommandInfo
...
$groupID = (Get-AzureADGroup -SearchString $GroupToDisableExternalGuests).ObjectId
