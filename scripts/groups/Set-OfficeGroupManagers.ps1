...
<#
.SYNOPSIS
Configures the Office 365 group management settings that define group creation permissions and usage guidelines for Office groups.

.DESCRIPTION
The Set-OfficeGroupManagers.ps1 script configures Microsoft 365 unified group settings using Microsoft Graph. It checks for required modules, validates environment configuration, ensures the existence of required usage guideline files, and sets the appropriate directory setting values, including disabling group creation for general users and assigning a specific group that can create new groups. Additionally, it supports configuring an on-premises group to be added as a member of the defined Office group manager group. The script logs its actions to a transcript file.

.INPUTS
None. The script reads configuration values from the 01_ConfigureEnv.ps1 environment file.

.OUTPUTS
Transcript log file containing all processed actions and informational messages.

.EXAMPLE
PS> .\Set-OfficeGroupManagers.ps1
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCAF7Oz1sRqjE9t
# vnpUlsX+fMXWGHk74u4bZk7GtwOBGKCCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIF0/+vTFGY/oD9g0
# fZ3eG4V0TdhL0klt4H2ix/sC8Mi6MA0GCSqGSIb3DQEBAQUABIICAA78pRdL1SsO
# ba9DJHPRWXx82mpABDnB5+u3xyNZg0DAlzifHkYFNqhwccYwN6Z5waG+UjmKSVNZ
# ZjthBX60EcoGlqklszEBydJUW7i5P2WOP95+FopzBuTfDJ9KB1Mi9YGCvJdozVfo
# tHOa7hKF/L+OxW8jW3m6eLb287MM9CaeeZDEVmNcFhJ3dEWzv8VslaLp8/DmABPD
# IQsix/FtO15oht97WoBpnX2H/l3EKR2h1NjOhqOvx+dMyp9nLgSs/e8ehGxCrCRG
# G92ilIVd114qryfziecTE37ru5YpjhAbGSHpnOGfyehZaMVlMo/fYS1nsCBvQj+c
# a4F8o+qrT1vMpxPOhA/CamDqpU/jlOWpYr5ZSvN0L2jp4ys4yPBIGt1Z3EV15umy
# LIxGleK8+CQKQNMsCtpVQR7x5jJwRv2BMVXO4PrD0Cl9khRdl+D7X6fRRdzeHH44
# x/mU3GUj7rxCYcPhWwgV1hNpaVdi4AtrcWOGoQC3a8XUerQP9gzr3SJtXiVH4jWz
# dnrtF/vWh+5kkdZEcBrMu7ncQfI6zuweuLGrWf6we0L/Y05YAS371G6NNDDcnBgx
# Nkn8yVwS48ETDqXqwtbjErmAG/iPW+nXMZAYwefwL6tLRyBaUMkUIqUb2vHzwcRm
# R2yRG+6ME505k2V7fLKRvetvcBapQAbVoYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCDDimrB2jfndOIgapbzqN5YJX/PkHdbl7ICrtyzjjNFiQIUJIYIIG70gi9b
# wOl07+ppok/KPxsYDzIwMjYwMjEwMTE0MTMwWjADAgEBoFikVjBUMQswCQYDVQQG
...
# IICwLsozuw48PMFkO9PIMS/X2JfDNlXJnCFYUlVW4zEQMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAUtTKE/r6Wg5o
# 486iE0Hyf50OCUct7k3bqYz21/3vr1P1Gan4bvCSInLC8JYAiZFvHmyq8GARKkch
# Ybv7+qhBT8b6q1aBtWBhUXy1M+G/JUU6Ty8pz70/WbpMPfGa4bIHpvFTCPzaHTfM
# LyLXrB4l75ZtDIvHtsaJAv8Rqk7vp0f5uY4j/BYqj1x2U5ff4j3H4dLMwgTrXJMi
# PlezBnIFa2rBz/Edje538phJV2h89fXwXVj0MrTOmM9SZ4vCGgkKnZRecmRRE+p6
# 0qqjGGTwpgJFzXADKqvXSJYy2uj2f+xpNEkeNjBiv6i0bficaIFm/ASCgRL6Mx+t
# NC3bMKL8uLvN+ag50hwLpNDbxc+8mFDGHz7ViPhPM5be4jWgnwhyi/HyOGkbKmt7
# 9cTJcwM+BykdtSc9i/sSnfyBe/51dsPquQCw86qzKDn3QLq55TWF0g49EuMGn6QI
# DVNAO/IhCgTVF1A/TohPsyDORt6gqgy6r8DeKN6t1fHufTCRBbo2
