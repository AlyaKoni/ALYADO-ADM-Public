...
<#
.SYNOPSIS
Changes the prefix of Intune apps, profiles, and policies using Microsoft Graph API.

.DESCRIPTION
The Change-IntuneWinAppPrefix.ps1 script connects to Microsoft Graph and renames Intune mobile apps, configuration profiles, compliance policies, device scripts, and other related Intune objects by replacing existing prefixes such as “Win10”, “Android”, “Mac”, and “iOS” with standardized short prefixes like “WIN”, “AND”, “MAC”, and “IOS”. The script logs all operations, checks required modules, and authenticates to Microsoft Graph with the necessary scopes. It operates using data configured in the Alya Base Configuration environment and updates all relevant Intune objects via PATCH operations through the Graph API.

.INPUTS
None. The script does not accept any pipeline input.

.OUTPUTS
None. The script performs update operations in Intune and writes progress and changes to the host and log files.

.EXAMPLE
PS> .\Change-IntuneWinAppPrefix.ps1
Executes the script to rename all Intune applications, profiles, and policies by updating their display name prefixes according to the defined mapping.
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBH7x+sSI7a6s+W
# 5jtx65nnK2oPlCpB25b1VJL3QCeK+KCCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEICYdR45w2ZpB4rVA
# eU2+ERXbBMAnXFhMh10nG4V/AwYqMA0GCSqGSIb3DQEBAQUABIICAHGTILcGfMy7
# mOk/HOjE2kFbXeZ+H4ABehcuiy7shytxBMRzut+t/N+/d0VewVPYpBFwmtDqe7Mb
# JmBHGF3pqwAAriASNqs5RgCS4ffUt2lxMp1246FBY82bGmuCjuw129T0duHnYCvk
# W/1oP7I29X5Z9HYslFJ0GbjJD+/r9NCJesjCJ2cji4PxfcFqSdFI9K3mScK1QFCX
# G4iipIy0gBMyp4hH/2mAtnAWJxiPtLPelhSBKqCoGkVYmnvE01/O7TEB0sTKUi98
# tQAbfy3HmOoRoE36bR/mPq50TqBQ8DOOZTb9beYZ/N9iZyYwGvMWMf27wGGjPRdC
# MtMT2+DsvEts5AXy+i4D92WfMGdOXxRiyigtLOuzUnoqK6imT8w4hhrh1bw+dDM8
# JOnQXE6B6ny5Tl2c+RPFzXBK8VYbzJbqzic2Gyv82SHwoXeaveBCdQWAeTi6Za8t
# HDaIvGL+ZlFhp4MJ+ItQIRgHCMDSb7oERJIn37YBZwzYvtcY0fT05qBKeDvXDXtu
# 2y2v8gKKcrjnb9q2JOKc9lLzjlbMec9+RBu8qX0F/DeVBfl8Hq+KDRtwhN8JtZ01
# w7EFlFD+Vit+xYW0haBDxk9N5ypGufIruEHGSudNcIbscHYg+YwZ+2PC9k/oOZ10
# Xx9wwLUOkGCw+7/DV9vs+31PtilYMXU7oYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCD+GrRISMVBCc1kdgkXhM6NPDDfbua19m631Vqu4fEs8wIUUqCtMIY40H8i
# nb9VACTE2nSfxNwYDzIwMjYwMjA2MTE1ODUyWjADAgEBoFikVjBUMQswCQYDVQQG
...
# IApfK2h4F+NwRrd2IjFVgEFsMR6xj3gEG97HT440INRuMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAXCzEW0aply4V
# k4PNxaUbOcIcUsCpB0+kcJ76k/Z1D6VKiL0OLllRBtnjLWuAi/jGxIe7Gp1iaph0
# H6zKhAX4okV77NSf3vF4nghJOPjPQb0uBblkTieDA//MNhqyc0biNkJlTEnUn+mN
# q0o8oT/yAYGX5norSRj1C7LbZQLAceb3Pa1AuwMPQ5czQrIxxy34y2RU45THZGlr
# HtZhHMw9gbiIoHo6+YPtgXWPiWS2dskIQyVoh6IVrlPmCYo/Hi96yjNuZySHy8Mc
# m61gEty3x+rIXtBO2SsFk01y/XBrLXyfHoeuxsmuhwoDw1gems1kgRb8dX4EQPhr
# pGw9TWxBIQESuBnaYVS5VVn8ferLsLhqxJTQTTWrANlLLLMdAd+E/GQKaj2me8Ju
# SfqRQ6gdx/2rv8gzyCgSqnfv63SH/EKn4RCUjN4zdShN4rf07q4F54hVSn7ZnFFe
# N2bfpivMRh9bJ86IJUcLoLzGWz+5gPxplrKxyRYqsWOPwdZbUixU
