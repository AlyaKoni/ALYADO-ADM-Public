...
foreach($pprofile in $profiles)
{
    ...
    if ($pprofile.description.Contains("ONLYIF(DEFENDER) "))
    {
        ...
        if ($AlyaHasDefenderATPEnabled -eq $false)
        {
            continue
        }
    }
    if ($pprofile.description.Contains("ONLYIF(NODEFENDER) "))
    {
        ...
        if ($AlyaHasDefenderATPEnabled -eq $true)
        {
            continue
        }
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDfUlJfkfsJRUKG
# ltbmrZ4vD5fmnOCNIOW7PrprD6He/KCCFIswggWiMIIEiqADAgECAhB4AxhCRXCK
...
# KwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIKBdJITD
# 77sp7fXQOUAcn62SfgfnuYfsEqvpadP9Rz5OMA0GCSqGSIb3DQEBAQUABIICAHGQ
# FRwyvpGu8PWaXNOgaqo1ShFzCD/L94jp+1LKXQm+hS2KZn7gFGx7ce6lX/9PxtP/
# vgp7LcKlk7djJFTkMsRaRdJuOdGMLsEFK7SA1HimH9ZmQqx9eD/rzdAgSFjKQAhQ
# 6TedQh++d4BL5ia4SlBIZHwXHj8GUMfIs3l+63iRKpnZY/qXfj/IL8xgHNHbm2rh
# mRsrPlyCtbZ+T8LCegyViY4c18C1pg4sG0bmqiGu+Bf8uhbkdb03uksOdXCB5DK6
# 1HGM0zK0cJXYAKhdDS7erxyFHyIYYfvCRrFj/ILRHmppWRBWbFSAOs4p8RBvqTdB
# rAjAquPoawgd+eHz6fbv/LNobn7m193BT9QDpDralkP/Er3YSJmcFC+R40fZtC3G
# uItGo9QUI7iY5xnjT0JFyQvXurc/iJe3ijZWlkT0Hab2vtgEnKFkS5dGd1ydBc+G
# g0XgfS3aP405OwrBfaQj4jn2XhhiiKDbeNlmvXzcUhEbvvLJN1+8Cwb98KRhFONX
# VBZSwcvi+MPvJYcq1F+QY+EHug5mhXFN3BA8iIPquWJtsbBJyHfSBcLy/Tyxt0Hw
# AkXOXlUDigo9/kOfWKpuGIHq/3Oj7LcdFUthFpg2RqcaJbI/IYHRD++bz8VjiFPE
# wHyeFPntDg2FoAZePY9KffSPqUBaB1uTDNndu4YuoYIWuzCCFrcGCisGAQQBgjcD
...
# SAFlAwQCAQUABCA2MRf1DlzbZo/k0NTGpkUGhz7XHkvFew0scCCfzMirIQIUJrJ6
# 0R+q7VlRldfji/fvqstcWfIYDzIwMjYwMTE3MTAxNjEzWjADAgEBoFikVjBUMQsw
...
# AQkEMSIEIL/xa0iNekcBK9SpDSTjthkr1N+xclVPzv7rS8rx85NjMIGwBgsqhkiG
...
# Mzg0IC0gRzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGADEoa
# It8eJBFNffTaPK7Hi4hbGWylD+/IjsvU2HC0OZvTJ37v/nokkVY3wMvgiVM7v9S9
# 0tP5pkpcJRPHePrQS5Q1c0JTwHkkJMSfsnC0/pfKXjYIPhj4HLht/BnduJ0KTcxi
# O/CTOeMAS4VsFljatrKVd8hAsETevcUdySo3gesayRjnyUPjHH7+QV4LL4OE8ALm
# HZyH9QhvmXBbTTIbi+Oo5ZUIEzUkDO5xDxvaNT8St7CRZqVgVyqUV/AvMPUcmAh1
# FnR8IsbETzcAmPdpvJl9ZFCu7KzdObsvLcE3YFWflxoxjVyyF4Twf0E02B2JI1Jz
# ztFrSUuL0HuL6V3pQDkLmxunsk0HFLQiiub/f/2bNxvvaUgBO5MpNQZtzxAORatY
# b3hcy9nwsDOLTkBq3vygOUXrJ2umuMiH0IhAKQsgjBfTmu3pUBAIuHGX0IVhQjun
# 9oc79A6Oc7Z87hkjmrfTeCsLkslYnB4UsvJQB1PG54qXRa7A0MQfl1/WHumk
