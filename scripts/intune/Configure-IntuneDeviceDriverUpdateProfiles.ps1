...
<#
    ...
    ---------- -------------------- ----------------------------
    22.09.2023 Konrad Brunner       Initial Version
...
<#
.SYNOPSIS
Creates, updates, and assigns Windows driver update profiles in Microsoft Intune using the Microsoft Graph API.

.DESCRIPTION
The Configure-IntuneDeviceDriverUpdateProfiles.ps1 script automates the configuration of Windows driver update profiles within Microsoft Intune. It reads profile definitions from a JSON file, connects to Microsoft Graph with the necessary permissions, creates new profiles when missing, updates existing profiles, and assigns them to appropriate Azure AD groups based on naming patterns. The script supports dynamic configuration values through token replacement and logs operations to a transcript file for auditing.

.PARAMETER ProfileFile
Specifies the path to the JSON file containing driver update profile definitions. If not provided, the script defaults to $($AlyaData)\intune\deviceDriverUpdateProfiles.json.

.INPUTS
System.String. The path to the profiles JSON file.

.OUTPUTS
None. The script produces log output and updates profiles in Microsoft Intune.

.EXAMPLE
PS> .\Configure-IntuneDeviceDriverUpdateProfiles.ps1 -ProfileFile "C:\Config\driverProfiles.json"
...
[CmdletBinding()]
Param(
    [string]$ProfileFile = $null #defaults to $($AlyaData)\intune\deviceDriverUpdateProfiles.json
)
...
Start-Transcript -Path "$($AlyaLogs)\scripts\intune\Configure-IntuneDeviceDriverUpdateProfiles-$($AlyaTimeString).log" -IncludeInvocationHeader -Force
...
Write-Host "Intune | Configure-IntuneDeviceDriverUpdateProfiles | Graph" -ForegroundColor $CommandInfo
...
foreach($pprofile in $profiles)
{
    ...
    try {
        ...
        $pprofile.PSObject.Properties.Remove("approvalType")
        $pprofile.PSObject.Properties.Remove("inventorySyncStatus")
    ...
    try {
        ...
        if ($actProfile.id)
        {
            ...
            if ($tGroups.Count -gt 0) { 
                $uri = "/beta/deviceManagement/windowsDriverUpdateProfiles/$($actProfile.id)/assignments"
                ...
                $uri = "/beta/deviceManagement/windowsDriverUpdateProfiles/$($actProfile.id)/assign"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCKVj5mdSkYUG0y
# FMg7+XfM1OZV0HggVxD5tQd41DY7V6CCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIBqoIUCTqpeIchw0
# L9X0/CdYokxrHEeebCUQImBkG1ffMA0GCSqGSIb3DQEBAQUABIICAFL0/45+6uJ2
# s2IGCRXWFxfkOcXxwRybEh19hWN1wj4MHyzN32KTKeZheZ/xtEc/XGRKL90HId5o
# RTpFQtNfAQ/I+dvgfDuAJGC3m5s0PVfYBbKjqwmHQvbj5eWhIMlBI+H9aGfmB+08
