...
<#
.SYNOPSIS
Configures and assigns Windows Feature Update Profiles in Microsoft Intune using Microsoft Graph API.

.DESCRIPTION
The Configure-IntuneDeviceFeatureUpdateProfile.ps1 script automates the creation, update, and assignment of Windows Feature Update Profiles in Microsoft Intune. It reads profile definitions from a JSON configuration file, validates their applicability based on device platform configurations, and uses Microsoft Graph API to manage profiles. Group assignments are automatically created based on naming conventions to target appropriate device groups in Intune.

.PARAMETER ProfileFile
Specifies the path to the JSON file containing the device feature update profile definitions. If not provided, the script defaults to using $AlyaData\intune\deviceFeatureUpdateProfiles.json.

.INPUTS
None. The script reads profile data from a JSON configuration file.

.OUTPUTS
The script creates or updates Windows Feature Update Profiles and assigns them to device groups in Microsoft Intune. It produces a transcript log file capturing all actions and results.

.EXAMPLE
PS> .\Configure-IntuneDeviceFeatureUpdateProfile.ps1 -ProfileFile "C:\Config\intune\deviceFeatureUpdateProfiles.json"
...
[CmdletBinding()]
Param(
    [string]$ProfileFile = $null #defaults to $($AlyaData)\intune\deviceFeatureUpdateProfiles.json
)
...
if (-Not $ProfileFile)
{
    $ProfileFile = "$($AlyaData)\intune\deviceFeatureUpdateProfiles.json"
}
...
foreach($pprofile in $profiles)
{
    ...
    try {
        ...
        $pprofile.PSObject.Properties.Remove("endOfSupportDate")
    ...
    try {
        ...
        if ($actProfile.id)
        {
            ...
            if ($tGroups.Count -gt 0) { 
                $uri = "/beta/deviceManagement/windowsFeatureUpdateProfiles/$($actProfile.id)/assignments"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAhCn8BFLnA8Xmo
# 5ThrZ0E3yUzXhTtbMjzCV0M3++IQJqCCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIBHOGZJNVBzoZyQk
# I//iLrBUgf0DT83+rHVuPnKCRNGgMA0GCSqGSIb3DQEBAQUABIICABdRqvtmwPk5
# p8rhpolrTRfT3RIgYYmr8hiYh5SrJIatZP+Y1ij5burz5fuR8pnKY8MRxmfcuEbn
# Q7GcAG5fzWsHnWhnj8j0xEt6Bdmqt8+FlnbOnyLDwmhAyQab8A2KliZLaCef+2ou
# RWkTL4C61VO9OBWkF+GH6mAStonxL8hmOWQBQIrkWvaG6tx1fiuDZUWtMzCD3ACy
# i2lnbT7gZ9FEkNgEjr53BBxluBnXrEvDEdZ+ItMa5HPDmA2FkSIaijBcUrgkyych
# a0y4tuinPq8emxjG7BaiM/5uRCQ423z2WjEPa+E7JBsj3jLh2IxC+BTvEQLWzcqo
# qQCtIXzhjD4MiIY9TIDGUIErySPmqenFAl6YklCiEg76ot+hvmzMMLWGDliSCnVg
# WtQyeeQBt/xpN/W52sk6FQ4WjwgLTl5FDXSRQbozS1SRqZ+upYqaNlq81kb7JTrd
# bg6c0fg2sFAGUYoujt2ZWj1ufS2sKvc27bwjh23XvsqbjJ7CDUsNwyJyGzX2TYSV
# 5rDaO0JJ4AU4i17yjc8VmF2ScaQBOxhEpfZNU+PzpH0h/5Erhh50lT/LGKbz2sFS
# POh7Bw+j/RGtAzFHgQY2LOEZ25oDKBOGm4awWtRFaOfXQ3YP1jNTry5m8WfL98BI
# MyUXbX3DEK+Pd6idxcnWY1ySAGMOVjGkoYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCCzi70IZ5TKiy5uWPtOIeZebskOoPiHZ+JM+Ug9Xgb6bgIUe1KQ8N3Ro1Pi
# 9sxt1enbPrURV3UYDzIwMjYwMjA2MTE1OTMwWjADAgEBoFikVjBUMQswCQYDVQQG
...
# INKGj2pdq/PXZVN4RfCYNSzgxfJnCYVWDnMq6GxsY1gKMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAj7sG8KpIMZti
# NtqneegJlxh8Nf/tCFVVY0Oq1OXxHaaPLH2hfrFWkX4nQR7UAVbTk4KhDeo0U3YC
# f9bJniNq6ZpCKB+2an8ou57vzAgZtA8p4Ms18ouLuaD9gRuTq3aefAUePkwX99EC
# mpJIpwSYU52PzCj0MfiRI2su7yaFgNJeFQVBb6NqHS3crjX6ThyO28TBiqICf+k3
# iY/tMZvCTD4trnrddWNZ5aoD2plX+m2iCC/VHPkVT6sL0EUAnx00zZh/zD4t8m9s
# YsZLp9IwThegJFbhJroe7xZUJtbCYM5G8wCBc7fpLOk3J41mSP0yrrj6sKNyl4/k
# 70rL64upOZXfPeHdqVewMVhxBVis38qHnBXymArO36zFiuD9JxQVQH94Nsu+74Xu
# 66UbZ3KFLfFqMajmmGfnEGp2F3qyHtFUPBSgvh4FbfUAWO6Uh+iJaQ3uATgUMqfp
# /gi+vF50b9hNs/q2naTohOlJem7iRjt2optlffSjJE7zxoxIFU0E
