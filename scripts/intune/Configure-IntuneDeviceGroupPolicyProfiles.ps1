...
<#
.SYNOPSIS
Configures Intune Device Group Policy Profiles using Microsoft Graph API.

.DESCRIPTION
The Configure-IntuneDeviceGroupPolicyProfiles.ps1 script automates the creation, update, and assignment of Intune Group Policy Configurations for managed devices in Microsoft Intune. It reads a JSON definition file that specifies the device Group Policy profiles and applies them to Intune using the Microsoft Graph API. The script validates module dependencies, logs into Microsoft Graph with appropriate permissions, processes definitions, and assigns profiles to device groups based on naming conventions.

.PARAMETER definedProfileFile
Specifies the path to the JSON file containing the Intune Group Policy profile definitions. If not provided, defaults to "$($AlyaData)\intune\deviceGroupPolicyProfiles.json".

.INPUTS
None. The script reads from a JSON definition file and retrieves data from Microsoft Graph.

.OUTPUTS
Creates or updates Intune Group Policy profiles and assigns them to appropriate Azure AD groups. Generates a transcript log file documenting execution details and potential issues.

.EXAMPLE
PS> .\Configure-IntuneDeviceGroupPolicyProfiles.ps1 -definedProfileFile "C:\AlyaData\intune\deviceGroupPolicyProfiles.json"
...
foreach($pprofile in $definedProfiles)
{
    ...
    Write-Host "Assigning GroupPolicy profile '$($pprofile.displayName)'" -ForegroundColor $CommandInfo
    ...
    try {
        ...
        if ($actProfile.id)
        {
            ...
            Write-Warning "Policy $($pprofile.displayName) not found! Please create it and rerun the script." -ForegroundColor $CommandError
            pause
            $hadError = $true
        }
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCMf8EHWIa+c4C/
# eChHwUyKsqgLo+J4so5gz427mgbCzaCCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIFfopAYL6g06JxiI
# c+bEDI4P2337rRwOrMgJVje46doTMA0GCSqGSIb3DQEBAQUABIICACQgP5ZDWZrB
# 9wWzeVJVHNeYQNi5WxQFMCwB9Yct7VxHHmaSrcy+WnbfRnxb0/Op57YWMq+eN4XI
# f5nBbFm8Ala5G0vHjxJdWUtQF6izvkpPM3Eq33KhrVg1OW0nc949+klQjVIvoe0M
# 9v2eB6HwLmq0X/vtZEyndR14fKQ/hpzyAhNQQyrw1uUFVIHWIaIEF9XXgxE1lYFh
# cM9MEZi4P4BQVs7S+Co0f5+wQdiIOmPtzmCGgjaUxzjBshmTLeOBnRVgDcHJ4CQo
# c1q8sLIr/GddG7EQOsfdqwdl7nRy0KmN17bb2Lz4qQ89xB/yOix7UwvnSw0/oXiQ
# CErBhKKO1I1kr96CY4CHz6c/c5zfjmJ9mN1czMuDtqVYJPjlHDpCtE2p/3YKLLFB
# CiouSXS1fzwEliJtu5HLGoEOLtCbTRnlDf+mRZqgF3CkVxMqLodVYV8aP0bbwyx1
# Z6vJPwyf+GB7UoLe4+7rSonqk6E65PdZDn23uO1xu25RITKnw+THU4Xecq9n+Uvu
# B4/r9DzEOU8MyYsWKfpYVMrzlcuyGxLQvOpkD19yXrxNGL4xC5GLH7gBCeCf5tlB
# yZ2FvneHjhRYJRh2TvzL+pJr44yivWVlD7Nc9Let9/pMsUI5tq88DxVm2UqMH3xR
# 8Ti1paDD4yLXZ0AHeTbFtxw+A1+ctn6koYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCDvnjpVmz9jx478tPqODjC1eLSOOeBCtzOVK/2cKphEuQIUO4xwcCDS2in7
# tRTkF73HbJsqlgkYDzIwMjYwMjEwMTE0MjAzWjADAgEBoFikVjBUMQswCQYDVQQG
...
# IJVjYgzmfD1i/axCiPwoTPT+eP88PbJTf3koVYQPPaIGMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAM2cyXKvjbzZd
# 1xav53C4wxdwmP6QGppoB6lnUVDuoH/52i2KrASJrb8TFsBSnMSbXQfh/WK0gJqv
# 12BhFZElXpigJHN8vW7dQuAz4JgLUsETjslShYRZRafH9tp9E4yXu5fBzuTCYIgB
# gVQ6UL2pzR89FgHXelI9b44iUuK7Th965MXYsDCLuj9AAxdEZCi8E4yqnLZC1kJY
# G5h3jpxH7RW/ZJu43RbzoNLLbIrI/Wjp8T7g21EWSyvGJyE8I9Vu+iSoFPw+rXoz
# mIZS5Hrggy9XYJ24sfqarRobxTog/YVNz2JidyZ4Q6eBKsvywOIWR+czU/0UsRb6
# yfD4uQXv0TjUMl7maeYG6lJUWq/SgtAPj1Knekb56Wis0IjW0vY96xz5+WSJeeM5
# q1Oc5PVCPvO/pvOVwEJaCoFbB6HrmtxxdfNnOTzdNJ8VywuN7qyHuEmig1Qn+txL
# R05xPz4i0wwQSgqLhDJic4k3oOY/PhXHQQ9nkoJKxTP2lBoEi4Fq
