...
<#
.SYNOPSIS
Configures and assigns Intune device management scripts for Windows and macOS using Microsoft Graph.

.DESCRIPTION
The Configure-IntuneDeviceScripts.ps1 script automates the process of uploading, updating, and assigning PowerShell and shell scripts to Intune-managed devices through Microsoft Graph API. It supports both Windows (.ps1) and macOS (.sh) device management scripts, allowing selective processing by filename or script type. The script ensures necessary modules are installed, authenticates against Microsoft Graph, and assigns scripts to predefined Azure AD device groups corresponding to Windows and macOS environments.

.PARAMETER ScriptDir
Specifies the directory containing the Intune device scripts. Defaults to $($AlyaData)\intune\Scripts if not provided.

.PARAMETER OnlyProcessShellScripts
If set to $true, the script will only process macOS shell scripts (.sh files) and skip Windows PowerShell scripts.

.PARAMETER OnlyProcessScript
Specifies the exact script filename to process. If provided, only that specific script will be configured and assigned.

.INPUTS
None. This script does not accept pipeline input.

.OUTPUTS
None. The script writes progress and status information to the host and transcript log file.

.EXAMPLE
PS> .\Configure-IntuneDeviceScripts.ps1 -ScriptDir "C:\Alya\Intune\Scripts" -OnlyProcessShellScripts $false
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAw6EVixKhp4kUw
# rhV0OjLzGo8StK2dM24gTGo/+K2T7KCCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIGmRpaCcH8pVSzs8
# nDK1HYcPfLsPh5d2dp3CiDSzuR2sMA0GCSqGSIb3DQEBAQUABIICABJjDCcqq8ED
# yQrzBfXwx6ZYKVcbjjfzJ+3jZs0Wbjplgum8UfaaBJrm3H4s9fnjYP2H0brtdgiT
# hQh00kppmF+xe46kKZDCdroe2YGJp5Hfrzy/hi+ZpCXPJUzUa9nt4VeYAzJ0Jp6O
# HRJd83SNYRTTnwNdMmKwGEu/DP2m37l+C9Vl6Wotf2uFoqkVERL+DWD6I4N/dwv0
# LdirnI1zzCvQksdlVS8i+OMSOT4MUkoUsng6oyIUTsjyQGHYfSLts+MWnG0+V8Gu
# bHkvdyBLPyIcHIROye4gelFzmYFuvD5xtDwYGWe6L6LhusQET9zjbW359hKoVUBM
# 6EUrfo5Yl7WbnS1HD+WwTFbO9ZROmFQ8BEpCeID9Wyp8j4hzAUobtJ5AmDH+ikKS
# a8qT82NzBPkA28J6xSy7Xxd5a6J8tRbS706BDjeHxKZvFOM9atQtvpU40nCMe7JI
# XlS+2Dw6f0rHa93OMkUey1Qi/4REv45ME5Py0PFBDPe9wG7EI5Vm6m+HGe0bs7pC
# hvmpxCF23eHVQCQ34Wa2aSz3l0u/6hBBub+G7vorwhjEhcjyIWcMcLk20iEydIoC
# 14fE8eOG8a1pYPHNKMP6dDlDanQV3pojukJiOnzkx4hAgISLvZwSWMRPEy80accZ
# T4sJlG8MxlV9hXiWtMpPQ11EAoMfb3V0oYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCCFb7unfUuu+qPyHpMrbFesjwqV+X3+6kblVL1IK+WGbwIUOtQfS5a6Wg4V
# 7he2v/CytXF433AYDzIwMjYwMjA2MTE1OTQzWjADAgEBoFikVjBUMQswCQYDVQQG
...
# IOP5RA21dC13e3iccsJ96jCJS5KbsNvKVB9lrb46XAPbMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAJV+FxF9uKq9a
# 1mSifAY0Mhy0tudFyA0d0VJbyrivTfgCOo13bPcVMgf57B5cqedWBRNMjo4DGWKL
# tD+LPyKe48epGV7jLWSLKjdCWpuLUXOyfAO5igOwgbTRiK3UJn9PEDLnhGx6B8by
# tQ4jCJU3S1jngAhP2rxT4Ox1TURZwyNi72lVCUkkuaA9CIu0LiM/OtZYpq4mllv1
# qxHPsS/J5yWI6Ltj35LrhGHDKDoWRYWCVq0Plrtl7BTsaGvrQb2ztBQdrpEcpngi
# cx2Y2eEhyU9IIV2HGUqCkH6iO0/9EDQqR4nTC5xEguGjkQgryBxxiXIrgemAlhtc
# CnJZ2D366SrDE3v8AJuWjp9scQvcu1evNlop004xCQSVHjowZYYAbsGwKH/MY/rq
# GxyEXAIPYrKobcKmF6WDtLREV1wfY9fy1Taufypwg9Ld/4zXGTr6rdcgUQVhMSZx
# jaah9s0g25JLGQqNoEBKTDnnDLdgzymFJH4gzU008dFgQ/X6rlj6
