...
<#
.SYNOPSIS
Configures and assigns Intune device update profiles using Microsoft Graph API based on a defined JSON configuration file.

.DESCRIPTION
The Configure-IntuneDeviceUpdateProfiles.ps1 script automates the creation, updating, and assignment of Intune device update profiles. It reads configuration definitions from a JSON file, validates environment settings, checks whether Apple and Android tokens are configured, and then processes the profiles accordingly. The script supports profile assignment to predefined Azure AD security groups corresponding to different device types such as Windows, Android, iOS, and macOS.

.PARAMETER ProfileFile
Specifies the path to the JSON file containing the Intune device update profiles to configure. If not provided, the script defaults to $AlyaData\intune\deviceUpdateProfiles.json.

.INPUTS
None. You cannot pipe objects to this script.

.OUTPUTS
None. The script writes output to the host and log file but does not produce pipeline output.

.EXAMPLE
PS> .\Configure-IntuneDeviceUpdateProfiles.ps1 -ProfileFile "C:\Config\deviceUpdateProfiles.json"
...
foreach($pprofile in $profiles)
{
    ...
    try {
        ...
        if ($actProfile.id)
        {
            ...
            $tGroups = @()
            if ($pprofile.displayName.StartsWith("WIN "))
            {
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAsJJt/2vNc7Qoe
# iqjhRdDDl6XorrIxLlCpQ2RJre352aCCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIOe0pYeUyr5tQN4L
# +kHRgzB34hrTf2iwSeJMWANvOguuMA0GCSqGSIb3DQEBAQUABIICAJPBpd4MvAQ9
# MsnVtT2DADgNA4OyYfuFVn9m9OmhfwnR8sYN9DWUsM4Tth1Fqu89Dt/DzVFZxXfI
# briorNZQ1Xqw2+1TDXYLDVfQEdT01ksG95C9rsX3SS+5hrOIDzNPWbF1mlKm4YqF
# nZXCpbPEhwrSb/vxbwYvntueQFP6qNbSJb3R32J5MF5PPOosMABNUGHT8aPAaumj
# VvpuAmAxJrraqd0IICl/3/VMJzStI5dXjJp2kpWHb/fpvSpsAd4PAAlinlrTVLMk
# 238ry78I7yfM7MmN9fZ05s9KD73DMFa5sdXbagL1vKH/gXMCl7Gz9n9RaATw1lBd
# O8yFvwfkXMRJifw0UGK+Xw1Dafgp0GHOL7bMsDO2RP5Yr8iTKICOzTuDa7uVOQ8r
# brvO1cPs+GgLMhPcsNA+EuZ8VExZgWt9M2YTjbpMI9fOdH0laRsor/0dm6hV7gi+
# NbhPgwI566BcoY8qiQhrxCeiQztXQyofG0smye0nHSUpOzyP5KL/ym7DCxuNowQx
# sGHdeKd4ql0/I3wSH0hXxcFSfhGcDA99w0kxAZQN7n3pPTw2Ymbb6ageNISdfwuO
# 5xAvF5r5pQtIOQ8XYCGeDB+3CsIdZCgNW/NU5RRbao89pX6sFq/IYZmfhw2k8kJD
# lVI12JVA/qS07Rz4ynicU4bql1otMPtFoYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCDH1IZ7ramxnAV0PTzJlTuHkaFyYuVkigdAtP49aexi6wIUCMbzCRsxzUAJ
# Xn/Wds22ZvT5v+UYDzIwMjYwMjA2MTE1OTQ4WjADAgEBoFikVjBUMQswCQYDVQQG
...
# IJLHLaaEfA2haRVzEgdkL1/PuqM7ymG/OeCbR/8cfLI5MIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAcfYOChya59jl
# c1xAxIgMOHxkbwFdNq2GlftNP6nXHOYMSuKXnN5V9WLAOu2iRGPTebb+HbZ+H2cP
# xE8YaZs+Wtz6QyjDW2rmA+hb65eU14s1hXM7Am/RLk1mT0JQk329jg2kvXxH9LOD
# MXkuiW5lewvJ+2ISxu8qAl2nJOpe7KW77bBZE8hFFYrtBtSYR6L5OVgItzoxiVBK
# tPrXQkN7SJs4PaOFVK9iYP6bMHgW9Nm/EmhYdzdBACWRqbrzMr8v8UUdz6syrFHV
# gkAQ3VCxncznF9IX0Uef0pbDdlewYNfwvXlbaIpHg6KXPfpmVpsrsrDi0RKUblZG
# PwY8KA/fmORVZR8cU14Lwm6ELRGspZR5PN8jO26ey98WEVVzapLlRia8kWg4VdN8
# PA9XFOpoB/XhJcNcdGIVzQ/uWq0Du962oTP0KV7ojm3vm3dTCW2k6JZa6f2c09sa
# alBRHQVQb6O08J2A5vzIAl2q9HyoXudz3Wvi17HsjW3l+ZIfYuUI
