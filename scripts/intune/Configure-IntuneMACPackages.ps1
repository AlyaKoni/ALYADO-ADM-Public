...
<#
.SYNOPSIS
Configures Intune mobile application packages for macOS, including dependencies, categories, and assignments using Microsoft Graph API. 

.DESCRIPTION
The Configure-IntuneMACPackages.ps1 script automates the configuration of macOS application packages in Microsoft Intune. It connects to Microsoft Graph, checks for the existence of applications, updates application dependencies, assigns categories, and manages deployment assignments based on JSON configuration files located in the specified data directory. The script can optionally limit configuration to a single app or resume at a specific app.

.PARAMETER ConfigureOnlyAppWithName
Specifies the name of the app to configure exclusively. If provided, only the specified app will be processed.

.PARAMETER ContinueAtAppWithName
Specifies the name of the app from which to resume the configuration process. Apps before the specified app are skipped.

.PARAMETER AppsPath
Defines the relative path under the intune data directory where macOS app definitions are stored. Default is "MACApps".

.INPUTS
None. The script reads configuration data from JSON files in the defined apps directory.

.OUTPUTS
The script generates logs in the Alya logs directory and writes progress and results to the console. No objects are returned to the pipeline.

.EXAMPLE
PS> .\Configure-IntuneMACPackages.ps1 -AppsPath "MACApps"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCD/BzIsACebTTLm
# m7wnCKcap0HFO0c1sVJCgUYA/XYu+aCCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIESvU2022v2t7n3r
# Ept6lUTl5PdmKzt91uaJ1U52Jlc3MA0GCSqGSIb3DQEBAQUABIICAIGXwGHZokMm
# HOdpxJ86t5BKkTKPDeKtP0/4rX8VwKaloNhH642CyOYNNwwmhqEsWHK85a4LQmRl
# kwDwn7+UEDe1vwia2ETU8ylt8b3ree5uSfJzsvT/BzaJm1k54rsfYbpHoiwgV16R
# USO7dPjUo67CVwYyt4YSoQj9X1tFCCu2U5jMZfxFo9oR7iEuYj/gMF2r2nZjRr1R
# oc6nelxP2RpanTyzFsoTS/6iVDYTLJ8mXpqBnIjXwINxcKjnAhqdL/Hj1E5z39b1
# JPh1MZKPrsmurb4vY6XpRLEUMUJNOnBOxXRTBr1BOhUbAoXmjQ+u8juro7zVdLOa
# vkrBnxiejgdzIG2TKXNPMv/gSyF2siMptsbxXGqRvOy1IiHshpks1dKAj7NV/gYm
# 13JzrmJrapy7jMQOI4PMgsJDqu8A3kzUc8DOI1rad+k419kVBBsSGu29cjpoJvW4
# yUxxBareY6On1JuG2O+O+OOSUjlWvHUaOVrNT1xLKp9ypRFSBggSB6v1mlUAt9+o
# 5vPWU8UGsh7/tL/J3TmKuVIMyN73vegAHimbe49OltJYBpENqjbcvhbRxA3lzH0/
# RjmzVulGYlMA8/thBQjJyFS1YyKXc0gGlm7by24bjwE0h26wnTa29ECFtfrmooH2
# 78Bow9EL2+ka+t3gWaZMA8itCOiVNDQNoYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCBkxLvAKrToCOGfevsbr+46+bweo5ZEXMI3Np+cv/HmiwIUd+HPLUSHO8Fe
# 0QpysHNbs0nVvToYDzIwMjYwMjEwMTE0MjEzWjADAgEBoFikVjBUMQswCQYDVQQG
...
# IMLdhjAFYAcgxvbPThHd3keP5I9nyGxaWrw5FA+mYzuFMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAI8vo/0I6/3B1
# Equ9A+P+fnYmsG60gmqurQGtFSFTeWLRVNYzsaflFiwXsxgEjIC8LsQROkQ9y8C8
# IiLSPGQrNoC/Sxct+njrTRqKfAp7kvJaNXmFOpmA+i6l9ixXhdjeyC4RmAFh5jCf
# qACfzzymxsRKZTLWf0XQDF8ApE1kp2isCvpRdYXaI9DdibSxnJJH3yWjcaA/kXnq
# YkziFMrgwe/Dj/tFgVlOqpQrntoSwrwTc8VKj08/OL2yhY426l+JaG9b7s0hBKDg
# LmrZ7oByxbQ6wFpzrLqBZbBEKe2pkFtkP6lFSJYKh24OWzGR6lzcDFDReabgOP0p
# iuSXYhGTE8PGbZjokc6ufBqeWsSLji8L5CI4aR5ZO7Y3aoNR61vwnGnzbuSfkZxI
# G9aS/OHKxWVB4HYoH4H7GuRM/aKfF6u1SPYKZpw51oMLI3hDSOP/wlqnGqXdP4Ar
# ZJTB5juRAvASfQLHOW39lE6/ASeYOe6tqvCW93FMlqWqyw6yjfLr
