...
<#
.SYNOPSIS
Configures Intune web applications and their associated categories and assignments through Microsoft Graph.

.DESCRIPTION
The Configure-IntuneWebApps.ps1 script automates the configuration of Intune web applications using data stored in local JSON configuration files. It authenticates to Microsoft Graph, verifies the presence of required modules, and iterates through all web app configuration directories. For each application, it validates the existence of the app in Intune, assigns categories, and applies deployment assignments. The script supports selective processing of specific apps or continuation from a given app name in case of previous partial runs.

.PARAMETER ConfigureOnlyAppWithName
Specifies the name of the application to configure exclusively. When set, only that application will be processed.

.PARAMETER ContinueAtAppWithName
Specifies the name of the application where configuration should resume. All applications before this one will be skipped.

.INPUTS
None. The script does not accept pipeline input.

.OUTPUTS
None. The script writes status information to the console and logs details to a transcript file.

.EXAMPLE
PS> .\Configure-IntuneWebApps.ps1 -ConfigureOnlyAppWithName "Contoso Portal"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAFmtMcBWNVJ7G4
# utnZNxgE2rRkPhhMzFqpjNstAxixbqCCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIABJPBpBtWyEzWgA
# x4yfDbYxX3z5hmxZJ5zlirm5xxk5MA0GCSqGSIb3DQEBAQUABIICAAJcrSnodXoT
# AFPtMYUZEyvfBze3aHwMlaoBh4V52LdkkfahpoBqYZBfZlGZVNf7cw7PV9Y2KcoK
# eAVUhe0E8IQXyC+9r9YaFNhPeaoCqY6VFYNDuAriuysszDC9Rj7UFu9wr5kfJFSS
# VcdtVfiDYT2OqvOv9lXYhWCSI9gmkjHnbym6bcPU28VLHcFXV7pOVmN2q9OJMq1m
# +mYYDxsLuC1QD+V2P77kxtpIvBDRdf3OzG96grtoVzD8PPODGdXmGCkHQUiEPCsf
# ksBqt/ueEo9UTWoh/6hhLsE1xYhG25uqSgg0UwoWmXbGDMzEfHauoNbNs2mAhgul
# ZlVLXYuOwEE7jrFaQ76QHC+5c1bN88haTFnZYoYhGT3J4RHr+kfQpAI4jmpMjYsK
# 2uSWToXga74a+iVuW/LL8Ctra751VYYvDSB0795DoduXT/0H0OJnE4s/ysTlzXRm
# s1nwzBO59x3pVXdt0SV4Hz3rFxOtj8F30swY/YLgF0VqbuYLEuBsJ5bKFfnxumGy
# iBIwGbhYhXYSSDQz6GYHhrFiJ7jAx4mlJ66LhiBki/5d/+ao9MCwNGEqVOZgpels
# pVK3fEZLRPN3AjNMgAkRPbM5clpfOX4rxSi8VyxXlElWqRttfRZ/LSit4KtYKUgT
# ByOAFAOpG3l+E366jkaSvTFNwt+ByPCcoYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCC3QDsD3vTrGYG6T4NbG9MPbKfojkM3k/9NEIiaC/eHoAIUZWcIoDambPpI
# Bu3gMo5WQJsMNHoYDzIwMjYwMjEwMTE0MjE2WjADAgEBoFikVjBUMQswCQYDVQQG
...
# IHFRrqrnOnxHHyO2Jfsy9xTjvcBwO+ZuawEBtfMdeV+/MIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAYeJ+FSGJO25w
# 2oXucX4olTvEDtPAWbx2UkrQEZgj6nto0JuV3YDXV3MCnaOt1gmj7YtRvcuan1ST
# vNfgKDkasUvcC9HOwCNRz537VaPq2r4b8AdyIGugVhjsxp0cf1Pv+xwwa4ybQBBY
# oVc/py0GOh5ucb2dWZEMq1Pg1EN0l7ug1XS9COlU/NAixCgnQymw3JwT03tozwHl
# WSZG4qqmpyxixGADiQ1RPWhw9ojw9suZvgIQAnJmu1VkbiPO52bPIJzdLAUgYABf
# mqLKjHl4yCYuOk5Yu1qJ0KtFQ4Nwq1LL/MoC6xco/kYhXBgh0TlKWn5gnhlPhuvT
# 4XKbPnRwacsszr6BX447qVrF7LYbyc1sFc4cvLmPZW/f8FKD7j6YsqR5JTK9bOrw
# 0i916jBDMW7BzvbFrCEOaD8EvFHmrrG+efF/e8baAKMx7w034Cod6xd+XEyBRdhJ
# mV43qQUhakYnxmBiULaHzIV3WDHk2yPnEh+SK8pPb5PAyRBd7iZZ
