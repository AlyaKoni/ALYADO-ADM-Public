...
<#
.SYNOPSIS
Configures WinGet applications in Microsoft Intune using Microsoft Graph API calls.

.DESCRIPTION
The Configure-WinGetApps.ps1 script automates the process of configuring Windows Package Manager (WinGet) applications managed through Microsoft Intune. It reads a JSON file defining WinGet application details, verifies app existence, assigns categories, and ensures the appropriate assignment configuration for users. The script validates required dependencies, authenticates to Microsoft Graph with necessary scopes, and logs all operations for auditing purposes.

.PARAMETER WinGetAppsFile
Specifies the path to the JSON file containing the WinGet app definitions. If not provided, the script defaults to the appsWinGet.json file located in the Intune data directory under $AlyaData.

.INPUTS
None. The script reads data from a JSON file defining WinGet applications.

.OUTPUTS
Console messages and a log file created in the scripts\intune directory under $AlyaLogs.

.EXAMPLE
PS> .\Configure-WinGetApps.ps1 -WinGetAppsFile "C:\Data\Intune\appsWinGet.json"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBpM9AaKbgXmtGH
# U8QrxG7/GutvRis/ALlEboFkAnlilaCCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIBsYBd+aHDz2KY9S
# p1yx3gj38tjv2wRv6qTW1bJZYwQmMA0GCSqGSIb3DQEBAQUABIICAAdT3Y9CTA3E
# tNZnNxVckfR8K8g87tfizSNEWFbiDf331nzetkZEzNaok3m23eGi2Dd+XHol+1Wg
# i3oX5hHz2H2xvWaPEMnHPjWB8SJ2OiXfADkA2pQo/en/U1HoMPwEthxvx8sL/4jZ
# fzuAY4G2u6ujzSLQQvjX+w/njLg+2pRvhSu7L4fFTfbLTTK7PnscumYwKJw8jT4R
# siT8Pujk9FiCd+GwV69Fya7WwgpqAkiixoyNOySQWuA8LrLNEC77U5WujBwiwFF9
# GMSQT1i6nwdal3/80QyV6tWGKZXAAgGOaOEcn4GxZQeMUQaAJpj0dD9TbUjGAtzQ
# gWfZjd0fUkxK/cWNZ3INlYLbdhefOBVGWpkgcRrdZ4geuRGpRs4DVjrU6bJE6z5q
# lEvXQqshJ3gdaV77vR5sLYYSbufMwNLkgDIFBffNwYfydBW8NOZ7qA8b56c7b7s5
# b7XszDX/8LWpkKV9WNC6xdpruRRdsrYSiu4IxrIYh6u/2ASpFeeGb/tDhhN8gMvp
# kIYp68AD7maAZI3y56Y4pT3e4px8k0GNh/M2B3Dq6zAYHxO1StS9l0i+C5hv0kDk
# sGUDIZXkY0XmprARlSbxMSo7zde8e+h3UXk+g7CsbyUzMmUJgxV4RXNWQm0slZ8r
# uOy82VVlV3ey3+KE6v3eqFBGlnuyPztAoYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCBFahSWt+5gklC4K5j3SZf0GEyS8BlDn+9u/yCwPP7opAIUNRILCHDHWKdT
# xk66F+Np+52RQNsYDzIwMjYwMjEwMTE0MjI3WjADAgEBoFikVjBUMQswCQYDVQQG
...
# IDIJHFe7Z17+xJDlKUjWWdfvPcw8Ar7kVD/5m3orBdHFMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAEA16b9y1GS3i
# DIMs/vTSNzn6OAe5hhmwtPpPAUeCGUFZLSp4CPzVVil7boSTj3kySWX2AXFMd0sV
# kNCX7ALF9MwhijKfi+uFeQ9E0wkHeCGurKghsZLrBR5yYk0NVj3CxJcW5tC5zXZC
# orlUoh2/UodLYY3qs86/8yDKb+X+LIzPAPlnSpvJnwyL425cZ22I6andQc1SQDl0
# apuQRDqEaZ4O6oImESkxZCRiXwoqE7veTHj1nuun9e9da3QQLOh/TmhTaUW8d42m
# 8XfuRr4/1Ia4IXbu3kQ6kx7NGK5Q3MzG+hOyvvBoZNOR+nljHiXy2Vl8IX94DSWW
# iZg5GF0USt/5ebptl5Xb2saO7D/ahoCXDWiZuEtwH8MjqIEX1x1hGYNf0Ey12C6l
# Kzqs7Jvz0AYtfjhrOrRnV3GZzaZaTIFM3b+JBCO31xktFIZ0P5YwPqcKm3RbgTSZ
# kCRfgw8gXEKo92xpYFQuroBMAPK+FL/PbWZjmoclFqFz3d7fQ/wX
