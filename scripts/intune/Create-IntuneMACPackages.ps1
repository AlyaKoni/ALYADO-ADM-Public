...
<#
.SYNOPSIS
Creates encrypted Intune Mac application packages from local sources, downloading installers if required, and preparing metadata for deployment.

.DESCRIPTION
The Create-IntuneMACPackages.ps1 script automates the process of building encrypted Intune packages for macOS applications. It scans a specified directory for application folders, optionally filters by name, cleans and rebuilds the content and package directories, executes helper scripts for preparation and versioning, downloads installer files, extracts and prepares the package, encrypts the final installer, and generates the associated JSON file for Intune deployment. The script supports resuming from a specific app and reusing existing packages to optimize the workflow.

.PARAMETER CreateOnlyAppWithName
Specifies a single application name to process, ignoring all others in the source directory.

.PARAMETER ContinueAtAppWithName
Specifies an application name at which to resume processing, skipping all prior apps.

.PARAMETER AppsPath
Defines the relative path (inside the Intune data root) where application package folders are located. Default is "MACApps".

.PARAMETER ReuseExistingPackages
When set to $true, existing package files are reused without rebuilding them. Default is $false.

.INPUTS
None. The script does not accept input from the pipeline.

.OUTPUTS
Creates encrypted macOS Intune package files and associated JSON metadata within each application’s package directory. Logs are written to the AlyaScripts logging path.

.EXAMPLE
PS> .\Create-IntuneMACPackages.ps1 -AppsPath "MACApps" -ReuseExistingPackages $false
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDiMX5jUn3aJO9p
# x6TKsba1BuPp4Ls+rVH96Uuxo9hByaCCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIJ661gdTu8xB/6+O
# zlj+yugUa08GwLvsDX6Zs1onMPHWMA0GCSqGSIb3DQEBAQUABIICADe7FwvaXb2m
# e/C8AJifALK4uBhCB8ovP6LaLRf+KJ3WceBQlwdMz7AJmVWkP+mfRDwfWvcDEbtr
# aiudGa0E6QBJfAFgVHiTRAT19zK4wivlWL63APf0pJONYFIgVsYh29nUSY75cTON
# 3+Y9zme4LYbPsIsbR0mRjfZ1epOrZ1iHK0AOzA1mnj2D5QlIviDDBInNQE/Guw73
# drllijv703FD6gNOAjhzrp2D3PjgVw0Hsu0u+IWKZuALbCshxMaiSe5aa3yZWRJj
# SPi4+k3vphug4ShmMI6x1lRkFUbdyV0njfaLtOYcrPqEb0JZmxYzM1zNweop7/t9
# HnKOJ0iCDf98Eb1im4yyoDQVPyiq06vKWeqKHeMBBgoYaRMJI37Y5BEZb8RsNclH
# NQ/F0zR8vTYe7o4rfjoMGWrMKmriHqWbCguKfpeuIA4dUyoCYhwM+iSFyiatqhfn
# lyv+6D41G2B65+5s5hRbORShprFrQ7QmDBVpiLq0dl0bFCQxgxdaF6EhARHrx3bN
# Ig0NSVMd2NOuzCPqzvK1qR43+sn18d7cBN+P/y+kvFhgE0SKbpPOWZVPetrCwcDx
# xqLBu5d/o0AlyC+Sp5VFmhHc5/C7sJC0hXPzgMHehV+isR/izE59kFPY1wYwmqz1
# eXdhXM9kcbZv8ldHPiK7CImWoaR2WNtpoYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCC13ehVyY/qaXP+7HaU7ktR8iDODxp9+pMJhRORMIlokgIUdH22Dqk7+DXp
# SG6uU1bH8HuNxn4YDzIwMjYwMjA2MTIwMDIxWjADAgEBoFikVjBUMQswCQYDVQQG
...
# IMFjMaGKmJUACGYuhnpRzfNqIh1CuFwdoyzfRi3OE5emMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAk2ocMeLngpfQ
# srTHaGRR6gAhxyiWpMaDSX0u+TMVVIdK6hrp1gO1Bw5pqn3Cvb19l7aHAX2XXnzt
# ajqNWDSGyKJgCdrp71vF2L9U7/snZ+oZ9Y19OSLJpzJaLTUTN/BXvpvUxkrDkKEp
# eQQcc4qK06MY/eP9GvEdpqNEIQD9CHjPRje9qASSnW+wqxC37cUM8wZG1skqsIcJ
# P0NjMlc2ZToou5RMNgve/AhcbL51e79mrsViPwk1kixf5Dzse2wO0BNBcrxPMf9d
# IZ6ZV/N7R+rv5wj0vJPR2RssM7R7G1BWILwswPIv14scdU0n7qr0YH1fbYU3qLSG
# HCcniJEVUuI88YbGwX0DxYSOXXwqwMdKwhdCA7eutRNpGF6KtcS/sF7HFxnK7Kro
# zaMswncuKnLd54V+s6WiumZJO2YWhu5OLJ0RysMa37QML23Wu3UghSO7XKBIMZpb
# wbs0a2NaQ8b5M4i90sl7hvySjTbMWh1ueljmQWuPUrazSnxkz3Ro
