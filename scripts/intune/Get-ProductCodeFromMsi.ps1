...
<#
.SYNOPSIS
Retrieves the product, package, and upgrade codes from a specified MSI file by processing it with IntuneWinAppUtil.

.DESCRIPTION
The Get-ProductCodeFromMsi.ps1 script extracts MSI metadata such as ProductCode, ProductVersion, PackageCode, and UpgradeCode from a given MSI file. It uses IntuneWinAppUtil.exe to create an IntuneWin package, unzips it, and reads the Detection.xml file to parse the required MSI information. The script logs its actions, validates input paths, and outputs the extracted metadata to the console.

.PARAMETER msiPath
Specifies the full path to the MSI file. If not provided, the user will be prompted to enter it manually.

.INPUTS
String. The path to an MSI file if provided as a parameter.

.OUTPUTS
String. Displays MSI product metadata in the console and writes logs to the transcript file.

.EXAMPLE
PS> .\Get-ProductCodeFromMsi.ps1 -msiPath "C:\Installers\MyApp.msi"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBMu1oJN3k/Y+EC
# EKStIaXREaIoKnS5WvALk7fQLDy1v6CCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIBUGAwotmRyYt0uo
# DzhKWEeA9mYiUb7FF/pvzBZ43gkKMA0GCSqGSIb3DQEBAQUABIICAIPneRfki1dc
# b1tStjYn/UFVWbHn+79aQEFxi/64Lpcasv7ZOxXplCCffioNfkbzKgQRJSVajtrJ
# qI7Asb0boz865yKuAQbAAw+Hb4SxZmDtkNhtBbAyWgGOkQHxCJphAZA4mgKQt7Rl
# J9kO+qn4WOMKkammYQzVXYaostTxpn8rnoPHBTg6DojoJeJ6YSPsiA0vr+lA/Eqr
# AW/fImeqAtYo2pdw2KB2NIB1AJC1Y4g1HglXTQ+sgDS92x+9PhxyE+rq7Cz+KB6D
# CVSpeC9mFA/dmM4Exxk6N5IVG2sSPBLP2b0dc7DDRhBxI78Syzx/ewfmA7zx29bs
# zNnGtuiFPRKjBt/u1El2OJB+2bGBKlmL2io1Kiewvn31F40QCWrUCE8nsUNgQkWK
# jlOMTq/aH/jMawGp4MsKffrTlV8u8pWAD5mduO7UZnVkNu2Rt0dLiWwkWC7nZE7e
# 48p64fBj4zMLfxlCNew4fpYa+2KvJIAMMokAGmD/3p2Is6U7kwYZXVmIKJoJIIqv
# HZ9YJBS3tSH/GC+HevkVMzKPDco8fNBj9Jnx4chYXIxlva/9gBU1+28c4T9sy1uM
# rorz7K97fpuw3bMaDrVoW3Y1YxG0tk2WCAWa2cayWKcWj3VVVw+cXHrEKl/xkzuI
# pCv4Fi3E5cIvoH0nMFBWknuxxM6w3bg5oYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCAGsDj0R76un50dM5qiwFOB/Qj69Dh7QjJ/5kL8SQbz7gIUNULKjUwJcqf4
# aeHOU2hVH7lpjtoYDzIwMjYwMjA2MTIwMTUwWjADAgEBoFikVjBUMQswCQYDVQQG
...
# IENcyE2lRHHbOgeSvawq8jHYKHKd3MW5cHrsTfoyOtVeMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAEw07/1wFqVLF
# e8gkdF9U57dsuiUtFUCX+39VALoor1oRtwEi25Azr0Yb3p50HTCwXO6K1/vYr0j9
# OTd4Z44mb4KnsBE3P9oTO4nJ7kbMnYDzy4B7hw+RFd9Gj2CATP5BkirGfAzc/pMw
# fQMRbEgu4QPSE7ODDoTgB5/0MF6qcY+z2IpoNnoMy+9AXIPcn4WyPrXY4LMrv7vT
# HcYmrNkbreo7ARjPivjdMtOd1uIvyMSiofCZVU/dbZWvyRfN7NUXWs3XznKko1LR
# s00q7rZOrzir9ORMGMPtE2hsJ/W1IsEudav6u/BZlC/hALMImqHoyJNQCYaUxz1w
# HOtyH074khDuDP7zB7WIut9mktPM3Fjqzd2UUiIvQfDXRoO6jPeBgrF91p1LfNV8
# 1Ytk2uJbfapbnb7zAf6jxa7q5zEPBHHb3WcZ2FGXCEhePFDKmwa52V2HZrIZcMUR
# buFXGTI1DTCu2n+jo6o/jNaVeX14pYGy7/ycl0fUFwxSq9dga+sp
