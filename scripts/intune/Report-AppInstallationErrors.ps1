...
<#
.SYNOPSIS
Generates a report of Intune mobile application installation failures across managed devices using Microsoft Graph API.

.DESCRIPTION
The Report-AppInstallationErrors.ps1 script connects to Microsoft Graph and retrieves details of all managed devices and mobile applications in Intune. It identifies application installation failures at the device level, compiles failure details into a report, and exports this data to CSV files. The script supports environment configuration, ensures required modules are installed, and logs all activity for auditing.

.PARAMETER doUserDataExport
Specifies whether to include user-level data export in the output. Defaults to $false.

.INPUTS
None. The script does not accept pipeline input.

.OUTPUTS
CSV files containing Intune managed device data and application failure details in the specified data directory.

.EXAMPLE
PS> .\Report-AppInstallationErrors.ps1 -doUserDataExport $true
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDefrQZRp4HVXuP
# aiH7cKHQjjz0ZOI0AVgaJ9OVMmb2zqCCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEICLGLXo8jMSwGRKw
# XsE+oVSFmQt7IEt7fI8Mc367lnguMA0GCSqGSIb3DQEBAQUABIICACUdlLWu1IkN
# RI/bqXSLMkTl1sjB4BmM9NwzRFHxHeh16VvyYmWw8mcNzPWo+e9uqezYGgszUaf0
# 0Fe7TZu0PSFTZgTP77yrmgWkUgFLxQcZh9F8/f/nWJR5FeSCzeQWpbTDEDvvEhy9
# N+v8qaiDqOjwQpYiEfBdBNU4G7rGSU0jd2p5mug+1CgGKDj+DSu2X45nT66D1/y0
# bjFtmy6nsD+8IeORU1BXFabeZhXaqI7h/rM9XFXekjyX37H9Hp58J5y/vZ0xLwWZ
# e7D7zZDQOlZgSUqulL9x4/2u+9TkMUOLWC5rucKUuXS0/Rxw7yod8up5rT21O5ai
# UNBXAm0P8G7h8MZHH9VDfAuYk0O47ChZaCtlulrgrRCJFkp0DUgIlNcsDw4ZS1sp
# QB0oRa36S2E56Fu7UvMAWLwnTEfiUhXuFEg5XSLp3mmKFccH6syXoeTDh+qEIryU
# dbxzsgpY4AEQ97cdCZxjmTxIdrSfqDTXcGb/xzvkMJAQDZFK39Yf4TGiUKotq3SD
# yNn3Ec+JsctOspnWv2kq3q4c0V3Jo2E09P2A0WgwmO1+FMP1DQ2Ti+2SqoPbWeJc
# 52ae7cUKwgVpAsgIn9AIlLLRvRWglnYpTsaV8dVUbX65vs3ybuUkakoImT+gxQ+A
# v0/rpmJvB7DcX5RSYE1AKV+n8xnlk3lloYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCAxNU2D9WUnh+xafYXarujmleelD0kB4hI4I8PwEh0FTQIUb19bNAQ9dSUN
# jjN7p/u6ETOICwMYDzIwMjYwMjEwMTE0MzMzWjADAgEBoFikVjBUMQswCQYDVQQG
...
# IFG7sXErLhf13eH9X5fJIJbKc8QLaKzKR8vuPu8g9yqNMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAZ8KuZQ2miNPd
# tF9k8TJzfDxBhEhKoL+aUr9nUnSx8VaKgtZyGwQSBNoHBMy2TssP7eapzJQbdL4E
# orWVSOspLipOb11tNg2YHXM9YAJ8xrl8Jgf2XtxtT3Fi0tYcG0bZTTo1YkaMZJkY
# DiIjC6IpODlU8+NBsgMrW+UC9x8DQJyfUYjPfqQx08oxuJrt7AdwUqAf9YG3JA6h
# Mp5zM4kR9XAHmck+E1kOuOEAiNnIZNzKe3RPQU2lP2aFwwfOD3Ji6P9y7a6NJ3Dx
# sQygpjkOTldf1S7cuIB8ng0g43Z6MNZkvNZEICYK/K+/UYh9QWVrmBMI92ZmWMTp
# W/4ApUgPFcsCRG1zjq1gHo6409JixgP4tqVTRexcM55X1ooEpo5dpxpT4cRkcr7W
# S6Jz+y4bDQ769Z1+avh1hE3YPmKRPLfhmj0doB/tVxZhXY+3GQaBwRecB8otDPr2
# OSWnRDBtZnBKUyb2b9RWOR+biYp3eCHs4A1c6HgJEGAXfPOYuF8i
