...
<#
.SYNOPSIS
Configures and updates Intune branding settings using Microsoft Graph based on predefined configuration and logo files.

.DESCRIPTION
The Set-IntuneBranding.ps1 script reads a JSON configuration file and associated logo files to apply or update branding settings in Microsoft Intune via Microsoft Graph API. It verifies logo size and format requirements, encodes them in base64, and injects them into the configuration. The script also ensures that necessary modules are installed, initializes environment variables, logs the process, and updates the Intune branding profile if it already exists.

.INPUTS
None. The script does not accept pipeline input.

.OUTPUTS
None. The script writes log and status messages to the console and to a transcript file.

.EXAMPLE
PS> .\Set-IntuneBranding.ps1
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCftQKJB+lm5Znf
# TZRfs1B4jOKKNyX7ca8UeYqxBQkLOaCCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIO4yppKPG2Nx3M9e
# gNzcg2046NO0vPqytLGGy/0GAOZUMA0GCSqGSIb3DQEBAQUABIICABTe4qUNQGew
# 6o7+/Ka7upMlkRYAEj/zrjiOEAMZQg70IamaHHrufUJZqwA7LiA5rAmhfEE1UEhk
# ZH8y8F+/OPKC5/X1F0MrUercK3vgFFXPSx43obFIL7ZyHj9N9J9Zz+bvpFh9h3XH
# y9fPlKl53BfU+jOKj4RDPKwkukieELPutaKnl5gYSDELMpHTP8bjdBPdceEj0pwJ
# RvSpqrQezxBymNXFCIQs5MfYoIIYPMbOqtUfNY05JYqcpmM9WRDQV5VkSICwU0gx
# AFuWN1fM7rfO/2e3+APv3mj7tzXNTDnJdMPmSxrJ2ej3EvPl38M+6oxK5JWx2fhT
# ihs+KUrEbTuxXjOPOAEzaXrIJnJltlRkguenY2JkZpjAKp/oUsyb9h+s8uxl9PvN
# OA7PDv8tkT422NjIHrBpvj6lWhMsOu/nuhJHdipVJ1KIn/jmuznPF0dJmnNdgrRs
# 5szBCvHZT/v8Wp13fRjnD3nxhoCIhK+Y45R4UxBPFOMGS4VWRRH0GD9H+DaGaBCF
# 9jxfj3k8hPjc7Enft64WINx31RBmR6Wm3moIp3GszV32suxFzP/snbgRrUrrQ7iu
# PdjWoL/cLvu1YVbADHpuH0H1sTxPvMe3Dl69ADbTYIUpJGmtHhIWmKcvX6LsPmNK
# PNqGYAFqqt32aFahvuOiRObxOiN682hWoYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCBIsY79xJMjiWytDbL1G8LbhRfB7yzjDusOI7mQFLglJQIUTePd1ZgJnrQ/
# u+VDnUERTyRtKGoYDzIwMjYwMjEwMTE0MzQ2WjADAgEBoFikVjBUMQswCQYDVQQG
...
# IN0u+cBquZn7Q59/kBEIuaj/ZY2kSQcyquIPh+fxsHtEMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAMPu07uCY9vwo
# 2aw1Jb7630mTarPoaNsjzpb+YoBBuav9B2qUruPZsVPgG8jtK9PUhusJ80OlFpcG
# GSImIcKPXnLeMIUbJlGoGUgVl+bJe9z1rpLC6XC2ortrJ/A7WXZdnGgu6qmlPHmH
# oValVAkF2EAdFY7GMujZrYziALdHQKJK/NOYiAt6+YTDlWUbtnWgdPp+kXW7Wt7g
# 6/wpbQm+88rCQ0n51Op4lW+Nbp+Zw/UnpMgrnwhbdmXmNhFzTC+DcydX4Bg8HIgM
# Ka2oWyYmrL+56H+D07lVmFw+RJOZGnsX64c2IykKkJfrH8IiiTa5HrlsKNXzaLb2
# tYFLsywRpmZY1VYo9YZlksQc+nbKmhVGN+kph2VE4d6FyOq5BFnZn8cW5k6dsoSY
# ry7DMfihOQW5MfrmqlY2wUrOsarAJA89UD7PfGfZ80cWLxwPXRb6WRiyyGlrymeL
# N+srFO2P08UGcP+AyZQvQhXx4Qr4miDiRMERcIyY1Mtts6HHRWSe
