...
<#
.SYNOPSIS
Uploads macOS application packages from a specified folder to Microsoft Intune using the Microsoft Graph API.  

.DESCRIPTION
The Upload-IntuneMACPackages.ps1 script automates the process of importing, checking, and uploading macOS application packages to Microsoft Intune.  
It supports both .dmg and .pkg formats and uses the Microsoft Graph API to manage mobile app objects in Intune.  
The script ensures that packages are only uploaded if they are new versions or if the user chooses to re-upload.  
It also handles upload chunking, throttling retries, and app creation if the application does not yet exist in Intune.  

.PARAMETER UploadOnlyAppWithName
Specifies the name of a single app to upload. If provided, only this app will be processed.  

.PARAMETER ContinueAtAppWithName
Specifies the app name from which the upload process should continue. Apps before this name are skipped.  

.PARAMETER AppsPath
Specifies the folder containing the macOS application packages to process. Defaults to "MACApps".  

.PARAMETER AskForSameVersionPackages
Determines whether the script should prompt when the same package version already exists. Defaults to $true.  

.PARAMETER ShowProgressBar
Displays a progress bar during file upload. Defaults to $false.  

.INPUTS
None. The script does not take pipeline input.  

.OUTPUTS
None. The script writes output to the console and log files.  

.EXAMPLE
PS> .\Upload-IntuneMACPackages.ps1 -AppsPath "MACApps" -ShowProgressBar $true  
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCD1ggpAnGPcazuz
# wt3pG9mq3KO5PZe3KmB/w/Natw/HoKCCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIJ5r59ecromhbIcW
# 44gdYWIOHqcpRIsTB+mF4CAjK6jKMA0GCSqGSIb3DQEBAQUABIICAG/ZhnNmyIhs
# rNKCbtJjlE21W/KAcFPblR4Z99a5ZlvfxYEtlZWnO0zmrhXIz1gr506JVubqKILZ
# DBqIpShfn2bLMR3TEWjdhvCTWc8r16DrnrYMHbl0bfsB0OhZopZ64V4+ok6VewQk
# kS5SRNOxNjxPTAkaUC96Vb4x/UHSViVgUHKP0Lb4sT/iBgPQg4hFCU0Ym9wJH4Y7
# KF/HsidSQZv3zSa8+Z/YBAfb2q3xwptzs3tSIaloIBK5vFEZ9cGKpQBPy7VUWxON
# S83AcWykeUkuXtHFEBrBEWqIVtY8KB63MLNdDo6WwAyAT1AJdixNwH8+T4P2hOeD
# VGYH7s+WuhAVg+df+rPwQGoznucjbOibiJyh8gZT4Z7JGkkQCLBOaPtId3D8je2Q
# 222PyTPASyPW7GLRsFE9enlPUi+baxnQlbQDozDfmOSVBPBXd2LAdh3UQPog+pGH
# b+dr6v+qM+bERjpves0g4Aueo+TjkIgZiLxVkHMNmiStsaxzSzGohfwQ996y+gBE
# g/pltTLfpUIMmIkCo+hKji0fr5r7NWDAAtwjEmFe5Qg2LqlrUnIBTGv74T5FwgeF
# 56TFNzDXxEmE1dXFnAU99BVgkudg42hjvlyWhsfgmy+qwS3VFdrYVPpZ39MmSrbf
# kuFFhV4h87c7TBiM0gMF2ZozMkxOmnbIoYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCAVyC2RQycz4urHRXXp/kkD1Y8z3H5IUVlJiqreeEphPwIUXwEDPr/NFXUk
# qFLXjbEmZN2COxEYDzIwMjYwMjA2MTIwMjQ1WjADAgEBoFikVjBUMQswCQYDVQQG
...
# IHiZ6ELYtmWOS7fz32hqOksbfLEIJJMAN/4Py3VWb2DQMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGARxlVopXQ5xSX
# jOFhZ/v81QhROw/zxwABgd8M1dYYD0er+T1Cq0qkB6Au0AMEJwhDeU2Np0OeZWtU
# szigZTqHxluX+1DQp/gr5BRRGWV1czbENTLQCc5DoKqAIF6A6KvlioKsM1NAqcMT
# +PlZ+bTtWKsuGBoJvK4aiLNglhkP36HxBmC2Bg/DyXIP+CcOOawwrPz4EBP48m/5
# O4dLUBNSyvMxEr6wMOLEW6E7MeYjegHh23ZYg9LT+L+tau9oK7a3DhstKKr3MK36
# x/qsvQfP3PH3myOImte4Q0B/P0nRHmRPVZeELQ5SshGtJxW5lZ4s7RwTB865f71+
# OdTfVUUE9r5GZNsWhhxonZTOe5UoJ6Azjw/x0bHH/wd/gJ86uOh6TojYOGcmCJv0
# q/DyihevCyQ366Mkcw2EzZCYKiaboIxWT2X35yLUMJkGL5F37YXCRr8Oqxo7jpqI
# X0Yy3t/TQkgFHalFPgXq2NVbcPispRVsNWHnHsOHTAJ0ihOqffs5
