...
<#
.SYNOPSIS
Uploads Win32 application packages to Microsoft Intune using Microsoft Graph API.

.DESCRIPTION
The Upload-IntuneWin32Packages.ps1 script automates the process of uploading and managing Win32 application packages within Microsoft Intune. It reads local application package folders, extracts and analyzes their configurations, creates or updates corresponding applications in Intune, uploads package content in chunks via Azure storage, and finalizes the upload using Microsoft Graph endpoints. The script supports resuming at a specific application, selective uploads, version management, and the creation of update applications with requirement detection scripts.

.PARAMETER UploadOnlyAppWithName
Specifies a single application to upload, identified by its package folder name.

.PARAMETER ContinueAtAppWithName
Specifies the application name in the sequence from which the script should resume execution.

.PARAMETER AppsPath
Defines the relative path to the directory containing Win32 application packages. Default is "Win32Apps".

.PARAMETER AskForSameVersionPackages
Determines whether the script should prompt for re-upload when the same version exists. Default is $true.

.PARAMETER OverwriteSameVersionPackages
Indicates whether to automatically overwrite packages of the same version without prompting. Default is $false.

.PARAMETER ShowProgressBar
Displays a progress bar during large file uploads when set to $true. Default is $false.

.INPUTS
None. This script does not accept pipeline input.

.OUTPUTS
None. The script writes progress and status messages to the host and log file.

.EXAMPLE
PS> .\Upload-IntuneWin32Packages.ps1 -AppsPath "Win32Apps" -ShowProgressBar $true
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCC/SkIlstsv3dha
# b6ySNt/sk2ihGHOO1wgMHfR/jUQaQaCCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIAULiipjzTFz+wm6
# Rz8AFC807e2Ojk7VUauyBoFQIW2XMA0GCSqGSIb3DQEBAQUABIICAFRzCfSAOIuy
# 1DCVnwvJTTjrj9TniDiiiBIVLh5MABKrxS0jX8oLI9Zseah+7ZxHmT7rzDm5mTew
# KnVLcO+Ec9ilJ39KyL+sa6uKb+OS7FpBDLpLxGfGuBhj5nKy+xPQrHVH7u138B/e
# oTUaZOUhKsv6oXUlqXd/7LfJumXMA0f6ijOIYHxQxYKo29DhVg2JbaHkdsJIFMzh
# X8lI1I58sJ9+K2m/vE0ctmCYTGJiW9/BqpSgkcQtH7V2UgP1WNodE9uw8+E+r5pM
# 9vJ8aOjFGCa+XM+9ISxOcXVjMogY7WR0SewZr5rvgSCK9R6cWGAJPN+N8r/Qcd1A
# 3j08y8ZvPUxFA2zLejMS3DVD7jwrTYttv23g4ZMMIQCPzSN2972eq9+L6HWzaCzf
# oFSEVa+G/getVeLJL0ksyOzg8c20hqfWWmuhy6h8Lj3wSaUIrko8495IGB9afIxx
# pJsrPILDNzxFW5mUfEY1wqS/DTsoYZAkQR8ZIUqvdGfzHLO8pnvBYA0SqTyvR5PJ
# KypCdJQPWiFmzz/2fwmEE149aJq7imk3qCjpKieIyLEmp1sXiNmyTOSNpGzOH3ct
# 7CrAIV8LP3hF/NBjpc+lnnTpo59oFOjRUgRtlsQFwtF5YHF+9JpCz34Ibzp2KBrS
# Zw0MiqA56R7+QrZL6UTPwqC/oivyMHgaoYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCCTZVXZdEbF0Npplx9JPLy6RvINBITz6jEdWeIz7WHQkAIUW/EWrlLMWvE5
# /NIhVOgiF3idhjgYDzIwMjYwMjA2MTIwMjU0WjADAgEBoFikVjBUMQswCQYDVQQG
...
# IIlvBYQm5pv2RYb+m2vg+byHxsFWe5X1FtUvOddbkgT1MIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGADpENQe9uk9qk
# w/FNGkZX584yg2qdxlVICTTTkRU/8udFjv9LeU+6micwmzRvkRtVHOFG+IsT8Dtj
# IJs4z1TWfCOCuciZJz+5dFVxSoE3un0kG8m/jEglnmxaqF5nC2Q3p50omQ/NJKKM
# esL4NRI2xN/kmoosnrfFU90YncWo5j37cmtyMx9Gb4rZTJshOQH0F8ho+tX9KuxG
# qHK3/zNVLNhFR5NvZfhS4vZoRVvqU5z1+dXfqJyTLLlXChKMk/flK2Peat82g951
# IcZWevnFK8Ht4B9qx4lAtO2RyOHriUw6VAhQorMrIVzDK+jboblS4C4C7Tx3uatn
# FLvmOYaoRVGMRM1A4MLUE/oWw9Gv85sdbhoLxUARoJlXTzwuDzeXQlSa/Mc2iomQ
# Y56RYoZTJrEZkjzwtRcbgYAtwzSTZYnPUufPY95sRIYjLC5SOYjA4RKe9QCl+cAR
# fA4R9qgqvINzq+oOu2rSisuZs7k77ctRcOVOeZX02WPK46lNpnzR
