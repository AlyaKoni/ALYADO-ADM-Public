...
<#
.SYNOPSIS
Checks whether specified Microsoft account email addresses exist using automated browser navigation.

.DESCRIPTION
The Check-MicrosoftAccountExists.ps1 script verifies the existence of one or more Microsoft accounts by automating the Microsoft login page with Selenium WebDriver and Microsoft Edge. It downloads and loads the required Selenium assemblies and Edge WebDriver dynamically if not present, then opens a headless Edge session to test each provided email address. Based on the page response, it determines whether the given email corresponds to an existing Microsoft account.

.PARAMETER email
Specifies a single email address to check for existence as a Microsoft account.

.PARAMETER emails
Specifies an array of email addresses to check for existence as Microsoft accounts.

.PARAMETER HideCommandPrompt
Determines whether the Edge WebDriver command prompt window should be hidden during the operation. Default is $true.

.PARAMETER Headless
Indicates whether Microsoft Edge should operate in headless mode (without a visible browser window). Default is $true.

.INPUTS
String array. Accepts one or more email addresses either via the -email or -emails parameters.

.OUTPUTS
Writes to the host whether each given email is associated with a Microsoft account.

.EXAMPLE
PS> .\Check-MicrosoftAccountExists.ps1 -emails user1@example.com,user2@example.com -Headless $true
...
{
    $browser = $null
    Load-NugetAssembly -url 'https://www.nuget.org/api/v2/package/Selenium.WebDriver' -name 'Selenium.WebDriver.dll' -zipinternalpath 'lib/net48/Selenium.WebDriver.dll' -EA Stop
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCA5ax/Jw5a865ny
# zveuwmCqfnG//SzfH3Y6Ug0eWnBW1KCCFIswggWiMIIEiqADAgECAhB4AxhCRXCK
...
# KwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIEEO/hU1
# 2VVUL5wtm4MmlYFi3E6Nc58DTp6qv7zTwYsWMA0GCSqGSIb3DQEBAQUABIICAMsD
# 6a4Ps5N3f5VwyX3hwcwn8rqWzTxrKaF+kbUcU7ud4dC4EhOCDc++ru+dEQEi/68a
# oFhE8xvD+/uL9/c+Nv7snBR0edhfxzODiL7zdovPez2jy9u8qa+F74kAMEIWTDDy
# LpKu0BJdPT3+zhZ6OGlOSF0fqDyuCEW41DGnxusGe4jvklC6y9e1nNzY3ZaGgNvT
# v8uhN2UH3/SZMayCnrwe0ucpiRWvkieBOv1fLFGiqYyJbT6aTk5u3DvgLIhPU5/A
# wOMcmOeo2Tw9fErb6VCCdl5NXCp+ZsiBSbWGqrX+5bJnYDLwxcZu0eq6uOCeqnuz
# SDLtL9CSzz+Taxb59efFH326PyRiTYXYS2oCjPX3U8Lz2khFVIBvsRzZMf6jnDOg
# E1EBaoUrQ+4s/KTaYeML4lp+dEMvyY3i01CHy6P7bgJ4uPpMzpcOn88gnq26BBKC
# 5tyDHFuPhjYEZGbk4Fii9C42fM5G7LfqtERnllXMsANFXoIoL8Wtt1S7VV+BQ/Xh
