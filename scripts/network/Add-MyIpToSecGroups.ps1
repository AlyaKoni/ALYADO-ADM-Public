...
<#
.SYNOPSIS
Adds the current public IP address of the executing machine to specific Azure Network Security Groups (NSGs) to allow RDP access.

.DESCRIPTION
The Add-MyIpToSecGroups.ps1 script retrieves the external IP address of the user and updates predefined Azure Network Security Groups by adding an inbound rule allowing RDP access (TCP port 3389) from the identified IP address. It supports automatic detection of the IP address through multiple external services and verifies the existence of necessary Azure resources such as resource groups, virtual networks, and subnets before applying updates. The script is designed to facilitate secure, temporary network access for administrative purposes.

.INPUTS
None. The script does not accept pipeline input.

.OUTPUTS
None. The script generates informational output and writes a transcript log file.

.EXAMPLE
PS> .\Add-MyIpToSecGroups.ps1
Retrieves the external IP address and adds it to configured Azure Network Security Groups to allow RDP access from the current machine.
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCQZH/7yvJkpd09
# iZusT5I+OoKHsHpvElQChT4+bKI0taCCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIKyseYgPsKndGmDB
# BQG/B/77X9UjVB9oQTBYsmlFmUaRMA0GCSqGSIb3DQEBAQUABIICAEAZbuO0i0wl
# 4f56DB7gy0Qo26mdbz4jE/H9umD87o/AfKWBgHTdzmK2TWTUO653oDNmasoLz6iD
# HmzIZClr68KhyO45FLRK35fvxvNW02oO4K9OdS7OBlig4LDkIwXjvkFgeAG6cDcn
# yK1rFAQVzcUmD95Gmjm3YF4N14BKEaJUFoVlr5+zlyCU0fGOXGmIKSHe9uvxljxY
# k+vytvnPLI1QpBHaLExqeo4cIHTDQLA5Fv/yVV53ANPmohIhqnGMOMA6sItZZDze
# ptdD8Z2AeRCK7QSt7QdkITyESHSv2biyclPVAW5EGWar8Iuy2HWeJ7S28J1U2bfj
# l/GO/ZHMrXztvxVafD2+n8qzEO3v8oWKkEfKX+WsMKgV8UfjgrIn06tXXSqCveLx
# XeuGROcwGtnZqnPLPffX2U4lF4aQY9N9d8x8QIXj5ISl0VYDJZya2q4wJbugd6hK
# uyhrj6MidgPU5Bw3AYwlkCQEJClkfaWMft42AZFpFvCHBne6etIBzu9vMlcI8QPh
# jHeel9Xdx5RODnPELagB6Tr9y+y6S2zYGjReFCKutdQAms4xy7Yn9ouvNU+8/6uB
# kvFqcSTY9FahhgTTC5uRgXFtq1sGws7osaGP9xutRdpUo17CEzaE2JjL6k8fk0Dz
# /foReC47awYigINGx4V3nei9A9wg5fafoYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCBmUS+WGf6HQ4ednyxqn2WkFKEpqhEg63h7cgwdMURs4gIUfHHttN9cOzuK
# R+Il2wQTdKAQ0ygYDzIwMjYwMjEwMTE0NDU5WjADAgEBoFikVjBUMQswCQYDVQQG
...
# IIE3hjn5duLeglNsd6RlvQeTnSkXoznNYk2cFBVaMqMkMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAXy9pwTe5fIUc
# v2nwSWjx78YA5eAvhyoQOhcu4t4fa3jw03fmqE3NU9jbDMu4DelfZ2TUGGPbIl9D
# xHTIe1Uv2sp/FsluSYryJgwwhmB3Gg8QOydv7rfcSyy+wUz3K7ccPX7oMLiedAdl
# C2Sl8pT3Dr7XnRoWurJ0TOmV9NzXYrVILnPV02tnkFdAAUflKlHMw63EWuNjieYP
# v7gzkzttFMRoFTYmRRdxA9ozG73AocD29U0mjBXGQrvIZ2waqv4dBob/Nl3n6BNA
# nNs9I1/yNp816wxUK9CP97EMOni4HPDqJbGLlEBEMbUAonzMkMpI0ur+NMErmm2y
# ysQyZdMZKiYGP9/2MH5egXMcLr9WyLUuxhV0ufmZc7IiunlKRezI7ave8bnYxGcz
# nw06P8tWs12trZQmhfWqF8DR7CPI7IoH7egE9QJgU+ZrumOzb7cH8twgP37j0CIO
# IYqJA5a5h8uWN+apMao0a91qAdyaIp0NCMJEHSyNNxGYF1+vw3RL
