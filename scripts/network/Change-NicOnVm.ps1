...
<#
.SYNOPSIS
Changes the network interface attached to an Azure virtual machine.

.DESCRIPTION
This script replaces a specified network interface of an existing Azure virtual machine with another network interface. It performs safety checks, validates resource existence, captures the current VM configuration, creates snapshots of disks, removes the VM, and re-creates it with the updated network interface. The script ensures that any attached resources are set to detach rather than delete and preserves diagnostic configurations, disk attachments, and tags.

.PARAMETER ResourceGroupName
Specifies the name of the resource group containing the virtual machine.

.PARAMETER VmName
Specifies the name of the virtual machine whose network interface will be changed.

.PARAMETER FromNicName
Specifies the name of the existing network interface to be replaced.

.PARAMETER ToNicName
Specifies the name of the new network interface to attach to the virtual machine.

.PARAMETER DiagnosticResourceGroupName
Specifies the resource group name of the diagnostic storage account if it is different from the VM's resource group.

.PARAMETER DiagnosticStorageName
Specifies the name of the diagnostic storage account if needed.

.INPUTS
None. You cannot pipe input to this script.

.OUTPUTS
None. The script outputs status messages and logs the operations to a transcript file.

.EXAMPLE
PS> .\Change-NicOnVm.ps1 -ResourceGroupName "MyResourceGroup" -VmName "MyVM" -FromNicName "OldNic" -ToNicName "NewNic"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDHmKsAOnwZPd0B
# pneV8+pWDKg6Ij+J/87+ICntS7YbwaCCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIFTDRr1W0bDzerri
# Msm2SsvE7WTr1tz9+hvaXbVIbvpwMA0GCSqGSIb3DQEBAQUABIICAJv4z+xPz743
# siuJcTTA00ceRidXsb5Opy7OLvSH2hbQXmXCkdoCB5YSGTr9eblKZQvPhodeeP/k
# u+GmLIPqoAfGOiojxXonaORhbxaDc439t4FdP2K1biCPmvD8eP5qIgPACsGMHsuC
# vdPyLsazKL4SEW/JdNkhRXTIMTwAgnU9JSETRKIA/RZyAy9OXjg+kVNgD+MeU1Q7
# lSLNND8IfJV8qMRlamACdp7+pR12a6re10pkrVuUyRQkuzhsyl4116zsgRdsOPll
# UXHtXbu4EPZ9dkHmIMO3vTdJpcEfZr1kjPl6kpzRIvPfRQR7P/II1gRQQrAYhd5Y
# XYnuAn5JQTvVxBo6BnrEtfBK+dcF9iEDWewbmCm4YMs118OEnDL9IEWEekptUxu9
# B+fo3RAwv00MwvExcyP/5xq3r5dCvOQCms1hsueZny3lk4bNcsVwMykbwYx8JWvu
# 9QqbOAoZ9q/BHZNZwXuMQNq6mVzAsL0ejUIM7Z82PL/K6LbvrAfM1i+z6Ulqq/pS
# n4N9Ch40g4+KnkTf05onQN0AjlUWkNMXYRwXF+09M5D7a6UWCsSRBr8GozPDfJM3
# dOgpB/l8hePPM322o4SiGO4UulfBOkjaViUnhAT5JS7zupJ/lco7ZCYOj5iZV+I+
# YUOFchshlDcx1x6kOh2MBdreSSZVAUQzoYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCDfNW4aDhgL7b6pIZZOjO8diBnM6T0mTs0jKUUjvdJ7tQIUNyMvy+quYfAn
# iu9tFqI6dhFhv3UYDzIwMjYwMjEwMTE0NTA1WjADAgEBoFikVjBUMQswCQYDVQQG
...
# INZ7B2LhuKmhiOazbVRe3mvNVzja6AC22m0HtqyWQdzHMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAgHrS++ENyi8x
# 5pLvSuEvmiOebrfNiYe0K3MdgaPtDvHJ/r4E23IQhdCMkGF5HxjhXw5Ut63VtmK+
# Lh1zQHW/neluAccP6PAinfj6j6zo5qkuYGx1mgBlN6HF5ooYvbkwlLq9l3QvqFzJ
# 8SpwY+qgf9xraMDpgqoO37RNp1umizhva1oIwmxF+jp02BRBj3/JoN/Bvv+8nUo4
# J1w1RkYwfhtCjkCXSG6UY2Q92JXiSPhCXTF4LWa9b5j3tugjkh71yyi4rS5T+G/z
# HqMEBFxm4ATc5PyKulQ9hnfX2lp+zYYFuF3avUFYUH1s0XcCYK9KsTYO7AeCSuL1
# RTHlU85JN2Lowl65ESoQQcEi2FrI0GcYyOGuFubCCuetwAmgqhZy6GCejWF0dmMB
# rb72SYm7wsTiFFo1dA9Qn2O7PjjTtaIgzGB4uZs+pfDM7qM+NwQiSeRdxcP0lc52
# AiQLbcbFZ68o0LeZRajRlwVtqkxCNjSt/QrDx2Ludr8P3/c/Id+E
