...
<#
.SYNOPSIS
Configures and validates the test virtual network environment in Azure, including resource groups, subnets, network security groups, and virtual network peerings between production and test environments.

.DESCRIPTION
The Configure-VirtualNetworksTest.ps1 script automates the setup and validation of Azure virtual network resources for a test environment. It verifies the existence of required Azure resource groups, virtual networks, subnets, and network security groups. If necessary, it creates missing components according to the configuration settings defined in the environment configuration script. The script also ensures resource provider registration and establishes peerings between production and test virtual networks for network connectivity. It generates detailed logs of all operations performed.

.INPUTS
None. The script relies on variables and settings loaded from the Alya environment configuration file (01_ConfigureEnv.ps1).

.OUTPUTS
This script produces no PowerShell objects. It writes log entries to the console and a transcript log file in the Alya logs directory.

.EXAMPLE
PS> .\Configure-VirtualNetworksTest.ps1

Executes the script to configure and verify the Azure test virtual network environment, ensuring all resources and peerings are correctly set up.
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCB+dDILGha/SRSM
# DDcon2PdnfMWuWZgIrWprQ6WZg4yaaCCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEICbpKoq7yoNwQRp/
# RNGcWbC7fNpBwAPs9RJruZWeegymMA0GCSqGSIb3DQEBAQUABIICAFFqcKNgmO0F
# SNipIbSiy8f5zGC8yyev/Oxzvy4KVW8ukQD/kVFgIQVQI56YawaPv3odvtc6Nldw
# NC8HOTThi3hQ+FI2vMo39Npt+ronqoZe047kjESbwj83jY4/LmGpkcoyKKIY38rd
# 1fwPFm8kOlHoBMfzTJ/yDY4zdVoHAx1IqBB7JOTLprB6RceRKrEKh+pcGTp1jE+y
# 9vH28GUklj7lmQOISdPQXUEK0YNnb3ekKAEsncnDJ0Ew8n4emD1jcfCakx/JbNvp
# l8LCSAcsBD/Kljzg8oeNTlu8RwN/c7f6/x1c2OFl7J6Plf8tihxBnPAjzAtf+SSl
# dIMnt2Vzxj49xO5Yae34HeEBELCRS13FNp3ojSDk6qvLRtGPwsH69HFqlDxI+uQm
# MnhI0VzE+Lj2jIU9rw/IKv0ITL9/5kPMlesSC+96WxayuQxTbw6gyqvCd1UioPrk
# wrM0Va+yi1BSbfeerHs4PNxaHXMC29EUiVxzk7KeilaeY/7I72EoNdZwZbQyYAq6
# GCpjtI0Iqs2kZwYjWZpb0f/4jzT89jNUqJ14zB+n2bdf1H/FX5J7tjx8nvA4KoPa
# O036CaxPCc4Hhp8YVGZPkuEuUIVMzr4vR/1g/qcO49jrI2I87h2qhAQYxmkPA9wa
# gcfH+qBDkYCgSII/eQ6qEJLRck3zLYNeoYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCDiJAtFZs9fqn5u7rAMl0wuRQIlRT9YnrzpoWvLviQKJAIUAxwzMQpkUBxD
# qdVilxavnXp9s/8YDzIwMjYwMjA2MTIwNDMzWjADAgEBoFikVjBUMQswCQYDVQQG
...
# IIsl2aGLicR//A2A0sPhA27/sBevvfSY71ZiMHqj48tbMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAazc1SZclWLGm
# HgcMaNLpPGVZB5SMeaFjl2IKihNa1/cwXt5OB4TDkbHWFF5ys0+lLGp51UFsOIK5
# rppQUMhxB5FRkjEy4hS9lHU5WHnH1qcmT2A3OqNFdCUr+cweYgkaayKBavKyK6Gm
# I3qNwBLw9M4hrbzTnri+F6FA7mwkvMJLojgukqhgSIFVX7bRHPYoXonGVcQQNh37
# cckDZKQqGalMH84fRwEyq/Kmoby6pvpPBhZZAUSV5GGKbJnvfb2XGDr7DkllWIKp
# 5yTGs3UnHKGRoXXR43gpgFOVRFLfpe+SeHzo4scpT7uM+zFotk0DNPZYo7APFRl5
# sjXVkEejdhBPAH8xIPLa4uemyBLhtM8+uFw7vNC0GHeFh+ACP0ijK4BgjhgKG3zj
# bd3ssNgEZr8kxxqY6uV0wZF9gv4Ue36/XUVdeonVdJ4lHfI/c30LH3e09EOyQDzI
# vA6uHrYbEct51jhxZF85yD+gbV5zH6pkOUNJqwlglAqHvW014mpA
