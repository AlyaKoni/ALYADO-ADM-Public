...
<#
.SYNOPSIS
Copies DNS records from a source DNS server to Azure DNS zones.

.DESCRIPTION
The Copy-DnsRecords.ps1 script connects to Azure and copies DNS records from a specified DNS server or from the DNS servers of configured domains to the corresponding Azure DNS zones. The script handles multiple record types including A, AAAA, MX, TXT, CNAME, and SRV records, while skipping or reporting on unsupported or sensitive record types such as SOA, NS, RRSIG, and NSEC. It supports copying both the main and additional domains as defined in the Alya Base Configuration.

.PARAMETER fromServer
Specifies the source DNS server from which to copy DNS records. If not provided, the script determines the source DNS server automatically.

.PARAMETER onlyDomain
Restricts execution to a specific domain. If not provided, all configured domains are processed.

.INPUTS
None. You cannot pipe objects to this script.

.OUTPUTS
No objects are returned. The script writes progress and informational messages to the host and logs output to a transcript file.

.EXAMPLE
PS> .\Copy-DnsRecords.ps1 -fromServer "ns1.example.com" -onlyDomain "example.com"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDyuHZZwihHqXae
# hQrI+leHwYkbq0Szr62qYFbU0L5uo6CCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIHQzV/TcUnqagme8
# LvZvU4P1ojLh4KGMtNsOIHX6VKX9MA0GCSqGSIb3DQEBAQUABIICAAotjmlB7dQQ
# mFjazKDaG1px4YUJaTcuwS+NR4KPh7p3MUbYCzbLCi3Em3AxmsbLwj8rB0hTo9OM
# Y+0Q0O8tin9cJ50b+CiFSndf5ozU5au/zLkYwBfO3TvD6i5WVU0cpg5qPyB91FTG
# DQd+06/Vp6Ui9L0CVxArNdJFKyg0+RgBT/2w8TLfpvwCG2gSGP7zYrvE+Q6vOsi4
# 1MQ2nOcm8mArJujXKIXDfoJU+nYAiFHHWx5Bkll5fz6u4a+8NbJgZO4e+3Wp/CBs
# jMzYZ9Ql8SSsUfsE0pAXXWlqHKBRUvENi2a1KQl64ppkeOQdIjbWpbEGANkgmQQ+
# qWbTlZmmaBSxDDNsPzZ66ncCdGAKO6qGE0cWN49pTZ/ZJ2hJp1gll94zwZSWPAeC
# Va2sx3l02uHrE6J8ETg2nkZZesO6opGKwuZkoFc/7uFIuLIcq4mtXavw0gVKEDsJ
# 6YLpzYo9VUMkwjGJZ1xJwgeot5QmHI6rLH8am0FhrSvcgboczaEJ/PeTxXLr3A1t
# oPRg4WRfS6baD5i7xYiYCeBseqa2SytXLaV+NcMNzPTP4tAdYJohIet020Cq8deN
# U57M27dpHpJndVEy296MTfeLyHXlDgwQRYcnU+hGn2dX4innyOxIprHaWVUB1ICg
# mcuddrixTsZRm68Wom24W+x1WCCALp+noYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCATCG2J8Ny80JR4OzyWM0N83/5+Bmggf21zxBN0SYe6LwIUcVBJV7SX170H
# Hn0Wb3tNXoE9XzYYDzIwMjYwMjA2MTIwNDQyWjADAgEBoFikVjBUMQswCQYDVQQG
...
# IA9rBSYP9qH8p5JoK6Gn7NtfWTyZAV26OpXHG5BdfktQMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAZs/1lF7sA7zS
# qwpzyYw1C1fVuVf9wt91UdtfSK8FaEWZTnnWw1ZUGhS9kedSxkluHN7PPfdAcZBJ
# UQNzHxEZDLTiBdxpMCCxPuBbk7HQ68bXnMclSdLGEmonZ6SYPBddxb+Snz+DKVUq
# AwXhzDyBmBltDhuAKhZ7Xhi/CmUc+8QmWygwvm7kbIXWuDqzmGN9wIDbv7q4uJfM
# hm/JU2s7t3/stEKVsRXUHR1bVVXAvTwjCb0MvmgjgYSjI5zwLjafOu4AYlSmPFI1
# NnFpv6MUnmOx8RCPsClpo4ClnsqAPwnsx1HiJdl4O1rX/Eal/kC6cTGNJVJQ/Suh
# abzmZRYAnosFzZxJq0a10wZwPvEokLowFCfXfnHXLollw+NQG4qIm4rGKoayomKZ
# yLRMci+J2xz5w34E5NJmqhWJL8yF7vFfhgECGkRsUWWYNMZP3fNi8MDbFslvVswf
# dWRhA69UcB6AShNAR6KVFBA519+Ip/41jbm0zPbctjJ10802T7QZ
