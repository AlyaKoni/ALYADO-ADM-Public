...
<#
.SYNOPSIS
Removes existing NSG flow logs.

.DESCRIPTION
The Remove-NsgFlowLogs.ps1 script automates the removal of Azure NSG flow logs. It checks for required modules, logs into Azure, ensures the Microsoft.Network provider is registered, and verifies the resource group and NSG flow log configuration. The script removes existing NSG flow logs and ensures the network environment is consistent with defined Alya configuration standards.
...
Write-Host "Network | Remove-NsgFlowLogs | Azure" -ForegroundColor $CommandInfo
...
# Checking existing nsg flow logs
Write-Host "Checking existing nsg flow logs" -ForegroundColor $MenuColor
...
foreach($sub in $subs)
{
    ...
    {
        Write-Host "Processing watcher $($watcher.Name) in resource group $($watcher.ResourceGroupName)"
        ...
        if ($flowLogs -and @($flowLogs).Count -gt 0)
        {
            ...
            {
                $target = $flowLog.TargetResourceId.Split("/", [System.StringSplitOptions]::RemoveEmptyEntries)[6]
                if ($onlyNsgFlowLogs)
                {
                    if ($target -ne "networkSecurityGroups")
                    {
                        continue
                    }
                }
                Write-Warning "  Deleting flow log $($flowLog.Name) on target $($target) in watcher $($watcher.Name)."
                if (-Not $dryRun)
                {
                    Remove-AzNetworkWatcherFlowLog -NetworkWatcher $watcher -Name $flowLog.Name
                }
            }
        }
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCC9O0weV+2qWRmh
# lEK3nMckP+2kWHH0t0OiZGzmiI03N6CCFIswggWiMIIEiqADAgECAhB4AxhCRXCK
...
# KwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIC7Up/99
# eN+iBGswRWvZlvrKfwtL3HBlSEVrqUKUAAURMA0GCSqGSIb3DQEBAQUABIICAINr
# nuCnLG+Wqi3nVhKKrE574H0wJ1T6KFqniiZ0nUpcUtjXl8Udl0fXrdWEzYKFuXHC
# UsvxFDz6yCYPsJ+0DLROhdMzO+otzc8Ms0ynSNtyF07WdC6x6xqqOVup8SbmjNUU
# EAAfwRorYxH42QLSwuFFq+AwqrluJeboXGGMT+RFWNRUqgeS7WxjGUi/h5VAji2G
# tMLAxFO6T3qm6flxavUg++vNIfmzIfyQ9HxWLQjBI8vQCUVz+GKIRJKGjct0pXsj
# wsdsKv0bJpxRtaUPul2fnnI8leQ+7F5tCwKq52KRbjBKphbux8S1AT7BzRertGLk
# yOmV+lHly9D8lFJeG28SHFKSiXSZpIEPdtbMMoj4XL3s0HlVcBlKWmRzeGyLBFLS
# Ijs44tzGNBnePp6xqfUyS8YwPnacIEbt/QAZcG3/6fcHErGMH1dDgyuHmZVM03Te
# ou8mmtv75PF8GfAzRDrGMRw5pJS9qq2pbieFI7Xj3bqpSXhsBlRykM709VNKOJYf
# qVgKm6zEeQ/CSLQTJijGL7fr1fSmM1xFYKOIRqO1l+r4RVUdfIGgwfa7tU+b5KJW
