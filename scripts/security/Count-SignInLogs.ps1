...
<#
.SYNOPSIS
Generates a report of Microsoft Entra ID sign-in logs per user and exports the results into an Excel file.

.DESCRIPTION
The Count-SignInLogs.ps1 script connects to Microsoft Graph and retrieves user sign-in logs. It counts sign-ins per user, including filters for a specific country, and calculates additional statistics such as failed sign-ins and sign-ins within the last day and week. The script exports these counts into an Excel file for further review and analysis. It ensures required modules are installed, logs the process, and supports custom output file paths.

.PARAMETER outputFile
Specifies the path to the Excel file where the output will be saved. Defaults to "$AlyaData\security\SignInCounts.xlsx" if not provided.

.PARAMETER countByCountry
Specifies the country for which specific sign-in counts should be calculated. This parameter is mandatory.

.INPUTS
None. The script does not accept pipeline input.

.OUTPUTS
An Excel file containing user sign-in statistics.

.EXAMPLE
PS> .\Count-SignInLogs.ps1 -countByCountry "Switzerland" -outputFile "C:\Reports\SignInCounts.xlsx"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDW3DVRLda/rmqp
# ZTwaPEZdvxWm7hvuSET+dR9T9SIzPaCCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIP9e5mjS//I9RvkK
# 2Ewn/b2TU/T7rAh2d26FomrzpF9jMA0GCSqGSIb3DQEBAQUABIICAE4tkZAjFUQP
# AvLLukq0tvtFyEMdxmKvFiXwpuFOW+BwOhc85LqlmiNWrqkpmrIQQ0960dWhpkIa
# LOvXf/1RWJftfU0dhFLAhWXVH680JYa/hzfsEzuUvpp1V0v0J6zLBF943VqwyKir
# P2xQgKsY/ISZIyxLH9JMUz30aT2UErgMbeYuKW+Ay418e0Scuiz57f5E8MA6PKiS
# LfXN+UKK6OmGV5UtX+ilM2gM2wC8oVv4KOymPOXaeCXjynaJKYCMbSGGhDQOPzYi
# XfCdf8F6FsdoV3JmGAqQfo5whDCXf3IDu5jqxlTcsYeqh0Cdk0l1FargLKR+FJ6X
# LV3ek9nrHitajgpxBSbB1SgWzvIZRwm9mmyN9bFDUuBtTR5/x3Wb2hLmwwm3tdo8
# hyXJGc7Cr8Bw42SMXYtMMAa/RcbXceBa6taIn+YHw/siISmtK5d2hzcVmkppASq2
# 9BIl2MYGUCTdS3HI45CMQusWSJyMTDSqPbZa182DDeTbHl0E/fFLOGjC0rB0KBwz
# gMZZgR7vG/6n34lu06KZfvfmowELfsoVW3ZsiIQaYCt01zU1pewf086R4fg41lP6
# 7X4zz6E9L6BNok2VQUV6y8Ya9j7Iqu6tDtI6Qvbhm95SWREdfEKdIbra5hAD0Trf
# oAmX4xFpst6hugmCcftZhHLhy5J+wsH4oYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCCiNtQXv8oEywMOwaA8zaFASRqQIBaXjnnG0g6itnxhtwIUHna8qdsgc4tR
# L0UMTH6h+d+ttCYYDzIwMjYwMjEwMTE0ODIxWjADAgEBoFikVjBUMQswCQYDVQQG
...
# IPyxSr/9R6zcSwuDf+ElPxl4IfDGTaZ8Z0SO1SMJSgbAMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAXRgaqTClSKGq
# qkZ93KkOelpidEWSavEcGVnoJb0fRh7Vq4nRvW2wlfLXYod5F1IrmQ7n4bYndNOi
# mbZ9bJDJiwEzoy+/I9YOKIgBBNB9pSny8CpabgUVktgCZ3kJZRdlSurTqZxeDtFY
# X8dXLUnWvTPqLjVsFOV2SVqkp+PeJFEwzOLfDN0tEdbxIr3Tsq7tIVDKsmzUrWlN
# kKwgs2kf55j2W7THmLuj4WYNcC9UgJphC0Chf7eug4oeMX9cItzs9YVpje67xnir
# Y+B+MF4iBcbeT0VyaH3wLGkwh/OKOsq7KjcY3YgkwnI2pT4QBvyrQ+9YCA9mX5FB
# 11PIwajXiO63Qti5fC+NaIHMhpUYela5HOoK73cVw0WQnqg261ZypgP69Dqiw71o
# pr7YtnkbXSGgpKgmEHBIKmg0eJcOjSN/NOkpB3gAZjx152UX48DjriQ7emantPV4
# ZGohEaKC0mgmUwFEzegGsvzz+Yv0Szq1sDV6cE/OtTf7Seqji1eE
