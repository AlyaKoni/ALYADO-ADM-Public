...
<#
.SYNOPSIS
Configures and enforces banned password settings in Microsoft 365 via Microsoft Graph.

.DESCRIPTION
The Set-BannedPasswords.ps1 script connects to Microsoft Graph and updates the “Password Rule Settings” directory configuration to enable banned password policies and apply a custom list of banned passwords. It ensures the necessary PowerShell modules are installed, reads the password list from the specified file (or a default location), and dynamically adds company-related terms to the banned password list to strengthen password protection.

.PARAMETER bannedPasswordFile
Specifies the path to the custom banned password file. If not provided, defaults to "$AlyaScripts\security\CustomBannedPasswordList.txt".

.INPUTS
None. The script does not accept pipeline input.

.OUTPUTS
None. The script writes progress and informational messages to the console and logs actions to a transcript file.

.EXAMPLE
PS> .\Set-BannedPasswords.ps1 -bannedPasswordFile "C:\Scripts\Security\MyCustomBannedPasswords.txt"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAgtShPYAdZk5cz
# y4we4DHIbeM+ytOjX3AsPoEtUN+OeaCCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIEsgVF1+lKHgkIsa
# NGQfByrL+A18eqhaZqyWB2D+8ngyMA0GCSqGSIb3DQEBAQUABIICAJcDKHpEw+Lw
# 8Utjg69IwuG54MpmG5JusM3bDmC7ZZyN1Xvfs27MBQshvWFP4elMBYEd9V1h0QIy
# 1AnUWAMy/UXVSM22C7ght44nV4MPjT33wCW7HPdReW8OHQj/OiiDsVso6QieHRee
# 552q5g/2nXpVdP9O2/jPqWtb405jwUoS1ZGoLwhojh3Tg84l/uBHxWa5gpqDb0dR
# QWi0RPTWr0PF3gq2pHKUVDs8W6P822/jhXBHXG/NnTm3c/6QB87eJ0qhHP7jNBbH
# QLFiRRjV4LZCeIlCMNOP4azgaUOam3jVVECxjsH9DgAuHeeyx1U5ixXQQheLAN1s
# IQORPkmlD9AJi9KYDiCIX5g2Pj8hxrkElMcxARN2Q83LqrSh7zxXdGgEClYCQu98
# GGnO3PI+Nx4fUcKJVvy9T82f+A2hAZbItm4bnoif3ypV1WrtAzQMTvjM8xFzza1h
# SE8FKFTIHDYeSH7vMv/r4Fdn+s3U+kQg6AiknUlQTW25e9BB0Q4VCS/4DYNi1QXb
# rj9wvviZAztq914YH8+sKIjudPVpooiRvOp7afD8VMscEmvrCHkBUNkTQn8Q7STV
# YGAOaMA2njEBqqPu3Insy/DvGZEkAZ/FZ+XVI82pGEvCrpOK6gr96F6qNn9sA6Ks
# UITMOlooWIgSuEm7SlOu9tjekmDMsTVdoYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCCjhlqMkGrwsDLKFdgYnVOD/Swd/029clis0E2/0ZQfkQIUENe93sdZupvw
# dzKIZ7qOSujbINEYDzIwMjYwMjA2MTIxMDE2WjADAgEBoFikVjBUMQswCQYDVQQG
...
# IKtAzZlg6pecXPGsoGp7PlD/I/bjMyEWH0aNmz6p05FlMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGACJOH1+XNZA9b
# aTO45YEx57+6qCGgwqkqjzGkng7gv4cC7TeTtGlSlrJFnqjKNe71MZbcppk4lwqq
# h92wW5OHsXh+lHHJXMWYFWi8NMSQsZG/2gc+wgbFavyIgX1Ym9cjIdR4DSjEK1OG
# 8vr3u56sku/3sJ0V5yKiXE/peiuuNusmK6gZhLswkRylFFVoyG5IenmIaYBCgj3Y
# 2VUNchiGYF7Q1lcDtTTTLiFTK0cO2TizKJQQhh8oZS9PSv34rybCjQM8auhaaGJm
# K0EtT4QTuS3l36+CpxgyP/B6OEaj5nUS9bUIHsY8/Ek1Do4419hIOz0rrscgMAQQ
# FFTyyhXwFF8jMUmbWJqxe0c/hQUhbG/KgIHuOMH787nNR/FNcfaDOP4lUOBSYylw
# bbQ/SI6Zn/yWwGtgUplPvztr4vuSfmNsmsYu3ZfSn/RHi54oVF22DDKlBRI9WjPu
# jgLAYyKv5lT59nkz93ue1ZvnyW4FMiHkQOyqNJPCoARrPbeTmC2V
