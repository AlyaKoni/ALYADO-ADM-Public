...
<#
.SYNOPSIS
Configures and manages Azure AD Conditional Access Policies using Microsoft Graph PowerShell modules.

.DESCRIPTION
The Set-ConditionalAccessPolicies.ps1 script automates the configuration, creation, and update of Azure AD Conditional Access Policies in a tenant according to the Alya Consulting base configuration standards. It connects to Microsoft Graph, retrieves existing conditional access policies, and applies rules for MFA enforcement, device compliance, session control, and authentication strength. The script also handles inclusion and exclusion of specific user groups, roles, and applications. It supports report-only mode and can optionally update existing policies. Additionally, it checks for required modules, disables Microsoft-managed policies, and ensures security defaults are turned off.

.PARAMETER ReportOnly
Specifies whether the policies should be created in report-only mode. If set to $true, policies are enabled for reporting but not enforced. Default is $true.

.PARAMETER UpdateExistingPolicies
Specifies whether existing conditional access policies should be updated. If set to $true, any existing policies will be updated with the current configuration. Default is $false.

.INPUTS
None. The script does not accept pipeline input.

.OUTPUTS
None. The script writes progress and status information to the console and generates a log file.

.EXAMPLE
PS> .\Set-ConditionalAccessPolicies.ps1 -ReportOnly $false -UpdateExistingPolicies $true
...
if ($HasEntraIdP2Enabled -eq $true)
{
    ...
    $policyObj = $ActPolicies | Where-Object { $_.DisplayName -eq "RISK: SSPR on risky sign-ins" }
    if (-Not $policyObj)
    {
        Write-Warning "Conditional access policy not found. Creating the policy 'RISK: SSPR on risky sign-ins'"
        $policyObj = & $NewMgCAP `
            -DisplayName "RISK: SSPR on risky sign-ins" `
            -State $procState `
            -Conditions $conditions `
            -SessionControls $sessioncontrols
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAKNWIFLLmO/2hu
# x3pk59VSreGF1SSqPFry0niPmMQ+LKCCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIAOEsrgPijIethcS
# heiPRYsGD871t0nS/T8W8T5piKpQMA0GCSqGSIb3DQEBAQUABIICABzMiFG544Yi
# ab0aGyzKXEiSgrlOS/dlIJ5Gap7ilBuMZbNtNwc56gtm2Pvu5zEOtGIJlqnVIfCA
# 3EaaD+KWCmVDOrwfhwB6KDmUf5eja16LJeKbiDuo3Fs9QJQ/3d8ZMmYkXEqXYLFm
# 2z9v1RBopP5nmIW/72U4hbEgbMJ2QG3pxApWl4tmOVO7Tv5a5EVC2hBLhgGlN63p
# mKZDwYwf+AdupgLnWqFNv4E5SlyIumNyKUfpXuUx5ExhzmIpfUvzku5VCLhqkhmB
# 8uW7a4L6Nq9aTPk1pQimeQWRUsrQmr521VL8wyta1ogr2hoRlz69TaYZRK76cJ7w
# bTBA8Lt3f4G6NPbzE0wd9y9MJlwy7B2p7cwoceBL953AwyZrnl5p2XOOpqJTw6Sj
# dK4bOhV4UtYjqn6kUjVwthyo/dx9hL2iH6Ikzl/FAgnEt9T4zSLkcr0NroVpU6W7
# Lw1el0pTyyGcHDYMFGCJOkcggQ1dmhqWw5ffp6mPGYodBCIUC6HhiT79ELq4B660
# ZTO8mlSQ1CgZI14dftbzzKWApg2vl/qPyQ97pSfOrvA5FjoPELlsmEokZQU/enw8
# Hp6xylnHPleYZO7ZlGNY8AdNBUR4tPddoGR8s8/WGY+bSCtC7xsyjCd1ns8Ocj8F
# mmiEG6X71bNy1iJh3kP+jshHUG9xH+yKoYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCCLx1nVcC/gfy/Oj3kOARBnTPibsjg0PNZndYn2+uyzgQIUfcfkobcUxYHk
# XD/3MpnjsOR612gYDzIwMjYwMjEwMTE0OTIyWjADAgEBoFikVjBUMQswCQYDVQQG
...
# IA+ezJB0MOwZfGi89TZQwzYEb2gxDOfrrPd6dh/pmCjhMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAklWRUmPGLLZG
# m5aepzRoQ3N1iXK0RY9JxKRi2mz4iOiImUxR/X4lOAwAPGalekWXifMg19Myyq78
# fSs6RI2Usox0DW5+Q4bFfUQNe4t3JrSKIp1FOVzYwo3qPk5X/LB3a3VI8ghi+dJw
# wBH1FF4ZgrnR5FrcDjXBn/bhUIa5iP8Pvgy3IUC7Lz7tFYqsDIScis2fVwjilUAq
# 9aiZ2xny6rufPQ6Nor4yoII4yPMYKjOELDaGfkf6Pj0i7gAfcRNLLz0BaTGg431+
# +qT9W5sEVCd7hfatKxVyMu0yt69CfQUgAKO010QOlj6q/IEXIWsJYq1yqY7Xd1+A
# DUgyKqy9wZWS9uvRXXkUIiNhYYs8JkVh/PHzqusvS/xKXf3eVuSjROKAJZX9cOqW
# VYtn0Ik1ISwIC+N1zvoqQd+3ir2IVlP2szGHbmFEqeQVh6N9qe7nvZjDePPNYd8b
# WccaBitK5+KZr16wNsbrOFNGqUTHpasWQGx4viRj9oB9EPuGKpeJ
