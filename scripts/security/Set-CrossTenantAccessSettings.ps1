...
<#
.SYNOPSIS
Configures and updates cross-tenant access settings in Microsoft Entra ID for trusted partner tenants based on predefined configuration settings.

.DESCRIPTION
The Set-CrossTenantAccessSettings.ps1 script reads tenant configuration settings and applies cross-tenant access policies in Microsoft Entra ID (Azure AD) using Microsoft Graph Beta API. It ensures proper module installation, authentication, and applies settings for collaboration, direct connect, MFA, and other access control parameters. The script logs all activities and provides warnings when certain configurations need manual updates due to API limitations.

.INPUTS
None. Tenant configuration data is read from the environment configuration file.

.OUTPUTS
Generates a log file with detailed information about the cross-tenant access configuration process.

.EXAMPLE
PS> .\Set-CrossTenantAccessSettings.ps1
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAi1t28uMz/Im53
# HJm9LxnbcEjtYXEcuLFG2jUnkRJlMaCCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIEOLYlkNaTeoV7zv
# gUDh6KhxunAB7HqZ4j7yzd1OWG1vMA0GCSqGSIb3DQEBAQUABIICAIGmDG8s5kJC
# utqUiCgNAyJ7XDOqj/Ao4giA8bcOahxQYatlJRG5/fYcgmijyuTXKRKfTdHExHUO
# Z0M4J/wVMjC1MEAwLfIowmWdwp6lc7/fTf2SameguiLbhPForva8lU7FvMsLoBQo
# eyj0e7FVcv9F6TJuZ8TLD0hnU9qAaMeXpLGhAhhof3H38As8pZJv7NZwcvgsyWZF
# 8Op5NiH87zzwaOW8OkSalo0un6/5RQUgC/qIe21WWvG5qlUw7pTSSEvCcGzuQGqJ
# PUdWrfGz0LMX99BjbQ50jKIUXz0gmyNmtNBQvJg1AbS6QCoe+KpcOoaI+sD32s5P
# jlTBWYWPGum8KXTA1mXgsma81BEcpApUY5CAQxfB3xJJtr4N2ALlsQRTPipyzTRe
# mnAPBlk0PUFRa5vYmvtjJuXBh8NFkaK16iV9XBRxlwyQu50HnHoY+4A++Vd8+7dB
# cDeezhmLsmWT4kyyMSLWQBMjVgLK122o2CB/uZnStkQiS+uIsVZZLekkFx4vpy38
# Np1P5Q59g2iyFAqdc5yQqM8NrAGAVlAZGvRRiDWKylSJqNd1+zF55eRr+Ls3xCsg
# j8Wqg504IXmPdP1ipA26IS8Gl/Gdi62CILawVoa7xD59+Xz+I4FxB1VTfecJqNfd
# oqmks2qvUr8m4+ePoVWwS2tw7kTc2j1WoYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCDB2PsFAEq8jk4F85TYepzRLwvNtMMdyJAUPTyPY7GogAIUP429cydA6TH0
# HDDNyDIMPaUoKA4YDzIwMjYwMjA2MTIxMDI1WjADAgEBoFikVjBUMQswCQYDVQQG
...
# INRyh0Jvf27Z1HJ5+79DyJwrWMQONXZWC1PpgJAT0IuDMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAUVFALW3UmoTy
# hh8aqRomOVkr/+ZRNQlw8JVl1i3lhNB5joVBmw+7Cw+VFLLhF0U4dFGL6t++/Pus
# FmUQGpj/rjrgdUWZFiErpfQqhpb9sUWkk5OaBsDMSNr1koyW+vRi9twNvnz+GpKp
# UKSzrxTW5vB/n9SSH9qT2vdMn9y/yXciKB7MJ+SYP6xhZAL0Vk1a47QISDT10teg
# TRDDnrvlydbj/Lb/Vi2+3i0IOEgLPBlWK3Ep7IdFQn10/A/KAeA8cBQdruIEgoiI
# rTadh6uvSfcmyL1Tg/bpdyMESKfbvN2TifiF4Px8WA9WhyIwIxtR1ayog4plRS/G
# ic7JWK1BNjtssHeP6tXpzTN/uXnuOgEWMKWFK1+eY+/SphQ0K8LApF+szBwLq+WZ
# Zgex4e7pFg/3sPCsFc0waOtyXZjwyM2uSOrvwqT1bxDYP9b7KNI1B2Wg5Tp7BVTl
# lERaXux3AQ/P0Kqk/A/G/ADaCvyn8FExYGzV8l3diEsgcD/Hfo8L
