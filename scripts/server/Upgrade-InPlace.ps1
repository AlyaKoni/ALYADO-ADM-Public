...
<#
.SYNOPSIS
Performs an in-place upgrade of a Windows Server to Windows Server 2022, including system validation, reporting, Active Directory handling, and Defender for Endpoint management.

.DESCRIPTION
The Upgrade-InPlace.ps1 script supports an automated and validated in-place upgrade path for Windows Server installations to Windows Server 2022. It gathers pre-upgrade system and environment data, performs health checks, prepares upgrade prerequisites, and initiates the OS setup process. The script can also reattach to a previous report directory for continuation after a reboot and restore critical post-upgrade configurations such as Active Directory FSMO roles and Defender for Endpoint. The script logs all activities and progress in report directories on a shared path.

.PARAMETER GatterOnly
Indicates that the script should only gather system information and health data, without initiating the upgrade process.

.PARAMETER ReattachToReportsDir
Specifies an existing report directory to reattach to, usually after a reboot or continuation of the upgrade process.

.PARAMETER ProceedAlways
Forces the script to continue even if health checks fail. Use with caution.

.INPUTS
None. The script does not accept pipeline input.

.OUTPUTS
Creates a structured report directory containing system information, health checks, and upgrade logs.

.EXAMPLE
PS> .\Upgrade-InPlace.ps1 -GatterOnly
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCA9Itg/FCmQJJVx
# sDg38YlR3URu4337n3xP507RDwACpqCCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIJAthbaADUAALGj3
# jhDUICfODSpNAwm05PEEx5uH/4ZGMA0GCSqGSIb3DQEBAQUABIICAHe6kydAKPw2
# ay/0wkinqTcQQGCAFIh+Lu31t62sUaWwRI1bUsvHdXsootajstfcrWI1qvcbcfXY
# RlXlMAfC+kHVP/cf5INOEp9PFH8m9NFAZMnA9WE4spOSLvJJ4gHUhGjh1yOSAY4U
# atYzSNoozTFx9h5T0G8bFHY657LJw7wg9xjBYNki/zwqg3ERBpNq7X8fWyYiKujj
# 19VHhh2jqJiLlavQu92wD431OvupY1CYhHfMJQp2lRcNQL/N8d/1zh1P31oOmCR8
# W3xrfN/rUSBaB3jSV7zDKDlO1t/m3nDMaBGoLVU4fGqJQkTJsKtZzut5n7C/PTZa
# hkJkXJ5bzIeCb1UsWx48trPxpVoP4UF17279CPjmU+MI2UR9XVXpOanPGARtR19C
# lzPNrgGLoziRBd/9wCN+zX6kqPz4URF7+UgbrC2MTbJX1dNEBNe+MvnFQKuyXj/n
# mxI+dvpgxvDRzUC8vF58igRX5Ct+gKikvV4DKK/v7PwyVb5p+CCILVTrY0FOS6Wm
# cMYK7H+GE/ePe0q40EnbvzzJMzy736q7cvBM1ZnQuQnznvyt53igNxSC1qvINLPC
# Y5659y22EK+BvJLEsA93tQCWEsRt4x+EPautRIkkAO8MuPXUJZ4mu0z5zf40pD2H
# 0cG3ik/5Wef2Cf/6TA5DiI0E3HR2gVbaoYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCAYA0G9XXbrBUTc6FYKbws+ABx3c1MgIzyWt9aHWidjBgIUGrKhu7ld6avq
# y3V/V4DUXU3F2IgYDzIwMjYwMjEwMTE0OTU3WjADAgEBoFikVjBUMQswCQYDVQQG
...
# IO6LLzNG8d4nP5rUbQPJP5bCe/sI32p1eCBpYCj1IKyzMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAmvHmpW/AbzrX
# bIMm6XYrZqb/Si9mwPUwMzcwBBR4Bm0bb/pfcCrpgvaQvUIasiHS6rAjrOkGYPll
# IPoHquwhj9GYmDM7I3CuOVsOsj8hCBGc7UCOoNnV0pRexXPeXW0dQjVLKzZAMLs5
# dz/FIRuKz9eDZ6eEP9oSA4/gMwricYuAjZPJOfi1ppiMyvDbXV74EmRq7MKFqtzj
# 9wzvNWBl9Zl+r8HhVAlplpRrG9EpGYQDR760mxhnxogJcRHCA174iprsEew8ynK0
# aju1oypZAbF1FqKp6UeF2osc6aiv4aMnY3gFPAkPBiUBNEW1ZsvJSyVtwri1nQru
# Qng7w8Xf/eu7CYZjZ1xEHR/2YZt4gtkxfRsH9s5ScQmP/Yj+PumvEOzyFgwZr8Is
# PG5y89hEvnvaU/o7sWBNDhnw7/9B2KgLbPlopJIm5Z1kvESPcpgr3oQwHjftdpB9
# weUsTke25OoOkT9AscaK2grj1QfcC2bYIiQCKoB0VGiKklV67DP2
