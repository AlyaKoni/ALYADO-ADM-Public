...
<#
.SYNOPSIS
Analyses local directories for SharePoint and OneDrive migration readiness by checking file and folder constraints and generating reports.

.DESCRIPTION
The Analyse-Dir4Migration.ps1 script inspects selected directories and evaluates their contents against SharePoint and OneDrive restrictions, such as file path lengths, invalid characters, and file size limits. It produces detailed CSV and Excel reports summarizing directories, files, errors, and file types to assist in migration planning. The script compiles a helper .NET class for performance and detailed file system access and requires administrative privileges for execution.

.PARAMETER directoriesToAnalyse
Specifies one or more local directory paths to be analysed for migration compliance.

.PARAMETER urlsToDocLibs
Defines the corresponding SharePoint document library URLs for each directory being analysed.

.PARAMETER maxOneDriveSyncPath
Represents a typical OneDrive synchronization path used to calculate potential OneDrive path length limitations.

.PARAMETER delemitter
Defines the delimiter character used when generating CSV output files.

.INPUTS
None. The script does not take pipeline input.

.OUTPUTS
Generates Excel and CSV files that summarize migration analysis results for files, directories, errors, and file types.

.EXAMPLE
PS> .\Analyse-Dir4Migration.ps1 -directoriesToAnalyse "C:\Data\Project" -urlsToDocLibs "sites/ProjectDocs/Freigegebene Dokumente" -maxOneDriveSyncPath "C:\Users\John.Doe\OneDrive - Company\ProjectDocs" -delemitter ","
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDsvjZlaFkW/3zk
# +jw1qxor9hQAdYn4Mb0TgmP4qa1rV6CCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIJV8ghDFrqJMpe7Q
# FXvlqgac0t9CLvCAFpdZpvROCnVhMA0GCSqGSIb3DQEBAQUABIICACm8HORoY0k6
# XJY61SKpf4LoeiD8PHN2/F4Vqmto9N5k56ugHK4EzARisIswLfrk4E+eWK2jiS0O
# ipGq26+bdtCKbCXDUDNxg7ZGo9OTC7zJRrG5SUvIWgVSWh2K3ELgNElxiopJZzdF
# ot42ckJGvcOKqtR2Q+hDSiXA7dQ8lfDyeVA6XwUpFolqiJc1IUQ7LcOCY80fyTSl
# Yru0uB+MwGnBDgYXrh2QmCFU0OT1BFeix5L26nuLmXwcb0f/SQ1bMDKBWchhn3Rr
# ZTlV/BwHfr/JmDT6X+aRw26Qg4jncmAW/MJgbxBO+rKsayqsFmbN2CKicUQDGrVP
# Oe/6yAd9fodUxXSnnsC4WeN/A0wKBkI4SNNuG0qVvyzgXzOhJ6Jp1RZqMe9YR0f8
# 02w/WDllqrN02c2RZomJkx8GbWegde7zVpf0+leocTb9BwuQg+XS0gyX+oJCbS7p
# 67km/dd+W/vNvlv0PGX9Vit64LOXqwIaWp6gkroHcUq2dl8jhqvJk980QlsAT0FB
# Y0PODWShx6oCYAxdsDwP/7gKGTem95KYMXLMXhnCDo0mmQq40RZyIbFRQwJ9Wwjp
# 33+qHY51MIRtl4x2GIdMURXV16Y8X3l2kql26s+xmcrRM5RIJfEy6+Qpxgor1bWT
# 0M4VOj99WdGyJz/pQ0lN6V3Dk61Oe0WaoYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCB7nZ/4XqeEdwc007kXL5hlEIaFBRVTpGsvpOIdYq19swIUQQ1PAL17aJdG
# qLxXsVGNmGGi6MwYDzIwMjYwMjEwMTE1MTM4WjADAgEBoFikVjBUMQswCQYDVQQG
...
# IGzM49+F8e63fJMY7gvNcfYeMCqUB/9Dsjx7xn60ATTUMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAKLH05w92cs6h
# 8vznIoje27/SucCejsgKdeDfc8aVyhuaZ/JohxrCmba/kAnNXFF9rsXfE74kb+NA
# lfUM+Qm94Bl0pNZJ84R4a9urvjwuGQDQDa1k57yo2//MZIkJN3Co2BbkF7ABwQ4W
# u/BmWQyFfYGSBPU/gesjQQDicvJI+CTUwrRcjH+68tRWX+gzgswKo7uQcmahEBiX
# jvPl+z/dLGRxwho3wwSFhgUmWQ5UqbjrQS5SWDb/Z7MBFvKp4/mYfy0ucVngqwQc
# 7uKA6LCm3ashWB2AoDF1V81mNZwaAW3xFb3DlTnakFJ0SXlJ1M5XHMG99LWK6lim
# lGWIChRzf0lrbTRci4AjSy6ipfpEjY0qxxD7/02v7cK//9ewrtaKeFTk6mvF8JWF
# gooc6DjWQobAGrId9T2jy/6yCSnck2eTwg2jDdPltG0M0mmWHgwoHTOdaIjjoqDs
# 4Iray935Rdh8q9EF59Ajw8JHqPImuo+XvgBsQpEuAr5Gpu5YelfK
