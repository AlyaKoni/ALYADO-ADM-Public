...
<#
.SYNOPSIS
Creates a full backup of all SharePoint Online site collections using the PnP.PowerShell module, exporting metadata and files to a designated backup location.

.DESCRIPTION
The Backup-AllSites.ps1 script connects to a SharePoint Online tenant, enumerates all site collections, and exports their structure, metadata, lists, and files. It supports two export modes: Fast, which uses REST API calls for lightweight exports, and Detailed, which gathers in-depth information through PnP client objects. The script ensures required modules are installed, validates certificates, and handles retries for robustness. All backup data including metadata and file versions is saved in local directories. The process is transcribed for logging and auditing purposes.

.PARAMETER backupLocation
Specifies the directory where the SharePoint backup will be stored. Defaults to "C:\Temp\Backup". If not provided, it falls back to "$($AlyaData)\sharepoint\Backup".

.PARAMETER exportMode
Determines the level of backup detail. Acceptable values are "Fast" for quick backups using REST API or "Detailed" for comprehensive exports using full client object traversal. Defaults to "Fast".

.INPUTS
None. The script does not accept pipeline input.

.OUTPUTS
A directory structure containing metadata and files for each SharePoint site collection, including JSON files describing the exported entities.

.EXAMPLE
PS> .\Backup-AllSites.ps1 -backupLocation "D:\SharePointBackups" -exportMode "Detailed"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCA6qKwLHofZgcMH
# 9TrfWk4hI5zoe+SvL8XhifyGriCnTKCCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIHtFmJ4ZsCDxTpaK
# erPHLy8dnHgLygH19eenfv7NCgXFMA0GCSqGSIb3DQEBAQUABIICAAL2P7lMk8Vr
# W8txjkxMibkGAw6x2wA+D/MMDWbfjiEQmqQZNAn7DcRVJz98MAXFugL9CzYe8D0l
# sNbcvZJo0aFiB5lR/abGnox8zALv9cJ2TxtRC+jACpQ3SFrmyF3UlHLdZF+552+E
# CqZGXbIzEWuEQDgpe/vyyuXJixFfWOkvk8wwbKizVbuQZ+pruzliL5JhVQTGmo8w
# HOqYlcYeEPIiROGFqEegF7MHqTdf1Ycn+fbYeVV5oRdvjDa+MM47t5NbkslR4ltn
# Hj6OOM+e8iP4iFcCxpvsp3fb4JcI+V+eLCWqWfd8D0QQc0SBPpNR90ZYiOehIwgj
# 6StK8+aAZKx7nnyOh/q6v1mEJknlt1DftExV595E6qGBtqmKp62bERGenjzkDXmZ
# HKDMZR7T7ID12YQCzR0GSyo78qKR0U7XS/UkiR5mXQZIFLJCA2soXbM80bHZZKrr
# wFxCFDTyr0K8APyMbELdR1n6Ow/Qhm92LWSCxh61H9yBhF1D3x7tT+PbS0w/18OA
# lCFQXl/4n/DRXwxwK+/9t0xVtrU6fh1UNTT/vdWhWLA+6XBSy8UEzvNydB364EDO
# CgfCNvGodBGcWZWTOjpD+M4E52vs85vNWbb4ae2bWgHXKFT+it0dqNw17WzUyugv
# 7FR/DGX2a30gBG4UCXPu6SXLayG9WxcioYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCARK1k10N+U6CFQaDrZrIBuDABeQJhqXm/bQHj+MXwOEwIUYvTuwMDrFsaK
# 8Hh+3F4DIsSm7nIYDzIwMjYwMjEwMTE1MTQ1WjADAgEBoFikVjBUMQswCQYDVQQG
...
# IMLvqe+2RxnfVNTHWGWZPUKvl8TOW0hH4fbiGmXfjehmMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAK2ZYSQy8Gfni
# 2j1QZb9YI3NZp2syxlIIF2OSHLH5XFUjLf8EWdQZPCs4dIkR7vQgXhxnMk9YMMmB
# 1MBzk7I0xdL43kArbaOO3kF3kNIVjbOr8B6aDHH7xd6hfrLsKKKgCU/1l8CRAJ1w
# peGndGbU6UQrL+QlAQkY7pvT2FzjvJfTyeIKv2wnkUb0Xcwog0wvlTifg2C+lN7U
# ROSkseZ/U4dQWocTBMlWeTj+Q/uMdaKPhDxJDqKTU1amRAGYVXojbvNhkixoKXpy
# cyl70cCs0TfkrCsxdWCeVTMnlXz7HRMzxo1IkeiMwBF5vuqHPfRxFdFg6ur/QUCh
# gA2YW9pB84JK6sZG+oem7wdB7LQbT43K8+IxDbWAtDsQOT5w2CU5SbVC8ZkKnIFl
# rqeARYJCdeMGvxAkSzX9Eb7urGhdQ0K5ptn/pAYqi1ujwl7vEx8dPbQBpt9pxCb5
# UxrDFpi4iiME0EPtHo8El+mwI7vkg/MvoHjlahyofpAa/cVoCAtl
