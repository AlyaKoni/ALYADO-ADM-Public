...
<#
.SYNOPSIS
Configures the SharePoint Service Application and its related Azure resources, including Key Vault and Azure AD application.

.DESCRIPTION
The Configure-ServiceApplication.ps1 script automates the setup and configuration of a SharePoint Service Application environment in Azure. It validates and prepares Azure components such as the resource group and Key Vault, ensures required PowerShell modules are installed, authenticates to Azure and Microsoft Graph, and verifies or creates the required certificates and Azure AD applications. The script manages permissions, assigns roles, handles self-signed certificates, and logs all actions during execution.

.INPUTS
None. The script reads its configuration from the environment variables initialized by 01_ConfigureEnv.ps1.

.OUTPUTS
The script produces log output and writes configuration details such as the created or validated client ID and certificate thumbprint to the console.

.EXAMPLE
PS> .\Configure-ServiceApplication.ps1
...
$AzureCertifcateAssetName = "$($AlyaCompanyNameShortM365)SharePointRunAsCertificate"
...
$applicationName = "$($AlyaCompanyNameShortM365)SharePointRunAsApp"
...
if (-Not $AzAdApplication)
{
    ...
    {
        $AzAdApplication = Get-AzADApplication -DisplayName $applicationName -ErrorAction SilentlyContinue
        if (-Not $AzAdApplication.Id)
        {
            Start-Sleep -Seconds 10
        }
    } while (-Not $AzAdApplication)
...
{
    $AzAdServicePrincipal = Get-AzADServicePrincipal -DisplayName $applicationName | Where-Object { $_.AppId -eq $AzAdApplication.AppId }
}

$AlyaSharePointAppId = $AzAdServicePrincipal.AppId
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBDPoT5KOvY/O6p
# b5MJ/rrrnsZkbtfTmVE4wms+ZyZhQKCCFIswggWiMIIEiqADAgECAhB4AxhCRXCK
...
# KwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIL5ogJhV
# p7WSnFRZj95jYd6YEM/k8lCgzcwnJXNs8jLBMA0GCSqGSIb3DQEBAQUABIICAEvO
# ONcKXVK+bRcaxDVQ99lPbUyVuFnCzj4QG9PpmxJcexWnVRM92UvkivRWFNBKjAqY
# OjTC4A8affkhEvAIf/eYrroLuNhJfJIKf3YihK4pwQJCBRRj9hVrDT50lzjoFtHG
# jrZvPWc2wt3sCwcI4b/O2sLiJ95uTOIA3uHVQpnDmp1ABo1i0RzsOGa4TOXDN5iY
# 8CiRt1iatCGvrT0X0QLELB/ogbOmyvjMVTcdEyEvCyi3ll3vzwgVSwpSFbpPDgvo
# kCIsqRILKXorpCnwiJoa5vbzSgDyA8CAWLjyJH72Is8kvrzYCv97p/euyL2DrmG3
# OORnA8571e1k7CQT8wuSmMGxfFzkVY9YX28ltvTHZkHvA8yBKpJADi1waNv16OKU
# GjX+46NIbkKkcFbsOTUfXjb3mmlRiNuny926lWRHruyWrdvw2jbFKxK+77tkQv4O
# aahj3VP0D6/UhvaG78XvdME+/A7gngGzV+wW78rY9uVBR1LVsSaOwOMWcqiGOa47
# kg3XaTSjTMeYLaCvo3FuwlApWFOlkqbDRjfA8KI85QZadCL5EntXpLRDWXbdJK7V
# SLzsUyOanT9O92/WrBTqiQ7fQ3CCv0+4OKkdzTOD2zqm3hiD4s+fGEa9rGwYnAw8
# NaaYvg09dc69s3/f8RVRKxr8D+T7v5Jt+yyiRCxjoYIWuzCCFrcGCisGAQQBgjcD
...
# SAFlAwQCAQUABCDvUJVnVaS8n63+kMaMChxq3HnF+0fAsjARZ8fsTzuqEQIUYImN
# WMUA/WvIcr1KFvFeDi6cQ3YYDzIwMjYwMjEyMjAzNDIwWjADAgEBoFikVjBUMQsw
...
# AQkEMSIEIMSgNiDmaaLnL0MILKn0yok1g34VVblBnYvAC3aoMRywMIGwBgsqhkiG
...
# Mzg0IC0gRzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAFP8Y
# s8YEWz9CPPQblUreB71LG0LBbf8apDSE0lLCtv2lMVIIzUTTgrVP5fn0Mowkqy5Z
# Ifv5IttNMtZlUNFddPfupffSg/c962L33t34ISK88S8hk34dBWkHOhWqtBPHDzdl
# xHtVpquD+b0lF6XjqQ/HFeZ3F8yKQorsJmgu9rRfVvNQmGFUaCTpDofZaAByjF97
# HBZ3JHERX/lurBsfkO6jTUauSGksQmTm+aBlOCUcTsA+7QdIHIMRXHRaZyIvW0hu
# 07wh8zbn3EAXqDbIS0F18ryH4GqfKjQhrmS6yz4toqtHg6dZ1dS/1QPFXrCsgsPm
# ASsuZ8Vg4uAG9yW90I7iRvv+jaDWHY/Xtx1i6eLj1KYq8V6DICw5/jkVASviriX4
# 4kEoWKrskKqFvsmSf8Zv8f4NvaZB4BK4MSMHTIT4xvndk5kdOMRI8/URt2Xx08lR
# FCNyKXtNP+1ip6MOTkYbF6nI6w7YMIzK11gR3S4Gol6ylGuSYmLzmhF4W5Tq
