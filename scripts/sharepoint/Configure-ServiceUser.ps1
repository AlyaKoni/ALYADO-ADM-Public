...
<#
.SYNOPSIS
Configures the SharePoint service user, related Azure AD configuration, and Key Vault access for the Alya environment.

.DESCRIPTION
The Configure-ServiceUser.ps1 script automates the provisioning and configuration of the SharePoint service account used within the Alya base configuration. It ensures required Azure modules are installed, logs in to Azure and Microsoft Graph, verifies and configures Key Vault access and secrets, creates or updates the service account in Azure AD, ensures password and MFA configurations are properly applied, and assigns the account to the correct administrative roles for SharePoint.

.INPUTS
None. The script uses configuration values sourced from the environment via 01_ConfigureEnv.ps1.

.OUTPUTS
A transcript log file located in the Alya logs directory.
Updated or newly created Azure AD user and secrets in the Key Vault.
...
$CredentialAssetName = "$($CompName)SharePointServiceUserCredential"
$UserName = "$($CompName)SharePoint.ServiceUser"
...
# Checking SharePoint service account
...
if (-Not $User)
{
    Write-Warning "SharePoint service account not found. Creating the SharePoint service account $CredentialUserName"
    $null = New-AzADUser -DisplayName "$($CompName) SharePoint Service User" -MailNickname $UserName -UserPrincipalName $CredentialUserName -Password $PasswordSec -AccountEnabled $true -ShowInAddressList:$false -UsageLocation $AlyaDefaultUsageLocation -ForceChangePasswordNextLogin:$false -GivenName "$($CompName) SharePoint" -Surname "Service User"
...
# Checking SharePoint service account role membership
Write-Host "Checking SharePoint service account role membership" -ForegroundColor $CommandInfo
$builtInRole = Get-MgBetaRoleManagementDirectoryRoleDefinition -Filter "displayName eq 'SharePoint Administrator'"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDyPfePFMgdSjdd
# V/VDi46sdiAgY19aqruZKbnswMwHmqCCFIswggWiMIIEiqADAgECAhB4AxhCRXCK
...
# KwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIBIetZKE
# 7xwiqsJtbi9ir/ZDu+igPgIhgA4+DSjPulbnMA0GCSqGSIb3DQEBAQUABIICAILj
# 5KEkDgdUV+1gLM1Kt6vCjgWU9yAzms3JtBn5KkC7PU3pMXkbi/qJkMIF7rE2QX4X
# 7oM3K1UqGk+OQVsE214JnE8nFeQHCY27n/E9DfEYgNWZGUDcRB7Q+dKRNdHV3Yfa
# xi2SJ+HgAEL6mcilZNwZgL0NNtNhGaJIgLtI83UgdfY63bvBH78qzmGBkzpfgT4W
# 7dXlon45Z+J5zf16b5rIXJ4gYxDJpXeny6sjb6KrC3l9zLy4bx27fFK5y3NrkWCr
# kYDBlLPKxuzUZQ/Qa7Vp2Mii2QyF5GD04ZncIJLV5ud5HmX3CyL71/J5mL3T2LG4
# noRMACh7fcXFWxed3YMcuGLulKtIsxclr5c5/Dpd8Ndj5/wbgRdXml/Op6LoXJ7W
# eP4Vr+jZ/QxO0E2mFH7TC7QKN7M6SuOrexV9IBzgSqDQjbw0ja5jNWVb9p6+OGhe
# FofLRc+grruBW0hRuvEYab0XpaBcBMzvt5wzgKZn3L1oXk/ww+233jWDXgcwOJRv
# 7V81zPTADdA2vhKwoioteNj22PXApKPORXIyUGqjwOozY8ADhGPnYtkG7Yb5GA2t
# xmiMW0YYwDJVvh1k63zSToHImMxhAJrfmW3EFES6nS/VCs5yU8wllzDpq028VYZO
# tlvuB3zD4N6XKtc18//fywvQ82M0C1pi5S6HDE4GoYIWuzCCFrcGCisGAQQBgjcD
...
# SAFlAwQCAQUABCBU0nQI+Y6ja5ypTTmt3c4a1qE7KWpxVPBj5gCZoHq6pwIUaYB1
# 6wXH6jwAWTIKH3WaDgG7Vv0YDzIwMjYwMjEyMjAzMzUxWjADAgEBoFikVjBUMQsw
...
# AQkEMSIEIH+eHJBCfED1txdAYVPAPjzavE4LcrEesQlJu0OgSXaeMIGwBgsqhkiG
...
# Mzg0IC0gRzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGABUR+
# nAU8D1et+7Mm1KA8TGNHzo/F89Ph7uQC0OxxWPmzLPQQoM/ArHOIB4cghXuE+zoJ
# IrvvFIn36Q6l2vJm9OWK+aR/wlT6EO9lpSlJrAwGVIB3JuqoTnDx4VBsx6W5sjG6
# QlNzg+yOTALXZLLrzNa6a5aQ9TyFB/sIJP4cx56Hp76KqE4XdnENsM1tMRbQuZyD
# NkMJs52f2K3OSbZXLtzRFbiHGzLDpNg8GbZi8FYuefqtdiCbPPrX+uMVuKFNBWNf
# j8EiakRNc8rNz1nkb1Pwv7+VdjzziRI0C3vP7oyPGUzP4oDBr8Iv49RYI7j8wjYA
# pzWTOF63AUkXQ8ymruF9BdUG3TRt397bjUeesrj3SAtDFP5M/riSRLpBOGJZrVxW
# ClIs+P2B6EjgcYKPv2n6kULtVVNVSF8wW2ilHAyAez/HVgKZwnMwfnSdEa8vwGwO
# S5aZbU03sr/PQ+OMkQHGSfawJusDN25c10iyNiNVBeWZXslt/tVRLjDHB/ME
