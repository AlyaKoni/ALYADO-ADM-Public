...
<#
.SYNOPSIS
Exports a specified SharePoint Online term group, including all term sets and terms, to an XML file.

.DESCRIPTION
The Export-TermGroup.ps1 script connects to a SharePoint Online environment and exports a given term group from a specified term store into an XML file. It gathers metadata such as term group properties, managers, contributors, and term sets with their associated terms, labels, and custom properties. This helps in documenting or migrating taxonomy structures between environments.

.PARAMETER siteUrl
Specifies the URL of the SharePoint site to connect to.

.PARAMETER termStoreName
Specifies the name of the term store from which the term group will be exported.

.PARAMETER termGroupName
Specifies the name of the term group within the term store to export.

.INPUTS
None. You cannot pipe objects to this script.

.OUTPUTS
XML file containing the exported term group data.

.EXAMPLE
PS> .\Export-TermGroup.ps1 -siteUrl "https://contoso.sharepoint.com/sites/main" -termStoreName "Managed Metadata Service" -termGroupName "Corporate Taxonomy"
...
Write-Host "SharePoint | Export-TermGroup | O365" -ForegroundColor $CommandInfo
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAs5yr5aUHWBNOf
# sGuTC3tT90GM/9towsVTH0CqGfBY0qCCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEINyGwiiwRliDtMUz
# sYEldWUQbLgfGlKxSE4gqzKWZbawMA0GCSqGSIb3DQEBAQUABIICAC8UkBOz/DkE
# PMoqEaMGFLDCUq9PliooF1mrrVxvilAACSjHqZTvSi8BUSsPO3oH2EWKoEr7udS0
# JQPrvzQB4W5AZNhKzymx6n/m/0jQs7ZNFQQTMvGge4ycZuz9T4Hqc+SB8jaebbR8
# LyZubU23eS93dwkz2zPAW32V9Mr6kKYkkljCfN0ASUnNp1/hCb3wl6q0wVwO1llY
# GGmp3GRyq1TFrrzOVGqiCT2TG/kGlO18RFAPJtmtvHs50/uFOJuL1zLatXGogwtI
# qzHUwoUJD1EMRRIr3EM4orHRftwbrDs+VXMLDanfORJIGANd/5XUjCBnsrh+nctB
# OM8XOTOMkuUKPZDJR63RnvqbAg49LETrqzfk6P4R8Q3blQgAGhpMeXmP3EjcF2Uo
# Acldp4RIXA3TIUXDcOazFWhaIg0EThBYAV5XITk+m8V1wBtA0mVZamThEBiXypLo
# x9+9wL5GnHKc96li3RfwbYN6VoL3FFQuzqW62xE3owqnhLyYHwubgKMMkE5IAJkQ
# XhFiftN540xoLtfVBVf256f8MnGJlQ+Amqw5wUl4cNEzQb8vD9Ne7y5Xo+ZCpzFi
# jYZ/wWBALEuTLUAAx+EXD1RwngRxFuC/STtf0C659yYbWx49F3JgLIlCGtHgoMn7
# OoCKvpzsmJniKlBcxZgWEMSFF53HLly+oYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCDsOI+UVWJo6b0gzbfRWZArG+yiVeuPT7CpHsWNuIeFxQIULt6XW+TVu9+E
# ET5EmxcKnEvd+aMYDzIwMjYwMjA2MTIxNjA5WjADAgEBoFikVjBUMQswCQYDVQQG
...
# IBpn7aWaQmILk8oTo7+bFAmb8fF2vI4oaiWehcXhB2A7MIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAd0s6D0oOdM1L
# agRN2Df/Dt4sJVMrrOQ+fSRqTfRmX6ic4+/9QRG2wZ8Rjt8UqfTiYtKG8IbjU3FZ
# wfaH4dYXYa3WcskJaIChZnnZMLUcZzFIQRGDyf4zm6rnd6VB3Wx97oDLElYlZcZi
# xKky11y+qE0/LvFLSKu1us9Di/zY3+eyOJTIPSg95hN+/+xQTqMHo+HAuXNwQhpz
# Z/Yl+yNF46izShyZJtVlVs8Q80Jd78DCGieMlN/R6gc9gzpOwvyNsXzJQxJZbBUM
# N8+BvQQ/heyVLQ4h2WZOMpkpSfDp8jXe8ZOEr8ongWyk26265aix3TZOCFWJmS6E
# U5vpk7WLGgzawrWDdrgd6o1SyY3AdO2rkJpwM1HGXgHnrnnkcfKH9IadPNZ4dfkl
# cC3+fi/BX6oH7rLIBmCDKMq2NDpOv2WVXwLIC7uDVrIDaNJCpeiAPZGuZPCkmKip
# zuwaiZpkEOQ3rYfFVce1a9B2TUPWohtzhMP1YWmjiMfSamxnoVHg
