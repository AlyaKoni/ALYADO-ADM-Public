...
<#
.SYNOPSIS
Exports a report of all users’ access permissions across SharePoint Online site collections, including detailed role and membership information.

.DESCRIPTION
The Export-UsersAccessPerSite.ps1 script connects to a SharePoint Online tenant using PnP PowerShell and enumerates all site collections and their associated users, groups, and roles. It retrieves permissions for each user or group, expands nested memberships, and records detailed access relationships across SharePoint sites and subsites. The output is exported into a CSV file that provides a comprehensive overview of user and group access per site. The script supports authentication using interactive user login or app-based authentication and optionally includes OneDrive sites in the analysis.
...
.OUTPUTS
CSV file containing user and group access information for each SharePoint Online site, saved to the configured data path ($AlyaData\sharepoint\UsersPerSites.csv).

.EXAMPLE
PS> .\Export-UsersAccessPerSite.ps1 -UseAppAuthentication $true -IncludeOneDriveSites $true
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCJ7w18F4qPhLFN
# yPAIGRTt/LXOVVaNw0ga2TUvnlGsbKCCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIOPLF6Me2J0F4f8A
# UBWdIt0nDXOKqNwtmrjCvTW4Rq0wMA0GCSqGSIb3DQEBAQUABIICAH7DoIfOLSbr
# mAgm2g9oTbCIR6/mjHlVoLFCOtbm6ol+DeWE2O4pJyjt6o9PvhSl8GAwp4ZtKIA1
# +DfhOH0FJqcXSgGUSYnGK/A24cyFDGKPxkLhWT87b0voASzQ29ouFXeyfaFEsZAK
# 943oOHR0SGrqyG6Fxc0bsrgGxdL4NKzhDb16EeTgb/njZSkKtia848PmZFpVd230
# 9qfUtnjTJJ63N+ircK6h2aKXgmdO4e1Zd92DHifInzGwFtp94c5JfOhErb9ik6PR
# xsHNwq3MESg0bgcCcBoFRydI6POo1mPM/XBHS6OJscnxdkA+PKSr5UXx0Nh6ceRF
# 1ZqprpUEnpx2ldpLXZ6MHQIe1W64RfJYmC6lRWPfWvwpdEUl1jlruBRor0sANpUu
# t/oy8f+b+OIKFjrpIJqEbr3eAspe0LpcJea1vJAe8TkP4J0E0pxU/co/H30DJ0J0
# LyDBVf91TtOxFuEO1pSToXiVYjxTnbPFFmUJDox9D361hotrjDnTdCvMPeHR5kK6
# Sk03rpcW2dM3YxaFVbkgdgF/Kag5o35IqUcFQjHIUYepgo4Ts2hiePRJNK3pehOt
# PpF4xfgObdaUyxr2B2k8EmQad04WSOZi0/2senq9dYBntXdPZSdL+TMUmVVr55D6
# a4hB4LZZScWy3KvFQLt1LYhoCfMkOpqVoYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCBLTRfEFWv7ZlP3CWMyXTGhxEXcnUU6yHYVCt0KM8LIwwIUdM1Rjmrki8gQ
# PwUZ1fYn0vtYvskYDzIwMjYwMjA2MTIxNjE0WjADAgEBoFikVjBUMQswCQYDVQQG
...
# IIG1dm1QbN6N3q+ZXfB6EcKrHg5Ie4ZSmoVOIHR8v2McMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAkqRABBH/J6A1
# zR3MuXzk0I5SxrhkqyrpNar2kt4litKz833ReRczQVh46l9v2KcLdbJ8cuncLfWw
# 58cj8GuI9wg3/mB35eGq/wKkppF8L67leS3AbmHscbIlqC7Mg3c3BW65vI6msPW/
# TYTHoXtWkF+P4GP6LjFwbHcPDTC4MlKVCfFsGhn4bAnzGZSxLDiOv5M0maqxSHHA
# rvKijf6r1t+LwDMvB0x87X0ufylYbKoGazd5e4edStKjJ9BDcPVqCdANSlE/hRHE
# HSHEazxffdsgygVLjOmMCaQrdl4Ewrzw/unkO6QK7rPqqG0ZLTVMr+QnYhqnPbIm
# JbFGav6ZitnDtds7RkbN0AuLjbtNHKbIf3+gzTl2SphOjXwN0Ue2tiO5mky1/0Kh
# p0vciZc3ckFxugF2wStfs8Kq3BSbhuwFCmCfyAyezvcqR67euKEpumrwNFJ54XDx
# wAUMvJm96L+NkVfjvgH4v7kbb3nQkLndosNAKLBr8AQoM+I5Z4x7
