...
<#
.SYNOPSIS
Defines configuration templates and hub site definitions for SharePoint Online hub sites in the de-CH region.

.DESCRIPTION
The HubSitesConfigurationTemplate-de-CH.ps1 script provides a set of configuration templates, site scripts, and homepage templates for different types of SharePoint Online hub sites such as administrative, collaboration, and customer/partner sites. It sets constants like prefixes and default site designs, defines PowerShell here-strings containing JSON and XML templates for site provisioning, and configures key attributes such as themes, site scripts, branding, and hub site metadata. The script is intended to be used as part of the Alya Base Configuration automation for deploying standard SharePoint Online environments.

.INPUTS
None. All configuration values are derived from global variables or constants defined in the script or the Alya Base Configuration environment.

.OUTPUTS
This script does not generate output directly. It prepares configuration objects and templates that are used by other provisioning scripts in the Alya Base Configuration.

.EXAMPLE
PS> .\HubSitesConfigurationTemplate-de-CH.ps1
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDJTPQIy79ubBtA
# MTfTux01WElkjnJhnoH/4CGR9q+vUaCCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIPIEOn6ehyKhu7XR
# Uw4NdgtmaJEyUyr1KPKUzdUtbluQMA0GCSqGSIb3DQEBAQUABIICADJ3qG22OHk6
# AqdQ9XyR2iictK3OXa0JjsdyeO86tkEtzy4PCmIAoQR3vMtbmKUEqdjM0GM9fWWw
# nzc3rK4ChIYXOelyBTTb2HofsPgjVjgCHLLt1216CeTNNVms55lbwYa/IJQ0A7/U
# pDtez+bUM7bTvgBojdFPU0yBy53JnBKwwAwh/md5BGA2n2YIGj8LJIh7NDhkrhw6
# HkAxAkfpvzk5u+k/opaMGNbA8G1jZ5hwksiFRyw5SWgDC//lHuffkYMvGks3Qfw0
# M1cMhYr9IxEyYx18CoEd7cfuWOd1BUfAS/QtGBX1rM4PA5xOq9/Lk2xIeDSDccY5
# FD+wzqRIA8s0VcklqCg+nb3iNIJssFGgvsetmLEivWyD9ATr0DGpp928Yi2UAdKk
# WkBsdkuRqhMrNgsmMl83Xe1bmYJ12iSnlUh+XMzHCgodSI04vgBozyQgTOyWlXcC
# vIYXDUVLPnW8Tj58pnYQ9CB3hM3gPxZw3xOkDaxJRp/4GqnW2wZRPn08lqT0eT9P
# lzwTm4zPYx5udhZ9tqRYKSllvcwY5/WOA4rYOaUzRhNbcBqUC+03dYgqGC8MXt1M
# MWP9FasdMqHnS6zguy/3S1ItleG0zbeb65shEscu5+6bNvKfpxyUaIGj0f5qc6zC
# 3UJvjQj2ngCthyyFCZJ8LQ3Px2nkXQ8eoYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCDMduo8l0vrxLDFfCf4n9dzNGRMBV0upNRqgl3Zco30cAIUPa2t3gdlGVyo
# rDewYrzPj875MYAYDzIwMjYwMjEwMTE1MzQ5WjADAgEBoFikVjBUMQswCQYDVQQG
...
# IF5t7UxglfxZLK35q/m6RgWpMYfEkBWAcbfRThg5cUnGMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAlv0866FREBtG
# AnNTJ+nf4Y2q/FXgltxbNbLqsa8Pq93xY+zZ/W8QXzJEw2lbLSgFfUbKGXw9CyYW
# FD1iD4QArAyPk5CP4BK4h4iFmhhexU48m4mUlGkLUlNmwpFQep5YhtpO4kx6JRG1
# EyI4rLQtYHx3kc9Gxo6TG7xt45IBbWfX+Lo5euQgLhmfpirD9kH4qBFr2B1Q23/S
# gnc6KxB9UfVhJ1bBUkhpH9zi/YWyruhsusvVdYNJRfVLIQPi+j75dYkxZheVqg9T
# hNzTQgUXnAZlhjJdT77qMMmi0ogJesLrajJk0C0PKiBI4gMvUs13A81Djcv1m4HL
# GTO329prJvx1EfmCfxGRZ4JY0D6t+A1Wu8OI54m/z4JUdojCVbUKN7ipvdzpv5dB
# XZPBkxTETpISKxXTrpLIM1uwyS1rcf+2JJ1v4EvalQd5te1jCtpKpww/BgaiF468
# FvpcRwq4ShTHkq4tWJWIJFpyXg31Ay2xz4vfx60s5Lddxb4wl3oi
