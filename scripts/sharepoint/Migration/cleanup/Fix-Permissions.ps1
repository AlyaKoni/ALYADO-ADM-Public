...
<#
.SYNOPSIS
Fixes discrepancies between on-premises and online SharePoint permissions by comparing exported permission data and removing obsolete members.

.DESCRIPTION
The Fix-Permissions.ps1 script automates the process of aligning permissions between an on-premises SharePoint environment and its corresponding SharePoint Online environment. It compares CSV exports of user and group permissions from both environments and identifies mismatches. When differences are found, it removes outdated users or groups from the online site. The script ensures consistency between environments by using SharePoint CSOM libraries, which are downloaded automatically if not already present. It records all operations to a log file for auditing and verification.

.INPUTS
None. The script reads configuration and CSV input files from disk.

.OUTPUTS
Log file detailing all actions performed.
Console output for progress and summary information.

.EXAMPLE
PS> .\Fix-Permissions.ps1
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBgwrfbJ95fDrdz
# r1P5RlU5e5Rg9YF+l8U7BdPVKTIuG6CCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIGVzg2wcg3aqtwSS
# cOmZ31s3PoXklTM9PIFlQfDoCDd8MA0GCSqGSIb3DQEBAQUABIICAJNtK7G+5vcC
# jCv+UP4PXmQ0XIHfx/yml/wKaJA4lXAHFGDug4RTEIJLJUqWsqrwj7hRdWBFFnV4
# yokRBJeUxAQv8BxKuWz9GNGuS0+CIaQ+daGfgCc1TerEIQEcqE8qJaE54T+VfQjL
# ktBNrkEPOW9KS2LjohWuhnL0vS4qLkJdryHAn8mQLB0BU6YxvK0Tw6wybHXIpNnY
# Yf0gelTRJJcYdNevn/vBwLpWw9C5ZX+VwaAkDXp8CkMxidfr64GWqFHrsLVvki4U
# 5pbS6hYctTYR7m0A7zaMM6o7f91zzMolLWndxNkixd3+SvjsaJj4vA1osWbxdx+H
# ynVmKZcpQ8hmNJ5+GsM/wDO23WaX6iqe83Z5OdV7bkU1Mu9GLAnBObiwJUIoq7uw
# d3pFntEp01XmCE6xOGo6HJ+P5C77r8w20WbHMPrZ8Q8Bp71v+QdOjk+jXkWrfoNm
# tLYrrgJAwqz2nfvat740S6ExxrWnkWzKE0+AGHfl8am+Y0HZTVBCT8MMxiqtXczt
# eqpT2SxIW7+2QkVBNZIEGF9DuKFp/tb6kqoIaeemD4N7vEXThBsGFGz5EEngqsnv
# F2CED4n+0ex6aGOX4DFbCw2EfPi7oGWPK/aDuoyalMPGIhIvRDOBR7rr+9rtCFv2
# /TZ8uDfXYItahOyFRqLh6QBgHufhVSBHoYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCCnul5TS4hggcww55xGONeo8Z1yWCtj7faIC/GXGpxK9QIUX7UlFHYJTrLN
# wKguJGQBl0Q9pAEYDzIwMjYwMjEwMTE1MDQ1WjADAgEBoFikVjBUMQswCQYDVQQG
...
# IB1jiGS7GdGk6s6EBAkCrDQX0mFFWS7CJ1jCd7iml2OXMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAOHew+Ax4OGn4
# X+arhFiXussJ7FOust/7kxS99czyo7Vs7ROslmVPj7OxMbaSD/5vjYaRPcmH1EB0
# 9swFJu0kj4jU5nTWLwUIdUPyZXM98Pu4nXBmfbZdDoCHv291ZPPIKO7yHRbJLZVA
# EJker++u1xuQaFP1QqrBr1ZTRW1oAV5p+vifVR/m9l9JZmsoxVnCTSYZ0nWLsxCs
# fJoF5VbqoK9cNh90pX13XodBr3/ErkIt3WgCt2BrSkj+ymtO4vdnVruelmgI4PHl
# 6VSPl3KXM1DrYN5MZz/HETwSOByA/9eWDCYsE8k3DfLxVvol6n8FfDxuzXYXDIBe
# FYoLl111UduVZu60PV5YvSXNebSQJIF/yx13kJ8wkmOt3+377LwjbBFtx2NTO1E6
# Ty6vFQi4L+9DmjpYOnHJuDAot+NBx9Sd4HY8bRcsh40hoXo4KvchxWI9XAe2qxrb
# +I3HaOMGPxIIDqwyjS9xBA62+/mbAl1hStjaNeCm1wJ74qNIO5YK
