...
# Starting Prepare-Folders
Write-Host "Starting Prepare-Folders"
$root = $PSScriptRoot
...
Start-Transcript -Path "$root\logs\Prepare-Folders-$($TimeString).log" | Out-Null
...
foreach ($SiteMapping in $SiteMappings) {
    ...
    try {
        ...
        Write-Host "Checking folder $($dstSiteUrl)/$($dstListName)/$($dstListFolder)"
        ...
        $rootFolder = Get-PnPFolder -Connection $siteCon -ListRootFolder $dstList
        $folderUrl =  $rootFolder.ServerRelativeUrl +"/$dstListFolder"
        Write-Host "  Checking '$folderUrl'"
        $folder = Get-PnPFolder -Connection $siteCon -Url $folderUrl -ErrorAction SilentlyContinue
        if (-not $folder) {
            Write-Host "  Folder doesn't exist, creating it"
            if (-not $DryRun) {
                $null = Add-PnPFolder -Connection $siteCon -Name $dstListFolder -Folder $rootFolder
            }
        } else {
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDodr3yDU1K24l+
# CUmZMQ8G5YqYIGnOYFT8DLk5gRIRpKCCFIswggWiMIIEiqADAgECAhB4AxhCRXCK
...
# KwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIGuWeoRP
# /vE87JGvlnwx22/3Uytqy3KIdh3jjxEt+hlWMA0GCSqGSIb3DQEBAQUABIICAFK0
# pfgpkIVt7wrEGNUQAE1f9qR0W50pFIS1w8WVXMhhKziDmqFTH62mi1t25+gq44Eb
# xkqyBACxFyxPB2Nho0iTNudw19m+zZGKK4c0I8CZl9XE5xC+2kGGEzoLLs1XgA69
# POjOUye0ghTeO5k4Xoi+7Yfi9RPP4QWPxiv6tWqDRdLHB9KdJ7KQ16CxQGk8sXXn
# 9dbpCBtmwBtrTyAKhGstVNDYYSOn23JQ5QuCwinY57W1z/wFeSp47jmlXAp66qXT
# b39gSl9uf+jJyoiB/jtjKBpy4qmLqX807luuGNv0F2QtlVAM1xcQx19/ZXG/R0ls
# 3Lp2oC3mYwBnF2aQztJ1mEst2ikzZkaJFN9+LTxQvW3TIDg/xjtlYj9DFNGGpTj2
# aM2OhgC+ocBOV55S9ONjzkWqhkoSymQgdbURvHFZRBP8ysq8WbS1+t1CArm9pJh3
# seFHLxf8o3YOiuU1kU6vHiaZ9iqOS/VkqF6aIZWxjv3NPEpwVyNCv0JjAQCtHwZO
# 9Lvgm5dOTZqUF1Iausr2Zwjf7H9FaOTVIUauVIQpCS8572f3YVbi+p804n0eaUCw
# RFUsLzup0e55+JAhObPSeyP3qounOLdlh6NiEo5//q0iBPOzZsJ+Kid4BveL1mFr
# W5ZOtYmQ1lq01zFjsQZneL14QeAPssZywDWB3nHfoYIWuzCCFrcGCisGAQQBgjcD
...
# SAFlAwQCAQUABCBJCUS2Xnm1ftEKdjyetWhVyq/e8LkprvcPj4oCtPfMwwIUPmIr
# EjSNTHxGICISS9saxn1KM7oYDzIwMjYwMjI2MDkzNTExWjADAgEBoFikVjBUMQsw
...
# AQkEMSIEIExNLT8yIgWNfzrPXmEGaaqxO7aeVgrx5Qqei7/IwkLdMIGwBgsqhkiG
...
# Mzg0IC0gRzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAIkRf
# gywuM20gUtKeswfdy+ziDz1L6aSWRmgikror/7/I8VxahNI9o+s2sh2oy2cpwPyE
# rHbq059+N6lS6ptJ+pR0eJCdsSrDocwJQg5l2ZxBQ+ZvoOeKRKGybkfv9OyXo/+y
# f04fW9+muLnSIeomOOsGpVzvv0pE6cGX7UBE/r9NufJ6npKIQVdtbPpQYeOvHpkL
# cRMDioRQ3aBs2G21ZUgfA6bJeMxfAonc4OIh2gOGIw3mn3+T5AeBqeO6rl4TuMMJ
# MZ2u5XVwPZPwMR1GnIaCK9edPGA7+6IfFzOtVUbTilRr8f9qJaGBL206CcLbpZ0W
# 54eCkRtuxGobFWRP624vJSrYuChofh+vnoOD6QVpHTnXKi1RdCXTcTnFLO/JjIQK
# hVnqpFy4tBmmtqCBE/dKymKeOW/+6hD/VjomFLu7uBM2eelTqo+gGgug6bSu0Uk8
# 5FN6+xGKVucR5Oj+BKG13xaD/Fi/D/opG77p1GZHZjz/FwiT6zwhLCAL5xsS
