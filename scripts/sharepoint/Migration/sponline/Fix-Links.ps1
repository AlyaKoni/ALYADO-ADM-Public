...
<#
.SYNOPSIS
Fixes broken or outdated SharePoint URLs and link references across site pages and navigation nodes.

.DESCRIPTION
The Fix-Links.ps1 script connects to SharePoint Online using the SharePoint Online Management Shell and the PnP PowerShell modules to identify and update outdated or incorrect URLs across SharePoint site collections. It processes wiki pages, web part properties, and navigation nodes to replace old links with the correct target URLs based on predefined replacer rules. The script reads site information from a CSV configuration file, iterates through relevant sites and subsites, and systematically applies updates to ensure internal consistency of SharePoint content links.

.PARAMETER
None

.INPUTS
CSV file containing site collection configurations (setupSites.csv).

.OUTPUTS
Log file detailing updated links and processing steps, stored in the logs directory.
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDeMYyiads+DvoU
# u/Ys92XELNAQ5mxQPkmHWBr1rsCccqCCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIJsUAC8w8FGMp58o
# Y685zXFoYeLrhTziP/C3onBGaKQZMA0GCSqGSIb3DQEBAQUABIICAJfgV0tra0Re
# fctxLX+RvZ1UNLZ6MOjbS+AOWKjgFtfTGHuLDY4vL8o4Qd3wgk63cnV4ZlX1FuMB
# Yb4uAnW17c0DyjbA7wEP+njfYGmu/dThEADTl4YESq3q1ZnQ0PmXj0kL5D0Cqsjg
# UF1laaCcfjrwCsygnFEKTfMA7oDrEPE5gdtKpnaz6G4+PTbuEpAn8h+wD1n7BffQ
# aklBsimb/8T0N3O9h85uFLI6+0EhUvLfAF2R4vrb8zj5LgP20gBg3M2wjZG6bk08
# rYN53GDo1Q6y7t0eXvXcIQCztHho14PCMbhhWYg6NPbKscDMmY7XwUg0G8aHTt4y
# moqV5vU6r/+O11KOpLIMCNRk5FYW3L6bta8TAaY+9nwGBsowuIqMSOlgmiqjY7L7
# 4MDnOGrfzctfeCjyFtJJAJoySkeMP/nDIIGEfwKbmwUuaTGFhyGfuLn6UJP7YE2i
# X7tqAF4y7Vxb0BMZ4hGaTYomD6AHktyU8CMGoM/GZgL12oQkAom8jjaX9ZIiHSBS
# eWQJitw8bucUPDraBGC+zZJBp0GTrqEy9AzZX8un10flke8YFk5b6kogDePsjabU
# MFM0lZc1C/Wi0Vrt3yiS6fuQixmUPJjy2Cq+6OL6jRI758TROEgRkxux2BDh87/G
# lm81BKyJ2qkve45KqpaZalKuEjexnhXqoYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCDL7zMuM1u+WIw2VjXTjKjcuUJ/05/zg9jPpaVx/om4/AIUZCa6Lqos4Low
# kFw2iy6x4GhYKy0YDzIwMjYwMjEwMTE1MDM2WjADAgEBoFikVjBUMQswCQYDVQQG
...
# INnqJrmXVTias2AbZD2khv2ouFBFCNeJrUouWFSSZTTHMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAAAs7rSlWsV7r
# skrMJLzc8QV+w5obDKpqd/K8RNzkI8poa/Fy8iSMX6onooOlg1kDmHIiV4ZJbcJC
# XW1l2o/3inpqqGoVK1eB7/nXZi2IOPrE4osRhx+1HmI0iO7rjJhemuXmRuipc7cN
# riJETrEQsTGM2Km57P3ntSG7mkSrkeqW9ibMkrrSbRIBHD5uZQBPp4ROX8RvFKfW
# iPxD1S78S80HQpwCwVWuk5byxqtBoalf9Q+TaGlzNey5Y/ls1RgqrNYDFoX2uVz1
# 1pfOFFPPW3yjDUKxovJILb6ZMkUaOegf0/Zlc2DZVA4VFXqc1ufRUTloXETAVKjZ
# 0WFFntnqgpNx/Ah1tRUINQpH1wH5D9oCLKIxo+qQjSLzeyGpXe6m1G99ULZh5ShJ
# ME0a0D+38Z/3P/Vbp0s7tGfjM3W1W+ELzP2UBOvmOrxN+TPq98tSXeXAqEbmTnKz
# CG2ZgmeDyuq35OCZ2A4J91pEQ0zn5eKW5HlDnbfemTKqQesaWuES
