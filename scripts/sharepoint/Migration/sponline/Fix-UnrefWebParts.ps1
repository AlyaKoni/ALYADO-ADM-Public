...
<#
.SYNOPSIS
Removes unreferenced web parts from SharePoint Online site pages and logs the actions performed.

.DESCRIPTION
The Fix-UnrefWebParts.ps1 script scans SharePoint Online site pages for web parts that are no longer referenced in the page content. It connects using SharePoint Online Client-Side Object Model (CSOM), recursively processes all document libraries and folders in migration target sites, identifies unreferenced web parts, deletes them, and logs the details to output files. The script also generates a report containing metadata about all detected unreferenced web parts.

.PARAMETER folder
Specifies the SharePoint folder object being processed recursively by the Process-Folder function.

.PARAMETER webUrl
Indicates the server-relative URL of the current site being processed.

.PARAMETER serverUrl
Defines the full SharePoint site collection URL used to establish client context.

.PARAMETER web
Specifies the SharePoint Web object currently being processed by the RunWeb function.

.INPUTS
CSV input file (setupSites.csv) containing site migration details such as source, destination, and command properties.

.OUTPUTS
Generates a CSV file containing details about removed or detected unreferenced web parts and a transcript log file under the logs directory.

.EXAMPLE
PS> .\Fix-UnrefWebParts.ps1
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBoap38Dk1XPj2v
# 6GtonHYnvmO0vKljHr/GssNIe7WUK6CCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIKX7fxfKJBkmEeDI
# WNvoPCEA7ONhNm9YPaEdGcLyOHZ4MA0GCSqGSIb3DQEBAQUABIICACnKTjY0xVBB
# EzYeurp7zWfLWlXB7Luze67mwWseLW3pEeUTFkiqnAVVDifFI47VMX35pRtJ5Urz
# RKUbwqQQALdjryl8LAxzsaqzuhbOvJZpzo6UfIjt8Lx5QElnnQd61inVGmsY7eSC
# JBNbF2PePNK3GPEesWD+Hf+9EsuUL0jzWBzvc7KAYCsN3tWiapXvxHQFsVdxlXi6
# AYENiUfJWkiOBtgNeJNeU+aDC7/7FRkpL/L/ghE28pyOruT7YmquPOS6ccYS5RKD
# ivtS00NpTqm0b1g56TOxfu1mBW++TsueZNtE5+AP68F6XPKqGYNWRBbVBbTrr7j1
# Nt6dftIgaN6/pEb1BnEZJixr20glYbFuEISQgLBqjjtpvbx2UMlJ2fYeRiwu1gSf
# k7zvJw/0bhdOLJKqIuxKuIxje59OxQ1C6/ozp9OqRoKwAEKmQxVIJm+hOiaAHmWD
# qZsRGRkNksW3IDvWTZNzQZySCJJ29oKptRNkEFUIwBJaPGatn49uR1j4PURFMMyS
# P+PY0uHKwY0ynFngew7Ye3kjD3O9o2Mk0sxF97z6q/ey3nc5Td7BMIWYsVqxj5DU
# 2F4uWuveMqayXEcN8+zohL6hxXUh46r1+vqKrc4aYS4Q8y2h0k7VNLKnnAWKuewP
# j7VATs29lxA1nmbGIwTT07ygpb1wSv4goYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCAa/rkDcKbZYsbBgoPZ260bDjhg/+QzvaK0ieHI/XL+aAIUHfWbgwowB6sq
# 0IQSFk8ESgDyReYYDzIwMjYwMjEwMTE1MDUxWjADAgEBoFikVjBUMQswCQYDVQQG
...
# IJWashrX57vv+51HyGE9OygyofGiR/b4z0B7HgflkMbOMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAi+mwowdeOH8r
# kgcjc8Fyy6O6XvrYY36YPA8nEUU9rfHPrvt1+G/fJAbftbKe4ZQDRaE2Jsu2ihc2
# ub88D0CdfBL/YekfqeofkLCU+fb/eDPnRIZ8r9duo801klWScOF6CIYxL966D199
# A0pKIOFly30/BzZv5cfXn3jCaaxQwRGZ8d6XYVcgtUJkJELjo3VJrb6gTzAKyOZT
# c1Q0rPIQiNMmhqawHtXPP5XO9ELK7MBx1w0glhsCdsNhbTf1oHA1vyofW87HfW7W
# +SQV7/DRpN3Sp/PsdesOa0X0IiwnZvMyjgw6MXHM3JUAEvDWNf1z6WKAmdKAlWC6
# mwNACYUkEL8EtMiIU5kd+IYabpnht+ZLBFvhPvjUF3O6aWuYxoSWrnbh1cuRFVff
# /k14FVzqRG+mrQoR3BDh6y1QiMVaqgG077uHMItQMiSUlSKspSW5pNA8VWdD0alK
# UtMCbl57d9HtbIcgYByXReVttJRrUqE2PmWU7098czhP6BQXwtJh
