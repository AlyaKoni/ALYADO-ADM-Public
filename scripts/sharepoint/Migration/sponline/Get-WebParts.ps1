...
<#
.SYNOPSIS
Retrieves all web parts from SharePoint sites and exports their properties to a CSV file.

.DESCRIPTION
The Get-WebParts.ps1 script connects to either SharePoint Online or SharePoint On-Premises environments, enumerates all sites defined in the setupSites.csv file, retrieves all pages from the Pages and SitePages libraries, and extracts detailed information about each web part. The results are exported to a CSV file for analysis or audit purposes. The script automatically downloads and manages the appropriate SharePoint CSOM libraries if not already present.

.PARAMETER onprem
Specifies whether the script should connect to an on-premises SharePoint environment. If not specified or set to $false, the script uses SharePoint Online.

.INPUTS
None. The script reads configuration data from setupSites.csv.

.OUTPUTS
CSV file containing details of all web parts in the processed SharePoint sites.

.EXAMPLE
PS> .\Get-WebParts.ps1 -onprem $false
Connects to SharePoint Online, enumerates all web parts, and exports the information to a CSV file.
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCnRwCVqOBunp6U
# bvCXafsiEhJP9ST/V5C95LwyXduQ0qCCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIMs1/CnWRCEAuXJM
# X2y/9bAElpEUA/ZGBFZm66X2GMM3MA0GCSqGSIb3DQEBAQUABIICAIOouDetZhd3
# HBDSFkz5a4FIL/p0YRykvK08RR+DzCL+aekkVLYot9Fgkl6+1MAa5HN+YOAkLw2q
# OJUQKBWkgo7fa0OD5LRWFlBaKWCun/43if5Yfl23vXXwgNgrBU9Gizuhq/jr56i4
# Oyk6clldBkbcGo2DL/ChAA29dyUxrygXoDGzprYmhr3OvihkRlPvHJrVh4LuGer8
# BFjR8HU/ezNZTBWPiqvPD69KU5+jO6KpvD2J5biHhBV63tiAjMyBmiF9wuUzMiUk
# JJhJZEvqHnj9FNMa8kU02JTUVS20tZ/V1Nc45OP01UhIdJygz1eughTr2VP3cQ6z
# 3lUkEJwggXk+Q40B6sU0/wGB2ERYNZK8S/rgoJhmKGZ+f8dWyxgbJOqOCzZ8iy47
# SfR7nmAWOnvAR7Zb9yxwauaWMPZumyKn6AzPD9o46Azn5SuoueLp8s9Hbq9Jyy+i
# 3+7zMgn++awaL154SAnJwf7TC2Mj4MAWE2jjnAV5SYVW30nfIMHLxDWEySm4t/yQ
# K08NV7EMnovYBjPi+S9jfUKE9f7cFMu+kENomFti1kTiqJIP6WG4hrTV7P2JnGO0
# wSMWu2ZXw52omJEDDyIabN93rciaEChzrABlbwX5PMtpKEC/qYhvw4y1fmZZDc3A
# EJRBbXcyH0LJ2e3zJIeA6qlR+73ShnO+oYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCAqL7C6633qoknEZstDOSHuzkiTniOxtzQ0YR1GTzJ9dgIUKVNxuDtEhJCc
# VvtxsnK9Thf5czUYDzIwMjYwMjEwMTE1MTAzWjADAgEBoFikVjBUMQswCQYDVQQG
...
# IGUDD6kcuIm0ywfv5Qao/fWTyrrWRIEucD/2Byu1fmVCMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAQYzcss57dKls
# MLOLe130V/oqisVIfq4CXxj9W1JDGUKU6iV1htjgWEuXGW2p39Qew769laCUhaAT
# sZm0TPFmbHDIt59ebSjzhiWqnpsYmvj8ydeNNPkDwfTRocLLduk8GE8j3p9MEdVG
# AB7lZFEmVv88yqZmmaEEG9jw962BIq1IU36qV5fWK9KfKWnZRCv9eTzme20n2fPY
# 8rXCJgA79eZNnmxyxn2EYBpDlu2wXGI5PGbB5ATKkbin0hD2osxa6LNCqGDED4bX
# AaTYEVt1CRxWhQRRBIjKn5KRQzPyORCh5C3hft9BBP+jBK0a1KziZmG2Q+cDnl2L
# t6PIOJ1s5yP5cKhhXn41I7W1hWXRqpZWzruiqn0AXK3j6GqJF35i6/A8qYR4MYng
# TiNLRTNtJ5jfTf0faJmZs3yzx6iMt1rmNehEA79fjOHA00gZEVfMRfmPqFjSATol
# 8nHk3nuVMam1YiEBWR92sCbDaZFFzvMbb65Iqv2YjRodDLEOBHUb
