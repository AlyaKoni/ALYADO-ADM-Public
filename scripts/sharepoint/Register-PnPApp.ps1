...
{
    Write-Warning "Azure AD Application found. Updating the Azure AD Application $applicationName"
    $MgApplication = Update-MgBetaApplication -ApplicationId $MgApplication.Id `
        -RequiredResourceAccess @(@{ ResourceAppId=$GraphApp.AppId; ResourceAccess=$GraphPerms } ,@{ ResourceAppId=$SpApp.AppId; ResourceAccess=$SpPerms })
    $MgApplication = Get-MgBetaApplication -Filter "DisplayName eq '$applicationName'" -Property "*"
...
#Admin consent
New-MgBetaOauth2PermissionGrant -ClientId $MgServicePrincipal.Id -ConsentType "AllPrincipals" -ResourceId $GraphApp.Id -Scope $GraphScopes -ExpiryTime ([DateTime]::MaxValue)
New-MgBetaOauth2PermissionGrant -ClientId $MgServicePrincipal.Id -ConsentType "AllPrincipals" -ResourceId $SpApp.Id -Scope $SpScopes -ExpiryTime ([DateTime]::MaxValue)
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBHy/iI3GulKj36
# cdP0zU+OckBv/JwkVVDbzLdcwIu/jKCCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIKYUjnPVwMn7auEC
# RdcJOHfhhu1tGV18+1HMbwX2hCxcMA0GCSqGSIb3DQEBAQUABIICAAz9LSBxjpiJ
# 6xNNR9InuR9wAvvuMaf6LPT5Ere96BuRn/mMqgQZPtxEUrsrN1s2a6HrvtXYJw1C
# E36NJJ+lPe9NC70Ra3IUFlobaTxS1Q2QZRzxgxP2jlBxsuUMBJXilVV7cqJjLz36
# nnzmtb0mm+aOkRyPYu3Arg33FUhMAC8iUp9f69de6Fu57N1ZkPi0BG7f/MTvzVZM
# erD9EEpJlK8RyjLxBOGC69qr6OnxooCe8xrXfEuQ9N4L6koVysBGiMZO0qwgxAcA
# p8XX2q0dJHUQcd+49HRhpTx4k9dcC9eXLWwU4LJmcHfn8CbaxpKP8I7Z4zsncoIj
# cpMduv9vHCzFtQiO82tBUbh2eO2goi7AjcF3S9MLrzR1kPQXAjuY+KVFUjDARj9S
# YlzHKq9PggO/vymXdXI2b3ErUQ0UeS/RUZgu/4aCl+oRppcQY2TavnxVXn5SaVn9
# xj7QeshpNMzwGDyGQmo86KBy6+kGNnThmOPiZUcgq7lYbGF02AUIgkikFc5nhf9A
# e3m1gDuf3Mz2SF6q6zM204ontFPzE50wJJVpnEtK531AwPbHTI15djEcQ0OfHl4I
# 3fvsZJ/cQd6eewucpRa7I30U6/Aq5WX7P001D9xTqfvQ5gGAx7493sShufJjTuED
# nOjY4JZ5g4MEA5/CZQNKby79YHxO6rIgoYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCArHZm3nLrUORpIk6Y81ucuXXjQKurwCMAvo/7/HZqNBwIUeWo82KrdaiQv
# p9YLAfJW97i1cswYDzIwMjUwNDI4MTIzMjM4WjADAgEBoFikVjBUMQswCQYDVQQG
...
# IOdzvzs8g6FN58K8zkaYP7FiC6SCKjCJOo7LG7GIaIZeMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAPXsdgD/p49xl
# qBthnuAJW3wiApPHAPbt/MoSA4L9idEnVuiMKKrRE7g3Fga6EaDGEHfqfmCsWyZ7
# 54tvxDclFAqmwxuL7vSj3TLkEkJHYXlg7nYFOamyBorWORKWgHLCsI4if95qKGAI
# rZZFUrNppB3du/HcHgNHj83+vNO5jVvVqLdmbEq79lIEe3VhXsmU1aF/50VpUw1w
# sBR+CQpcjvaX84AnH9u4Dg3SeBosM8iBdhz0yBqhFL57aX1QLQMsdxwGnSVKC3Nu
# vp9JJp4YiU54VlUSx7r9dnNnNwoOWbPlzzKBv5sGu0LeoRifCQ1ZnscwPS92w4eW
# +rI8oH4pTG1wnJqt0YU9J7nTBssSTL5U1yEZHkimCX05tbcrN/HEl5s+mEdQnYN7
# 24SOoCmgtsotrD3J2fRdkluVHtIQZ2IQkdC23bTzU17NQCL2gwZ9XzPBiIImT9TU
# urlCyQmta+fJeovmuBkZ/khl9yCi+i7XCTTEUnuYz7e6/TkuGL+q
