...
<#
.SYNOPSIS
Creates and configures the internal Projects Team in Microsoft Teams with appropriate permissions, membership, and branding for the specified company.

.DESCRIPTION
This script automates the setup and configuration of an internal Microsoft Teams group used for managing internal projects. It performs environment setup, ensures required modules are installed, connects to Microsoft Teams and Microsoft Graph, and configures the team with specific settings. It supports adding owners and members dynamically, setting the team logo, restricting permissions, configuring guest access, and posting welcome messages in both German and English. The script can also adjust its configuration based on the supplied company name, ensuring correct branding and ownership setup.

.PARAMETER assignedGroups
Boolean parameter that determines whether to assign group members from predefined internal groups or use a dynamic membership rule. Default is $false, which applies a dynamic rule.

.PARAMETER seleniumBrowser
Optional Selenium browser object used to interact with Microsoft Teams in a browser session. If not provided, a Chrome Selenium instance is created or the global one is used if available.

.PARAMETER CompanyName
Optional string representing the company name used for determining branding settings and naming conventions within Teams.

.INPUTS
None. The script does not accept pipeline input.

.OUTPUTS
None. The script writes progress and status messages to the console and creates a log file for the execution.

.EXAMPLE
PS> .\Configure-ProjectsTeam.ps1 -assignedGroups $true -CompanyName "Alya" -seleniumBrowser $browser
...
[string]$TitleAndGroupName = "$($CompanyName.ToUpper())TM-PRJ-ProjekteIntern"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBw1a6HV7rPob7m
# diqjx9rr4nIwTe76xVjrPhE/67+qe6CCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIG/PHNA04/9q6uX0
# wWO5GG/68lu54hQaTeciPKy04ffTMA0GCSqGSIb3DQEBAQUABIICAFPwlvPFK5Xv
# lV3o88R89WmvV/eQ4hzjrXVmc/7g2Smorx9w7F2povaDcJa9yiamKNzw8byLAFsY
# fSOvFXbI/BZD1fva+S4a3bLhLHYGmlNXVSWHSiGkoQ6dc2N9ANgBZeflvTM29AWQ
# 3ber7L7OmPMIoFINR34xd/yWw5M5ucEwpDdiXDNslBg7ANo6GLAh/+E8GxIgTnQ7
# h9E+tl/4qLLx/kfzMxgVkNDUord1hpSv/3GacQurn14rz8gkEPcxc/MCq6OLtajJ
# nba77KBMHMWR15NVwuCE8U6rnvM7vaJfA60c7XdltSvkzQVVoKd+bg1xC0ld+6q1
# CfXHfporLhUqmF+XrfBr6Dn227enFhaQ4gcB8kjoGPihoOeLx3c6kA3QNXx2eH1C
# qin3N3hDXOnRgEqttqVVw4Jcf7FcjZSxCeIKX7I8upWre+9ccihC6Ep/701A8E6O
# ar0+SnrnfvMD1B8Ls6JJkfLVQzGlszO0D/FUUlP6l4x2+rAqBS7gNeKkTDQLzdCb
# 9SdXnImPUi60Q0vsqWoV0zCukkV85bqEX6K2FTpauil85HxOwCNQPat+J5alJa1Q
# wy/oKhO6qhG370jKIw4mbGevQRox4x810lGd9YDCsQuA66PtL0I66CV1bq/0WXnx
# Pi+cBZYpgTUAtme6nDaod1QySSFGyPyRoYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCAkuNIjfxjjvsGRYKAJIXTK8U326CMsKKzDFSIfKmKUQQIUbtHGGiRaqskR
# AeAroJQX+DGKSx8YDzIwMjYwMjEwMTE1NTU5WjADAgEBoFikVjBUMQswCQYDVQQG
...
# IEqkpgjvPjACGySPyfeM9L5GYR8/mAq0ySQPHUfK+4MaMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAYXIWETMR5qhO
# AtMeYJGs088174TshJ8lbHY0m3EVEF4KltxN67HahR/yobdEW/V0C7tw0DBBhEvH
# KgqEaRngu7BV/OyoRBn1oLpoOQmA8OdeA48q2lsyOi24+xD3CXxF2MYqi/2PyZ2W
# 9MTh52lQzCpT3jaqeSuy15RJVc+ilJLsqIoR1gHsb5rgocZ/oLPwzd6UAvP5ePne
# SBr/CzfIaOARe+m0UqZmOy56sjJjpFOT2sVm+kEd9kzkxNlPBo7SAi+ongpseY8i
# FajiXSCn6j1XPExL8K18gLAd+jI84hHfnw0IqchySXF6q7SVXdIPRqddVyfEollf
# pCmZlDgs6DzqMEJHQILDUwFNxs9LpaVe6lS1XYClHUcVgsygt+/Ths0dmkOeVKxa
# Tn7kO+pGh/74r3Sx5y62WYyvRW+paKHIxZx8m8RsF0PVpMEwXImzaPn7n2tU6Rtr
# gwrzaBZoKyDpihcD98ij9PpC+zy9KGsRZ3VDty4DBcudoiZndmQW
