...
<#
.SYNOPSIS
Configures and validates custom domain settings in Azure Active Directory using Microsoft Graph.

.DESCRIPTION
The Set-CustomDomain.ps1 script connects to Microsoft Graph, retrieves domain details, ensures all required supported services are configured for the specified custom domain, and checks DNS records to ensure they match the expected configuration. It logs all actions to a transcript file and helps administrators confirm the domain setup for email, communications, and Intune services.

.INPUTS
None. The script uses environment configuration variables imported from 01_ConfigureEnv.ps1.

.OUTPUTS
None. The script writes logs and messages to the console and to a transcript log file.

.EXAMPLE
PS> .\Set-CustomDomain.ps1
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCWA3J5baxpsz9Y
# gujdkZlt6bOkq3BrpA8SxmdMXWkSKqCCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIEYhFUemEGF9jG6X
# ODgsac+4K0WHD6ncIvbbfACvbnqLMA0GCSqGSIb3DQEBAQUABIICAHGDLP95FuQw
# vxlEOSRDJpU92mkiCPvwSJdk7tk7S4jYNDM4RoyQ0EAc5wVVHUwII8EMct3mEcvM
# Y/FDkMptCQGcDGgzBxOXTWbuoBjappjlNSoR6OZP0ewSxSuUoX8xB8+6y5M8c0hl
# LiNl9C4otaUDr+pVg67Awa542ZcM52zMiyCuzobRiGsN6FTcazhSQJinKw5mgBSU
# 7d+xlM+c6pyPfj0GJqQbVgKzKO1KgV8KcBvQ8ZP9e8dxxAR+z6EuLz3mBSqhhtFi
# 7jgKY1ENHUaNpvXrkPdrPPbQUkv03p3F0c8NEGvN6G2dOjoH4Q45QoKR8J/hFkOM
# b2K9QvCA9W8M8xmj5mbLRXJp06jDaunfEkeWy3eERiHhwMVr+yz+QrPlGXKmevat
# SBUAgisXtl6vQ/HSrmtReYFDOnqJn0GSlMRGQvZZUtaVV+F0h8+6IOZHDgPHTjgc
# orMn+TKiIPiuWpqSQfgOtlNel67lTSmBa3iYrxcnDLgKUGbzVtyTCIk6SczFMvSx
# NkhlDXvXJLyzOxDSQFDq3sxzYAI29J5qyIM7g9vhg+tu/0uZuF6QMNhrgJJFDdhR
# bSAHJ6ULUGLN8TNxejttj2XO64hNyI9sNlg57RW0YEhBoKGBParG61Opw3BlNPjy
# V5iuamWOIcDQ0vYlzNFiOucIkGN4BobvoYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCDfl1vQFInVdE+rjrO8F0fN0+kwiUIlflZLggCsV38nYQIUJqCr2aZZfBpF
# 5JEqnYGVbx4TCQsYDzIwMjYwMjEwMTE1NzIwWjADAgEBoFikVjBUMQswCQYDVQQG
...
# IOHU5Ioq0zQ9UpEhoQCvbgR7PMX1E5DyKUZ/gSfZraQyMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAjqTyiJ1xDQOR
# tjHU1/yJLkhO4kmYXHhavCw7gX7zzQTEes6VP61Zgr7AD2CF1j3JH7cMznbT6HiZ
# ncBAgy0gHS2Dcg2uxPG44IzQScJKnZlu7oQvgZVUmmSCZFSBRJ+GMyuxmS2dYcna
# X2fK7ZVGlmSO8uQsIdSe+QBtZw8BWMQbG93y8hsVcV9NEctrE0wE0oG5wY7XmkwW
# +mwiGl9/p/4srqmBX9R1G3nriRyi/XSBe6Vn8LKufTDhtxoqUICm+snhLHLEBScd
# 9wNUk5H1Fie4wyWdj0pcbQ9nhA1IBD9xn+ZsKHGzo7KQ5BDRviRVm1FQXkczpGZd
# cZ53xSTQ9OpdjGGz+WfIrMyi24s3p0yJXxvPPNwnwPTzHuZ3GxT1JTqxGkx2kLcc
# WoohkwjVibcDVXCVJyZdPAhlluaDqJTLem3Yw+w8px698cBOjdrU5r9YfOfg4jkp
# GzWLp8UjsllrYgdbOIQAsz8J7L3xandI/C+3KDjDkqqn+aOUSIn8
