...
Start-Transcript -Path "$($AlyaLogs)\scripts\tenant\Set-PasswordResetEnabled-$($AlyaTimeString).log" | Out-Null
...
Write-Host "Tenant | Set-PasswordResetEnabled | O365" -ForegroundColor $CommandInfo
