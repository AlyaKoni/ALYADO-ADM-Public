...
if (-Not $MsolCompanySettings.UsersPermissionToReadOtherUsersEnabled)
{
    Write-Warning "UsersPermissionToReadOtherUsers was disabled. Enabling it."
    Set-MsolCompanySettings -UsersPermissionToReadOtherUsersEnabled $true
}
else
{
    Write-Host "UsersPermissionToReadOtherUsers was already enabled." -ForegroundColor $CommandSuccess
}
