...
<#
.SYNOPSIS
Creates and configures a network share directory for a host pool, including permissions and structure setup.

.DESCRIPTION
The 05_prepareShare.ps1 script prepares a directory to be used as a host pool share by creating the necessary folder structure, assigning proper NTFS and share permissions, and creating SMB shares. It reads configuration settings from a base environment configuration file and logs its operations. The script ensures the existence of subdirectories such as Profiles and Containers with appropriate access rights for domain users and administrators.

.PARAMETER hostpoolShareDir
Specifies the full path to the directory where the host pool share will be created.
...
.OUTPUTS
None. The script creates folders, sets ACLs, and creates an SMB share as side effects.
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDbs03F2pebIZaA
# obsTwQMoMly6QLp55hxE4nOcjzeNp6CCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIJj+PX9b/8Rnbrcn
# 4IIo/NpMCofIT0Tafecxz+voKcQWMA0GCSqGSIb3DQEBAQUABIICAGZbNOnXNM4N
# fehZfRqj0qp371YP2Dlmd99/OAn/bNbyUnEImlDc9hcS2rpuYSaQMDEXuJsJjh+B
# wazhDtqwjdElyOx5kudj8RqFJo8aFxqCQPFfTCq8ZBtbDi4BxY5nlTaAOczas2dG
# lQgFE1e4ftxXBSqKfXEIng8fWE7QcJTxQO1S2auZsqaz4kV7AlYf3BkvTC7ztrfO
# kaBbEazAsFPvDqbHXWKl2YMqxyN3Z+d95wnaupRB949YggihhlU1zx0e1WOvopap
# Z8ssSfyeWaY0SVIumsLB4CdYDygarxT6pKOo+CXM+WsBRovDuc56B8l2C9KyrLus
# Uii9O+ObWA8h56RiA+/tFcDIFNLFTJ19u5x9ogAqx2WiTcURrcZxYsYS9p4degE+
# M02Nf32NyxGIb+6JOoTa46wOW50sS0W7+Wv1gDH07x2RE8SbtMtO4l6+VJ0LEwdF
# SW9vTbrQ4CBm5KZ0AUuiQTs3V8vZXGE1v42w0WOh4yLiLukoYKyldeZ4W5M7Ppm9
# ktWagCNV+UhH5nbNYdxWLz4gpJBdvRQdGQECsVz76hCOAqbzgabqih463VUu9sRj
# 6la5+llKioQ+pUTiEcOZC8TCa9Ht3+59NdGi/4amtP9zFY6QYfZ7Q8XvFYJXE0jX
# AB/FMJKxd8JxiK2pUzV47x7LIXF1u0EcoYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCDzAFVt14RtEHdOQz1l3xhYjnchpxKF8G+MALO80ZsbsgIUcFNns4gAfH3a
# XLcg2LOW6E94ndkYDzIwMjYwMjA2MTIyMzI5WjADAgEBoFikVjBUMQswCQYDVQQG
...
# INziEJUc9dI6Mv4z1weiA7ZIyD6tviQlwmCG+0qUx8cFMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGARhbuesCRL5K8
# NAb07H928IRpv1sX3ZcurepWiYAtIcMIfwwHPZ0yyKcK4GoWQXqVGZ345OzKqs+D
# nOtd+3XHNMg3qWna0gADl3+LT0Dz77TCy3Jhh3SZ0DQ/mJosWKy1PhrIPFnX4FH5
# bsbr3pWsEzWNRi6ugp5tQDDb6ISD+o/Kxqsz2ujkPby9w6ZA7rYnc/JfmEuXrJOd
# OtZHHy5EQ98WlugMnX/kbBq1aoV7dVUqtwm2YMsmwP9ScUNayvPiwt4qmHgNni1v
# 8xRKQOq93EBrFq7m7nBdF9seB+6pW/QTaBRCEixz7szJqDCPhNnZU4FBU/kA+2N2
# J/Chj28VWY+xhavEkf3RiqFa9SavdledgRbbsP/Nr2PERcRvQvtrud+kM6TLunLL
# ztnSsmWKWc/CrtVdoQb2HS13AVAoS9U/W8+sptT2OOgkvj795pusygh/P7PYkzJ7
# TgZwPDLl5NXqtpKoWRi0sYXYlmuE23JH6UYda/AHWWmhfjBHMZG6
