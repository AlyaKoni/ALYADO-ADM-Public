...
Start-Transcript -Path "$($AlyaLogs)\scripts\wvd\admin\fall2019prod\09_updateRdpHostPool_hpol002-$($AlyaTimeString).log" | Out-Null
...
$ImageSourceResourceGroupName = "alyainfpresg050"
$NumberOfInstances = 5
...
$ExistingVnetName = "alyainfpvnet000"
$ExistingSubnetName = "alyainfpvnet000snet01"
$virtualNetworkResourceGroupName = "alyainfpresg000"
