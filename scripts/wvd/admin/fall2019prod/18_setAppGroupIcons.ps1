...
<#
.SYNOPSIS
Sets custom icons for Remote Desktop application groups within a specified Windows Virtual Desktop (WVD) host pool.

.DESCRIPTION
The 18_setAppGroupIcons.ps1 script configures custom icons for remote applications assigned to specific WVD application groups. It verifies the required Azure modules, authenticates with Azure and WVD, retrieves available application groups, and compares current icons with available local icon files. If an icon is missing or outdated, it updates the application with the corresponding local icon. The script ensures that environments are properly configured using predefined Alya configuration scripts.

.INPUTS
None. The script does not take input directly through the pipeline.

.OUTPUTS
The script writes status and progress information to the console and transcript log file.

.EXAMPLE
PS> .\18_setAppGroupIcons.ps1
...
#Get-RDSStartMenuApp -TenantName $AlyaWvdTenantNameProd -HostPoolName $HostPoolName -AppGroupName "Desktop Application Group" | Where-Object {$_.AppAlias -eq "Notepad"}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAvwhLUUKqVD8LB
# Og5eilUqh6wFF6Ud1LZ1ATp9e0adXKCCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIFWQVS5jHuB2imSu
# gV2mp1rv3j6H7gf6Qibde6JPiIqPMA0GCSqGSIb3DQEBAQUABIICAKZVtPXmJkVs
# t26dLwt7erW3/VGJSB6dzQ2nzjT7uQPodUpTA8kJSrDJ8Vqih4kyxYx2nNNY76aS
# TdV0A/Kefyy8m3xlAfV8mOf+BRJyAye46OxPPsNz0xyju/4p9C9rf+NgfOBIbgoq
# H/Tab8Wzfr58ajgtnYBYevKKQR4YFbvNxdioOdu5f2EpbvWar5VAJ3OyqVm75QAZ
# PbugqnWBqrxLmmbUjg+uE/yWoHhv3OUdbSRv7/BOaf9E7B/fU84DD4Vtzx+o28fj
# nJAkJLK89aSbZybiWsQ9vua8Hdnccc7miPS0CSoQar47ixXKRfm1UnTRUlalGShK
# ThJGzycQ9b2M3KofCMQBbIk+0Nc2Ts+uu9FAHukXMxXN5YVhVjSHuJlodn1GrqYH
# zyOdE3DUfNoRquUIIiaawvy6NeQ1ISBvv8n4eSANEGsW/DaFkBgBaF5Sk7iE7GX6
# ZdsgOJwQu0gZ4BXipLENYRWu6D7lecfLfwvMg9BGoacij8xsf8cWZ2/MhYRbtI5G
# 3q0VWf8oMLDUc0QNiexwwFYWve6rr22wG5WMn7kotapYmQ1QgjehJQh4OgICt7Io
# d5juh32njvZoqNs8rEms5H2f5nIQhSS/YDbSJdnneQlvMYr6684B+gxBQsCqfe8g
# k5mXoqDGJ6Qea3x2+2kXoKhmeV4uqP8loYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCDd4UHLfiTMp8EofuZxDv44t/FfK/8FXK3UVmUYQaA6nQIUUawtH7yD1jk9
# NyLVFq9IesFUiY8YDzIwMjYwMjEwMTA0NzIyWjADAgEBoFikVjBUMQswCQYDVQQG
...
# INBB1ZMllbvmCC9R1mflN9z3f2ojRaWGhJYdZNysL1QmMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAQNYHiRlEaAkJ
# soMFxEN9Kgcsjlg+jH8SaHhz3ZYhia9PCx6tKCxCSY7o8L4zcbX3tyw2FFP7xupm
# iW+QYqyq9QSxng9Zlma2uTIu0WYCdl/fmiFfS43Hzrli7aTCD01X/aSwrsCeM9CW
# Id1rhkuiPMO/nWdOuJppjRQOixT/hcT+rbjzd3+UkeZV8hNglyuN2wJ7dZyUI6Kz
# MkNP2+Ct4CyzfnVI7qKKz32Gl9GsVozSgPzmZpzPnyKql7aIsYoO1OoT+a3Hbftm
# +21LaJv0FuOnwsDhd5DYiyevp+LB0NAK6LzBn7EKX0xfDP1qwyH9DdArRM99hMMt
# ZMzh8qBNn3o6CfJtD9TuV/oIxqCtAZYetAuVYbJ2KVjTi5HKRsvKRhpkzSigZd3y
# A8YdS2VnNbrSbKHedNfjoYRQ+qKhMPdP0HxjIserxmgCl8SLf89FWw89kCsNvbx7
# MioIHxWwVK16LR3MOmNY91Vlwp9UHIVlbIK/Me5p5dCLh3hR6DaW
