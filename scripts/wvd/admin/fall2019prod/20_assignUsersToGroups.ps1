...
<#
.SYNOPSIS
Assigns users and administrators to Windows Virtual Desktop (WVD) application groups based on predefined Azure AD groups.

.DESCRIPTION
This script automates the assignment of users and administrators to various Azure WVD application groups. It checks for required modules, authenticates to Azure and WVD using service principal credentials stored in an Azure Key Vault, and manages membership of app groups according to configured access groups. The script ensures that necessary application groups exist, assigns appropriate users from Azure AD, and removes users who are no longer part of the designated access groups.

.INPUTS
None. The script reads configuration and credentials from external sources such as environment configuration files and Azure Key Vault.

.OUTPUTS
Log file containing a transcript of all operations performed during the execution, stored in the specified logs directory.
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCD27djD3MtVRx/u
# pVzh6XUoJCulRGKFclwyi01eEXkIiqCCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIAMs7ahxVPlRxNn6
# NXBF3z7uslLJDrCOXPDHVDU9STZYMA0GCSqGSIb3DQEBAQUABIICAGPccgVoEUxz
# E3kVtzv6kO/1ethC5MeJ27ms3wRn+vc/ESf8EML2bBqo+5mK6nAsXeYVK7U9YZFg
# 9nTYcxXhyAQSMKaDz6npvvXLhODy9oXSbxbxhaeBj4nTgH9GmZgHGI2y7E1XqLFD
# CZ9mbLTFlfMRUs8ychQWaYfv94WO+icfsPJLvpjKCPEAbXPXfo1GUNJK5JTq5A4j
# REgUlVPQcqFssv486FzK1QVCdLcB/v2GboVUzPmO762DnTX9em8b0iOwcYJW8pZu
# FG9Er7L9LpTpt6dhspE5Qgk3TIR/F/advwTALMNpdFyxr+YCnAD+AyiQj8YrdRk5
# R1/ot6HTy1nXTgdTU02uE6Bwo5XYdSrypq9wclUJiVbodADjVByn9SfA0KnpdLqZ
# jIx7hwgEcOmun0N+0KQBiBgVh8r5sIq0ZB15Rm2jhXa9agycjI0JNWYgrVB2c/Fm
# yMTqamTZ63c9ht7YAh2cfuVofiaxDK5NVuscdDxdK55R95WoA53+q6/BsFwsh7Ij
# Jn4rg6LP5N5zcU5EfVsnow8BK72wdb74YAwTrSBpIobZIbDQXV4VZFj9WFOqRyyL
# 3BLB+stUdm2FY+B6vdPCDr3Bt8FdvWS7n6Z0TM0ySNI1GY2TtwQDt0awRJerse+3
# dg0DQ05aEgNSXvRT2tavFkAhdnyvgjYooYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCBABfqFlgjcs/ThvJW8vIsaaeSGiNVX/o9ljcMa6aPrmwIUC/3lmc6H2D5L
# ECn+luwV3wDkYNkYDzIwMjYwMjEwMTA0NzM0WjADAgEBoFikVjBUMQswCQYDVQQG
...
# IEACEgFkoNw1mQM7ZMgMcSl+1AcbbEeXP10U6gnFTAceMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAJyhE7eNGeiAJ
# PZHuYSKMPSt8QjyGi/CZSrsu/VfkYM0ShReAIgDz3Rji6TwKVAj0VDmmm2aXRLyn
# hoZHOVpEy9zAzzdzZj+5ZUYm71fzja8DdYn110oomABtfxPRk/rpEJA2rbprSbi0
# khWnMRj+9Rj8k6xlEcn56IM+11LtMZ7bIUAjbED2VzSS52f7hLFHXhoJSmGoAKR5
# We0F3rmn7IDwQj8uLewJ4pTa1BxCoNEbPtVOc37DPKkmF/40+4TtpYiUbKFEXXK5
# di67QjNDuUdoB2qP6gxR6vLwEUxxmxKgF1cn4o8HO7Rh1uYPkENFlGPId+irHlTR
# qXkciYP+YLIEb7JOKrGFYgmwsyOT1juuroZ/5uZ2Mc4JUf6DZVj0lruALQPJUkGK
# b+zRkImtOKULZlOgJdLIHtLdqr1IhE0Jk4EOWvw4ZVRwsx06OMAIJqWpzfvdmGnc
# b0bokr1sx626d/zDkc9rpWct7Oikp78rU0s3GJeb8yo5VT65p7+e
