...
<#
.SYNOPSIS
Sets custom RDP properties for a specified Windows Virtual Desktop (WVD) host pool.

.DESCRIPTION
The 22_setHostPoolCustomProerties.ps1 script configures custom RDP settings for a specified Windows Virtual Desktop host pool within Azure. It ensures the necessary Azure modules are installed, logs into Azure and the WVD environment using stored credentials from an Azure Key Vault, retrieves the current custom RDP properties of the host pool, adjusts them according to predefined configuration options such as audio capture, device redirection, clipboard access, and printer redirection, and updates the host pool settings if changes are detected.

.PARAMETER HostPoolName
(optional) The name of the WVD host pool to modify. Defaults to "alyainfphpol002" if not specified.

.INPUTS
System.String. The name of the host pool to configure.

.OUTPUTS
None. The script modifies host pool settings in Azure.

.EXAMPLE
PS> .\22_setHostPoolCustomProerties.ps1 -HostPoolName "myHostPool01"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBsXhtxCh0Z34eW
# C/KP7Nfh2GEAe3SR8xKLvJbaIm9UTaCCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIBTcoS3G4S+HKKuw
# TyIPlBYdIlychOqKmZeO2h1LTGu0MA0GCSqGSIb3DQEBAQUABIICAG/qp9epJaez
# OyXd0xQCdiRPLtuCgAZUraDiNDck6ka2hMEQ5BtfZSi5UJp6ILsyt0x/Q6bcUIH0
# xnGyYXWmntKlkc0vDvBJIGvatKj80wboS7klu0GEGMHIB/pYimfxHCv/H2i+z5t3
# 79cQEmWmAh4wpla1UJzXvKT5ZnDSlu7evnPLOrlDpzxiq0AiuUVMVfpXw4Ra0m8b
# RhyhB7aBd5O6B+UJhyD+eU6UyV+3UnLyENxiE2MHs0geeoSkgG+GtTHlsKbpwocG
# 4fJjXxqIRkPUwzO7bpsG9IkBvvP5ziJK/Npudp6lYY6SBYIizcbPBEkgjnyfbSAU
# W3lp9vYsd/yL2Ej2IVJ5OZxR0P8FFdYZ1bUojsuRDTctOZeuhZPFXgJpzxWndpMX
# vfEkoR6zxvPvIuGseCv+/x5/imcBt147gGrcXqycfGDug0grCHkyb39q6wfGiaOZ
# sAL/YXEOPvZnBJRvoBjPvWnu9C6ff8+HpNA95d7FhM4f3KQBeQ1UFYH7vBcRloVI
# NdHPtZZreHAkhvQ0O3CT7MsylPeL5a2E854knOLVQd3N90y+Hdn2yQBKuPIa+YRV
# NCxXSAyMLa3uMb60X+FCN7lu1onjG2FrPhHjtnFJrqPZhqr1XCP6g8QIa+YIQu0t
# x0jnBYJlfqdJ31T4FhxYjJYNa71iQxY2oYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCC/TnQ+kJdGwYjJ8nLWM/ODkL0umJWWzKgT3F97zfqDogIUU7MUG8WYeJTX
# iUNMLZhrMLeXrFAYDzIwMjYwMjEwMTA0NzI0WjADAgEBoFikVjBUMQswCQYDVQQG
...
# INOEr3RguXvGM14GVIHDVnhLDQLLuEa6c2YSLUHybSnQMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGATdut6gQai1Wb
# cQ21ecOGXJ/cYsfXSGpePLDRh3iR2y8DJhtVyXW3ZT2ofxwmPkuQxaTEF6xuCOvb
# Pyv+ESNdqMOVsGyCPq6eKzfCgUVd2l7s2G5W4BhSoCJgqwOD6mgaPezZ/zBcDOWm
# CXiD577VIcGE5SB3KVL9XNTTzBl/8aHA5quJZqdhO4MSjvrds/Q2hejhUU9TIFjn
# 6Q19fPaAWKHGlkfMgDcb8fOhNB117vNgreGfm44qB7vkV8dbV3+BQ3RqfnKLj+i1
# I60Ane+6LFxiPxsWBAym6YQLCq2R4Kcr9wAs+CNndgfzaeIEx2XKSxaiA13asTSF
# 0zIz0AuZPFT7OGPHAVtb7K0gpjXn2o44t2oOG2gOqKswS2qe5j6XWOGn8Y3JVTkI
# qkAI+fTPi1BWGiTPheQr6NkV8ARuQS8FFmHNP+UG9gYY4ZemQkNaQ9LfJADXQSdZ
# KWDuPkA0+YzrHwM5qWbSzsoQdSUHhjT+G1Y6n/diBzDVyzQ3BAdy
