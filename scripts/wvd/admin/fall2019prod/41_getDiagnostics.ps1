...
<#
.SYNOPSIS
Retrieves, analyzes, and displays diagnostic information and health data for Windows Virtual Desktop (WVD) environments.

.DESCRIPTION
This script connects to the Azure and WVD environments using stored credentials from Azure Key Vault, retrieves diagnostic activities, analyzes disconnections and errors, and performs health checks for each host pool and session host. It outputs detailed diagnostic results, errors, and health information to the console and logs the activities in a transcript file. It ensures that the necessary modules are installed and the correct accounts are authenticated before execution.

.INPUTS
None

.OUTPUTS
Diagnostic and health information of WVD components printed to the console and logged in a transcript file.

.EXAMPLE
PS> .\41_getDiagnostics.ps1
...
$acts = Get-RdsDiagnosticActivities -TenantName $AlyaWvdTenantNameProd -Detailed -StartTime $reportStartTime -ErrorAction SilentlyContinue # | Where-Object {$_.UserName -like "*$($AlyaDomainName)"}
...
#((Get-RdsDiagnosticActivities -TenantName $AlyaWvdTenantNameProd -UserName alex.papadopoulos@alyaconsulting.ch -Detailed -StartTime "18.09.2019 13:00:00").CheckPoints | Where-Object {$_.Name -eq "OnClientDisconnected"}).Parameters
#Get-RdsDiagnosticActivities -TenantName $AlyaWvdTenantNameProd -UserName alex.papadopoulos@alyaconsulting.ch -Detailed -StartTime "19.08.2019 17:00:00" | Format-Table ActivityType,StartTime,Outcome
#Get-RdsDiagnosticActivities -TenantName $AlyaWvdTenantNameProd -UserName test.user@alyaconsulting.ch -Detailed -StartTime "19.08.2019 17:00:00" | Format-Table ActivityType,StartTime,Outcome
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCC2VfkDVh5hJWTg
# XC227Wk2+PXDIxJ1j3irNnznBiKs/KCCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIHdrWh3SuB8ce8hh
# bzpSaxyvmN/pO0QUcdL0FoN1KTM7MA0GCSqGSIb3DQEBAQUABIICAHBau8tYVcGN
# 4Do9Ks4o1Ta2zVw02LgpB9shkS8OTd1uRXYSYQkyyFT7iEOdx3O8+tLqQWbihh9R
# QmmCegGo7LiMu2uDBWypLK68JZbzVVsDxIJGY8JcQwXL5BEnPqrTSkuoysItHpdV
# PEla+vDxAA3e0vC91W9cRqL1al2XaeS96hc6Kx66IXyH3l1jxGVqioSvg43NUC5P
# FwWW62ILz1NBDXFEJ6FiD6xJJEAUHT1zJJyTcV5mnXizzgVMy7bREC4qE2CJi6Un
# NO2iFU8o3PYf9Jr0Aw5mYHMS8t8HJzuXOzvPJVfTGXAQMFFDUCMAhB3JkhwuUgny
# HxZcQiS314sZeYHtcDl1ztX/HcuxnOb/eMnCqEZcpInp6sWFTLHKyloYTL1zTKJ7
# srloNYF43Y6hJ39l03993HPfg4fIay1n79SJo3iktUZKTK/8jimuhoY887dbqyAc
# IwZCpv8k6qdwEhavE5Iywiw0yGGCnJeD6hWfHMjcAev4AR6SC4biNv6pSiu1YTAu
# +iO4pAEGzuAK6JjiqdubiuggMmZxvKUZA1aNJ7CAdUmvv6dVVTf+35qORm2Vu1id
# kxUgt+IwtgrgpXA8fOFy0MAHQLtOB7JMZFq2DxnTWbUX5aF+c9/Q6fsozgRbbNhU
# MtVpMkdq3aEUt68bLWMjxgXAbFch/m57oYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCDqMImvLP1PBwQwXL2YaK0NTbbVjGpfM50jDOA/j3o/KQIUPwhwetntUcsz
# vaHeaWSZX7ns/sUYDzIwMjYwMjEwMTA0NzQxWjADAgEBoFikVjBUMQswCQYDVQQG
...
# IBPlZOOZowR3JIIb9f4S4R7S5EPolq+xTEwTFHAev+nBMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAkZLkfcLNnulo
# Qhv6vUzewv/+HwyK/GdvDoAhr1XPpqeE1rSnIIyVyCoU811qegKQnf+AJ3pl5LG1
# eJ7m0WqtdTD2PKcuqrLdgFk00tGaKUSq2/SOJqtQytnpYAVhJOi9j91o6wYgEEXH
# oPDLBqmoe9g/Ea4BqaSOjmgItUrIQ9FpHj86eG49eF1xTE620fldv1FIJSvKbtHk
# UzcM8CADh9NtwrvgUEi3WHo73ykJBlmIJCc6QZUjAGvmA8IyehrYzh5DIeXddhvB
# oFIZQEQ3WQl5QtYS8ecgTJr//qrny4TnhCcrpwlUW/8PEqDgwIbsSwbDivLPPEfI
# L8P/ia/w/CIS71Epf4gOohy3OqLcrOOuLW9Mg0JhzqBf6Z92l1H2DbN3MTG9mNNO
# uJzi+Jr9nQBGFmKeyri2bWV/b4d228kYBz05ikC08mkAKsXwBmgBgVLVC/hbUcyz
# m+fVEcYETRnAO/0Kjw13ya4Sr/D8UUD9VfguOSreArJsy0ZaJG9e
