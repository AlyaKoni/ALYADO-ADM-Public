...
<#
.SYNOPSIS
Creates and configures a network share directory structure for a host pool, applying appropriate NTFS and share permissions for administrators and users.

.DESCRIPTION
The script 05_prepareShare.ps1 is used to prepare a shared directory for a Windows Virtual Desktop (WVD) or similar environment. It ensures the target directory exists, configures access control lists (ACLs) for administrators and users, and creates subdirectories required for profiles and containers. Additionally, it creates a corresponding SMB share on the local computer with appropriate access rights. The script logs all actions taken during execution.

.PARAMETER hostpoolShareDir
Specifies the file system path where the host pool share directory will be created and configured.

.PARAMETER hostpoolShareName
Specifies the name of the SMB share to be created for the host pool.

.INPUTS
None. You cannot pipe input to this script.

.OUTPUTS
None. The script writes status messages to the console and a log file but does not produce any objects as output.

.EXAMPLE
PS> .\05_prepareShare.ps1 -hostpoolShareDir "D:\HostPoolShare" -hostpoolShareName "HostPoolShare"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCA0UI4kYF90xb4u
# JsVsW9TsHelWrmk+a+osAg8obWd31qCCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIHApvM8akxcavqHk
# o+RRvuf3CqMrHbaxAm3eEB+8sq6SMA0GCSqGSIb3DQEBAQUABIICACIH7hdJjsOA
# jR2UwS6Z2DOLevKQzpWX4WODJSnlthzxj/QOmnWvRWujSY/pzKeBXeGCkrRWF4hb
# ++S/rZDvvRYPa3qAkdzHkuC9IbuYnFG/R0q2I5p23BpQDFCgsugwXogaUIHSbIWf
# xiTGHa61eTfk0L/u7mzS9J4OpNk3rjjclxGeBFMZnwGqMDslAZ7jEtxTHrCcLmAm
# af7EdpYoQ7AFPwxKwT5ymPcmkkurywe9LPOUCeb9SAJhMy0xdATCowMroBFS3EsU
# klris9EhOAzy41NQFF5lgytnhaifP3l8XVHlL/pEhHMzcJ0HtrY8/zh8EXO7z/4e
# h92n1XApXv5t+NkIrZRhPYlAmLmNvoPacs0XwtSYWargfOeJtw0JRpDhF9v5Pqn6
# CvC9ICcQarY7bDNTR8ZlUOm6dtitXUyC7hbr1wJhnpsyLScJAXEDSWrPbbccZWj+
# Bww7Uwae6Ev8Efp6RHun+mGSXW/E7cu9qSgJGXLOeF+W7oKVPUvVGPEnj2ChFiZl
# dWGVKe4h+4qibA/DRz0KPXT22CHT1italYflw9wTJD+02GQyVuPBISk61SqE8+B1
# 4th3X3O8J5gChhjfM7iF3Az9CtEOdk34V1iWAWqAkgZInkwsjCcw60V8Sbqr8v86
# +eJk4G90Tm+2Fmg/hS16whG6q5xkrVaXoYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCAjo2tjbxECwwshpbBl7F+OtJtZ6lNQNxk7GP/5F74b7gIUNA0PBY4teCx5
# MCUiXxajcpcPB4AYDzIwMjYwMjEwMTE1OTE4WjADAgEBoFikVjBUMQswCQYDVQQG
...
# ICgiOjJqZI7Nz21kvnuwDqDiYicH7tg4ERE5f3xxrWSdMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAO5abVfMB8App
# iCsdoBfiQCP01TW2m3j9D7mTal9KY6jpD1okmrzmoAQvG4dpyUFFVgLjX+8F5upf
# V8DvRj0Ibs1mW1Y0x6dN14fQn8ESu5xlraLGls22G6iKn/DXlwqdZfoFKcAqINLL
# Q0XjR2ssSx2eOhwm7rFu2olCUNLPtqJpZmOS/4xQMizKySPcT+yXwqFPa8uVhVPK
# YNhWxi3n928a/atFkZDZv6hFhMQ2F6m+3zyM/rJvMk2Oh1Mpk28y3x9L5CFu/lIS
# 8U0/9PipE544ZcUhUxYljdBzLU/IAuGsiA9BGy6rnAXGbr9Z/VvS5PZrfP+p/6Ii
# sjypv+3zL0JC0wFjiO5JI6uaVKMjifezkIs4c4xxsSeHutLyHziq+i8urRm/IgKt
# AcJERknn3JDdnD1ERgQlrqXow1jq13hwck7TJhPo3xzxpvfVkZmgzuHZOlw+hFOy
# QHtRAQyGazIsfWSxJ1dtkALmYWwpUNpGnBIzvvitkWyVEkGnGOyH
