...
Start-Transcript -Path "$($AlyaLogs)\scripts\wvd\admin\fall2019test\07_createRdpHostPool_hpol002-$($AlyaTimeString).log" | Out-Null
...
$ImageSourceName = "$($AlyaNamingPrefix)serv$($AlyaResIdWvdImageServer)_ImageServer"
...
$ExistingSubnetName = "$($AlyaNamingPrefixTest)vnet$($AlyaResIdVirtualNetwork)snet01"
...
Write-Host "WVD | 07_createRdpHostPool_hpol002 | AZURE" -ForegroundColor $CommandInfo
