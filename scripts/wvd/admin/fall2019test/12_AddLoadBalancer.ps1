...
<#
.SYNOPSIS
Creates or updates an Azure Load Balancer and its related network configurations for a specified resource group and number of virtual machine instances.

.DESCRIPTION
The 12_AddLoadBalancer.ps1 script automates the creation and configuration of an Azure Load Balancer, including frontend IP configurations, backend address pools, health probes, and outbound rules. It also ensures that required public IP addresses and other Azure resources exist, and associates network interfaces of specified virtual machine instances with the created load balancer. The script logs its execution process and checks required PowerShell modules and Azure login context before proceeding.

.PARAMETER ResourceGroupNumber
Specifies the identifier of the resource group where the load balancer and related resources will be created or updated.

.PARAMETER NumberOfInstances
Defines the number of virtual machine instances (network interfaces) to associate with the load balancer’s backend pool.

.INPUTS
None. You cannot pipe objects to this script.

.OUTPUTS
None. The script produces informational output to the console and log files.

.EXAMPLE
PS> .\12_AddLoadBalancer.ps1 -ResourceGroupNumber "001" -NumberOfInstances 3

This example runs the script to create or update the load balancer and its configuration in the resource group "001" for three virtual machines.
...
$ResourceGroupName = "$($AlyaNamingPrefixTest)resg$($ResourceGroupNumber)"
$NamePrefix = "$($AlyaNamingPrefixTest)vd$($ResourceGroupNumber.TrimStart("0"))"
$WvdHostName = "$($NamePrefix)-"
$WvdNicSuffix = "-nic"
$LoadBalancerName = "$($AlyaNamingPrefixTest)ldbl$($ResourceGroupNumber)"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDCJffSlqa+znQz
# N3qmavJ9tMwhsz7AaWB4T09gPyCoLaCCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIFJ+BAHFPXr0ZB7N
# UBXuF3e6M+JxOVMPl+3BQMDOrZBDMA0GCSqGSIb3DQEBAQUABIICAEpjJ7EVsBqb
# 4UUf7+JUK0MzBoSGM01G2V+wnldF84yfs3i92uS6L0yc/AU/2sk70WPoL0+joumU
# 8P1nfaurPccjQrmYZyZAE5OPkh/sR46+btj7aj+5FNjZtdq5s5bgy92yDFzPglvx
# mT/LOK9DqOBSO6ggRlWjSwyIoog0TXFkUOaE0DK1Ic7PDrIruRfCC40NC9Aehvtk
# 77/npyTnGNWe+0CCSQ8tZVV5iG9nyNGLoWLwolOogbGyR6h9hhlyqGu4Qa5wFy6z
# fG192PGmK/Fctlx8CwoCbJ8dv1wnxgkIagQcs+klSBD3CGrZ4HpPGwDim56d40di
# oSeWrLQ0TuUo7/8KLsPpZBiFZnGowJwUxnOT9tcX4xFXbWWPadJly8qN2QnyWQ+W
# GVuG3EwX18pzglRgXysDqHM8HVU/jIwHACD42rF60d96nB3Rj2D0g3ExJUeUi+O7
# dwv15Tp/gIe8VPz1AIhVn03nXjmgy4p68OgmaVWK4xRjCN55gQTqCKwe6kC/6EAr
# bQ6jBGwDHqx95/KkDwMpC5WjmmKsH7B/aaMO83cUTKPxRIOqt1WLCzw844SWQnfO
# nqKJTn5wUgdyMo3/TthwnTyLEM5VZBDz139qKczPbk7FedMQ6bosnHWdGY7tT+a0
# VhRp78IsQAqLq1RppEUlB6yQ8cmwOVEPoYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCD5YQXvZa3VN22v/fBNdGPDS+0lfF79g+7rpkzffJViOQIUCo+Pe8iwTtGR
# vlvaQHnag8/wzwgYDzIwMjYwMjEwMTE1OTIyWjADAgEBoFikVjBUMQswCQYDVQQG
...
# IOJ4dqGKedKMUH5oiigRuJCyY6EtA6H4n1VmyaWaX9j3MIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAHUEaMOGprL/p
# u/4Pm6FaY2JluNcTJl6uWF7Nd90DrszIO4WWKHrHU2jjqEDAUYbbF8CUBVZ2eOup
# MnZck0pSsK2dDrWklFroykon7/OnC/ElsTN+t3yrW+BU6kon2ulSuQgkdHUBcAnN
# zb12I0b5RTkMscUqCR1KuQFVoxELRaWBvjikgcmwdwC1Ky0DOzjnKlipJY/bbqVH
# phHmrDFwALttOXpTBTArW4Qm5KtUtKobUdoQHMVZloStkshjnCgth5lAHMXwUY2Z
# Aizv4i7zR8EJ0osWD0aIE7dKMA827En2Zf/PQkIFg8YS4dUH2sKmVXxF03dktd0O
# YbiwxL7kZibO4l+mCtI1OBMPtaG9pu1Cg25vuFyaiZvRdyYp6quN9YgD+BkSD5PT
# chYw/VZROLzABliRGEvIUdf1GvJvIScXezgMmybiUGn1S/wzUqrhyPaHZxuCxhO9
# gOQ9Lh0OYlRhrPGZXx6+2fxGt/L+TbFx7A+agP3OPo5qnrCaPpJo
