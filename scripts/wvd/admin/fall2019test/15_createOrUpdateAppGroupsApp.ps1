...
<#
.SYNOPSIS
Creates or updates application groups and associated remote applications within a Windows Virtual Desktop (WVD) host pool.

.DESCRIPTION
This script connects to Azure and WVD environments using pre-configured credentials and context. It verifies the presence of required modules and logs in to Azure and WVD services. The script creates, updates, and deletes application groups and remote apps as needed, sets appropriate icons, and manages user and group access to those app groups. Additionally, it maintains logging and ensures that group memberships are synchronized, including administrative user access. It also removes obsolete app groups as part of the cleanup process.

.PARAMETER HostPoolName
Specifies the name of the host pool where the application groups and remote apps will be created or updated.

.PARAMETER appDefs
Provides definitions for specific applications, including file paths, command line parameters, and icon information.

.PARAMETER appsToGroup
Specifies a list of app groups and the applications to include in each group, along with access assignments.

.PARAMETER availableIcons
Provides a list of available icons that can be used for applications that do not have a defined icon.

.INPUTS
None. All inputs are provided through parameters and environment configuration files.

.OUTPUTS
None. The script produces log files and modifies Azure and WVD resources.

.EXAMPLE
PS> .\15_createOrUpdateAppGroupsApp.ps1 -HostPoolName "WVD-HostPool" -appDefs $appDefs -appsToGroup $appsToGroup -availableIcons $availableIcons
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBPuI6c9hQRDXsH
# kb3Kk4MkiCnGDoFDGy/d/GmIAJhAZKCCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIMQ8vpe+1TWLss7G
# XrBpSPbhxOzTgUc6lBxANbuLEwY1MA0GCSqGSIb3DQEBAQUABIICADqaoP4CJOrH
# yVIO3QPRhzMbKMQmd5yM2k0GnczseZFnPE86gYPoSq9ndiS1E549y7Rk/3uvXuzB
# fErIiSiciy13mMcl7qDXggi86AFRTEIFZ2eooU7qv/BmOoPvraEYlH3twhl58omt
# A+ZyW6IC/HyaBKUcFY8dJLJ4gNJwF2tgdbp2PXki5kA52Zh6//ehl9eaSwj1kyNr
# s14jzlCPdvZbdDL64mqAAQzfLvks+pdkJDNIzN6aQdiw8oFtF66WTZaXweDKXldY
# lWcu4ighqZeZk5gQfaE5bCcNoWVFkCnoRXMVWZ9TI2rXQnqsmjYTcoyZvGYpOf2I
# luuoyGWQ7WzdixFEtdpbYmLCa2mDbto2Pl+8GoGx16JziZJua1dLpePYWNgeJsFV
# +ZOHFQXkHpnY02cOfwUIWjyR1OYCgn1lypjUhVcnMdXY9NsLkPEiFg58BlA5Xxt0
# ALfZkd4OVD4p3XY25BictHf3qxqO2dg4DtcTylIaJsmmWBFfw64njLKpce/N6y1k
# 2D7/zbci348qpe75Cp/ZYUZLv/Xg6KDUAzu8aKDMakaGmIXURa5Q+/TBMe0NpqMQ
# oALRqiDBT49Wi3Y4xuYoXk9/yYsFxoA+ZHJtvuZsaYQyfD1f9g6zjILvjSAUV6Xz
# 6go9AONa7Xq6LSlRVPld0XsYch5pSnbYoYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCA/jXR1P276erCWfc2CYM84nYl9d3ogRdTQ0ILEQukZSAIUNkZIyJyjSFnz
# uqBtYaylkNmrRMEYDzIwMjYwMjEwMTA0NjM3WjADAgEBoFikVjBUMQswCQYDVQQG
...
# IIatLT37SwupI+H6xZwdexG66Ogy8L3G+GCkSq4fMoxBMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGACxoe/JmcOTA9
# B1+Aagib1AD8vYnYQNmAVhoIvscIBBgY9XU0y8b62MBLyHwW+BtxKZu82K6GZ6VY
# jE9gDyZi+IGbOBPbCqSeAM+8yiehTwXH5gTFNTcdfLxSKk4HTO1xe6fGRhVkXfdY
# EA0AhJL5SizHZ563WLcjki/llJnk2ZgBBiERMqibsO1Ifdb7Sj3ToMwqp1PS1JgX
# bEuS4HUtRxHUVsQ9knEI2AWh8so/w8RnQRn/PsVVL1KXWQfwvFAIP9+iAHTbObPv
# 9XIQ0zaGycGiAsxqLyE+Sa9d7r/tDIauAo4ng8680Add9bx9q4VULGOui9/QMhap
# xYpMJVpDsUg/UC587N8SGRxlSN+FeXJ96i95l9UujJOb6lJ1KaBwDnyL+Rx3lILa
# 2aORcpPT7WTdDiDtorwBEcCOg3TxcHfugG3Rw8ZT9VSTg3JdYADkhyjzi4j66Gf1
# xSUJ9Vg46m1abQsjErTAQzsdgeaHwgPld/ms0mGRJkcKJf/x/5DU
