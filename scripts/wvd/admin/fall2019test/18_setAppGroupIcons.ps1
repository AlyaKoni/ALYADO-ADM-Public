...
<#
.SYNOPSIS
Sets or updates application group icons for Remote Desktop Services (RDS) or Windows Virtual Desktop (WVD) applications within a host pool.

.DESCRIPTION
The 18_setAppGroupIcons.ps1 script connects to Azure and Windows Virtual Desktop environments to update icon paths for published remote applications. It ensures the necessary modules are installed, logs into Azure and RDS using a service principal, and checks for required assets in Azure Key Vault. The script loops through all app groups in a specified WVD host pool, matches available icon files by application name, and updates the icons accordingly. It generates a transcript log of all operations performed.

.INPUTS
None. The script does not accept input from the pipeline.

.OUTPUTS
None. The script writes progress and status messages to the console and logs output to a transcript file.
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCA6QKDyAWZhBww6
# Ab1tI9gmMonJoctC5iUZauqKcfFzlqCCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIBhkXOVZgsU9Uj/f
# XOzGFtxaYeRlFquwMEBRhmiE94xPMA0GCSqGSIb3DQEBAQUABIICAF8m3m2EY2cn
# clb8Q6OYiqLi3wTdyk9XruWBuNw7xy0yAeloNOjXfDDrR8aZFh/ZBJWbzQVgYtqT
# /SUUaZyn+XPODSNNUMO+34OaZYU3OeFbq9bEIC78blwK1DbKEagF9fvoUzWSmuG6
# H4kS2YvHsn+0lTVPMIex+T+13hdOOj9ZObbX7tcqq1LrBUGz7zRwQc4XlVX40RRt
# /oS75LG225oFatwrP9NCE/xOXkHM3Hx/OGwRgsEEATpGMV/QD6YW896+sMtHZD0d
# OQF0vf35CskNJxfmxUMwnlIpGXEywFrR+19xGU5r/Y6gdHOuLFJcecFMzoRlQFch
# 0cuQbkH82n/MyqxzYCiMbWJ+T+36HJEA+s1B6kZniB3iRA5xJfJr9MPQCGmI6OKG
# Wy7AdlncLFegZ0rHJFCoWTpxkdkq5JaC+kT9PBt75XnobIPYe9eUtwlVGH1eQxpr
# i9KECNY+xBnV+vFDlXKlt6ezhk/gHx6hQHTIzpjbZa5mU6TTM+61ewP+tu+ykq4F
# 0lG9ytCaABCVvCVcho6aA7kd/TtFPcg9G6hbv39bVOiTQo62CCgNdz8GTk+H6VDF
# GxnGxxd4vgiqQ74OzLmCDmX99sqlSMs2a+jqY7Fzie52UoZ8EM9KjAUUq2tBMUTS
# bt62lHqHyvxpnQE4QHVFleQMXxRxVMXVoYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCC/gKVDoBcSfDV8AcWPwZ3P4nqlIi8oYzOM+z9hVx2kPwIUckSB9/IXxvFC
# gBdFTJpGZn108jUYDzIwMjYwMjEwMTA0NzI4WjADAgEBoFikVjBUMQswCQYDVQQG
...
# IBbf75n3tQ37gUGuv2T0BF50WvwezcutsMJ12/p+gWd/MIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAVYKP/AnlYy+f
# paY3fvRuBBndKMX0mnTt/6zN9pDbZ3OQL+tRijXvp10wCGAfTNvh0P/VCEayLhWk
# /Os+zJxRZuPykp9Y6taBEPiMQNmmQDBRZ8Nn+x1Y0GRfq6oeSYtUg/kGpL+GXppI
# WkVmUSGu4+PPFSKxBPjC35Vn9JgbepOJGE2iOSy3zyzyzhwMk/jzUfOzdG9xWOFx
# xprMbxyFpM53t5ZJ7o1xCRz5FsXLb2MiatMS0KVZRS/rM1t12UF7rYFrqRU/7fkP
# abcrS54okaxsl2NuE54rA0vJqtngxESTT6OUbXrrwhtd0WIrkbhC6KC/RYHzhO2l
# rdxt/BXdlCwVB0FRo0oOnfuC+sODPux3Yb5/FhIXyJzKR7jDmSoFcE+i06M5yhhk
# SYWN/WYOhk3jmyFVDMHNO9IHwujJ8YFCbIJ8y7m3O0vPHk56dXXerXnAagJlUwBQ
# 8NdwiZ6W841sdu+/ZodTce7fhjI5TNOJVFlU+jzukdcarWutLMLq
