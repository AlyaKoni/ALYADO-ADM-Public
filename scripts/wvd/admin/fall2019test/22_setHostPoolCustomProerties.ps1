...
<#
.SYNOPSIS
Configures custom Remote Desktop Protocol (RDP) properties for a specified Windows Virtual Desktop (WVD) host pool.

.DESCRIPTION
The 22_setHostPoolCustomProerties.ps1 script updates the custom RDP properties for a given WVD host pool in Azure. It allows administrators to control features such as audio playback, audio redirection, camera access, device redirection, drive mapping, clipboard redirection, printer redirection, and multi-monitor support. The script verifies Azure context, retrieves service principal credentials from Azure Key Vault, logs into Azure and the WVD environment, and applies the necessary RDP property changes to the specified host pool.

.PARAMETER HostPoolName
Specifies the name of the WVD host pool to configure. If not provided, the default value "alyainfthpol002" is used.

.INPUTS
None. The script does not accept pipeline input.

.OUTPUTS
None. The script performs configuration tasks and outputs logging information to the console and transcript files.

.EXAMPLE
PS> .\22_setHostPoolCustomProerties.ps1 -HostPoolName "myHostPool"
...
Param(
    ...
    [string]$HostPoolName = "alyainfthpol002"
)
...
Start-Transcript -Path "$($AlyaLogs)\scripts\wvd\admin\fall2019test\22_setHostPoolCustomProerties-$($AlyaTimeString).log" | Out-Null
...
# Default: empty
$Dirty = $false
$properties = (Get-RdsHostPool -TenantName $AlyaWvdTenantNameTest -Name $HostPoolName).CustomRdpProperty
if (-Not $properties)
{
    $properties = ""
}
...
if ($Dirty){
    ...
    Set-RdsHostPool -TenantName $AlyaWvdTenantNameTest -Name $HostPoolName -CustomRdpProperty $properties
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAnOXLO/52wwrNt
# VUitJw2fcd39aLAjxy+fQ3b7YCeLcqCCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIIpHs9d/Oz8YglSc
# uSBTYilek4jpoWoTvO/90K0OlY1qMA0GCSqGSIb3DQEBAQUABIICACZ7ersPvSJf
# JZvD3uqLXpim6Oo13zGj0liQVnz7rIvf/+2XJbgM/9U0YDCLL8V4/OZlcOFVXfLG
# uGGksY67dGre3taBl9t7gZjKerwI9RxxGiKsS1Idwvae4BycnKhs+2PyfM+hx5CG
# DHveuEDx1BBVNkgSIyuI78kQTXUAb14XFDdGjmLP4bxSJzq5PLy8e5ttdJy8uHit
# ST3cCQYhEM7VJ0Oqy2Q8t+l1uAZL09fW5w0DVSJZ9bm/h9zBld6UNv5ggDYjQFbU
# g9z3OpMjOuWW0tDgUqhSMP5iCYliK36sDNmtCpQujbkF3xjA7STuu+7CAAkDsi94
# SUrKfi3ERsuAMzGtfwPMAYRFvBtbJhYL1T6WYS4/J0Ba1Uv9dOgTsxqEq1hbZwjY
# XxRfqP7MbiRBzUQas/mbrXWhzKBfbue96+L6uN9KVMkkv6SA5ZpM3zFPcm/LTt3o
# YWh/ycXi18Lvc3lxN6s7NxdLhuzZywgqBkQQmylRHylC7SyZp4Wi1+yO/yAga/Ol
# RFJ44250UBUecEWdVOa9HlF7RseRDKQ7gIDBLKnCRfE5NnRxyMOQjr0LmMiEWFjQ
# HOL5/YZxRTvmpp5l7KB7IMBgNIErcK0xSAxZXrYQDk0tFT7vytO9gmB/Z0Xnp1pj
# 9E6IZrEeyjpqDThz4Y0Wsy1e7izSzYlfoYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCDsErMCEJ7p52TaxA+hNMdrvO/cQDrvIIGEuKZmU+5EKwIUDgpRgUcuWDqK
# 9vHrAPh4aI0EtYoYDzIwMjYwMjEwMTA0NzQ2WjADAgEBoFikVjBUMQswCQYDVQQG
...
# IJz197aTZUUc5xWxHmSDj8e+TGRKL7aL7q1wKjxDSWhkMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGABsV3hz8JadZ/
# dKpunpfhxotBFgxqxcgvAZ4qeT3aWk/1CkVkYq6b4JUwldBf2SheRfIrzpI32hBj
# agArXy+6D/gsLh0dUA+Tgoni+G8Y0xl9tpq/2/CBPBKsMYnzL+RvR6aeueF639za
# 99UU+HKeistrmlEvYbpvjzBL8oEI+d4tA8V4y/lAgsUIQwDqmz2fgmkGVXoIGsvj
# n5lXSnBPBqKZeWNXPx5TLubn9nClqj2A9aYh6JSRuKv0ql1cWlzrDT9BPsP5Mss6
# y1qLuua/h3Blbj0aWV9Ig0NtCotw8DAiqafMMMDLHQ6+2LATJh/rCV8Kl2gwK3gi
# EG0R/kPiX0oXDj1UTibILUUGTtMZV/OLlbzOn8enxbwNkCPbkPxdM9V8W4DYlJkd
# aebXs6dFsTKoUQ34E04gqSGiJxk4crT7Ct2tpxGPanM5NrIqHOlWzlvz8VqCHe+k
# KgoCjXWg2feeCwKDmU7iTzxaBPCOGTdKk31+Uaw5pe7MrCw9c9N5
