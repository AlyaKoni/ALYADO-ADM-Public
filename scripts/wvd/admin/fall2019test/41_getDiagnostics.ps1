...
<#
.SYNOPSIS
Collects and displays diagnostics, errors, and health information for Windows Virtual Desktop (WVD) environments in a test subscription.

.DESCRIPTION
The 41_getDiagnostics.ps1 script retrieves diagnostic activities and health information for configured WVD tenants. It validates the required Azure resources and WVD context, then connects using a service principal to query WVD diagnostic data such as disconnects, errors, and session host health statuses. The output provides an overview of recent user sessions, host pool health, and any connectivity issues. The script logs all execution details to a transcript file for auditing and troubleshooting purposes.

.INPUTS
None. The script uses predefined configuration values and environment variables defined in 01_ConfigureEnv.ps1.

.OUTPUTS
The script writes diagnostic and health check information to the console and saves a transcript log file to the configured AlyaLogs location.

.EXAMPLE
PS> .\41_getDiagnostics.ps1
Executes the WVD diagnostic collection and displays information about user activities, disconnections, errors, and host pool health.
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDKiluykZdTdU1/
# 6Sz7xfKpHF4AkJaBT3OHayJIebABTqCCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEICTY4Za3EriwskAI
# hM8hdvTr8a/D48YJmFl7o3q78+5dMA0GCSqGSIb3DQEBAQUABIICAHNa8WZEnJTq
# jb0VLd4tbatQeGNopbYkz2bGS0UuRQ8+5mMjHmkZ1y+I0cCtjH/sn8iAljZC2B5e
# kLLl8zQITDMSWENRZhN6wfH4wQXchv6IA7S799sDslyAy7ZS2IkrWZiNblCrjbjP
# PdUegAzb4K+vPSemMhfuASSx+xDTfeRfdLIHWti12+/7idxOIx83ZNrzlgqDj4jX
# pfMxSZ2yY3gYx3p18Fiif3DfIF4I2ASbYM44qaUQD/SVWdAKtpiUtCIMEKtE1iHf
# 8AV7MRwdkfvBPA01ARPM51AuaPNx1scI1Nnm8+fm1HZLInHsOsReCx5fLsT9vEFg
# qwkUUCnD1ArZeXlj3HZO1WdSqQEnddHWEsRhz7v6iB4TYJBRnkrShQeLga+ufoqX
# GpMzGlnWU4gVgF+yACAfv0nEGCGP3D+VvWxPicj5NmsxshPa3iYzzxZfYo/bQoIA
# etwuPkduBMzT+qNWYZ9udcc0Ec7+kGejpjZdyCYXdH1v0N8znfNDxrgJxr/8bCfI
# GYpqo5vVcHDrfl19YNHIXLJJDDW2k8qIosvQTa2JhVw1IEz1ezNG7qRQ6hN44jyy
# kzhtwYYQnj2WLajL2BaQNd15pu9iJdfIZDoCRdRgGDTygzNujWDTtzt2GEJH/NjZ
# yQlkt06hShA0mlKwt8APCIjSBELiJ6UooYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCBRtJl49yzSQwqeM7xOg0bXrJJGo1a9ynsYy4vj9foBAQIUIkrwI2rIqo/i
# j0eg5KmqfSy6+5sYDzIwMjYwMjEwMTA0NzIzWjADAgEBoFikVjBUMQswCQYDVQQG
...
# IPH/EVhLQc0JUs1Lm970PSzU3oXB7NcIEF4uWngZUgXCMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGARlWyKB7N/0yJ
# 387I4FLUdcQGVn1XfYru3nZRgJm+FVe9MfHkfo++Ujnqkk23PM2isrxw94yuaxO0
# piPMBrdnO668903OSo0dKDFsBzZhMW919Af6Ory3ZoB2kilWWGzuUygdQKl10R0q
# 9YBqWO23PNHwxxA06BCMqFage5wqPXpc+CtDmwAlQc35E1/MKu/kZSHDQN76pHZy
# MZqp9yGnG7Evp7MkJ20zKpeduoAIQYnFTyw6BAfZ062eX7whze/4s11bT8xEdagz
# +RyuRo0XuiqjiRVC5mn0yU3PWQqtug5q8C8pHyx6VUjtWLWHmjnNyE+jRQUn9i8f
# zU9jZ2TgssfQEVPuzttEmVvjc0OE+3E5MHSmR1JpnRclwLHSLeILmmLcTKsttynA
# rBGqW3HGcmqGABkSQQqXantfEpLw3ZjAHORhfaJ8mdK1EEhdcymRmJtJ2aQq83vz
# zXZtEgBGtVpC4psGmJGhGKqPpAzbLCv+091crBj+2sugC5SzVmWp
