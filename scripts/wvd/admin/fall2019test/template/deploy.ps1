...
<#
 ...
 .PARAMETER ParametersObject
    Optional, parameter object. Defaults to parameters.json. If not provided, will prompt for parameter values based on ParametersFilePath or template.
#>
...
{
    New-AzResourceGroupDeployment -ResourceGroupName $ResourceGroupName -TemplateFile $TemplateFilePath -TemplateParameterObject $ParametersObject
}

# SIG # Begin signature block
# MIIvGwYJKoZIhvcNAQcCoIIvDDCCLwgCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBRXIzBQxY3PSpz
# BTWrYsEDjeuX0wms+DKnp5IekPP6y6CCFIswggWiMIIEiqADAgECAhB4AxhCRXCK
...
# KwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEINZgkrSD
# WW1bTwJxpKPFC++AWZfo4OVbTiy5rvgIDlHGMA0GCSqGSIb3DQEBAQUABIICALKZ
# df7aZGhUl4gcUZkGfw+iKQFNr6jhW9HqVrn0p34YdMh2cbygN775BSoeJ6RKn3Cl
# LmhUB5bNXAfrydfQbyTvtjjDLr42wSYZ1DXKDIePQwFf4KT1VySQvRdQxFUex0Bl
# BE+1umWCZNibxayjawte4VHT2E5f4keAdLvRubeSaZ5EzrEOSTk6NWSbRG8arPgL
# bCtQeSn2Hxwh3AtqNl1np8e+W48ycc+ReSzDa2M1K/7EHZgTGx09/QZlmT7+bgB6
# UzVjJ1n+MQRZWcWSQBPHQe+J4CHuMQvQSa7Rt4jPZeRGEWl6i84AtxYT/6lbssAA
# GqJ9Yds/ueMPy8RxokXRPPYRrl+5rdbgQSljNqLiJmscwuPVOKBPx/3gq3H/WEvF
# T5L+SQBi1icnGXKC+ViHnm9MrZId0/SDiOsJ5bFfvv5uWaqJgrWaTzDkSAQGGR4D
# d7YT6+NfFFRJ0wT3Iy/tL0dDJlMZLEHFTCMUCFVERtzctlt0sFFMV6gxHcqGByAj
# e1LNS0badMSVRHYAfZ2YJnS47mZnstEhwpNKn9yzjHuSxzX3ICtGXkmyWHfNHc65
# a3zNIpy4cmkDuwTNhOUbn9wA/4ugwXdktdX5M/Wjkr6MkI0CrvpidLC5tEY72+AO
# KDzHAZOJBZOj/m97I50AB/AzpiL8QqFERCUSIz0QoYIWzTCCFskGCisGAQQBgjcD
...
# SAFlAwQCAQUABCCv5Zv7hQmW6GRVHkkwMP+Q2JjiK2wcinkckcZD+NL8GgIUVyln
# MKaHxN9KhraplNQFGtnKmxIYDzIwMjUwMjA2MTk0MDQ4WjADAgEBoGGkXzBdMQsw
...
# hvcNAQELBQAwLwYJKoZIhvcNAQkEMSIEIDnAXG32+6OjILCfGo32LYHDVRY8ivLu
# SO+r8h/EalVeMIGwBgsqhkiG9w0BCRACLzGBoDCBnTCBmjCBlwQgOoh6lRteuSpe
...
# KoZIhvcNAQELBQAEggGA1/AafFqTyLoe2xj8khIymPECZK1uGuuyTO2ihVLN+jYW
# 166zNh1L1lFCg4KdNBSi7cU9zDsZeYhr48w8hH2uKks+Ldsfv1ddLMQXmuo/rJnN
# wfJm7KNc4S8cZquC0U0mAaXUJCTj7Okl2ovsTnUe3gS8XViOI7v2cfn1a8U6Lu0h
# ZJ03FU6UDe4Tjjh+51N2hw8+RW2C6+mVAt9bJSJWae7XDVMY9ggBBV0oboiQUuC9
# GXE6a16JfNbVg8C4Q4o/WIeelfyqCiCsqInN2YIrqzwpyKSkkaYRNSoWGBEEBfEx
# qP7XDASaBPWPxeWptfI+ZBAEqb+cniqeOFWUp2qhPEqtxxSfpJNSjKEaXS/Pz4tU
# M1UwGXF7MvbpaZEuoI81MRN7RzRThKexs8A+fcSlZEOe9WH3artWX3TiEwvKeIUY
# Im00uE1SF7fmcE0gBU0ty8nR8g+rOjZ0Jh7rMdE/2RwPqY1Ak6yS+1GuKPnDCZfR
# sIfFCidDeeO0IrLCBhYS
