...
Start-Transcript -Path "$($AlyaLogs)\scripts\wvd\admin\prod\07_createRdpHostPool_hpol003-$($AlyaTimeString).log" | Out-Null

# Constants
$ErrorActionPreference = "Stop"
$HostPoolName = "$($AlyaNamingPrefix)hpol003"
$ResourceGroupName = "$($AlyaNamingPrefix)resg053"
$NamePrefix = "$($AlyaNamingPrefix)vd53"
...
$OuPath = "OU=PRODS,OU=WVD,OU=COMPUTERS,OU=CLOUD,DC=ALYACONSULTING,DC=LOCAL"
