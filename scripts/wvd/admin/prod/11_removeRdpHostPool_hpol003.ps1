...
Start-Transcript -Path "$($AlyaLogs)\scripts\wvd\admin\prod\11_removeRdpHostPool_hpol003-$($AlyaTimeString).log" | Out-Null
...
Write-Host "WVD | 11_removeRdpHostPool_hpol003 | AZURE" -ForegroundColor $CommandInfo
