...
Start-Transcript -Path "$($AlyaLogs)\scripts\wvd\admin\test\09_updateRdpHostPool_hpol003-$($AlyaTimeString).log" | Out-Null
...
Write-Host "WVD | 09_updateRdpHostPool_hpol003 | AZURE" -ForegroundColor $CommandInfo
