...
Param(
    ...
    [string]$ResourceGroupNumber = "053",
    [Parameter(Mandatory=$false)]
...
Start-Transcript -Path "$($AlyaLogs)\scripts\wvd\admin\test\12_AddLoadBalancer_hpol003-$($AlyaTimeString).log" | Out-Null
...
Write-Host "WVD | 12_AddLoadBalancer_hpol003 | AZURE" -ForegroundColor $CommandInfo
