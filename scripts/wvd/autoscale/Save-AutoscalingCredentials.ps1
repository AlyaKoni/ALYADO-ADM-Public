...
<#
.SYNOPSIS
Saves and manages credentials for Windows Virtual Desktop (WVD) autoscaling configurations.

.DESCRIPTION
The Save-AutoscalingCredentials.ps1 script automates the creation, storage, and verification of credentials used for Azure WVD autoscaling operations. It reads a configuration template, gathers required values from the user and Azure AD, stores credentials securely, and generates environment-specific configuration files. The script can list stored credentials and handle both production and test environments based on provided parameters.

.PARAMETER ConfigFile
Specifies the JSON configuration file used for autoscaling setup. Defaults to "Autoscaling_Config.json".

.PARAMETER ConfigEnv
Specifies the configuration environment. Accepted values are "Prod" or "Test". Defaults to "Prod".

.INPUTS
None. Inputs are provided interactively or through configuration files.

.OUTPUTS
Generates and updates autoscaling configuration JSON files and saves user credentials as encrypted files in the specified credential directory.

.EXAMPLE
PS> .\Save-AutoscalingCredentials.ps1 -ConfigFile "Autoscaling_MyHostPool.json" -ConfigEnv "Test"
...
if ($ConfigFile -eq "Autoscaling_Config.json")
{
    ...
    $AzAdServicePrincipal = Get-AzADServicePrincipal -DisplayName $AlyaWvdAzureServicePrincipalName
    ($Variable.WVDScale.Azure.Variables | Where-Object { $_.Name -eq "AADTenantId" }).Value = $AlyaTenantId
    ($Variable.WVDScale.Azure.Variables | Where-Object { $_.Name -eq "AADApplicationId" }).Value = $AzAdServicePrincipal.AppId.Guid
    ...
    {
        $AzAdServicePrincipal = Get-AzADServicePrincipal -DisplayName $AlyaWvdServicePrincipalNameProd
        ...
        ($Variable.WVDScale.Deployment.Variables | Where-Object { $_.Name -eq "userName" }).Value = $AzAdServicePrincipal.AppId.Guid
    }
    else
    {
        $AzAdServicePrincipal = Get-AzADServicePrincipal -DisplayName $AlyaWvdServicePrincipalNameTest
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDNkU/j96DB1wj7
# ro2cOFP/4X7ndDyCekLrHO4UJ/CIBqCCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIPQiZincs2w5OPWe
# l7UMRH8FSv3pKUm3xlSnm2P6hsBVMA0GCSqGSIb3DQEBAQUABIICAJhIXLrP7FbT
# kfs59UmVGXvnDNFKPSCJEHOJ9cIbn5cudkTf64JjQcGjLmqPvMKvONTyits386pw
# 1Lk5VjucyVXgc9T/suiUE1YvJ6gpW8+PZmOim743uROPQr1PFJXaz+LiWpC6UnbV
# wL+J3Br9dp/PVCtedOIhJkrfPBf56QAnpF0nTVzP1NNqrbEdkZrNd/V1aWuYwjlT
# NNGNgOJYaA1Oy5ACouuzZrfMHyjl2sLpdRJjb/q16hixefeiDvYvYCsoBPNtHJWX
# OGohSphQ0k/IqdpIrDVWycjeZdo1/KfNrxIvhKSs2frpUmmNNR2WByGTyim65x7B
# iTlXuly1DtXfMX6UmKVbMxK6fNLHmZ5mRUNMkaABnaumZkpxBR6kbuhy2OQV7Dgx
# kP84T6NsZQpBlnVauwpseet1gGFu6LhXqsDwQXanoCMs5bUuoHGa4+OqsfdVzMOw
# efQ0N6ACEASboDe4YZO+qyYoAhbYaFveL4U2mr95hGlx749ciiGWMSdFsr9Iq2Qu
# XN2H/j0oun+oPy590+yvH8dO5TH/2+03TCQU+NkGq9QEAxwWKZQxFwpP8/UhokIz
# 9U+RkUBD27rwrzx1joBOBi3oCCftk4A99S1uiZw3IyBE3mdQj7Ejg0WTQNFIyODT
# JE38QLLkmPgNn3VueJAaMzMURgsVCYU7oYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCAYko8527FcW9N2SRqWDXJEi6YOZ+HjyO1Ji5jQWutmcwIUcuwwEUx8qlrD
# iTUpQJdErSsBiSoYDzIwMjYwMjEwMTE1OTU2WjADAgEBoFikVjBUMQswCQYDVQQG
...
# IBHlnoTf6ujY5lEh0uMeyT7nJDJbbCFE53FaukONSxaKMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAeYJzELqCeKcD
# ewOm8BrYtm+27UIrqe43arKSnuieQ1Qgyqnw7yyW6hPW9a706OlBkbco6/FPz06O
# 1AZ49JKGShInOtfGJ1YqjzKGEGV6M96ZJH97kouKIRR/NUNK8kim32Qr0YivErp8
# aLPxkfkZji8YUwK8Fwyn55kFsUZLbHJyrO5V8NLKeKKbf/E6h+esBtoE6aXZAYMI
# FB/GwqkOpIu1YF0la1HqF7+0IgGSCMT+/aVO3q/StA9VPYJ/LrpQ2TJl6y2Le2aS
# UVpV7DYrwbI9GRMEoAsXtDMSkeBwWfL4axCxzg2Lygw4K/SVEGyK45V/sD1ycDWB
# p6nLpXjPFP5ANsNqatT2iGYkR7Ma1WVFbzz8QbYiuuAzpXzS55ZQ6to1yN3HLpg2
# lvEBm48KPcOFLZetM4hNWVgJ/NNqPMhLYpcJaSM3BRjAlCg2jZNPO3+HRw1S1HvA
# QioZ0ExDvXO666ciQ8yvIp5PwgzjdluKGPLTE+Owrtc6xiSWSscb
