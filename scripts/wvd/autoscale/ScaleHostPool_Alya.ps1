...
<#
.SYNOPSIS
Automates scaling operations for Windows Virtual Desktop (WVD) host pools by starting or stopping session hosts based on utilization metrics and configuration parameters.

.DESCRIPTION
The ScaleHostPool_Alya.ps1 script monitors and manages WVD host pool capacity according to a defined configuration file. It authenticates using stored credentials, validates configuration settings, ensures required modules are installed, and checks the WVD host pool’s current session and capacity states. Based on thresholds defined in the JSON configuration, the script starts additional session hosts when utilization exceeds defined limits. It maintains logs of actions taken and writes usage statistics to a log file.

.PARAMETER ConfigFile
Specifies the JSON configuration file containing the autoscaling setup for WVD. Defaults to "Autoscaling_ssvpinfhpol010.json". The template file "Autoscaling_Config.json" is not permitted as an input.

.INPUTS
System.String. The path and name of the autoscaling configuration file.

.OUTPUTS
Log files recording transcript output and WVD tenant usage information. Console output provides process and status messages.

.EXAMPLE
PS> .\ScaleHostPool_Alya.ps1 -ConfigFile "Autoscaling_ProjectX.json"

Executes the scaling script using the specified configuration file to manage session hosts within a Windows Virtual Desktop host pool.
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAbkdS9Znc571kg
# qSkJ28W0AEED5IVC8S1H3H1k6ye6cKCCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEINWu5KH7UM/Nh8Xz
# W4TI+H+7F+lo7yDN4FkikHXzWiN1MA0GCSqGSIb3DQEBAQUABIICAMQs3R+ioDPz
# TnwO6qvztaXTqJIg9jCvhKXvZXjnDEXav11slZ//2N4iyoG6S7qwHMWFFm5OGZgX
# W4a0Ylq8w3qUOo/BMzOjnL/Jf6lfEhXooqCo4VA854FxdNIEw9ibS4OPF5MF40rm
# MVPJOJHvU09/PFhQ9/CHh+mslA/zqKhMWa4SE1wZy9PU/D7Atq0JGVvlXknHQszC
# SFyfkRJ8Ys41NFldaCiIQ5lCpuVrNPecSqwlbmjo8HFyqpKTknHZNY82hiPWlSPM
# x7Q6gAZP5tgOxVQvzd/S38LLMYscXGE8mPS3MySJpvtYNgYtjiChcx5i79vip1u/
# eBgmLV2D1mwFaF4R1zMB6R+V1c/mxiAv95gU36joI5H500dtHG5P9njcL7vHCATD
# E6DF4CU0Jl3Ty81kORR+VYzcEuvfBA7xF8Uv7m/uN11gmzOFVhGqtzDvXIUWZF3t
# XXg29nONYQi+oQUO+8exFwtCxHwF3MOIGJ4UKVcz7YsIzk9cMo/lmPGhJeTKEc+m
# 1u6MiQJoelyNbQ2PsXol3yALxpW7ST0pW2zsEGdIKDNFi2hdTHoW2r6osGYDzElI
# 0Q53S7XVOiDC5FTn5YypOk5BEjSSRRHjZ9RPUqKQ0KMH58/cuNHU5DtrzlVjLhai
# oxjehtAM2KFtOzgPq371CKKzrxAK6NVzoYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCD+yIndMXVHl5EZjcmHLVFNrGeFOyvpxLVO7/8E7jPIwQIUHK2l5cxjtSZG
# 1eBwKNfGsaoN31gYDzIwMjYwMjA2MTIyODE0WjADAgEBoFikVjBUMQswCQYDVQQG
...
# IFV9VNe+hL+dWLRDBuy2iEB9Q6JZOeFdtlh15H9MHs7PMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAQFZk2TGS8WDK
# dplcu5PUSMsKIkmsSwweL0SkQ/iO3u0CKK6akgRlBAwl/pJLAnF4JsdqfEDESvJy
# eq/CUv2KSvzMorxERyunopVaSsRB9HRkqtWR90F7UA8b5HukQ1ii5K3cBqm/cD4F
# KeoRVGC0/DkLR/2dtIr+uCrkeWeZYFqzznTsMzR8Ttyh8yLDhS1ErxP5mM3t1sx+
# 2VuSvKxP0b0kYbzMPW/8haJrUbKP5gMw6E7KsCjhx00yQNqw8yv3V0385N/74duK
# l43fhC9lu9dY+m1PeZiYbMKs0TYDtF1YuWul2q21cvmfQM3aFbwcgSPMCeMYi6Uy
# xEHN52d5yb+w5kirOmCJMpiFIqFbvriFfhJydy9ssgBuZ2f09UOh6iqLr5w4iP5n
# Id+FaKHUVWuxRD9bl4dp0vTcYy1pwZiFTjAZru/9IR9kRmSybgGnWUxOB93gUyQJ
# G02VqgF8Ls134pIgiTgVY3ausQbMGIFBdz06Mm+ZE9Ypify/7H5e
