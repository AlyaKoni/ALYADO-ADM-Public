...
<#
.SYNOPSIS
Prepares an Azure Virtual Desktop image host virtual machine, generalizes it, captures it as an image, and then recreates the VM from the new image.

.DESCRIPTION
The Prepare-ImageClient.ps1 script automates the process of preparing a Windows Virtual Desktop image host for deployment. It ensures all necessary Azure modules are available, manages resource groups and locks, verifies VM states, generalizes the source VM, captures an image, stores VM credentials securely in an Azure Key Vault, deletes and recreates the VM from the new image, and updates relevant metadata and security settings. The script also logs its activity and restores any previously existing resource locks after processing.

.INPUTS
None. The script relies on environment variables and configuration files such as 01_ConfigureEnv.ps1.

.OUTPUTS
This script produces log files in the Alya logs directory and creates or updates Azure resources such as virtual machines, images, and Key Vault secrets.
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCD8qIltFBU5k7v0
# g+ZkTYChJ942na5Z30e+EcP2pKnAsKCCFIswggWiMIIEiqADAgECAhB4AxhCRXCK
...
# KwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIHpxyLvM
# lhDSu1B7cEV1sf2ipgpF93nmz8ynu9FEauobMA0GCSqGSIb3DQEBAQUABIICAEIp
# onxBimVI9+4HlfgM+PLnTNqf8MfhCO8MKbfqYpTxOhuL3Ptq2LZFZ3+gFpVgXwFt
# O/LCKfGIubj2FAok2VSjnKdPGUzu00dcyDu42mnZ4X7vW1Q8x1mP6DBkdU8Q1QDm
# QLzKlsPERKCaS74CxC6Ll7yRVPml1n/yelkdsP3TblBrFU5+9C1fINaXbvPQJ/UC
# zay9sxy1fOJgw/yCHMQGsx6/xswtwnoqZqgM+x9sZAYRuZejPL3VA0gjg0SkRHQm
# ZGfab5Ldvz985Bp2VYcRXBqntW70oqc4lLl/VnHmVq5Ul1DYldwx8WapnRnq596Y
# +/IxTVNQzTJ3Wkqu1UoqJMXY/Mw4Fx7K1Cm8pu64qrri2i5ENv0CHOE9MfvgxosQ
# v8jIZaV3vKp6+/1ZifCw83BbPlJTlF7HJJ0Bqr47y6gMpwBYSsfMjgbTjkPSp+hv
# Do2OM0jttDzFLuIOrDgnxVzp9dMZ68E+IUlaE92sh+AIZpO+1EXSZS6tHfuUZLkc
# MEIfMdy/rq+LBa5ItzKnPCnqcS10/UZDnddwgVEDzCpqdvQpDCBPCozBXeb90nnz
# H3JoVJV/xLNIxACaLZW93yCHYAgInRNijyoTFbbVa/Mpyv76Vhj0gKdsc9rPo8xs
# eUs4llTR+jaK2OaWS/01WH8ELiWzRFwz9qFEp9/boYIWuzCCFrcGCisGAQQBgjcD
...
# SAFlAwQCAQUABCAvISYR3BO6PiqT0Bz/Bq7P420/nPL8DVWPQNtypf0UEgIUK3vo
# r56/pFy4liO4JeUHbaQo8PYYDzIwMjYwMjEyMjAzMzQ4WjADAgEBoFikVjBUMQsw
...
# AQkEMSIEIBZ0gAPzsDs5dn+b2uyKeM0E1wASRBUF39SlsAn757GbMIGwBgsqhkiG
...
# Mzg0IC0gRzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAQB2j
# eKDDvABN+P16vNCijoV8vXVzN3ShpTKWSuLGWN2kcv/RduqB0LJjvTDLF8AtkWzj
# ys1y5z/n70li2n6++WLNLveOFmK4v8TMrPWQOMS1ZOU8hYCeY6yil62wKY1wJqRj
# fMLJQ0NEHOewtCe4o8mQk/pHHmdJspiAqmqZ0USntoTlyXaxw8pCeNXlkxX26Jd0
# Gx4SO+M2vAMnIiL2B8W9zE5VNFWEudYLvqb00e/TE4do3wUbns2X2XXVljXB3APr
# /QIG/dRKtpFHPyHag2cSIOGd/nBy1eRsgtYCSZhQn3x232y7cujAOdc+dmLA0xn+
# 1kCGbUVwd96U5hq3PBqHEeB4nXpIWATdZVjfL94+2qkKoCYvy3MnffufeYVMphBc
# d6h7KxfLvxYbdXFO7cnl0aPP3UbGezdZ/sckWoH/owUfAdbxvNW4oKVrlrqqzuee
# s/6aY8Yta+YHXWZUu5F/LyMLOQGQS5ZzTS92qZSmoW5Q7YDKLVIrZXZdUrdn
