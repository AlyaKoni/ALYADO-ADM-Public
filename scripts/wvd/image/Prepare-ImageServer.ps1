...
<#
.SYNOPSIS
Prepares an Azure Virtual Machine as an image server by generalizing the VM, creating an image, managing Azure resources, and recreating the VM based on the new image.

.DESCRIPTION
The Prepare-ImageServer.ps1 script automates the process of converting a specified Azure virtual machine into a generalized image for use in image-based deployments. It verifies necessary modules, checks and creates resource groups, prepares and generalizes the source VM, creates images in Azure, manages key vault secrets, recreates the VM using the new image, applies tagging and restores resource locks. The script ensures consistent and repeatable image preparation and deployment within the Alya Base Configuration framework.

.INPUTS
None. The script uses configuration and context variables defined in the Alya Base Configuration environment file.

.OUTPUTS
The script creates a generalized Azure image resource and outputs log files stored in the specified AlyaLogs directory.
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBxhzmV48DaOKs8
# FtisApsONP2hw/oUJTKRnl5JnsSNyaCCDuUwggboMIIE0KADAgECAhB3vQ4Ft1kL
...
# NwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIINjXa4wloT7d8HY
# 4JM/+JAapckQDraEPyYKHOEGY3mMMA0GCSqGSIb3DQEBAQUABIICAK3yt3FuTdON
# lphx3qPU29abSEmllMFX0eo5s6s7mAmmKNu94/4FHQHK/6ibdAlEgJMzOk1R4s9v
# mtJq0eU0gOYrhAk/JdnSdZn5byq7coLIM1GW7jWXvalhwlrur96DhytuTcLSM2uc
# iSL0z79gPnNuuGWh4SNKxM353Pdtlg9mE38PStD5XBpkm2MBBj2rYD/fk2IAuODd
# cVpCCD4Rng0UB/E3VRXK7zGTWtW96Pnz+u0mo44P3fZjHLdK6N4AZN8oIIJQYZ31
# a7snAX0sGXmperbWhvpkN+bd73TDhNIhsC0Lo8AawDYkVrLNZON7pDwGOoRfO2UN
# CCJyFIId2heZwbX/3Ht9Lv3c4F0ppr+JYkn6WWjXqRF8ujeYNjKVLL6ArsJ+ZfXM
# 3jSivvun2HE3aDgDr6ukpFOGQrxx9Tt4tPr3dmiDggqbkOvuUu1PGeNTycUeJTgY
# MTAaxZNT9mIcQMFUAx+qopVaCa+wKoJgQhwUp62otsqHWFJ4ziuoWSTpU0UJ6PtA
# 26/6dmSepS3SEgVsw1UBXVz8YMCYWl6eQUaUHpllMqH/UdlYySi021xhHWCp7JdT
# JrMlVy9RNiC0Tg+jiK4YBPSyemcuPQPuvb0PE/EcLzwcfNanGMUqqDMVGIMfY1IH
# pJSZa+4WmCZY7KZS43hcakf6CJ/ICnG+oYIWuzCCFrcGCisGAQQBgjcDAwExghan
# MIIWowYJKoZIhvcNAQcCoIIWlDCCFpACAQMxDTALBglghkgBZQMEAgEwgd8GCyqG
# SIb3DQEJEAEEoIHPBIHMMIHJAgEBBgsrBgEEAaAyAgMBAjAxMA0GCWCGSAFlAwQC
# AQUABCBzxw7ihKtGltTwyeasbLJMbwt1nmugQeXP/fWG00xQnAIUChtomFe5PbVt
# wlyRSx+yHXaM1CkYDzIwMjYwMjA2MTIyOTA1WjADAgEBoFikVjBUMQswCQYDVQQG
...
# IPkm3Hwoz6ICxwfdCHhBklRn8a7T2ldaHULmrao7+naVMIGwBgsqhkiG9w0BCRAC
# LzGBoDCBnTCBmjCBlwQgcl7yf0jhbmm5Y9hCaIxbygeojGkXBkLI/1ord69gXP0w
# czBfpF0wWzELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# MTAvBgNVBAMTKEdsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gU0hBMzg0IC0g
# RzQCEAEACyAFs5QHYts+NnmUm6kwDQYJKoZIhvcNAQELBQAEggGAoIuSTaU+hw0Q
# UBW6pfX2TvRvIIt53mKty5MX7feoxb+si35n7O/6TEDLCoMlXZQ6bkZ+eYcHNnrC
# g6UYEQ1pJ/hgV3g86TegPzLk4myNNxe9rxb0FfVDx47KO2aCH+Ehh9/v3ZbyKEd6
# rqpqSqfZd/1EvY5j8zB0FH00ah3qMFvkNLn8tH6KezmLRAp6u3/AWNxDHViDWwar
# veco83dYha9m6SXsb0C2v8vtxukqyfk9/mfEPoo1tvpxNwwUHcxxL7H2/iUl/3RG
# V8r1+1Pq8mW2RRhCLtJ5TG9Oc8Esrw7WvLErXfBPTgo75YAkCCAEey2PJU1NeKDk
# xFiAN58/u6AvmuST9Gj7z8F9nRkSYjWYCBx2kfjqy7UtwhHQ2xac1Nenb8kI7awD
# Yj66t13pU4kjajGvPRi5bgvby2pz+j7Et3U468ytQewD8hYPtmYns8NGPbf5jMqu
# TNKOl7XbUi3cJj4MDi8myeEPxq21ScoTvVNpzIcswf/VIrkw0cxv
